...
DEFINE INPUT PARAMETER xchange-rate AS DECIMAL. /*FDL Change exrate to xchange-rate: 8FE76C*/
...
DEFINE VARIABLE to-name AS CHAR INITIAL "". 
  ...
  DO:
    ...
    DO:
      ...
      END.
      ASSIGN
        total-saldo = total-saldo * xchange-rate
        arriv-saldo = arriv-saldo * xchange-rate
      .
    END.
  END.
