...
release_table_data, Release_table = create_model("Release_table", {"dept":int, "tableno":int, "pax":int, "gname":string, "occupied":bool, "session_parameter":string, "gemail":string, "expired_session":bool, "dataqr":string, "date_time":datetime})

def pos_dashboard_release_tablebl(release_table_data:[Release_table], dynamic_qr:bool, asroom_service:bool):
    ...
    release_table = query(release_table_data, first=True)
