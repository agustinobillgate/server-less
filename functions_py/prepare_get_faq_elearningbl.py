...
#   ------------------------------------------------
# Rd, 20/11/2025
# Remark, skip Elearning, ada comment connect hdesk
#   ------------------------------------------------
...
def prepare_get_faq_elearningbl():
    ...
    module_list_data, Module_list = create_model("Module_list", {"module_no":int, "module_name":string})
    ...
    def generate_output():
        ...
        return {"tot_video": tot_video, "errormsg": errormsg, "module-list": module_list_data}
    ...
    #     tot_video, module_list_data = get_output(prepare_get_elearningbl_hdesk())
