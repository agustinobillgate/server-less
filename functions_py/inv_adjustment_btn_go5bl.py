...
c_list_data, C_list = create_model("C_list", {"artnr":int, "bezeich":string, "munit":string, "inhalt":string, "zwkum":string, "endkum":int, "qty":Decimal, "qty1":Decimal, "fibukonto":string, "avrg_price":Decimal, "cost_center":string, "flag_coa":bool}, {"fibukonto": "0000000000"})

def inv_adjustment_btn_go5bl(from_grp:int, transdate:date, curr_lager:int, sorttype:int, user_init:string, c_list_data:[C_list]):
