...
stage_list_data, Stage_list = create_model_like(Akt_code)

def aktstage_admin_btn_exitbl(case_type:int, rec_id:int, stage_list_data:[Stage_list]):
    ...
    stage_list = query(stage_list_data, first=True)
