...
def ts_restinv_btn_transfer_paytype56bl(rec_id:int, guestnr:int, curr_dept:int, balance_foreign:Decimal, balance:Decimal, pay_type:int, transdate:date, double_currency:bool, exchg_rate:Decimal, price_decimal:int, user_init:string):
    ...
    def generate_output():
        nonlocal payment_exist, p_artnr, billart, qty, description, price, amount_foreign, amount, bill_date, fl_code, t_h_artikel_data, h_artikel, h_bill, h_bill_line, queasy, htparam, h_umsatz, artikel, kellner, kellne1, umsatz, h_compli, arrangement, argt_line, billjournal
        ...
        return {"payment_exist": payment_exist, "p_artnr": p_artnr, "billart": billart, "qty": qty, "description": description, "price": price, "amount_foreign": amount_foreign, "amount": amount, "bill_date": bill_date, "fl_code": fl_code, "t-h-artikel": t_h_artikel_data}
    ...
    def adjust_complito():
        ...
        nonlocal payment_exist, p_artnr, billart, qty, description, price, bill_date, fl_code, t_h_artikel_data, h_artikel, h_bill, h_bill_line, queasy, htparam, h_umsatz, artikel, kellner, kellne1, umsatz, h_compli, arrangement, argt_line, billjournal
        nonlocal rec_id, guestnr, curr_dept, balance_foreign, balance, pay_type, transdate, double_currency, exchg_rate, price_decimal, user_init
    ...
    def adjust_revbdown(bill_date:date, amount:Decimal, qty:int):
        ...
        nonlocal payment_exist, p_artnr, billart, description, price, amount_foreign, fl_code, t_h_artikel_data, h_artikel, h_bill, h_bill_line, queasy, htparam, h_umsatz, artikel, kellner, kellne1, umsatz, h_compli, arrangement, argt_line, billjournal
        nonlocal rec_id, guestnr, curr_dept, balance_foreign, balance, pay_type, transdate, double_currency, exchg_rate, price_decimal, user_init
