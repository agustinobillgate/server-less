...
def pr_sphbill_webbl(pvilanguage:int, user_init:string, print_all:bool, printnr:int, hbrecid:int, use_h_queasy:bool, bill_nr:int):
    ...
    t_print_head_data, T_print_head = create_model("T_print_head", {"str_date":string, "str_time":string, "bill_no":string, "resto_name":string, "table_usr_id":string, "curr_time":string, "guest_member":string}, {"str_date": "", "str_time": "", "bill_no": "", "resto_name": "", "table_usr_id": "", "curr_time": "", "guest_member": ""})
    ...
    def generate_output():
        nonlocal msg_str, room_no, guest_name, t_print_head_data, t_print_line_data, lvcarea, session_parameter, winprinterflag, filename, table_no, usr_id, pax, counter, gs, pay_str, pay_amount, curr_amount, curr_pay, rechnr_str, flag_change, flag_pay, flag_vat, foot_note, guest_addr, guest_addr1, count_i, gs_1, split_no, printer
    ...
    print_all, winprinterflag, filename, msg_str, output_list2_data, t_printer_data = get_output(pr_sphbill1_lnlbl(pvilanguage, hbrecid, printnr, use_h_queasy, session_parameter, user_init, bill_nr, print_all))
    ...
    print_list = query(print_list_data, filters=(lambda print_list: print_list.str_pos == 5), first=True)
