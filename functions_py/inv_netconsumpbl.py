    ...
    def create_list():
        ...
        if sorttype != 3:
            ...
            if to_date <= close_date:
                ...
                l_ophis = L_ophis()
                l_artikel = L_artikel()
                for l_ophis.artnr, l_ophis.anzahl, l_ophis.warenwert, l_ophis.fibukonto, l_ophis.lager_nr, l_ophis._recid, l_artikel.bezeich, l_artikel.masseinheit, l_artikel.traubensorte, l_artikel._recid in db_session.query(L_ophis.artnr, L_ophis.anzahl, L_ophis.warenwert, L_ophis.fibukonto, L_ophis.lager_nr, L_ophis._recid, L_artikel.bezeich, L_artikel.masseinheit, L_artikel.traubensorte, L_artikel._recid).join(L_artikel,(L_artikel.artnr == L_ophis.artnr) & (L_artikel.endkum == main_grp)).filter((L_ophis.datum >= from_date) & (L_ophis.datum <= to_date) & (L_ophis.op_art == 3) & (substring(L_ophis.lscheinnr, 0, 3) == ("INV").lower())).order_by(L_artikel.bezeich, L_ophis.datum, L_ophis.lscheinnr).all():
                ...
                l_op = L_op()
                l_artikel = L_artikel()
                for l_op.artnr, l_op.anzahl, l_op.warenwert, l_op.lager_nr, l_op._recid, l_artikel.bezeich, l_artikel.masseinheit, l_artikel.traubensorte, l_artikel._recid in db_session.query(L_op.artnr, L_op.anzahl, L_op.warenwert, L_op.lager_nr, L_op._recid, L_artikel.bezeich, L_artikel.masseinheit, L_artikel.traubensorte, L_artikel._recid).join(L_artikel,(L_artikel.artnr == L_op.artnr) & (L_artikel.endkum == main_grp)).filter((L_op.datum >= from_date) & (L_op.datum <= to_date) & (L_op.op_art == 3) & (L_op.loeschflag <= 1) & (substring(L_op.lscheinnr, 0, 3) == ("INV").lower())).order_by(L_artikel.bezeich, L_op.datum, L_op.lscheinnr).all():
            ...
            if to_date <= close_date:
                ...
                l_ophis = L_ophis()
                l_artikel = L_artikel()
                for l_ophis.artnr, l_ophis.anzahl, l_ophis.warenwert, l_ophis.fibukonto, l_ophis.lager_nr, l_ophis._recid, l_artikel.bezeich, l_artikel.masseinheit, l_artikel.traubensorte, l_artikel._recid in db_session.query(L_ophis.artnr, L_ophis.anzahl, L_ophis.warenwert, L_ophis.fibukonto, L_ophis.lager_nr, L_ophis._recid, L_artikel.bezeich, L_artikel.masseinheit, L_artikel.traubensorte, L_artikel._recid).join(L_artikel,(L_artikel.artnr == L_ophis.artnr) & (L_artikel.endkum >= 3)).filter((L_ophis.datum >= from_date) & (L_ophis.datum <= to_date) & (L_ophis.op_art == 3) & (substring(L_ophis.lscheinnr, 0, 3) == ("INV").lower())).order_by(L_artikel.bezeich, L_ophis.datum, L_ophis.lscheinnr).all():
                ...
                l_op = L_op()
                l_artikel = L_artikel()
                for l_op.artnr, l_op.anzahl, l_op.warenwert, l_op.lager_nr, l_op._recid, l_artikel.bezeich, l_artikel.masseinheit, l_artikel.traubensorte, l_artikel._recid in db_session.query(L_op.artnr, L_op.anzahl, L_op.warenwert, L_op.lager_nr, L_op._recid, L_artikel.bezeich, L_artikel.masseinheit, L_artikel.traubensorte, L_artikel._recid).join(L_artikel,(L_artikel.artnr == L_op.artnr) & (L_artikel.endkum >= 3)).filter((L_op.datum >= from_date) & (L_op.datum <= to_date) & (L_op.op_art == 3) & (L_op.loeschflag <= 1) & (substring(L_op.lscheinnr, 0, 3) == ("INV").lower())).order_by(L_artikel.bezeich, L_op.datum, L_op.lscheinnr).all():
        ...
        for tbuff in query(tbuff_data, sort_by=[("bezeich",False)]):
            tbuff.nr = i
            i = i + 1
