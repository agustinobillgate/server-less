...
def hk_statadmin_chk_btn_exit1bl(bline_list_data:[Bline_list], om_list_data:[Om_list], pvilanguage:int, resflag:bool, dept:int, zinr:string, user_nr:int, from_date:date, to_date:date, ci_date:date, reason:string):
    ...
    def generate_output():
        nonlocal msg_str, z_list_data, return_flag, from_stat, to_stat, curr_date, lvcarea, stat_list, res_line, zimmer, outorder, bediener, res_history, queasy, zimkateg
        ...
        return {"bline-list": bline_list_data, "om-list": om_list_data, "msg_str": msg_str, "z-list": z_list_data}
