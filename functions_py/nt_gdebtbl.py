...
def nt_gdebtbl():
    ...
    def generate_output():
        nonlocal pvilanguage, lvcarea, n, progname, night_type, reihenfolge, line_nr, line, p_width, p_length, htl_name, htl_adr, htl_tel, bill_date, paramtext, htparam, nightaudit, nitestor, umsatz, debitor, bill, reservation, artikel
    ...
    def balance_list():
        ...
        for i in range(1,10 + 1) :
            line = line + " "
        line = line + translateExtended ("Bill.Date :", lvcarea, "") + " " + to_string(bill_date)
        add_line(line)
        ...
        add_line(line)
        add_line(" ")
        line = translateExtended ("List of Debts Balance", lvcarea, "")
        add_line(line)
        add_line(" ")
        line = ""
        ...
        # Rulita,
        # - Fix space in string
        line = translateExtended ("Debts Account                               Balance", lvcarea, "")
        add_line(line)
        line = ""
        for i in range(1,p_width + 1) :
            line = line + "-"
    ...
    def create_debtbalance():
        ...
        cl_list.bezeich = translateExtended ("Resident Guests", lvcarea, "")
        ...
        cl_list.bezeich = translateExtended ("Non Stay Guests", lvcarea, "")
        cl_list.saldo =  to_decimal(tot_val)
        tot_val =  to_decimal("0")
        ...
        cl_list.bezeich = translateExtended ("Master Bills", lvcarea, "")
        cl_list.saldo =  to_decimal(tot_val)
        tot_val =  to_decimal("0")
        ...
        cl_list.bezeich = translateExtended ("Deposits", lvcarea, "")
        cl_list.saldo =  to_decimal(tot_val)
        tot_val =  to_decimal("0")
        cl_list = Cl_list()
        cl_list_data.append(cl_list)

        cl_list.bezeich = translateExtended ("Outlet Cashier's Outstandings", lvcarea, "")
        cl_list.saldo =  to_decimal(tot_val)
        cl_list = Cl_list()
        cl_list_data.append(cl_list)
        ...
        cl_list.flag = "**"
        cl_list.bezeich = translateExtended ("Total Debts", lvcarea, "")
