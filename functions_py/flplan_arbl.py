...
def flplan_arbl(pvilanguage:int):
    ...
    cr_list_data, Cr_list = create_model("Cr_list", {"curr_row":int, "curr_col":int, "zistatus":int, "i_bgcol":int, "i_fgcol":int, "i_resnr":int, "i_reslinnr":int, "i_rstat":int, "rmcat":string, "ankunft":date, "abreise":date, "g_info":string, "r_info":string, "arrival":bool, "selectflag":bool, "room":string}, {"i_bgcol": 15, "i_rstat": None, "rmcat": "", "g_info": "", "r_info": "", "selectflag": True, "room": ""})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal max_row, max_col, cr_list_data, curr_i, ci_date, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, item_fgcol, lvcarea, htparam, zimmer, zimkateg, outorder, res_line, reservation, queasy, waehrung, reslin_queasy
    ...
    def create_r_list():
        ...
        for res_line in db_session.query(Res_line).filter(
            ...
            cr_list = query(cr_list_data, filters=(lambda cr_list: cr_list.room == res_line.zinr), first=True)
