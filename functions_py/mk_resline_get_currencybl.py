...
def mk_resline_get_currencybl(reslin_list_betriebsnr:int, marknr:int, foreign_rate:bool, t_contcode:string, 
    ...
    def generate_output():
        ...
        return {"reslin_list_betriebsnr": reslin_list_betriebsnr, "local_nr": local_nr, "foreign_nr": foreign_nr, "guest_currency": guest_currency, "curr_wabnr": curr_wabnr, "waehrung1_wabkurz": waehrung1_wabkurz, "err_msg": err_msg, "return_flag": return_flag, "err_whr": err_whr, "t-waehrung1": t_waehrung1_data}
