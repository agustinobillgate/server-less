...
def create_totp_secretbl(user_name:string, hotel_code:string):
    ...
    hotel_code = hotel_code.strip()

    def generate_output():
        nonlocal totpuri, recoverycode, epoch_signature, signature_list_data, base32chars, randombyte, i, issuer, algorithm, digits, period, totpsecret, bediener, queasy, res_history, paramtext
        ...
        return {"totpuri": totpuri, "recoverycode": recoverycode, "epoch_signature": epoch_signature, "signature-list": signature_list_data}
