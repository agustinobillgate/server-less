    ...
    def update_it():
        ...
        if (substring(l_op.docu_nr, 0, 1) == ("P").lower()):
            ...
            if not l_order:
                ...
                l_order = db_session.query(L_order).filter(L_order.lief_nr == l_op.lief_nr,
                         ...
                         L_order.geliefert > l_op.anzahl).with_for_update().first()
            ...
            if l_order:
                ...
                l_order1 = db_session.query(L_order).filter(L_order.docu_nr == l_order.docu_nr,
        ...
        if substring(l_op.docu_nr, 0, 1) == ("D").lower()  or substring(l_op.docu_nr, 0, 1) == ("I").lower() :
            ...
            l_pprice = db_session.query(L_pprice).filter(
                     (L_pprice.artnr == l_op.artnr) & (L_pprice.bestelldatum == l_op.datum) & (L_pprice.anzahl == l_op.anzahl) & (L_pprice.einzelpreis == l_op.einzelpreis) & (L_pprice.lief_nr == l_op.lief_nr) & (L_pprice.docu_nr == l_op.lscheinnr)).with_for_update().first()
            ...
            l_pprice = db_session.query(L_pprice).filter(
                     (L_pprice.artnr == l_op.artnr) & (L_pprice.bestelldatum == l_op.datum) & (L_pprice.anzahl == l_op.anzahl) & (L_pprice.einzelpreis == l_op.einzelpreis) & (L_pprice.lief_nr == l_op.lief_nr) & (L_pprice.docu_nr == l_op.docu_nr)).with_for_update().first()
