...
def fo_journal_cld_3bl(from_art:int, to_art:int, from_dept:int, to_dept:int, from_date:date, to_date:date, sorttype:int, exclude_artrans:bool, long_digit:bool, foreign_flag:bool, mi_onlyjournal:bool, mi_excljournal:bool, mi_post:bool, mi_showrelease:bool, mi_break:bool, id_flag:string):
    ...
    def generate_output():
        ...
        return {"log": log_debug, "gtot": gtot, "output-list": output_list_data}
    ...
    def handle_null_date(inp_date:date):
        ...
        if inp_date == None:
            ...
            return to_string(inp_date, "%d/%m/%y")
    ...
    def custom_record():
        ...
        log_debug.append(f"Zinrdate: {zinrdate}, JournalDate: {journdate}, Roomnumber: {roomnumber}, Billnumber: {billnumber}, Artikelnr: {artikelnr}")
        curr_str = " "
        curr_resnr = 0
        ...
        if output_list.mb.lower()  == ("*").lower() :
            ...
            if billnumber != 0:
                ...
                res_line = db_session.query(Res_line).filter(Res_line.resnr == output_list.resnr, Res_line.zinr == roomnumber, Res_line.ankunft <= zinrdate, Res_line.abreise >= zinrdate).first()
            ...
            if guest and reservation:
                ...
                segment = db_session.query(Segment).filter(Segment.segmentcode == reservation.segmentcode.strip()).first()
        ...
        if roomnumber != "" and billnumber == 0:
            if zinrdate != None and journdate != None:
                if zinrdate >= journdate:
                    ...
                    # res_line = get_cache (Res_line, {"resnr": [(eq, output_list.resnr.strip())],"ankunft": [(le, zinrdate)],"abreise": [(ge, zinrdate)]})
                    res_line = db_session.query(Res_line).filter(Res_line.resnr == output_list.resnr, Res_line.ankunft <= zinrdate, Res_line.abreise >= zinrdate).first()
                    
                    # if res_line:
                    #     log_debug.append(f"Res Line Found, Resnr: {res_line.resnr}, Zinr: {res_line.zinr}, Ankunft: {res_line.ankunft}, Abreise: {res_line.abreise}")
                    # else:
                    #     log_debug.append(f"Res Line Not Found: Resnr: {output_list.resnr}, Zinr: {roomnumber}, Ankunft: {zinrdate}")    

        
                    # reservation = get_cache (Reservation, {"resnr": [(eq, res_line.resnr)]})
                    reservation = db_session.query(Reservation).filter(Reservation.resnr == output_list.resnr).first()
    ...
    def journal_list():
        ...
        for artikel in db_session.query(Artikel).filter(
            ...
            for curr_date in date_range(from_date,to_date) :
                ...
                if sorttype == 0:
                    ...
                    for billjournal in db_session.query(Billjournal).filter(
                             ...
                             (Billjournal.anzahl != 0)).order_by(Billjournal.sysdate, Billjournal.zeit, Billjournal.zinr).all():
                        do_it = True
                        ...
                        if do_it:
                            ...
                            if output_list:
                                ...
                                output_list.voucher = format_fixed_length(str(voucher_no), 40)
                            ...
                            if billjournal.bediener_nr == 0 and mi_onlyjournal == False:
                                ...
                                if get_index(billjournal.bezeich, "Deposit") > 0 and get_index(billjournal.bezeich, "[") > 0 and get_index(billjournal.bezeich, "#") > 0 and billjournal.rechnr != 0:
                                    ...
                                    if not long_digit:
                                        output_list.str = to_string(handle_null_date (billjournal.bill_datum)) + format_fixed_length(handle_null_char (billjournal.zinr) , 6) + format_fixed_length(str(billjournal.rechnr), 9) + to_string(billjournal.artnr, "9999") + to_string(handle_null_char (descr1) , "x(50)") + format_fixed_length(deptname, 12) + to_string(billjournal.betriebsnr, ">>>>>>") + format_fixed_length(to_string(billjournal.anzahl, "-9999"), 5) + format_fixed_length(to_string(amount, "->>,>>>,>>>,>>>,>>9.99"), 22) + to_string(billjournal.zeit, "HH:MM:SS") + to_string(handle_null_char (billjournal.userinit) , "x(4)") + to_string(handle_null_date (billjournal.sysdate)) + to_string(handle_null_char (voucher_no) , "x(24)")
                                    else:
                                        output_list.str = to_string(handle_null_date (billjournal.bill_datum)) + format_fixed_length(handle_null_char (billjournal.zinr) , 6) + format_fixed_length(str(billjournal.rechnr), 9) + to_string(billjournal.artnr, "9999") + to_string(handle_null_char (billjournal.bezeich) , "x(50)") + format_fixed_length(deptname, 12) + to_string(billjournal.betriebsnr, ">>>>>>") + format_fixed_length(to_string(billjournal.anzahl, "-9999"), 5) + format_fixed_length(to_string(amount, "->,>>>,>>>,>>>,>>>,>>9"), 22) + to_string(billjournal.zeit, "HH:MM:SS") + to_string(handle_null_char (billjournal.userinit) , "x(4)") + to_string(handle_null_date (billjournal.sysdate)) + to_string(handle_null_char (voucher_no) , "x(24)")
                                else:

                                    if not long_digit:
                                        output_list.str = to_string(handle_null_date (billjournal.bill_datum)) + format_fixed_length(handle_null_char (billjournal.zinr) , 6) + format_fixed_length(str(billjournal.rechnr), 9) + to_string(billjournal.artnr, "9999") + to_string(handle_null_char (descr1) , "x(50)") + format_fixed_length(deptname, 12) + to_string("", "x(6)") + to_string(billjournal.anzahl, "-9999") + to_string(amount, "->>,>>>,>>>,>>>,>>9.99") + to_string(billjournal.zeit, "HH:MM:SS") + to_string(handle_null_char (billjournal.userinit) , "x(4)") + to_string(handle_null_date (billjournal.sysdate)) + to_string(handle_null_char (voucher_no) , "x(24)")
                                    else:
                                        output_list.str = to_string(handle_null_date (billjournal.bill_datum)) + format_fixed_length(handle_null_char (billjournal.zinr) , 6) + format_fixed_length(str(billjournal.rechnr), 9) + to_string(billjournal.artnr, "9999") + to_string(handle_null_char (billjournal.bezeich) , "x(50)") + format_fixed_length(deptname, 12) + to_string("", "x(6)") + to_string(billjournal.anzahl, "-9999") + to_string(amount, "->,>>>,>>>,>>>,>>>,>>9") + to_string(billjournal.zeit, "HH:MM:SS") + to_string(handle_null_char (billjournal.userinit) , "x(4)") + to_string(handle_null_date (billjournal.sysdate)) + to_string(handle_null_char (voucher_no) , "x(24)")
                            ...
                            try:
                                ...
                                log_debug.append(f"Error in custom_record 1262: {e}, Resnr: {output_list.resnr}")
                                log_debug.append(output_list.str)
                                log_debug.append(traceback.format_exc())
                        ...
                        if do_it:
                            ...
                            if billjournal.bediener_nr == 0 and mi_onlyjournal == False:
                                ...
                                if get_index(billjournal.bezeich, "Deposit") > 0 and get_index(billjournal.bezeich, "[") > 0 and get_index(billjournal.bezeich, "#") > 0 and billjournal.rechnr != 0:
                                    ...
                                    if not long_digit:
                                        output_list.str = to_string(handle_null_date (billjournal.bill_datum)) + format_fixed_length(handle_null_char (billjournal.zinr) , 6) + format_fixed_length(str(billjournal.rechnr), 9) + to_string(billjournal.artnr, "9999") + to_string(handle_null_char (descr1) , "x(50)") + format_fixed_length(deptname, 12) + to_string("", "x(6)") + format_fixed_length(to_string(billjournal.anzahl, "-9999"), 5) + format_fixed_length(to_string(amount, "->>,>>>,>>>,>>>,>>9.99"), 22) + to_string(billjournal.zeit, "HH:MM:SS") + to_string(handle_null_char (billjournal.userinit) , "x(4)") + to_string(handle_null_date (billjournal.sysdate)) + to_string(handle_null_char (voucher_no) , "x(24)")
                                    else:
                                        output_list.str = to_string(handle_null_date (billjournal.bill_datum)) + format_fixed_length(handle_null_char (billjournal.zinr) , 6) + format_fixed_length(str(billjournal.rechnr), 9) + to_string(billjournal.artnr, "9999") + to_string(handle_null_char (billjournal.bezeich) , "x(50)") + format_fixed_length(deptname, 12) + to_string("", "x(6)") + format_fixed_length(to_string(billjournal.anzahl, "-9999"), 5) + format_fixed_length(to_string(amount, "->,>>>,>>>,>>>,>>>,>>9"), 22) + to_string(billjournal.zeit, "HH:MM:SS") + to_string(handle_null_char (billjournal.userinit) , "x(4)") + to_string(handle_null_date (billjournal.sysdate)) + to_string(handle_null_char (voucher_no) , "x(24)")
                                qty = qty + billjournal.anzahl
                                gqty = gqty + billjournal.anzahl
                            ...
                            try:
                                ...
                                log_debug.append(f"Error in custom_record 1881: {e}")
                                log_debug.append(output_list.str)
                                log_debug.append(traceback.format_exc())
                                return generate_output()
                            ...
                            if do_it:
                                ...
                                if billjournal.bediener_nr == 0 and mi_onlyjournal == False:
                                    ...
                                    if get_index(billjournal.bezeich, "Deposit") > 0 and get_index(billjournal.bezeich, "[") > 0 and get_index(billjournal.bezeich, "#") > 0 and billjournal.rechnr != 0:
                                        ...
                                        if not long_digit:
                                            output_list.str = to_string(handle_null_date (billjournal.bill_datum)) + format_fixed_length(handle_null_char (billjournal.zinr) , 6) + format_fixed_length(str(billjournal.rechnr), 9) + to_string(billjournal.artnr, "9999") + to_string(handle_null_char (descr1) , "x(50)") + format_fixed_length(deptname, 12) + to_string(billjournal.betriebsnr, ">>>>>>") + to_string(billjournal.anzahl, "-9999") + to_string(amount, "->>,>>>,>>>,>>>,>>9.99") + to_string(billjournal.zeit, "HH:MM:SS") + to_string(handle_null_char (billjournal.userinit) , "x(4)") + to_string(handle_null_date (billjournal.sysdate)) + to_string(handle_null_char (voucher_no) , "x(24)")
                                        else:
                                            output_list.str = to_string(handle_null_date (billjournal.bill_datum)) + format_fixed_length(handle_null_char (billjournal.zinr) , 6) + format_fixed_length(str(billjournal.rechnr), 9) + to_string(billjournal.artnr, "9999") + to_string(handle_null_char (billjournal.bezeich) , "x(50)") + format_fixed_length(deptname, 12) + to_string(billjournal.betriebsnr, ">>>>>>") + to_string(billjournal.anzahl, "-9999") + to_string(amount, "->,>>>,>>>,>>>,>>>,>>9") + to_string(billjournal.zeit, "HH:MM:SS") + to_string(handle_null_char (billjournal.userinit) , "x(4)") + to_string(handle_null_date (billjournal.sysdate)) + to_string(handle_null_char (voucher_no) , "x(24)")
                                    else:
                                ...
                                try:
                                    ...
                                    log_debug.append(f"Error in custom_record 2221: {e}")
                                    log_debug.append(output_list.str)
                                    log_debug.append(traceback.format_exc())
                                    return generate_output()
                        ...
                        for billjournal in db_session.query(Billjournal).filter(
                            ...
                            if do_it:
                                ...
                                if (billjournal.bediener_nr != 0 and mi_excljournal == False) or (billjournal.bediener_nr == 0 and mi_onlyjournal == False):
                                    ...
                                    if not long_digit:
                                        output_list.str = to_string(handle_null_date (billjournal.bill_datum)) + \
                                                            format_fixed_length(handle_null_char (billjournal.zinr) , 6) + \
                                                            format_fixed_length(str(billjournal.rechnr), 9) + \
                                                            to_string(billjournal.artnr, "9999") + \
                                                            to_string(handle_null_char (descr1) , "x(50)") + \
                                                            format_fixed_length(deptname, 12) + \
                                                            to_string(billjournal.betriebsnr, ">>>>>>") + \
                                                            format_fixed_length(to_string(billjournal.anzahl, "-9999"), 5) + \
                                                            format_fixed_length(to_string(amount, "->>,>>>,>>>,>>>,>>9.99"), 22 ) + \
                                                            to_string(billjournal.zeit, "HH:MM:SS") + \
                                                            to_string(handle_null_char (billjournal.userinit) , "x(4)") + \
                                                            to_string(handle_null_date (billjournal.sysdate)) + \
                                                            to_string(handle_null_char (voucher_no) , "x(24)")
                                    else:
                                        output_list.str = to_string(handle_null_date (billjournal.bill_datum)) + \
                                                            format_fixed_length(handle_null_char (billjournal.zinr) , 6) + \
                                                            format_fixed_length(str(billjournal.rechnr), 9) + \
                                                            to_string(billjournal.artnr, "9999") + \
                                                            to_string(handle_null_char (billjournal.bezeich) , "x(50)") + \
                                                            format_fixed_length(deptname, 12) + \
                                                            to_string(billjournal.betriebsnr, ">>>>>>") + \
                                                            format_fixed_length(to_string(billjournal.anzahl, "-9999"), 5) + \
                                                            format_fixed_length(to_string(amount, "->>,>>>,>>>,>>>,>>9.99"), 22 ) + \
                            ...
                            try:
                                ...
                                log_debug.append(f"Error in custom_record 2507: {e}")
                                log_debug.append(output_list.str)
                                log_debug.append(traceback.format_exc())
                                return generate_output()
            ...
            if it_exist:
                ...
                try:
                    ...
                    log_debug.append(f"Error in custom_record 2536: {e}")
                    log_debug.append(output_list.str)
                    log_debug.append(traceback.format_exc())
                    return generate_output()
        ...
        try:
            ...
            log_debug.append(f"Error in custom_record 2570: {e}")
            log_debug.append(output_list.str)
            log_debug.append(traceback.format_exc())
            return generate_output()
