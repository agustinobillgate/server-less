...
t_interface1_data, T_interface1 = create_model_like(Interface)
t_interface2_data, T_interface2 = create_model_like(Interface)

def write_interfacebl(case_type:int, t_interface1_data:[T_interface1], t_interface2_data:[T_interface2]):
    ...
    def generate_output():
        ...
        nonlocal case_type, t_interface1_data, t_interface2_data
    ...
    if case_type == 1:
        ...
        t_interface1 = query(t_interface1_data, first=True)
        ...
        t_interface2 = query(t_interface2_data, first=True)
        ...
        for t_interface1 in query(t_interface1_data):
            interface = Interface()
            db_session.add(interface)
