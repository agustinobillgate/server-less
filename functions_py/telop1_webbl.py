...
def telop1_webbl(sorttype:int, room:string, fdate1:date, fdate2:date, ci_date:date, lname:string, last_sort:int, lnat:string, lresnr:int, lvoucher:string):
    ...
    def generate_output():
        nonlocal troom, tpax, telop_list_data, i, str, v_no, rmlen, temp_total, temp_total2, guest, waehrung, reservation, zimkateg, res_line, zkstat, reslin_queasy, messages
    ...
    def disp_arl1():
        ...
        if last_sort == 1:
            ...
            if lvoucher != "":
                ...
                gmember = Guest()
                for res_line.resstatus, res_line.l_zuordnung, res_line.zimmeranz, res_line.erwachs, res_line.zimmer_wunsch, res_line.wabkurz, res_line.voucher_nr, res_line.zinr, res_line.name, res_line.ankunft, res_line.abreise, res_line.ankzeit, res_line.abreisezeit, res_line.flight_nr, res_line.kind1, res_line.gratis, res_line.resnr, res_line.reslinnr, res_line.betrieb_gast, res_line.cancelled_id, res_line.changed_id, res_line.bemerk, res_line.active_flag, res_line.gastnrmember, res_line.gastnr, res_line.betrieb_gastmem, res_line.pseudofix, res_line.zikatnr, res_line.arrangement, res_line.zipreis, res_line._recid, waehrung.wabkurz, waehrung._recid, reservation.gastnr, reservation.grpflag, reservation.name, reservation.segmentcode, reservation.groupname, reservation.bemerk, reservation._recid, zimkateg.kurzbez, zimkateg._recid, gmember.adresse1, gmember.wohnort, gmember.plz, gmember._recid, gmember.nation1 in db_session.query(Res_line.resstatus, Res_line.l_zuordnung, Res_line.zimmeranz, Res_line.erwachs, Res_line.zimmer_wunsch, Res_line.wabkurz, Res_line.voucher_nr, Res_line.zinr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.ankzeit, Res_line.abreisezeit, Res_line.flight_nr, Res_line.kind1, Res_line.gratis, Res_line.resnr, Res_line.reslinnr, Res_line.betrieb_gast, Res_line.cancelled_id, Res_line.changed_id, Res_line.bemerk, Res_line.active_flag, Res_line.gastnrmember, Res_line.gastnr, Res_line.betrieb_gastmem, Res_line.pseudofix, Res_line.zikatnr, Res_line.arrangement, Res_line.zipreis, Res_line._recid, Waehrung.wabkurz, Waehrung._recid, Reservation.gastnr, Reservation.grpflag, Reservation.name, Reservation.segmentcode, Reservation.groupname, Reservation.bemerk, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid, Gmember.adresse1, Gmember.wohnort, Gmember.plz, Gmember._recid, Gmember.nation1).join(Waehrung,(Waehrung.waehrungsnr == Res_line.betriebsnr)).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Gmember,(Gmember.gastnr == Res_line.gastnrmember)).filter(
                         (Res_line.active_flag == 0) & (Res_line.ankunft >= fdate1) & (Res_line.ankunft <= fdate2) & (matches(Res_line.zimmer_wunsch,("*Voucher*")))).order_by((Res_line.kontakt_nr * Res_line.resnr), (Res_line.kontakt_nr * Res_line.resnr), Res_line.resstatus, Res_line.name).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
                    ...
                    for i in range(1,num_entries(res_line.zimmer_wunsch, ";") - 1 + 1) :
                        ...
                        if substring(str, 0, 7) == ("voucher").lower() :
                            v_no = substring(str, 7)

                    if trim(lvoucher) == trim(v_no):
                        assign_it()
                ...
                gmember = Guest()
                for res_line.resstatus, res_line.l_zuordnung, res_line.zimmeranz, res_line.erwachs, res_line.zimmer_wunsch, res_line.wabkurz, res_line.voucher_nr, res_line.zinr, res_line.name, res_line.ankunft, res_line.abreise, res_line.ankzeit, res_line.abreisezeit, res_line.flight_nr, res_line.kind1, res_line.gratis, res_line.resnr, res_line.reslinnr, res_line.betrieb_gast, res_line.cancelled_id, res_line.changed_id, res_line.bemerk, res_line.active_flag, res_line.gastnrmember, res_line.gastnr, res_line.betrieb_gastmem, res_line.pseudofix, res_line.zikatnr, res_line.arrangement, res_line.zipreis, res_line._recid, waehrung.wabkurz, waehrung._recid, reservation.gastnr, reservation.grpflag, reservation.name, reservation.segmentcode, reservation.groupname, reservation.bemerk, reservation._recid, zimkateg.kurzbez, zimkateg._recid, gmember.adresse1, gmember.wohnort, gmember.plz, gmember._recid, gmember.nation1 in db_session.query(Res_line.resstatus, Res_line.l_zuordnung, Res_line.zimmeranz, Res_line.erwachs, Res_line.zimmer_wunsch, Res_line.wabkurz, Res_line.voucher_nr, Res_line.zinr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.ankzeit, Res_line.abreisezeit, Res_line.flight_nr, Res_line.kind1, Res_line.gratis, Res_line.resnr, Res_line.reslinnr, Res_line.betrieb_gast, Res_line.cancelled_id, Res_line.changed_id, Res_line.bemerk, Res_line.active_flag, Res_line.gastnrmember, Res_line.gastnr, Res_line.betrieb_gastmem, Res_line.pseudofix, Res_line.zikatnr, Res_line.arrangement, Res_line.zipreis, Res_line._recid, Waehrung.wabkurz, Waehrung._recid, Reservation.gastnr, Reservation.grpflag, Reservation.name, Reservation.segmentcode, Reservation.groupname, Reservation.bemerk, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid, Gmember.adresse1, Gmember.wohnort, Gmember.plz, Gmember._recid, Gmember.nation1).join(Waehrung,(Waehrung.waehrungsnr == Res_line.betriebsnr)).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Gmember,(Gmember.gastnr == Res_line.gastnrmember)).filter(
                         (Res_line.active_flag == 0) & (Res_line.ankunft >= fdate1) & (Res_line.ankunft <= fdate2) & (matches(Res_line.zimmer_wunsch,("*Voucher*")))).order_by((Res_line.kontakt_nr * Res_line.resnr), Res_line.resstatus, Res_line.name).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
    ...
    def disp_arl2():
        ...
        if last_sort == 1:
            ...
            if lvoucher != "":
                ...
                gmember = Guest()
                for res_line.resstatus, res_line.l_zuordnung, res_line.zimmeranz, res_line.erwachs, res_line.zimmer_wunsch, res_line.wabkurz, res_line.voucher_nr, res_line.zinr, res_line.name, res_line.ankunft, res_line.abreise, res_line.ankzeit, res_line.abreisezeit, res_line.flight_nr, res_line.kind1, res_line.gratis, res_line.resnr, res_line.reslinnr, res_line.betrieb_gast, res_line.cancelled_id, res_line.changed_id, res_line.bemerk, res_line.active_flag, res_line.gastnrmember, res_line.gastnr, res_line.betrieb_gastmem, res_line.pseudofix, res_line.zikatnr, res_line.arrangement, res_line.zipreis, res_line._recid, waehrung.wabkurz, waehrung._recid, reservation.gastnr, reservation.grpflag, reservation.name, reservation.segmentcode, reservation.groupname, reservation.bemerk, reservation._recid, zimkateg.kurzbez, zimkateg._recid, gmember.adresse1, gmember.wohnort, gmember.plz, gmember._recid, gmember.nation1 in db_session.query(Res_line.resstatus, Res_line.l_zuordnung, Res_line.zimmeranz, Res_line.erwachs, Res_line.zimmer_wunsch, Res_line.wabkurz, Res_line.voucher_nr, Res_line.zinr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.ankzeit, Res_line.abreisezeit, Res_line.flight_nr, Res_line.kind1, Res_line.gratis, Res_line.resnr, Res_line.reslinnr, Res_line.betrieb_gast, Res_line.cancelled_id, Res_line.changed_id, Res_line.bemerk, Res_line.active_flag, Res_line.gastnrmember, Res_line.gastnr, Res_line.betrieb_gastmem, Res_line.pseudofix, Res_line.zikatnr, Res_line.arrangement, Res_line.zipreis, Res_line._recid, Waehrung.wabkurz, Waehrung._recid, Reservation.gastnr, Reservation.grpflag, Reservation.name, Reservation.segmentcode, Reservation.groupname, Reservation.bemerk, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid, Gmember.adresse1, Gmember.wohnort, Gmember.plz, Gmember._recid, Gmember.nation1).join(Waehrung,(Waehrung.waehrungsnr == Res_line.betriebsnr)).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Gmember,(Gmember.gastnr == Res_line.gastnrmember)).filter(
                         (Res_line.active_flag == 1) & (Res_line.resstatus != 12) & (matches(Res_line.zimmer_wunsch,("*Voucher*")))).order_by(Res_line.name).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
                ...
                gmember = Guest()
                for res_line.resstatus, res_line.l_zuordnung, res_line.zimmeranz, res_line.erwachs, res_line.zimmer_wunsch, res_line.wabkurz, res_line.voucher_nr, res_line.zinr, res_line.name, res_line.ankunft, res_line.abreise, res_line.ankzeit, res_line.abreisezeit, res_line.flight_nr, res_line.kind1, res_line.gratis, res_line.resnr, res_line.reslinnr, res_line.betrieb_gast, res_line.cancelled_id, res_line.changed_id, res_line.bemerk, res_line.active_flag, res_line.gastnrmember, res_line.gastnr, res_line.betrieb_gastmem, res_line.pseudofix, res_line.zikatnr, res_line.arrangement, res_line.zipreis, res_line._recid, waehrung.wabkurz, waehrung._recid, reservation.gastnr, reservation.grpflag, reservation.name, reservation.segmentcode, reservation.groupname, reservation.bemerk, reservation._recid, zimkateg.kurzbez, zimkateg._recid, gmember.adresse1, gmember.wohnort, gmember.plz, gmember._recid, gmember.nation1 in db_session.query(Res_line.resstatus, Res_line.l_zuordnung, Res_line.zimmeranz, Res_line.erwachs, Res_line.zimmer_wunsch, Res_line.wabkurz, Res_line.voucher_nr, Res_line.zinr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.ankzeit, Res_line.abreisezeit, Res_line.flight_nr, Res_line.kind1, Res_line.gratis, Res_line.resnr, Res_line.reslinnr, Res_line.betrieb_gast, Res_line.cancelled_id, Res_line.changed_id, Res_line.bemerk, Res_line.active_flag, Res_line.gastnrmember, Res_line.gastnr, Res_line.betrieb_gastmem, Res_line.pseudofix, Res_line.zikatnr, Res_line.arrangement, Res_line.zipreis, Res_line._recid, Waehrung.wabkurz, Waehrung._recid, Reservation.gastnr, Reservation.grpflag, Reservation.name, Reservation.segmentcode, Reservation.groupname, Reservation.bemerk, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid, Gmember.adresse1, Gmember.wohnort, Gmember.plz, Gmember._recid, Gmember.nation1).join(Waehrung,(Waehrung.waehrungsnr == Res_line.betriebsnr)).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Gmember,(Gmember.gastnr == Res_line.gastnrmember)).filter(
                         (Res_line.active_flag == 1) & (Res_line.resstatus != 12) & (matches(Res_line.zimmer_wunsch,("*Voucher*")))).order_by(Res_line.resnr, (Res_line.kontakt_nr * Res_line.resnr), Res_line.resstatus, Res_line.name).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
    ...
    def disp_arl4():
        ...
        if last_sort == 1:
            ...
            if lvoucher != "":
                ...
                gmember = Guest()
                for res_line.resstatus, res_line.l_zuordnung, res_line.zimmeranz, res_line.erwachs, res_line.zimmer_wunsch, res_line.wabkurz, res_line.voucher_nr, res_line.zinr, res_line.name, res_line.ankunft, res_line.abreise, res_line.ankzeit, res_line.abreisezeit, res_line.flight_nr, res_line.kind1, res_line.gratis, res_line.resnr, res_line.reslinnr, res_line.betrieb_gast, res_line.cancelled_id, res_line.changed_id, res_line.bemerk, res_line.active_flag, res_line.gastnrmember, res_line.gastnr, res_line.betrieb_gastmem, res_line.pseudofix, res_line.zikatnr, res_line.arrangement, res_line.zipreis, res_line._recid, waehrung.wabkurz, waehrung._recid, reservation.gastnr, reservation.grpflag, reservation.name, reservation.segmentcode, reservation.groupname, reservation.bemerk, reservation._recid, zimkateg.kurzbez, zimkateg._recid, gmember.adresse1, gmember.wohnort, gmember.plz, gmember._recid, gmember.nation1 in db_session.query(Res_line.resstatus, Res_line.l_zuordnung, Res_line.zimmeranz, Res_line.erwachs, Res_line.zimmer_wunsch, Res_line.wabkurz, Res_line.voucher_nr, Res_line.zinr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.ankzeit, Res_line.abreisezeit, Res_line.flight_nr, Res_line.kind1, Res_line.gratis, Res_line.resnr, Res_line.reslinnr, Res_line.betrieb_gast, Res_line.cancelled_id, Res_line.changed_id, Res_line.bemerk, Res_line.active_flag, Res_line.gastnrmember, Res_line.gastnr, Res_line.betrieb_gastmem, Res_line.pseudofix, Res_line.zikatnr, Res_line.arrangement, Res_line.zipreis, Res_line._recid, Waehrung.wabkurz, Waehrung._recid, Reservation.gastnr, Reservation.grpflag, Reservation.name, Reservation.segmentcode, Reservation.groupname, Reservation.bemerk, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid, Gmember.adresse1, Gmember.wohnort, Gmember.plz, Gmember._recid, Gmember.nation1).join(Waehrung,(Waehrung.waehrungsnr == Res_line.betriebsnr)).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Gmember,(Gmember.gastnr == Res_line.gastnrmember)).filter(
                         (Res_line.active_flag == 1) & (Res_line.resstatus != 12) & (Res_line.abreise == ci_date) & (matches(Res_line.zimmer_wunsch,("*Voucher*")))).order_by(Res_line.name).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
    ...
    def disp_arl5():
        ...
        if last_sort == 1 and room != "":
            ...
            if lvoucher != "":
                ...
                gmember = Guest()
                for res_line.resstatus, res_line.l_zuordnung, res_line.zimmeranz, res_line.erwachs, res_line.zimmer_wunsch, res_line.wabkurz, res_line.voucher_nr, res_line.zinr, res_line.name, res_line.ankunft, res_line.abreise, res_line.ankzeit, res_line.abreisezeit, res_line.flight_nr, res_line.kind1, res_line.gratis, res_line.resnr, res_line.reslinnr, res_line.betrieb_gast, res_line.cancelled_id, res_line.changed_id, res_line.bemerk, res_line.active_flag, res_line.gastnrmember, res_line.gastnr, res_line.betrieb_gastmem, res_line.pseudofix, res_line.zikatnr, res_line.arrangement, res_line.zipreis, res_line._recid, waehrung.wabkurz, waehrung._recid, reservation.gastnr, reservation.grpflag, reservation.name, reservation.segmentcode, reservation.groupname, reservation.bemerk, reservation._recid, zimkateg.kurzbez, zimkateg._recid, gmember.adresse1, gmember.wohnort, gmember.plz, gmember._recid, gmember.nation1 in db_session.query(Res_line.resstatus, Res_line.l_zuordnung, Res_line.zimmeranz, Res_line.erwachs, Res_line.zimmer_wunsch, Res_line.wabkurz, Res_line.voucher_nr, Res_line.zinr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.ankzeit, Res_line.abreisezeit, Res_line.flight_nr, Res_line.kind1, Res_line.gratis, Res_line.resnr, Res_line.reslinnr, Res_line.betrieb_gast, Res_line.cancelled_id, Res_line.changed_id, Res_line.bemerk, Res_line.active_flag, Res_line.gastnrmember, Res_line.gastnr, Res_line.betrieb_gastmem, Res_line.pseudofix, Res_line.zikatnr, Res_line.arrangement, Res_line.zipreis, Res_line._recid, Waehrung.wabkurz, Waehrung._recid, Reservation.gastnr, Reservation.grpflag, Reservation.name, Reservation.segmentcode, Reservation.groupname, Reservation.bemerk, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid, Gmember.adresse1, Gmember.wohnort, Gmember.plz, Gmember._recid, Gmember.nation1).join(Waehrung,(Waehrung.waehrungsnr == Res_line.betriebsnr)).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Gmember,(Gmember.gastnr == Res_line.gastnrmember)).filter(
                         (Res_line.active_flag == 2) & (Res_line.resstatus == 8) & (Res_line.abreise >= fdate1) & (Res_line.abreise <= fdate2) & (matches(Res_line.zimmer_wunsch,("*Voucher*")))).order_by((Res_line.kontakt_nr * Res_line.resnr), Res_line.resstatus, Res_line.name).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
    ...
    def disp_arl6():
        ...
        if last_sort == 1:
            ...
            if lvoucher != "":
                ...
                gmember = Guest()
                for res_line.resstatus, res_line.l_zuordnung, res_line.zimmeranz, res_line.erwachs, res_line.zimmer_wunsch, res_line.wabkurz, res_line.voucher_nr, res_line.zinr, res_line.name, res_line.ankunft, res_line.abreise, res_line.ankzeit, res_line.abreisezeit, res_line.flight_nr, res_line.kind1, res_line.gratis, res_line.resnr, res_line.reslinnr, res_line.betrieb_gast, res_line.cancelled_id, res_line.changed_id, res_line.bemerk, res_line.active_flag, res_line.gastnrmember, res_line.gastnr, res_line.betrieb_gastmem, res_line.pseudofix, res_line.zikatnr, res_line.arrangement, res_line.zipreis, res_line._recid, waehrung.wabkurz, waehrung._recid, reservation.gastnr, reservation.grpflag, reservation.name, reservation.segmentcode, reservation.groupname, reservation.bemerk, reservation._recid, zimkateg.kurzbez, zimkateg._recid, gmember.adresse1, gmember.wohnort, gmember.plz, gmember._recid, gmember.nation1 in db_session.query(Res_line.resstatus, Res_line.l_zuordnung, Res_line.zimmeranz, Res_line.erwachs, Res_line.zimmer_wunsch, Res_line.wabkurz, Res_line.voucher_nr, Res_line.zinr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.ankzeit, Res_line.abreisezeit, Res_line.flight_nr, Res_line.kind1, Res_line.gratis, Res_line.resnr, Res_line.reslinnr, Res_line.betrieb_gast, Res_line.cancelled_id, Res_line.changed_id, Res_line.bemerk, Res_line.active_flag, Res_line.gastnrmember, Res_line.gastnr, Res_line.betrieb_gastmem, Res_line.pseudofix, Res_line.zikatnr, Res_line.arrangement, Res_line.zipreis, Res_line._recid, Waehrung.wabkurz, Waehrung._recid, Reservation.gastnr, Reservation.grpflag, Reservation.name, Reservation.segmentcode, Reservation.groupname, Reservation.bemerk, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid, Gmember.adresse1, Gmember.wohnort, Gmember.plz, Gmember._recid, Gmember.nation1).join(Waehrung,(Waehrung.waehrungsnr == Res_line.betriebsnr)).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Gmember,(Gmember.gastnr == Res_line.gastnrmember)).filter(
                         ((Res_line.active_flag == 1) & (Res_line.resstatus != 12)) | ((Res_line.active_flag == 0) & (Res_line.ankunft == ci_date)) | ((Res_line.active_flag == 2) & (Res_line.resstatus == 8) & (Res_line.abreise == ci_date)) & (matches(Res_line.zimmer_wunsch,("*Voucher*")))).order_by((Res_line.kontakt_nr * Res_line.resnr), Res_line.resstatus, Res_line.name).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
    ...
    def assign_it():
        ...
        if last_sort == 5:
            telop_list.voucher_str = trim(v_no)
        else:
            if matches(res_line.zimmer_wunsch,r"*Voucher*"):
                for i in range(1,num_entries(res_line.zimmer_wunsch, ";") - 1 + 1) :
                    str = entry(i - 1, res_line.zimmer_wunsch, ";")

                    if substring(str, 0, 7) == ("voucher").lower() :
                        telop_list.voucher_str = substring(str, 7)
