...
def tada_post_payment_btn_transferbl(pvilanguage:int, rec_id:int, guestnr:int, curr_dept:int, paid:Decimal, exchg_rate:Decimal, price_decimal:int, balance:Decimal, transdate:date, disc_art1:int, disc_art2:int, disc_art3:int, kellner_kellner_nr:int):
    ...
    def generate_output():
        nonlocal billart, qty, description, price, amount_foreign, amount, bill_date, fl_code, fl_code1, msg_str, var_testing, t_h_artikel_data, h_artikel, guest, h_bill, tisch, htparam, h_umsatz, artikel, h_bill_line, queasy
        ...
        return {"billart": billart, "qty": qty, "description": description, "price": price, "amount_foreign": amount_foreign, "amount": amount, "bill_date": bill_date, "fl_code": fl_code, "fl_code1": fl_code1, "msg_str": msg_str, "var_testing": var_testing, "t-h-artikel": t_h_artikel_data}
