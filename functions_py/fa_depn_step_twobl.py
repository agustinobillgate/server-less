...
def fa_depn_step_twobl(datum:date, user_init:string, curr_anz:int, debits:Decimal, credits:Decimal, remains:Decimal):
    ...
    buff_g_list_data, Buff_g_list = create_model_like(G_list)
    ...
    def generate_output():
        nonlocal buff_g_list_data, debit_betrag, credit_betrag, depn_value, dept_methode, gl_acct, gl_jouhdr, htparam, mathis, fa_artikel, fa_grup, fa_kateg
        ...
        nonlocal s_list_data, g_list_data, buff_g_list_data

        return {"curr_anz": curr_anz, "debits": debits, "credits": credits, "remains": remains, "buff-g-list": buff_g_list_data}
