...
def prepare_mk_gcf1_1bl(lastname:string, firstname:string):
    ...
    def generate_output():
        nonlocal err_nr, curr_gastnr, lname, f_logical, avail_genlayout, refno_label, t_nation1_data, t_sourccod1_data, t_guest_data, guest, htparam, sourccod, genlayout, nation
        ...
        return {"err_nr": err_nr, "curr_gastnr": curr_gastnr, "lname": lname, "f_logical": f_logical, "avail_genlayout": avail_genlayout, "refno_label": refno_label, "t-nation1": t_nation1_data, "t-sourccod1": t_sourccod1_data, "t-guest": t_guest_data}
