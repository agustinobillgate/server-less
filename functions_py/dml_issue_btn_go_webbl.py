...
def dml_issue_btn_go_webbl(op_list_data:[Op_list], billdate:date, closedate:date, curr_lager:int, curr_dept:int, cost_acct:string, lief_nr:int, lscheinnr:string, user_init:string, t_amount:Decimal):
