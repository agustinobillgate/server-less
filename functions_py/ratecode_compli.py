...
def ratecode_compli(resnr:int, reslinnr:int, prcode:string, rmcatno:int, datum:date):
    ...
    ratecode = db_session.query(Ratecode).filter((Ratecode.code == prcode) & (Ratecode.marknr == res_line.reserve_int) & (Ratecode.argtnr == argtno) & (Ratecode.zikatnr == rmcatno) & (Ratecode.startperiode <= datum) & (Ratecode.endperiode >= datum) & (Ratecode.wday == w_day) & (Ratecode.erwachs == res_line.erwachs) & (Ratecode.kind1 == res_line.kind1) & (Ratecode.kind2 == res_line.kind2)).first()
    if not ratecode:
        ...
        ratecode = db_session.query(Ratecode).filter((Ratecode.code == prcode) & (Ratecode.marknr == res_line.reserve_int) & (Ratecode.argtnr == argtno) & (Ratecode.zikatnr == rmcatno) & (Ratecode.startperiode <= datum) & (Ratecode.endperiode >= datum) & (Ratecode.wday == 0) & (Ratecode.erwachs == res_line.erwachs) & (Ratecode.kind1 == res_line.kind1) & (Ratecode.kind2 == res_line.kind2)).first()
    ...
    if not ratecode:
        ...
        ratecode = db_session.query(Ratecode).filter((Ratecode.code == prcode) & (Ratecode.marknr == res_line.reserve_int) & (Ratecode.argtnr == argtno) & (Ratecode.zikatnr == rmcatno) & (Ratecode.startperiode <= datum) & (Ratecode.endperiode >= datum) & (Ratecode.wday == w_day) & (Ratecode.erwachs == res_line.erwachs)).first()
    ...
    if not ratecode:
        ...
        ratecode = db_session.query(Ratecode).filter((Ratecode.code == prcode) & (Ratecode.marknr == res_line.reserve_int) & (Ratecode.argtnr == argtno) & (Ratecode.zikatnr == rmcatno) & (Ratecode.startperiode <= datum) & (Ratecode.endperiode >= datum) & (Ratecode.wday == 0) & (Ratecode.erwachs == res_line.erwachs)).first()
