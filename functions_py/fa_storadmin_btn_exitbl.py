...
fa_list_data, Fa_list = create_model_like(Fa_lager)

def fa_storadmin_btn_exitbl(fa_list_data:[Fa_list], case_type:int, rec_id:int):
    ...
    def update_name():
        ...
        while None != mathis:
            ...
            mbuff = buffer_copy(mathis, Mbuff)
    ...
    fa_list = query(fa_list_data, first=True)
