...
def hk_statadmin_chg_zistatus_cldbl(bline_list_data:[Bline_list], om_list_data:[Om_list], pvilanguage:int, ci_date:date, chgsort:int, t_zinr:string, user_init:string, user_nr:int, remark:string):
    ...
    def generate_output():
        ...
        nonlocal pvilanguage, ci_date, chgsort, t_zinr, user_init, user_nr, remark
            ...
            if chgsort == 8:
                ...
                if trim(remark) != "":
                    ...
                    res_history.aenderung = "Room " + zimmer.zinr +\
                            ...
                            "|" + substring(from_stat, 0, 1) +\
                            "|" + substring(to_stat, 0, 1) +\
                            "|Reason:" + trim(remark)
