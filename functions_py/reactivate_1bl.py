...
# =======================================
# Rulita, 20-10-2025 
# Tiket ID : F8882B | New compile program
# =======================================
...
from models import Htparam, Reservation, Zimkateg, Res_line, Guest

def reactivate_1bl(fresnr:int, fdate:date, fname:string, comments:string):

    prepare_cache ([Htparam, Reservation, Zimkateg, Res_line, Guest])
    ...
    str:string = ""
    sysdate:date = None
    htparam = reservation = zimkateg = res_line = guest = None
    ...
    def generate_output():
        nonlocal resname, address, city, stat_avail, t_reactivate_data, loopi, hitung, str, sysdate, htparam, reservation, zimkateg, res_line, guest
    ...
    def create_t_reactive():
        ...
        if reservation.bemerk != None and reservation.bemerk != "":
    ...
    if fresnr == 0 and fdate == None:
        ...
        zimkateg = Zimkateg()
        for res_line.gastnr, res_line.resnr, res_line.reslinnr, res_line.name, res_line.ankunft, res_line.abreise, res_line.resstatus, res_line.zimmeranz, res_line.erwachs, res_line.gratis, res_line.arrangement, res_line.zipreis, res_line.zinr, res_line.cancelled, res_line.cancelled_id, res_line.bemerk, res_line.anztage, res_line.active_flag, res_line.betrieb_gastpay, res_line.kind1, res_line.kind2, res_line.changed, res_line.changed_id, res_line.zimmer_wunsch, res_line.resname, res_line._recid, reservation.name, reservation.gastnr, reservation.activeflag, reservation.bemerk, reservation.depositgef, reservation._recid, zimkateg.kurzbez, zimkateg._recid in db_session.query(Res_line.gastnr, Res_line.resnr, Res_line.reslinnr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.resstatus, Res_line.zimmeranz, Res_line.erwachs, Res_line.gratis, Res_line.arrangement, Res_line.zipreis, Res_line.zinr, Res_line.cancelled, Res_line.cancelled_id, Res_line.bemerk, Res_line.anztage, Res_line.active_flag, Res_line.betrieb_gastpay, Res_line.kind1, Res_line.kind2, Res_line.changed, Res_line.changed_id, Res_line.zimmer_wunsch, Res_line.resname, Res_line._recid, Reservation.name, Reservation.gastnr, Reservation.activeflag, Reservation.bemerk, Reservation.depositgef, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).filter(
                 (Res_line.active_flag == 2) & ((Res_line.resstatus == 9) | (Res_line.resstatus == 10)) & (Res_line.l_zuordnung[inc_value(2)] == 0)).order_by(Reservation.name).all():
            ...
            if fname != "":
                ...
                if (get_index(res_line.resname, fname) > 0 or get_index(reservation.name, fname) > 0):
                    create_t_reactive()
            else:
                create_t_reactive()
        ...
        zimkateg = Zimkateg()
        for res_line.gastnr, res_line.resnr, res_line.reslinnr, res_line.name, res_line.ankunft, res_line.abreise, res_line.resstatus, res_line.zimmeranz, res_line.erwachs, res_line.gratis, res_line.arrangement, res_line.zipreis, res_line.zinr, res_line.cancelled, res_line.cancelled_id, res_line.bemerk, res_line.anztage, res_line.active_flag, res_line.betrieb_gastpay, res_line.kind1, res_line.kind2, res_line.changed, res_line.changed_id, res_line.zimmer_wunsch, res_line.resname, res_line._recid, reservation.name, reservation.gastnr, reservation.activeflag, reservation.bemerk, reservation.depositgef, reservation._recid, zimkateg.kurzbez, zimkateg._recid in db_session.query(Res_line.gastnr, Res_line.resnr, Res_line.reslinnr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.resstatus, Res_line.zimmeranz, Res_line.erwachs, Res_line.gratis, Res_line.arrangement, Res_line.zipreis, Res_line.zinr, Res_line.cancelled, Res_line.cancelled_id, Res_line.bemerk, Res_line.anztage, Res_line.active_flag, Res_line.betrieb_gastpay, Res_line.kind1, Res_line.kind2, Res_line.changed, Res_line.changed_id, Res_line.zimmer_wunsch, Res_line.resname, Res_line._recid, Reservation.name, Reservation.gastnr, Reservation.activeflag, Reservation.bemerk, Reservation.depositgef, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).filter(
                 (Res_line.active_flag == 0) & ((Res_line.resstatus == 9) | (Res_line.resstatus == 10)) & (matches(Res_line.zimmer_wunsch,"*cancel*")) & (Res_line.l_zuordnung[inc_value(2)] == 0)).order_by(Reservation.name).all():
            if res_line_obj_list.get(res_line._recid):
                continue
            else:
                res_line_obj_list[res_line._recid] = True
        ...
        if fdate == None:
            ...
            if fresnr == 0:
                ...
                zimkateg = Zimkateg()
                for res_line.gastnr, res_line.resnr, res_line.reslinnr, res_line.name, res_line.ankunft, res_line.abreise, res_line.resstatus, res_line.zimmeranz, res_line.erwachs, res_line.gratis, res_line.arrangement, res_line.zipreis, res_line.zinr, res_line.cancelled, res_line.cancelled_id, res_line.bemerk, res_line.anztage, res_line.active_flag, res_line.betrieb_gastpay, res_line.kind1, res_line.kind2, res_line.changed, res_line.changed_id, res_line.zimmer_wunsch, res_line.resname, res_line._recid, reservation.name, reservation.gastnr, reservation.activeflag, reservation.bemerk, reservation.depositgef, reservation._recid, zimkateg.kurzbez, zimkateg._recid in db_session.query(Res_line.gastnr, Res_line.resnr, Res_line.reslinnr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.resstatus, Res_line.zimmeranz, Res_line.erwachs, Res_line.gratis, Res_line.arrangement, Res_line.zipreis, Res_line.zinr, Res_line.cancelled, Res_line.cancelled_id, Res_line.bemerk, Res_line.anztage, Res_line.active_flag, Res_line.betrieb_gastpay, Res_line.kind1, Res_line.kind2, Res_line.changed, Res_line.changed_id, Res_line.zimmer_wunsch, Res_line.resname, Res_line._recid, Reservation.name, Reservation.gastnr, Reservation.activeflag, Reservation.bemerk, Reservation.depositgef, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).filter(
                         (Res_line.active_flag == 2) & (Res_line.l_zuordnung[inc_value(2)] == 0) & ((Res_line.resstatus == 9) | (Res_line.resstatus == 10)) & (Res_line.ankunft == sysdate)).order_by(Reservation.name).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
                ...
                zimkateg = Zimkateg()
                for res_line.gastnr, res_line.resnr, res_line.reslinnr, res_line.name, res_line.ankunft, res_line.abreise, res_line.resstatus, res_line.zimmeranz, res_line.erwachs, res_line.gratis, res_line.arrangement, res_line.zipreis, res_line.zinr, res_line.cancelled, res_line.cancelled_id, res_line.bemerk, res_line.anztage, res_line.active_flag, res_line.betrieb_gastpay, res_line.kind1, res_line.kind2, res_line.changed, res_line.changed_id, res_line.zimmer_wunsch, res_line.resname, res_line._recid, reservation.name, reservation.gastnr, reservation.activeflag, reservation.bemerk, reservation.depositgef, reservation._recid, zimkateg.kurzbez, zimkateg._recid in db_session.query(Res_line.gastnr, Res_line.resnr, Res_line.reslinnr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.resstatus, Res_line.zimmeranz, Res_line.erwachs, Res_line.gratis, Res_line.arrangement, Res_line.zipreis, Res_line.zinr, Res_line.cancelled, Res_line.cancelled_id, Res_line.bemerk, Res_line.anztage, Res_line.active_flag, Res_line.betrieb_gastpay, Res_line.kind1, Res_line.kind2, Res_line.changed, Res_line.changed_id, Res_line.zimmer_wunsch, Res_line.resname, Res_line._recid, Reservation.name, Reservation.gastnr, Reservation.activeflag, Reservation.bemerk, Reservation.depositgef, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).filter(
                         (Res_line.active_flag == 0) & (Res_line.l_zuordnung[inc_value(2)] == 0) & ((Res_line.resstatus == 9) | (Res_line.resstatus == 10)) & (Res_line.ankunft == sysdate) & (matches(Res_line.zimmer_wunsch,"*cancel*"))).order_by(Reservation.name).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
            ...
            if fresnr == 0:
                ...
                zimkateg = Zimkateg()
                for res_line.gastnr, res_line.resnr, res_line.reslinnr, res_line.name, res_line.ankunft, res_line.abreise, res_line.resstatus, res_line.zimmeranz, res_line.erwachs, res_line.gratis, res_line.arrangement, res_line.zipreis, res_line.zinr, res_line.cancelled, res_line.cancelled_id, res_line.bemerk, res_line.anztage, res_line.active_flag, res_line.betrieb_gastpay, res_line.kind1, res_line.kind2, res_line.changed, res_line.changed_id, res_line.zimmer_wunsch, res_line.resname, res_line._recid, reservation.name, reservation.gastnr, reservation.activeflag, reservation.bemerk, reservation.depositgef, reservation._recid, zimkateg.kurzbez, zimkateg._recid in db_session.query(Res_line.gastnr, Res_line.resnr, Res_line.reslinnr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.resstatus, Res_line.zimmeranz, Res_line.erwachs, Res_line.gratis, Res_line.arrangement, Res_line.zipreis, Res_line.zinr, Res_line.cancelled, Res_line.cancelled_id, Res_line.bemerk, Res_line.anztage, Res_line.active_flag, Res_line.betrieb_gastpay, Res_line.kind1, Res_line.kind2, Res_line.changed, Res_line.changed_id, Res_line.zimmer_wunsch, Res_line.resname, Res_line._recid, Reservation.name, Reservation.gastnr, Reservation.activeflag, Reservation.bemerk, Reservation.depositgef, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).filter(
                         (Res_line.active_flag == 0) & (Res_line.l_zuordnung[inc_value(2)] == 0) & ((Res_line.resstatus == 9) | (Res_line.resstatus == 10)) & (Res_line.ankunft == fdate) & (matches(Res_line.zimmer_wunsch,"*cancel*"))).order_by(Reservation.name).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
                ...
                zimkateg = Zimkateg()
                for res_line.gastnr, res_line.resnr, res_line.reslinnr, res_line.name, res_line.ankunft, res_line.abreise, res_line.resstatus, res_line.zimmeranz, res_line.erwachs, res_line.gratis, res_line.arrangement, res_line.zipreis, res_line.zinr, res_line.cancelled, res_line.cancelled_id, res_line.bemerk, res_line.anztage, res_line.active_flag, res_line.betrieb_gastpay, res_line.kind1, res_line.kind2, res_line.changed, res_line.changed_id, res_line.zimmer_wunsch, res_line.resname, res_line._recid, reservation.name, reservation.gastnr, reservation.activeflag, reservation.bemerk, reservation.depositgef, reservation._recid, zimkateg.kurzbez, zimkateg._recid in db_session.query(Res_line.gastnr, Res_line.resnr, Res_line.reslinnr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.resstatus, Res_line.zimmeranz, Res_line.erwachs, Res_line.gratis, Res_line.arrangement, Res_line.zipreis, Res_line.zinr, Res_line.cancelled, Res_line.cancelled_id, Res_line.bemerk, Res_line.anztage, Res_line.active_flag, Res_line.betrieb_gastpay, Res_line.kind1, Res_line.kind2, Res_line.changed, Res_line.changed_id, Res_line.zimmer_wunsch, Res_line.resname, Res_line._recid, Reservation.name, Reservation.gastnr, Reservation.activeflag, Reservation.bemerk, Reservation.depositgef, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).filter(
                         (Res_line.active_flag == 2) & ((Res_line.resstatus == 9) | (Res_line.resstatus == 10)) & (Res_line.resnr >= fresnr) & (Res_line.resnr <= (fresnr + 100)) & (Res_line.ankunft == fdate) & (Res_line.l_zuordnung[inc_value(2)] == 0)).order_by(Res_line.resnr).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
                ...
                zimkateg = Zimkateg()
                for res_line.gastnr, res_line.resnr, res_line.reslinnr, res_line.name, res_line.ankunft, res_line.abreise, res_line.resstatus, res_line.zimmeranz, res_line.erwachs, res_line.gratis, res_line.arrangement, res_line.zipreis, res_line.zinr, res_line.cancelled, res_line.cancelled_id, res_line.bemerk, res_line.anztage, res_line.active_flag, res_line.betrieb_gastpay, res_line.kind1, res_line.kind2, res_line.changed, res_line.changed_id, res_line.zimmer_wunsch, res_line.resname, res_line._recid, reservation.name, reservation.gastnr, reservation.activeflag, reservation.bemerk, reservation.depositgef, reservation._recid, zimkateg.kurzbez, zimkateg._recid in db_session.query(Res_line.gastnr, Res_line.resnr, Res_line.reslinnr, Res_line.name, Res_line.ankunft, Res_line.abreise, Res_line.resstatus, Res_line.zimmeranz, Res_line.erwachs, Res_line.gratis, Res_line.arrangement, Res_line.zipreis, Res_line.zinr, Res_line.cancelled, Res_line.cancelled_id, Res_line.bemerk, Res_line.anztage, Res_line.active_flag, Res_line.betrieb_gastpay, Res_line.kind1, Res_line.kind2, Res_line.changed, Res_line.changed_id, Res_line.zimmer_wunsch, Res_line.resname, Res_line._recid, Reservation.name, Reservation.gastnr, Reservation.activeflag, Reservation.bemerk, Reservation.depositgef, Reservation._recid, Zimkateg.kurzbez, Zimkateg._recid).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).filter(
                         (Res_line.active_flag == 0) & ((Res_line.resstatus == 9) | (Res_line.resstatus == 10)) & (matches(Res_line.zimmer_wunsch,"*cancel*")) & (Res_line.ankunft == fdate) & (Res_line.resnr >= fresnr) & (Res_line.resnr <= (fresnr + 100)) & (Res_line.l_zuordnung[inc_value(2)] == 0)).order_by(Res_line.resnr).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
