...
menu_list_data, Menu_list = create_model("Menu_list", {"request":string, "krecid":int, "posted":bool, "nr":int, "artnr":int, "bezeich":string, "anzahl":int, "price":Decimal, "betrag":Decimal, "voucher":string}, {"voucher": ""})

def ts_restinv_add_kdsbl(menu_list_data:[Menu_list], tischnr:int, curr_dept:int, curr_waiter:int, rechnr:int, user_init:string):
