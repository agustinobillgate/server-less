...
def pj_arrive2_webbl(pvilanguage:int, from_date:date, to_date:date, ci_date:date, disptype:int, incl_tentative:bool, sorttype:int, comment_type:int, incl_accompany:bool, split_rsv_print:bool, total_flag:bool, zikat_list_data:[Zikat_list], segm1_list_data:[Segm1_list], arrangement_list_data:[Arrangement_list]):
