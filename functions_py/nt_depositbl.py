...
def nt_depositbl():
    ...
    def generate_output():
        nonlocal pvilanguage, lvcarea, long_digit, n, progname, night_type, reihenfolge, line_nr, line, p_width, p_length, curr_date, htl_name, htl_adr, htl_tel, htparam, paramtext, nightaudit, nitestor, bill, res_line, billjournal, guest, reservation
    ...
    def deposit_list():
        ...
        add_line(line)
        add_line(" ")
        line = translateExtended ("List of transferred deposits", lvcarea, "")
        add_line(line)
        line = ""
        ...
        # Rulita,
        # - Fix space in string
        line = translateExtended ("RmNo        BillNo GuestName                Bill Receiver         Deposit-Amount", lvcarea, "")
        add_line(line)
        line = fill("-", p_width)
        add_line(line)
        add_line("##end-header")
    ...
    def create_deposit():
        ...
        cl_list.flag = "**"
        cl_list.name = translateExtended ("Total Opened Paid Hotel Guest Deposit:", lvcarea, "")
