...
def ts_restinv_btn_transfer_paytypegt1bl(bilrecid:int, h_bill_recid:int, balance_foreign:Decimal, balance:Decimal, pay_type:int):
    ...
    def generate_output():
        nonlocal billart, qty, price, amount_foreign, amount, gname, description, transfer_zinr, t_h_bill_data, h_bill, bill, counters, res_line
        ...
        return {"billart": billart, "qty": qty, "price": price, "amount_foreign": amount_foreign, "amount": amount, "gname": gname, "description": description, "transfer_zinr": transfer_zinr, "t-h-bill": t_h_bill_data}
