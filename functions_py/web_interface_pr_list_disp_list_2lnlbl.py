...
def web_interface_pr_list_disp_list_2lnlbl(char1: str, billdate: date, from_date: date, to_date: date, outstand_flag: bool, expired_flag: bool, approve_flag: bool, reject_flag: bool, sorttype: int, sort_app: str):
    ...
    def disp_list(pr_nr: str):
        ...
        if pr_nr != "":
            ...
            if l_orderhdr:
                ...
                l_order = get_cache(
                    L_order, {"docu_nr": [(eq, l_orderhdr.docu_nr)], "pos": [(gt, 0)], "lief_nr": [(eq, 0)], "loeschflag": [(eq, sorttype)]})
                # while None != l_order:
