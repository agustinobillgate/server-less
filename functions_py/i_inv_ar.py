...
def i_inv_ar(curr_art:int=0, zinr:str="", gastnr:int=0, gastnrmember:int=0, rechnr:int=0, saldo:decimal=to_decimal("0.0"), saldo_foreign:decimal=to_decimal("0.0"), bill_date:date=None, billname:str="", userinit:str="", voucher_nr:str=""):
