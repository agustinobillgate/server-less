...
def tada_store_articlebl(case_type:int, vhp_artnr:int, deptno:int, article_flag:bool, t_article_data:[T_article]):
    ...
    if case_type == 1:
        ...
        for t_article in query(t_article_data):
        ...
        for t_article in query(t_article_data):
            ...
            if queasy:
                ...
                h_artikel = db_session.query(H_artikel).filter(
                    H_artikel.departement == deptno,
                    H_artikel.artnr == vhp_artnr
                ).with_for_update().first()
