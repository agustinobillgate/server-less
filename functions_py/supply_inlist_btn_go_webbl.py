...
taxcode_list_data, Taxcode_list = create_model(
    "Taxcode_list", {
        "taxcode":string, 
        "taxamount":Decimal
        }
...
def supply_inlist_btn_go_webbl(pvilanguage:int, last_artnr:int, lieferant_recid:int, l_kredit_recid:int, ap_recid:int, long_digit:bool, show_price:bool, store:int, all_supp:bool, sorttype:int, from_grp:int, to_grp:int, from_date:date, to_date:date, taxcode_list_data:[Taxcode_list]):
    ...
    str_list_data, Str_list = create_model(
        "Str_list", {
            ...
            "invoice_date":date, 
            "remark_artikel":string, 
            "ap_voucher":int, 
            "disc_amount":Decimal, 
            "addvat_amount":Decimal, 
            "disc_amount2":Decimal, 
            "vat_amount":Decimal, 
            "direct_flag":bool
            }, {
                "lscheinnr": ""
    ...
    def generate_output():
        ...
        return {
            "first_artnr": first_artnr, 
            "curr_artnr": curr_artnr, 
            "last_artnr1": last_artnr1, 
            "unit_price": unit_price, 
            "str-list": str_list_data
        }
    ...
    def assign_create_list11(t_anz:Decimal, t_amt:Decimal, t_amountexcl:Decimal, t_tax:Decimal, t_inv:Decimal, lief_nr:int):
        ...
        l_ophdr = get_cache (L_ophdr, {
            "op_typ": [(eq, "sti")],
            "lscheinnr": [(eq, l_op.lscheinnr)],"datum": [(eq, l_op.datum)]})
        ...
        if str_list:
            ...
            buff_l_kredit = get_cache (L_kredit, {
    ...
    def create_hislist(t_anz:Decimal, t_amt:Decimal, t_amountexcl:Decimal, t_tax:Decimal, t_inv:Decimal):
        ...
        for l_ophis in db_session.query(L_ophis).filter(
            ...
            l_ophhis = get_cache (L_ophhis, {
                "op_typ": [(eq, "sti")],
                "lscheinnr": [(eq, l_ophis.lscheinnr)],
                "datum": [(eq, l_ophis.datum)]})
            str_list = Str_list()
            str_list_data.append(str_list)
            ...
            queasy = get_cache (Queasy, {
                "key": [(eq, 335)],
                "char1": [(eq, l_ophis.lscheinnr)],
                "number1": [(eq, l_ophis.artnr)]})
