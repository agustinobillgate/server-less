...
def sall_onhand_btn_go1_webbl(all_flag:bool, show_price:bool, zero_flag:bool, from_grp:int, sub_grp:int, from_lager:int, to_lager:int, sorttype:int, mattype:int, minoh_flag:bool):
    ...
    soh_list_data, Soh_list = create_model("Soh_list", {"artnr":int, "bezeich":string, "unit":string, "act_qty":Decimal, "act_val":Decimal, "cont1":string, "d_unit":string, "cont2":string, "last_price":Decimal, "act_price":Decimal, "avrg_price":Decimal, "min_oh":Decimal, "must_order":Decimal})
    output_list_data, Output_list = create_model("Output_list", {"flag":int, "artnr":int, "bezeich":string, "unit":string, "act_qty":string, "act_val":string, "cont1":string, "d_unit":string, "cont2":string, "last_price":string, "act_price":string, "avrg_price":string, "min_oh":string, "must_order":string})
    ...
    def generate_output():
        nonlocal soh_list_data, curr_best, long_digit, i, j, tot_anz, tot_val, t_anz, t_val, t_value, tt_value, avrg_price, zwkum, bezeich, grp1, grp2, must_order, tt_val, qty, wert, tot_bezeich, l_bestand, htparam, l_lager, l_artikel, l_untergrup
        ...
        nonlocal str_list_data, soh_list_data, output_list_data
    ...
    def create_list():
        ...
        for l_lager in db_session.query(L_lager).filter(
            ...
            if t_val != 0:
                ...
                output_list.flag = 1
                output_list.bezeich = to_string(bezeich, "x(50)")
                output_list.cont1 = to_string(" ", "x(9)")
                output_list.d_unit = to_string(" ", "x(8)")
                output_list.cont2 = to_string(" ", "x(9)")

                if not long_digit:
                    output_list.act_val = to_string(t_val, "->>,>>>,>>>,>>9.99")
                else:
                    output_list.act_val = to_string(t_val, "->,>>>,>>>,>>>,>>9")
                output_list = Output_list()
                output_list_data.append(output_list)
            ...
            output_list.flag = 1
            output_list.bezeich = to_string(tot_bezeich, "x(50)")
            output_list.cont1 = to_string(" ", "x(9)")
            output_list.d_unit = to_string(" ", "x(8)")
            output_list.cont2 = to_string(" ", "x(9)")

            if not long_digit:
                output_list.act_val = to_string(tt_val, "->>,>>>,>>>,>>9.99")
            else:
                output_list.act_val = to_string(tt_val, "->,>>>,>>>,>>>,>>9")
            output_list = Output_list()
            output_list_data.append(output_list)
        ...
        output_list.flag = 1
        output_list.bezeich = to_string("GRAND T O T A L", "x(50)")
        output_list.cont1 = to_string(" ", "x(9)")
        output_list.d_unit = to_string(" ", "x(8)")
        output_list.cont2 = to_string(" ", "x(9)")

        if not long_digit:
            output_list.act_val = to_string(tt_value, "->>,>>>,>>>,>>9.99")
        else:
            output_list.act_val = to_string(tt_value, "->,>>>,>>>,>>>,>>9")
        ...
        if tot_anz != 0 or (tot_anz == 0 and zero_flag):
            ...
            if show_price:
                ...
                if not long_digit:
                    ...
                    output_list.unit = to_string(l_artikel.masseinheit, "x(3)")
                    output_list.act_qty = to_string(tot_anz, "->,>>>,>>9.99")
                    output_list.act_val = to_string(tot_val, "->>,>>>,>>>,>>9.99")
                    ...
                    output_list.last_price = to_string(l_artikel.ek_letzter, ">>>,>>>,>>9.99")
                    output_list.act_price = to_string(l_artikel.ek_aktuell, ">>>,>>>,>>9.99")
                    output_list.avrg_price = to_string(l_artikel.vk_preis, "->>,>>>,>>9.99")
                    output_list.min_oh = to_string(l_artikel.min_bestand, "->,>>>,>>9.99")
                    output_list.must_order = to_string(must_order, "->,>>>,>>9.99")
                    ...
                    output_list.d_unit = to_string(l_artikel.traubensorte, "x(8)")
                    output_list.cont2 = to_string(l_artikel.lief_einheit, ">>,>>9.99")
                    output_list.last_price = to_string(l_artikel.ek_letzter, ">,>>>,>>>,>>9")
                    output_list.act_price = to_string(l_artikel.ek_aktuell, ">,>>>,>>>,>>9")
                    output_list.avrg_price = to_string(l_artikel.vk_preis, "->,>>>,>>>,>>9")
                    output_list.min_oh = to_string(l_artikel.min_bestand, "->,>>>,>>9.99")
                    output_list.must_order = to_string(must_order, "->,>>>,>>9.99")
                ...
                if not long_digit:
                    ...
                    output_list.unit = to_string(l_artikel.masseinheit, "x(3)")
                    output_list.act_qty = to_string(tot_anz, "->,>>>,>>9.99")
                    output_list.act_val = to_string(0, "->>,>>>,>>>,>>9.99")
                    output_list.cont1 = to_string(l_artikel.inhalt, ">>,>>9.99")
                    output_list.d_unit = to_string(l_artikel.traubensorte, "x(8)")
                    output_list.cont2 = to_string(l_artikel.lief_einheit, ">>,>>9.99")
                    output_list.last_price = to_string(0, ">>,>>>,>>9.99")
                    output_list.act_price = to_string(0, ">>,>>>,>>9.99")
                    output_list.avrg_price = to_string(0, ">>,>>>,>>9.99")
                    output_list.min_oh = to_string(l_artikel.min_bestand, "->,>>>,>>9.99")
                    output_list.must_order = to_string(must_order, "->,>>>,>>9.99")
                    ...
                    output_list.unit = to_string(l_artikel.masseinheit, "x(3)")
                    output_list.act_qty = to_string(tot_anz, "->,>>>,>>9.99")
                    output_list.act_val = to_string(0, "->,>>>,>>>,>>>,>>9")
                    output_list.cont1 = to_string(l_artikel.inhalt, ">>,>>9.99")
                    output_list.d_unit = to_string(l_artikel.traubensorte, "x(8)")
                    output_list.cont2 = to_string(l_artikel.lief_einheit, ">>,>>9.99")
                    output_list.last_price = to_string(0, ">,>>>,>>>,>>9")
                    output_list.act_price = to_string(0, ">,>>>,>>>,>>9")
                    output_list.avrg_price = to_string(0, ">,>>>,>>>,>>9")
                    output_list.min_oh = to_string(l_artikel.min_bestand, "->,>>>,>>9.99")
                    output_list.must_order = to_string(must_order, "->,>>>,>>9.99")
    ...
    for output_list in query(output_list_data):
        ...
        soh_list.last_price =  to_decimal(to_decimal(output_list.last_price) )
        soh_list.act_price =  to_decimal(to_decimal(output_list.act_price) )
        soh_list.avrg_price =  to_decimal(to_decimal(output_list.avrg_price) )
        soh_list.min_oh =  to_decimal(to_decimal(output_list.min_oh) )
        soh_list.must_order =  to_decimal(to_decimal(output_list.must_order) )
