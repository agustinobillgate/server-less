...
def prepare_main0_1(pvilanguage:int):
    ...
    def check_room_pos_license():
        ...
        nonlocal lstopped, lic_nr, htl_name, h_name, htl_city, h_city, htl_adr, htl_tel, vhp_multi, vhp_lite, rest_lic, eng_dept, i_param111, i_param297, p_decimal, d_currency, msg_str, coa_format, dateflag, condo_flag, newdb, t_queasy_data, p_787, p_223, loyalty_flag, lvcarea, queasy, bediener, htparam, paramtext, zimmer, hoteldpt
        nonlocal pvilanguage
