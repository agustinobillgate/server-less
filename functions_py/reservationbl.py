...
def reservationbl(case_type:int, gastno:int, resno:int):
    ...
    def generate_output():
        nonlocal mainres_list_data, res_list_data, ci_date, i, str, res_bemerk, loopk, res_line, reservation, zimkateg, guest, kontline
        ...
        return {"mainres-list": mainres_list_data, "res-list": res_list_data}
    ...
    def update_gcfinfo():
        ...
        nonlocal mainres_list_data, res_list_data, i, str, res_bemerk, loopk, res_line, reservation, zimkateg, guest, kontline
        nonlocal case_type, gastno, resno
        nonlocal bresline
