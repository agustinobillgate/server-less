...
def ts_restinv_pay_cash2bl(rec_id:int, transdate:date, curr_dept:int, disc_art1:int, disc_art2:int, disc_art3:int, kelner_nr:int):
    ...
    def generate_output():
        nonlocal bill_date, fl_code, get_rechnr, get_amount, active_deposit, recid_hbill, htparam, h_bill, interface, h_bill_line, h_artikel, queasy, tisch, h_umsatz, artikel
        nonlocal rec_id, transdate, curr_dept, disc_art1, disc_art2, disc_art3, kelner_nr
