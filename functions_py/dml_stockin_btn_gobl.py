...
def dml_stockin_btn_gobl(pvilanguage:int, op_list_data:[Op_list], curr_dept:int, billdate:date, curr_lager:int, lscheinnr:string, lief_nr:int, f_endkum:int, b_endkum:int, m_endkum:int, fb_closedate:date, m_closedate:date, user_init:string, t_amount:Decimal):
