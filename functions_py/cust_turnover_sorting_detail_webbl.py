...
def cust_turnover_sorting_detail_webbl(cardtype:int, sort_type:int, fdate:date, tdate:date, check_ftd:bool, currency:string, excl_other:bool, curr_sort2:int, idflag:string):
    ...
    pass
    curr_sort2, b_list_data = get_output(cust_turnover_sorting_detail_cldbl(cardtype, sort_type, fdate, tdate, check_ftd, currency, excl_other, curr_sort2))

    for b_list in query(b_list_data):
        pqueasy = Queasy()
