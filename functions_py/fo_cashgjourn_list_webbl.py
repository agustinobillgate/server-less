...
def fo_cashgjourn_list_webbl(pvilanguage:int, case_type:int, curr_shift:int, summary_flag:bool, onlyjournal:bool, excljournal:bool, from_date:date, bline_list_data:[Bline_list]):
