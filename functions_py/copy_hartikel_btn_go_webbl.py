...
payload_list_data, Payload_list = create_model("Payload_list", {"all_flag":bool, "dept1":int, "dept2":int, "art1":int, "art2":int, "overwrite_flag":bool, "user_init":string})

def copy_hartikel_btn_go_webbl(payload_list_data:[Payload_list]):
