...
def dml_list_create_pr_11_webbl(c_list_data:[C_list], s_list_data:[S_list], curr_dept:int, rec_id:int, dunit_price:bool, selected_date:date, user_init:string, dml_hdr_remark:string):
    ...
    dml_hdr_remark = dml_hdr_remark.strip()
