...
def pj_depart1_4bl(pvilanguage:int, case_type:int, disptype:int, fdate:date, tdate:date, froom:string, troom:string, disp_accompany:bool, setup_list_data:[Setup_list], zikat_list_data:[Zikat_list]):
    ...
    def generate_output():
        nonlocal tot_rm, tot_a, tot_c, tot_co, str_list_data, s_list_data, cl_list_data, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, all_remark, curr_zinr, lvcarea, htparam, guest, reservation, res_line, history, guestseg, segment, reslin_queasy, nation, bill, mc_guest, mc_types
