...
def hcost_anal_btn_gobl(sorttype:int, incl_bf:bool, incl_fb:bool, from_date:date, to_date:date, f_eknr:int, b_eknr:int, f_l_eknr:int, b_l_eknr:int, preis_typ:int, food_bev:string, bev_food:string):
    ...
    s_list_data, S_list = create_model("S_list", {"flag":int, "artnr":int, "bezeich":string, "munit":string, "qty1":Decimal, "val1":Decimal, "qty2":Decimal, "val2":Decimal, "d_qty":Decimal, "d_val":Decimal, "s_qty1":string, "s_qty2":string, "s_qty3":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal s_list_data, h_artikel, artikel, h_cost, l_artikel, h_rezept, h_rezlin, l_op, l_ophdr, gl_acct
        nonlocal sorttype, incl_bf, incl_fb, from_date, to_date, f_eknr, b_eknr, f_l_eknr, b_l_eknr, preis_typ, food_bev, bev_food
            ...
            for h_cost.anzahl, h_cost.betrag, h_cost._recid, h_artikel.artnrlager, h_artikel.artnrrezept, h_artikel._recid, artikel.endkum, artikel._recid in db_session.query(H_cost.anzahl, H_cost.betrag, H_cost._recid, H_artikel.artnrlager, H_artikel.artnrrezept, H_artikel._recid, Artikel.endkum, Artikel._recid).join(H_artikel,(H_artikel.artnr == H_cost.artnr) & (H_artikel.departement == H_cost.departement) & ((H_artikel.artnrlager != 0) | (H_artikel.artnrrezept != 0))).join(Artikel,(Artikel.artnr == H_artikel.artnrfront) & (Artikel.departement == H_artikel.departement)).filter((H_cost.datum == datum) & (H_cost.flag == 1)).order_by(H_artikel.bezeich).all():
                ...
                if h_artikel.artnrlager != 0 and artikel.endkum == f_eknr:
                    ...
                    if l_artikel:
                        ...
                        s_list = query(s_list_data, filters=(lambda s_list: s_list.artnr == l_artikel.artnr), first=True)
    ...
    def create_list11():
        ...
        for datum in date_range(from_date,to_date) :
            ...
            for h_cost.anzahl, h_cost.betrag, h_cost._recid, h_artikel.artnrlager, h_artikel.artnrrezept, h_artikel._recid, artikel.endkum, artikel._recid in db_session.query(H_cost.anzahl, H_cost.betrag, H_cost._recid, H_artikel.artnrlager, H_artikel.artnrrezept, H_artikel._recid, Artikel.endkum, Artikel._recid).join(H_artikel,(H_artikel.artnr == H_cost.artnr) & (H_artikel.departement == H_cost.departement) & ((H_artikel.artnrlager != 0) | (H_artikel.artnrrezept != 0))).join(Artikel,(Artikel.artnr == H_artikel.artnrfront) & (Artikel.departement == H_artikel.departement) & (Artikel.endkum == f_eknr)).filter((H_cost.datum == datum) & (H_cost.flag == 1)).order_by(H_artikel.bezeich).all():
    ...
    def create_list22():
        ...
        for datum in date_range(from_date,to_date) :
            ...
            for h_cost.anzahl, h_cost.betrag, h_cost._recid, h_artikel.artnrlager, h_artikel.artnrrezept, h_artikel._recid, artikel.endkum, artikel._recid in db_session.query(H_cost.anzahl, H_cost.betrag, H_cost._recid, H_artikel.artnrlager, H_artikel.artnrrezept, H_artikel._recid, Artikel.endkum, Artikel._recid).join(H_artikel,(H_artikel.artnr == H_cost.artnr) & (H_artikel.departement == H_cost.departement) & ((H_artikel.artnrlager != 0) | (H_artikel.artnrrezept != 0))).join(Artikel,(Artikel.artnr == H_artikel.artnrfront) & (Artikel.departement == H_artikel.departement) & (Artikel.endkum == b_eknr)).filter((H_cost.datum == datum) & (H_cost.flag == 1)).order_by(H_artikel.bezeich).all():
    ...
    def recipe_bdown(p_artnr:int, menge:Decimal):
        ...
        for h_rezlin in db_session.query(H_rezlin).filter((H_rezlin.artnrrezept == p_artnr)).order_by(H_rezlin._recid).all():
            ...
            if h_rezlin.recipe_flag :
                ...
                if l_artikel and (((l_artikel.endkum == f_l_eknr) and (sorttype == 1)) or ((l_artikel.endkum == b_l_eknr) and (sorttype == 2))):
    ...
    def create_food():
        ...
        for l_ophdr.fibukonto, l_ophdr._recid, l_op.anzahl, l_op.warenwert, l_op._recid, l_artikel.artnr, l_artikel.bezeich, l_artikel.inhalt, l_artikel.masseinheit, l_artikel.endkum, l_artikel.ek_aktuell, l_artikel.vk_preis, l_artikel._recid in db_session.query(L_ophdr.fibukonto, L_ophdr._recid, L_op.anzahl, L_op.warenwert, L_op._recid, L_artikel.artnr, L_artikel.bezeich, L_artikel.inhalt, L_artikel.masseinheit, L_artikel.endkum, L_artikel.ek_aktuell, L_artikel.vk_preis, L_artikel._recid).join(L_op,(L_op.lscheinnr == L_ophdr.lscheinnr) & (L_op.loeschflag <= 1) & (L_op.op_art == 3)).join(L_artikel,(L_artikel.artnr == L_op.artnr)).filter((func.lower(L_ophdr.op_typ) == "stt") & (L_ophdr.datum >= from_date) & (L_ophdr.datum <= to_date) & ((func.lower(L_ophdr.fibukonto)) == (food_bev).lower())).order_by(L_ophdr._recid).all():
        ...
        for l_ophdr.fibukonto, l_ophdr._recid, l_op.anzahl, l_op.warenwert, l_op._recid, l_artikel.artnr, l_artikel.bezeich, l_artikel.inhalt, l_artikel.masseinheit, l_artikel.endkum, l_artikel.ek_aktuell, l_artikel.vk_preis, l_artikel._recid in db_session.query(L_ophdr.fibukonto, L_ophdr._recid, L_op.anzahl, L_op.warenwert, L_op._recid, L_artikel.artnr, L_artikel.bezeich, L_artikel.inhalt, L_artikel.masseinheit, L_artikel.endkum, L_artikel.ek_aktuell, L_artikel.vk_preis, L_artikel._recid).join(L_op,(L_op.lscheinnr == L_ophdr.lscheinnr) & (L_op.loeschflag <= 1) & (L_op.op_art == 3)).join(L_artikel,(L_artikel.artnr == L_op.artnr)).filter((func.lower(L_ophdr.op_typ) == "stt") & (L_ophdr.datum >= from_date) & (L_ophdr.datum <= to_date) & ((func.lower(L_ophdr.fibukonto)) != (food_bev).lower()) & ((func.lower(L_ophdr.fibukonto)) != ("0000000000").lower())).order_by(L_ophdr._recid).all():
    ...
    def create_beverage1():
        ...
        for l_ophdr.fibukonto, l_ophdr._recid, l_op.anzahl, l_op.warenwert, l_op._recid, l_artikel.artnr, l_artikel.bezeich, l_artikel.inhalt, l_artikel.masseinheit, l_artikel.endkum, l_artikel.ek_aktuell, l_artikel.vk_preis, l_artikel._recid in db_session.query(L_ophdr.fibukonto, L_ophdr._recid, L_op.anzahl, L_op.warenwert, L_op._recid, L_artikel.artnr, L_artikel.bezeich, L_artikel.inhalt, L_artikel.masseinheit, L_artikel.endkum, L_artikel.ek_aktuell, L_artikel.vk_preis, L_artikel._recid).join(L_op,(L_op.lscheinnr == L_ophdr.lscheinnr) & (L_op.loeschflag <= 1) & (L_op.op_art == 3)).join(L_artikel,(L_artikel.artnr == L_op.artnr) & (L_artikel.endkum == b_l_eknr)).filter(((func.lower(L_ophdr.op_typ)) == "stt") & (L_ophdr.datum >= from_date) & (L_ophdr.datum <= to_date) & ((func.lower(L_ophdr.fibukonto)) == ("0000000000").lower())).order_by(L_ophdr._recid).all():
            ...
            s_list = query(s_list_data, filters=(lambda s_list: s_list.artnr == l_artikel.artnr and s_list.flag == 0), first=True)
        ...
        for l_ophdr.fibukonto, l_ophdr._recid, l_op.anzahl, l_op.warenwert, l_op._recid, l_artikel.artnr, l_artikel.bezeich, l_artikel.inhalt, l_artikel.masseinheit, l_artikel.endkum, l_artikel.ek_aktuell, l_artikel.vk_preis, l_artikel._recid in db_session.query(L_ophdr.fibukonto, L_ophdr._recid, L_op.anzahl, L_op.warenwert, L_op._recid, L_artikel.artnr, L_artikel.bezeich, L_artikel.inhalt, L_artikel.masseinheit, L_artikel.endkum, L_artikel.ek_aktuell, L_artikel.vk_preis, L_artikel._recid).join(L_op,(L_op.lscheinnr == L_ophdr.lscheinnr) & (L_op.loeschflag <= 1) & (L_op.op_art == 3)).join(L_artikel,(L_artikel.artnr == L_op.artnr)).filter(((func.lower(L_ophdr.op_typ)) == "stt") & (L_ophdr.datum >= from_date) & (L_ophdr.datum <= to_date) & ((func.lower(L_ophdr.fibukonto)) == (food_bev).lower())).order_by(L_ophdr._recid).all():
            ...
            s_list = query(s_list_data, filters=(lambda s_list: s_list.artnr == l_artikel.artnr and s_list.flag == 1), first=True)
    ...
    def create_food1():
        ...
        for l_ophdr.fibukonto, l_ophdr._recid, l_op.anzahl, l_op.warenwert, l_op._recid, l_artikel.artnr, l_artikel.bezeich, l_artikel.inhalt, l_artikel.masseinheit, l_artikel.endkum, l_artikel.ek_aktuell, l_artikel.vk_preis, l_artikel._recid in db_session.query(L_ophdr.fibukonto, L_ophdr._recid, L_op.anzahl, L_op.warenwert, L_op._recid, L_artikel.artnr, L_artikel.bezeich, L_artikel.inhalt, L_artikel.masseinheit, L_artikel.endkum, L_artikel.ek_aktuell, L_artikel.vk_preis, L_artikel._recid).join(L_op,(L_op.lscheinnr == L_ophdr.lscheinnr) & (L_op.loeschflag <= 1) & (L_op.op_art == 3)).join(L_artikel,(L_artikel.artnr == L_op.artnr)).filter((func.lower(L_ophdr.op_typ) == "stt") & (L_ophdr.datum >= from_date) & (L_ophdr.datum <= to_date) & ((func.lower(L_ophdr.fibukonto)) == (bev_food).lower())).order_by(L_ophdr._recid).all():
        ...
        for l_ophdr.fibukonto, l_ophdr._recid, l_op.anzahl, l_op.warenwert, l_op._recid, l_artikel.artnr, l_artikel.bezeich, l_artikel.inhalt, l_artikel.masseinheit, l_artikel.endkum, l_artikel.ek_aktuell, l_artikel.vk_preis, l_artikel._recid in db_session.query(L_ophdr.fibukonto, L_ophdr._recid, L_op.anzahl, L_op.warenwert, L_op._recid, L_artikel.artnr, L_artikel.bezeich, L_artikel.inhalt, L_artikel.masseinheit, L_artikel.endkum, L_artikel.ek_aktuell, L_artikel.vk_preis, L_artikel._recid).join(L_op,(L_op.lscheinnr == L_ophdr.lscheinnr) & (L_op.loeschflag <= 1) & (L_op.op_art == 3)).join(L_artikel,(L_artikel.artnr == L_op.artnr)).filter(((func.lower(L_ophdr.op_typ)) == "stt") & (L_ophdr.datum >= from_date) & (L_ophdr.datum <= to_date) & ((func.lower(L_ophdr.fibukonto)) != (bev_food).lower()) & ((func.lower(L_ophdr.fibukonto)) != ("0000000000").lower())).order_by(L_ophdr._recid).all():
