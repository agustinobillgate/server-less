...
def prepare_view_staycostbl(pvilanguage:int, resnr:int, reslinnr:int):
    ...
    def generate_output():
        nonlocal ci_date, contcode, ct, curr_rmcat, t_str, str_arrangement, kurzbez, t_res_line_data, output_list_data, new_contrate, lvcarea, bonus_array, wd_array, htparam, res_line, guest_pr, zimkateg, arrangement, waehrung
        ...
        return {"ci_date": ci_date, "contcode": contcode, "ct": ct, "curr_rmcat": curr_rmcat, "t_str": t_str, "str_arrangement": str_arrangement, "kurzbez": kurzbez, "t-res-line": t_res_line_data, "output-list": output_list_data}
    ...
    output_list_data = get_output(view_staycostbl(pvilanguage, resnr, reslinnr, contcode))
