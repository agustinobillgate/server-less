...
from models import Artikel, Bill, Htparam, Res_line, Argt_line, Billjournal, Umsatz, Bill_line, Arrangement

def i_master_taxserv(recid_mbill:int, currzeit:int, amount:Decimal=Decimal("0.0"), price_decimal:int=0, exchg_rate:Decimal=Decimal("0.0"), user_init:str="", bill_date:int=0, qty:int=1, price:Decimal=Decimal("0.0"), curr_room:int=0, cancel_str:str="", curr_department:int=0, double_currency:bool=False, arrangement:Arrangement=None):
    ...
    artikel = bill = htparam = res_line = argt_line = billjournal = umsatz = bill_line = arrangement = None
