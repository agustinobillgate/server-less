...
def upload_imagesetup_webbl(case_type:int, base64image:string, user_init:string, image_number:int, image_number2:int):

    prepare_cache ([Bediener, Guestbook, Res_history])
    ...
    def generate_output():
        ...
        nonlocal case_type, base64image, user_init, image_number, image_number2
    ...
    if case_type == 1:
        ...
        info_str = "FLOORPLAN IMAGE-" + "L" + to_string(img_num1) + "F" + to_string(img_num2)
        ...
        info_str = "QUOTE ATTACH-" + to_string(image_number)
