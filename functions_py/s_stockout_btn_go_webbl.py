...
def s_stockout_btn_go_webbl(op_list_data:[Op_list], pvilanguage:int, out_type:int, rec_id:int, curr_lager:int, jobnr:int, cost_acct:string, transdate:date, t_datum:date, transfered:bool, t_lschein:string, to_stock:int, lscheinnr:string, bediener_nr:int, qty:Decimal, t_amount:Decimal):
    ...
    stock_oh_tmp_data, Stock_oh_tmp = create_model("Stock_oh_tmp", {"stock_oh":Decimal, "artnr":int})
    ...
    def generate_output():
        ...
        nonlocal stock_oh_tmp_data, out_list_data
    ...
    def create_l_op(zeit:int):
        ...
        if l_bestand:
            ...
            stock_oh_tmp_data.append(stock_oh_tmp)
    ...
    def update_request_records():
        ...
        while None != l_op:
            ...
            if op_list:
                ...
                stock_oh_tmp = query(stock_oh_tmp_data, filters=(lambda stock_oh_tmp: stock_oh_tmp.artnr == op_list.artnr), first=True)
