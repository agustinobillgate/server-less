...
"""_yusufwijasena_30/12/2025
        ...
        remark: - added validation for b1_list to avoid NoneType error
"""
...
def prepare_prtable_adminbl():
    ...
    b1_list_data, B1_list = create_model(
        "B1_list",
        {
            "nr": int,
            "marknr": int,
    ...
    fill_t_waehrung_data, Fill_t_waehrung = create_model(
        "Fill_t_waehrung",
        {
            "wabkurz": string
        }
    ...
    def generate_output():
        ...
        return {
            ...
            "f_char": f_char,
            "f_logical": f_logical,
            "fill_wabkurz": fill_wabkurz,
            "b1-list": b1_list_data,
            "t-waehrung1": t_waehrung1_data,
            "fill-t-waehrung": fill_t_waehrung_data,
            "margt-list": margt_list_data,
            "hargt-list": hargt_list_data,
            "hrmcat-list": hrmcat_list_data,
            "mrmcat-list": mrmcat_list_data
        }
    ...
    def check_array():
        ...
        for i in range(1, 99 + 1):
            ...
            if array[i - 1] != 0:
                ...
                hrmcat_list = query(hrmcat_list_data, filters=(
                    lambda hrmcat_list: hrmcat_list.nr == mrmcat_list.nr), first=True)
        ...
        for i in range(1, 99 + 1):
            ...
            if array[i - 1] != 0:
                ...
                arrangement = get_cache(
                    Arrangement, {"argtnr": [(eq, array[i - 1])]})
                ...
                hargt_list = query(hargt_list_data, filters=(
                    lambda hargt_list: hargt_list.nr == margt_list.nr), first=True)
