...
def read_artikel1bl(case_type:int, artno:int, dept:int, aname:string, artart:int, betriebsno:int, actflag:bool):
    ...
    if case_type == 1:
        ...
        for t_artikel in query(t_artikel_data, filters=(lambda t_artikel: t_artikel.artikel.departement == dept and artikel.artart == artart and artikel.artnr >= artno and artikel.pricetab == actflag)):
            cr_artikel()
    elif case_type == 20:
