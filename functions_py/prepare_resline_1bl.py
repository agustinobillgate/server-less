...
def prepare_resline_1bl(pvilanguage:int, res_mode:string, session_date:string, user_init:string, inp_gastnr:int, inp_resnr:int, inp_reslinnr:int, rate_readonly:bool, qci_zinr:string, res_dynarate_data:[Res_dynarate]):
    ...
    def generate_output():
        ...
        nonlocal rline_list_data, reslin_list_data, curr_resline_data, t_history_data, currency_list_data, reschanged_list_data, f_resline_data
