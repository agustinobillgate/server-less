...
# 
# yusufwijasena, 2/2/2026
# - modify query to check if has fa_orderheader
# ------------------------------------------
from functions.additional_functions import *
from decimal import Decimal
from datetime import date
from models import Fa_ordheader, L_lieferant, Mathis, Fa_op
...
def fa_incomingbl(fromdate: date, todate: date, searchby: int, devnote_no: string, po_no: string, supp_no: int):
    ...
    if searchby == 1 and devnote_no:
        ...
        fa_op_data = (
            ...
            .join(Fa_ordheader, (Fa_ordheader.order_nr != Fa_op.docu_nr))
            .filter(
                 (Fa_op.opart == 1) &
            ...
            .order_by(Fa_op.datum, Fa_op.docu_nr)
        )
        ...
        fa_op_data = (
            ...
            .join(L_lieferant, (L_lieferant.lief_nr == Fa_op.lief_nr))
            .join(Mathis, (Mathis.nr == Fa_op.nr))
            .join(Fa_ordheader, (Fa_op.docu_nr != Fa_ordheader.order_nr))
            .filter(
                 (Fa_op.opart == 1) &
                 (Fa_op.datum >= fromdate) &
                 (Fa_op.datum <= todate) &
