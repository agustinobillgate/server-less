...
def print_rcbl(sorttype:int, last_sort:int, lname:string, fdate:date, lresnr:int, room:string):
    ...
    def generate_output():
        ...
        nonlocal rc_list_data

        return {"rc-list": rc_list_data, "msg_str": msg_str}
