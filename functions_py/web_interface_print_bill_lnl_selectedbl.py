...
def web_interface_print_bill_lnl_selectedbl(t_spbill_list_data:[T_spbill_list], pvilanguage:int, curr_status:string, briefnr:int, resnr:int, reslinnr:int, inv_type:int, rechnr:int, curr_program:string, gastnr:int, spbill_flag:bool, user_init:string, lnldelimeter:string, for_curr:Decimal, conv_wabkurz:string, curr_bezeich:string):

    prepare_cache ([Guest, Res_line, Htparam, Paramtext, Bill, Mc_guest, Artikel, Reservation, Bediener, Arrangement, Waehrung, Zimmer, Queasy, Exrate])
