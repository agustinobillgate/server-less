...
def hk_roomlist_1bl(casetype:int, pvilanguage:int, curr_date:date, prog_name:string):
    ...
    def generate_output():
        ...
        return {"def_cotime": def_cotime, "pr_opt_str": pr_opt_str, "ci_date": ci_date, "output-list": output_list_data, "t-history": t_history_data}
    ...
    def fill_cashbasis():
        ...
        for output_list in query(output_list_data, filters=(lambda output_list: output_list.resnr > 0)):
