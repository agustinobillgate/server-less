...
# - Fixing filter  GE from-date to eg_request.from-date
# - Fixing filter  LE to-date to eg_request.to-date
...
def eg_reglist1_btn_cancelbl(location:int, rmno:string, main_nr:int, reqstatus:int, sguestflag:bool, copyrequest_reqnr:int, user_init:string, st_cancel:string):
    ...
    def generate_output():
        nonlocal flag, copyrequest_data, eg_request, queasy, eg_property, eg_location, zimmer, eg_subtask
        ...
        nonlocal tpic_data, copyrequest_data, tcategory_data, tsource_data, tsubtask_data, tmaintask_data, tlocation_data, troom_data, tstatus_data

        return {"location": location, "rmno": rmno, "main_nr": main_nr, "reqstatus": reqstatus, "flag": flag, "copyRequest": copyrequest_data}
    ...
    def create_request1():
        ...
        for eg_request in db_session.query(Eg_request).filter(
                 (Eg_request.delete_flag == False) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request._recid).with_for_update().all():
            ...
            if rmno != "" and main_nr != 0:
                ...
                if reqstatus == 0:
                    ...
                    for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                             (Eg_request.zinr == (rmno).lower()) & (Eg_request.maintask == main_nr) & (Eg_request.deptnum >= 0) & (Eg_request.delete_flag == False) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                        ...
                        tsubtask = query(tsubtask_data, (lambda tsubtask: tsubtask.sub_nr == eg_request.sub_task), first=True)
                        if not tsubtask:
                            continue
                        ...
                        tpic = query(tpic_data, (lambda tpic: tpic.pic_nr == eg_request.assign_to), first=True)
                        if not tpic:
                            continue
                    ...
                    eg_request_obj_list = {}
                    for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                             (Eg_request.zinr == (rmno).lower()) & (Eg_request.maintask == main_nr) & (Eg_request.deptnum >= 0) & (Eg_request.reqstatus == reqstatus) & (Eg_request.delete_flag == False) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                        tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                        if not tstatus:
                            continue
                ...
                if reqstatus == 0:
                    ...
                    eg_request_obj_list = {}
                    for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                             (Eg_request.zinr == (rmno).lower()) & (Eg_request.deptnum >= 0) & (Eg_request.delete_flag == False) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                        tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                        if not tstatus:
                            continue
                    ...
                    eg_request_obj_list = {}
                    for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                             (Eg_request.zinr == (rmno).lower()) & (Eg_request.delete_flag == False) & (Eg_request.deptnum >= 0) & (Eg_request.reqstatus == reqstatus) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                        tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                        if not tstatus:
                            continue
                ...
                if reqstatus == 0:
                    ...
                    eg_request_obj_list = {}
                    for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                             (Eg_request.reserve_int == location) & (Eg_request.maintask == main_nr) & (Eg_request.deptnum >= 0) & (Eg_request.delete_flag == False) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                        tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                        if not tstatus:
                            continue
                    ...
                    eg_request_obj_list = {}
                    for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                             (Eg_request.reserve_int == location) & (Eg_request.maintask == main_nr) & (Eg_request.deptnum >= 0) & (Eg_request.reqstatus == reqstatus) & (Eg_request.delete_flag == False) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                        tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                        if not tstatus:
                            continue
                ...
                if reqstatus == 0:
                    ...
                    eg_request_obj_list = {}
                    for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                             (Eg_request.reserve_int == location) & (Eg_request.delete_flag == False) & (Eg_request.deptnum >= 0) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                        tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                        if not tstatus:
                            continue
                    ...
                    eg_request_obj_list = {}
                    for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                             (Eg_request.reserve_int == location) & (Eg_request.deptnum >= 0) & (Eg_request.reqstatus == reqstatus) & (Eg_request.delete_flag == False) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                        tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                        if not tstatus:
                            continue
            ...
            if location == 0:
                ...
                if main_nr != 0:
                    ...
                    if reqstatus == 0:
                        ...
                        eg_request_obj_list = {}
                        for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                                 (Eg_request.maintask == main_nr) & (Eg_request.deptnum >= 0) & (Eg_request.delete_flag == False) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                            tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                            if not tstatus:
                                continue
                        ...
                        eg_request_obj_list = {}
                        for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                                 (Eg_request.maintask == main_nr) & (Eg_request.deptnum >= 0) & (Eg_request.reqstatus == reqstatus) & (Eg_request.delete_flag == False) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                            tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                            if not tstatus:
                                continue
                    ...
                    if reqstatus == 0:
                        ...
                        eg_request_obj_list = {}
                        for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                                 (Eg_request.deptnum >= 0) & (Eg_request.delete_flag == False) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                            tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                            if not tstatus:
                                continue
                        ...
                        eg_request_obj_list = {}
                        for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                                 (Eg_request.deptnum >= 0) & (Eg_request.reqstatus == reqstatus) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.reqnr).all():
                            tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                            if not tstatus:
                                continue
                ...
                if main_nr != 0:
                    ...
                    if reqstatus == 0:
                        ...
                        eg_request_obj_list = {}
                        for eg_request, eg_location, eg_property in db_session.query(Eg_request, Eg_location, Eg_property).join(Eg_location,(Eg_location.nr == Eg_request.reserve_int)).join(Eg_property,(Eg_property.nr == Eg_request.property)).filter(
                                 (Eg_request.reserve_int == location) & (Eg_request.deptnum >= 0) & (Eg_request.delete_flag == False) & (Eg_request.reqstatus == reqstatus) & (Eg_request.opened_date >= eg_request.from_date) & (Eg_request.opened_date >= eg_request.to_date)).order_by(Eg_request.opened_date).all():
                            tstatus = query(tstatus_data, (lambda tstatus: tstatus.stat_nr == eg_request.reqstatus), first=True)
                            if not tstatus:
                                continue
