...
t_cflow1_data, T_cflow1 = create_model_like(Queasy)

def update_status_cashflowbl(case_type:int, t_cflow1_data:[T_cflow1]):
    success_flag = False
    queasy = None
    ...
    def generate_output():
        ...
        nonlocal case_type, t_cflow1_data
        nonlocal t_queasy
    ...
    if case_type == 1:
        ...
        t_cflow1 = query(t_cflow1_data, first=True)
