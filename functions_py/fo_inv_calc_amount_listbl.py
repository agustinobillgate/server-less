...
def fo_inv_calc_amount_listbl(transdate:date, betriebsnr:int, artart:int, pricetab:bool, balance_foreign:Decimal, double_currency:bool, balance:Decimal, price:Decimal, price_decimal:int, foreign_rate:bool, p_145:int, epreis:Decimal, adrflag:bool, artgrp:int, qty:int, res_exrate:Decimal, exchg_rate:Decimal, zipreis:Decimal):
    ...
    balance_foreign = to_decimal(balance_foreign) or to_decimal("0.0")
    balance = to_decimal(balance) or to_decimal("0.0")
    price = to_decimal(price) or to_decimal("0.0")
    price_decimal = int(price_decimal) or 0
    epreis = to_decimal(epreis) or to_decimal("0.0")
    res_exrate = to_decimal(res_exrate) or to_decimal("0.0")
    exchg_rate = to_decimal(exchg_rate) or to_decimal("0.0")
    zipreis = to_decimal(zipreis) or to_decimal("0.0")
