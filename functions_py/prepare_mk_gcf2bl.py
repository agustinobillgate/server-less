...
def prepare_mk_gcf2bl(lastname:string, firstname:string):
    ...
    def generate_output():
        nonlocal err_nr, curr_gastnr, lname, f_logical, avail_genlayout, t_guest_data, t_sourccod1_data, t_nation1_data, guest, htparam, sourccod, nation, genlayout
        ...
        return {"err_nr": err_nr, "curr_gastnr": curr_gastnr, "lname": lname, "f_logical": f_logical, "avail_genlayout": avail_genlayout, "t-guest": t_guest_data, "t-sourccod1": t_sourccod1_data, "t-nation1": t_nation1_data}
