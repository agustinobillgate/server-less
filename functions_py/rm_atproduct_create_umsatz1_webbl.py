...
# ---------------------------------------------------------------------------------
# Rulita, 08-09-2025
# Fixing persentage total sales from default 0, ">>>>>>" to default string "      "
# ---------------------------------------------------------------------------------
            ...
            if sales_id == "" or (entry(0, curr_id_screenvalue, "-") == to_list.sales_id):
                ...
                if curr_sales != to_list.sales_id:
                    ...
                    if price_decimal == 0 and currency_type == 1:
                        ...
                        rm_atproduct.mtdproz = to_string("      ")
                        ...
                        rm_atproduct.ytd_proz = to_string("      ")
