...
def ts_closeinv_pay_typegt1bl(bilrecid:int, recid_h_bill:int, balance_foreign:Decimal, balance:Decimal, pay_type:int):
    ...
    def generate_output():
        nonlocal billart, qty, price, amount_foreign, amount, description, transfer_zinr, t_h_bill_data, h_bill, bill, counters
        ...
        return {"billart": billart, "qty": qty, "price": price, "amount_foreign": amount_foreign, "amount": amount, "description": description, "transfer_zinr": transfer_zinr, "t-h-bill": t_h_bill_data}
