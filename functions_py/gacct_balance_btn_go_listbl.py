...
def gacct_balance_btn_go_listbl(pvilanguage:int, bill_alert_data:[Bill_alert], heute:date, billdate:date, ank_flag:bool, sorttype:int, fact1:int, price_decimal:int, short_flag:bool):
    ...
    def generate_output():
        nonlocal msg_str, msg_str2, gacct_balance_list_data, i, prevbal, debit, credit, balance, current_counter, t_prevbal, t_debit, t_credit, t_balance, tot_bline, curr_rechnr, curr_flag, jl, lvcarea, bill_line, bill, res_line, guest, artikel, uebertrag
