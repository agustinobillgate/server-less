...
def ts_restinv_update_void_item_webbl(pvilanguage:int, rec_id:int, rec_id_h_artikel:int, deptname:string, 
    ...
    t_kellner1_data, T_kellner1 = create_model("T_kellner1", {"departement":int, "kumsatz_nr":int, "kcredit_nr":int, "kzahl_nr":int, "kellnername":string, "updatedatum":date, "saldo":Decimal, "kellner_nr":int, "sprachcode":int, "masterkey":bool, "nullbon":bool, "ignore_pers":bool, "kel_unique":bool, "storno_begruendung":bool, "betriebsnr":int})
    ...
    kellner1 = get_cache (Kellner, {"kellner_nr": [(eq, h_bill.kellner_nr)],"departement": [(eq, curr_dept)]})
