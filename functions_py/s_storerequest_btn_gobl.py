...
def s_storerequest_btn_gobl(op_list_data, recid_l_ophdr:int, transdate:date, curr_lager:int, transfered:bool, cost_acct:string, deptno:int, to_stock:int, lscheinnr:string, user_init:string):
