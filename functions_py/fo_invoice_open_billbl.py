...
def fo_invoice_open_billbl(bil_flag:int, bil_recid:int, room:string, vipflag:bool):
    ...
    prepare_cache ([Bill, Res_line, Htparam, Zimmer, Waehrung, Master, Counters, Queasy])
    ...
    t_bill = t_res_line = resbuff = guestmember = mbill = masbill = bill1 = None
    ...
    Masbill = create_buffer("Masbill",Bill)
    ...
    if master:
        ...
        mbill = get_cache (Bill, {"resnr": [(eq, bill.resnr)],"rechnr": [(eq, master.rechnr),(ne, 0)],"reslinnr": [(eq, 0)],"zinr": [(eq, "")]})
