...
menu_data, Menu = create_model("Menu", {"artnr":int, "anzahl":int, "departement":int, "prtflag":int, "pos":int, "bcolor":int, "epreis":Decimal, "betrag":Decimal, "fremdwbetrag":Decimal, "bezeich":string, "bez0":string}, {"bcolor": 1})

def ts_disc1_btn_exitbl(rec_id:int, billart:int, dept:int, transdate:date, amount:Decimal, description:string, netto_betrag:Decimal, exchg_rate:Decimal, tischnr:int, curr_select:int, disc_value:Decimal, qty:int, cancel_str:string, curr_waiter:int, procent:Decimal, b_artnrfront:int, o_artnrfront:int, price_decimal:int, user_init:string, disc_list_data:[Disc_list], vat_list_data:[Vat_list], menu_data:[Menu]):
