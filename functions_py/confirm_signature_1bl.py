    ...
    if confirmsign_flag :
        ...
        if flag_type.lower()  == ("DML").lower() :
            ...
            if not queasy:
                ...
                res_history.datum = get_current_date()
                res_history.zeit = get_current_time_in_seconds()
                res_history.aenderung = "Using E-Signature For DML: " + docu_nr + "|Approve No: " + to_string(app_no) + "|" + app_id
                res_history.action = "E-Signature"
            ...
            if queasy:
                ...
                res_history.datum = get_current_date()
                res_history.zeit = get_current_time_in_seconds()
                res_history.aenderung = "Change E-Signature For DML: " + docu_nr + "|Approve No: " + to_string(app_no) + "|" + app_id
                res_history.action = "E-Signature"
        ...
        if flag_type.lower()  == ("DML").lower() :
            ...
            if queasy:
                ...
                res_history.datum = get_current_date()
                res_history.zeit = get_current_time_in_seconds()
                res_history.aenderung = "Cancel E-Signature For DML: " + docu_nr + "|Approve No: " + to_string(app_no) + "|" + app_id
                res_history.action = "E-Signature"
