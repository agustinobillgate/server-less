...
def prepare_rarticle_admin2_webbl(dept:int):
    ...
    q1_list_data, Q1_list = create_model_like(H_artikel, {"bez":string, "zknr":int, "bezeich2":string, "zk_bezeich":string, "ek_bezeich":string, "fart_bezeich":string, "fo_dept":int, "barcode":string, "max_soldout_qty":int, "soldout_flag":bool, "sub_menu_included":bool})
    ...
    for h_artikel in db_session.query(H_artikel).filter(
        ...
        if queasy:
            q1_list.sub_menu_included = queasy.logi1
