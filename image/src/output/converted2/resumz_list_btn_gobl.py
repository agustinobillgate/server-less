...
def resumz_list_btn_gobl(ldry_flag:bool, ldry:int, dstore:int, from_dept:int, to_dept:int, from_date:date, to_date:date, detailed:bool, long_digit:bool):
    ...
    output_list_list, Output_list = create_model("Output_list", {"mqty":int, "str":string})
    cl_list_list, Cl_list = create_model("Cl_list", {"flag":string, "artnr":int, "dept":int, "bezeich":string, "dnet":Decimal, "proz1":Decimal, "dgros":Decimal, "proz2":Decimal, "mqty":int, "mnet":Decimal, "proz3":Decimal, "mgros":Decimal, "proz4":Decimal})
