...
def gcf_birthdatebl(from_date:int, to_date:int, from_age:int, to_age:int, sorttype:int):
    ...
    birth_list_list, Birth_list = create_model("Birth_list", {"name2":string, "geburtdatum":date, "ankunft1":date, "abreise1":date, "zinr":string, "adresse":string, "wohnort":string})
