...
def arl_list_update_browsebl(show_rate:bool, recid_resline:int, long_stay:int, ci_date:date):
    ...
    def generate_output():
        nonlocal arl_list_list, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, all_inclusive, loopi, loopj, loopk, loopl, ratecodestr, str1, str2, web_com, paramtext, guest, res_line, waehrung, reservation, zimkateg, kontline, gentable, mc_guest, htparam, reslin_queasy, zimmer, queasy
