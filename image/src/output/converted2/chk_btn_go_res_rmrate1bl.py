...
def chk_btn_go_res_rmrate1bl(pvilanguage:int, curr_select:str, max_rate:decimal, fact1:decimal, inp_wahrnr:int, inp_zikatnr:int, user_init:str, resnr:int, reslinnr:int, recid_reslin:int, contcode:str, p_list_list:[P_list]):
    msg_str = ""
    error_found1 = False
    error_code = 0
