...
def prepare_view_staycost_1bl(pvilanguage:int, resnr:int, reslinnr:int):
    ...
    def generate_output():
        nonlocal ci_date, contcode, ct, curr_rmcat, t_str, str_arrangement, kurzbez, repeat_charge, t_res_line_list, output_list_list, new_contrate, lvcarea, bonus_array, wd_array, htparam, res_line, guest_pr, zimkateg, arrangement, waehrung, queasy
        ...
        return {"ci_date": ci_date, "contcode": contcode, "ct": ct, "curr_rmcat": curr_rmcat, "t_str": t_str, "str_arrangement": str_arrangement, "kurzbez": kurzbez, "repeat_charge": repeat_charge, "t-res-line": t_res_line_list, "output-list": output_list_list}
    ...
    output_list_list = get_output(view_staycost_cldbl(pvilanguage, resnr, reslinnr, contcode, repeat_charge))
