...
def lunchdinner_list_webbl(v_key:int, fdate:date, incl_accom:bool, incl_guarantee:bool, show_lunchdinner_rate:bool):
    ...
    def generate_output():
        nonlocal lunchdinner_list_list, mxtime_dayuse, param_561, diffcidate, p_87, num_of_day, lunch_artnr, dinner_artnr, bfast_dept, exchg_rate, qty_argt, htparam, zimkateg, res_line, arrangement, artikel, argt_line, reslin_queasy, fixleist, guest, reservation, segment, ratecode, mc_guest, mc_types, waehrung, genstat, bill, master
        nonlocal v_key, fdate, incl_accom, incl_guarantee, show_lunchdinner_rate


        nonlocal lunchdinner_list, zikat_list
        nonlocal lunchdinner_list_list, zikat_list_list

        return {"lunchdinner-list": lunchdinner_list_list}
    ...
    def create_lunch():
        ...
        for res_line in db_session.query(Res_line).filter(
            ...
            if do_it:
                ...
                lunchdinner_list_list.append(lunchdinner_list)
