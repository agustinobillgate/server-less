...
def prepare_ts_tbplan1_webbl(dept:int, curr_waiter:int):
    ...
    t_queasy_list, T_queasy = create_model_like(Queasy, {"bcol":int, "fcol":int, "rec_id":int, "billprint_flag":bool, "splitbill_flag":bool}, {"bcol": 10})
    ...
    t_zimmer_list, T_zimmer = create_model("T_zimmer", {"zinr":string})
    ...
    def generate_output():
        nonlocal ci_date, pos1, pos2, mc_flag, mc_pos1, mc_pos2, vpos_flag, t_queasy_list, t_tisch_list, t_h_bill_list, t_kellner_list, t_mc_guest_list, t_zimmer_list, t_queasy31_list, t_queasy33_list, s, curr_n, split_count, queasy, tisch, h_bill, kellner, mc_guest, htparam, zimmer, h_bill_line
