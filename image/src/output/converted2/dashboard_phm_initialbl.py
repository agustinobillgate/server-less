...
def dashboard_phm_initialbl(banquet_dept:string, commision:string, payable:string):
    ...
    his_res_list, His_res = create_model("His_res", {"number":int, "resnr":int, "reslinnr":int, "staydate":date, "ci_date":date, "co_date":date, "nbrofroom":int, "room_type":string, "rm_rev":Decimal, "fb_rev":Decimal, "other_rev":Decimal, "resstatus":string, "reserveid":int, "reservename":string, "bookdate":date, "rate_code":string, "nationality":string, "segmentcode":string, "cancel_date":string, "zinr":string, "nights":int, "adult":int, "child":int, "complimentary":int, "arrangement":string, "guest_name":string, "banquet_rev":Decimal, "commision":Decimal, "payable":Decimal, "nation2":string, "booktime":string, "salesid":string})
