...
from models import Argt_line, Waehrung, Guest, Artikel, Htparam, Res_line, Zimmer, Genstat, Arrangement, Exrate, Reservation, Billjournal, Bill, Segment, Zimkateg, Reslin_queasy

def rmrev_bdown_create_billbalance4_webbl(exc_taxserv:bool, pvilanguage:int, new_contrate:bool, foreign_rate:bool, price_decimal:int, fdate:date, tdate:date, srttype:int):

    prepare_cache ([Waehrung, Guest, Artikel, Htparam, Res_line, Zimmer, Genstat, Arrangement, Exrate, Reservation, Billjournal, Bill, Segment, Zimkateg, Reslin_queasy])
    ...
    argt_line = waehrung = guest = artikel = htparam = res_line = zimmer = genstat = arrangement = exrate = reservation = billjournal = bill = segment = zimkateg = reslin_queasy = None
    ...
    def generate_output():
        nonlocal cl_list_list, currency_list_list, sum_list_list, s_list_list, argt_list_list, exchg_rate, frate, post_it, total_rev, lvcarea, argt_line, waehrung, guest, artikel, htparam, res_line, zimmer, genstat, arrangement, exrate, reservation, billjournal, bill, segment, zimkateg, reslin_queasy
        nonlocal exc_taxserv, pvilanguage, new_contrate, foreign_rate, price_decimal, fdate, tdate, srttype
    ...
    def get_genstat_argt_betrag(frate:Decimal, argt_betrag:Decimal):
        ...
        nonlocal cl_list_list, currency_list_list, sum_list_list, s_list_list, argt_list_list, exchg_rate, post_it, total_rev, lvcarea, argt_line, waehrung, guest, artikel, htparam, res_line, zimmer, genstat, arrangement, exrate, reservation, billjournal, bill, segment, zimkateg, reslin_queasy
        nonlocal exc_taxserv, pvilanguage, new_contrate, foreign_rate, price_decimal, fdate, tdate, srttype
        nonlocal waehrung1, cc_list
