...
member_list_list, Member_list = create_model("Member_list", {"member_code":string, "member_type":string, "titled":string, "fullname":string, "firstname":string, "lastname":string, "email":string, "mobilenumber":string, "birthdate":date, "gender":string, "country":string, "city":string, "address":string, "stamps":int, "reg_date":date, "is_active":bool})

def memberid_membershipbl(case_type:int, gastnr:int, member_list_list:[Member_list], user_init:string):
    ...
    member_list = query(member_list_list, first=True)
