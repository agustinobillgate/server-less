...
t_l_order_list, T_l_order = create_model_like(L_order, {"rec_id":int, "a_bezeich":string, "price0":Decimal, "brutto":Decimal, "disc":Decimal, "disc2":Decimal, "vat":Decimal, "disc_val":Decimal, "disc2_val":Decimal, "vat_val":Decimal})

def mk_po_btn_go_webbl(t_l_orderhdr_list:[T_l_orderhdr], t_l_order_list:[T_l_order], docu_nr:string, lief_nr:int, billdate:date, create_new:bool, pr:string, globaldisc:Decimal, currency_screen_value:string):
    ...
    def generate_output():
        ...
        nonlocal docu_nr, lief_nr, billdate, create_new, pr, globaldisc, currency_screen_value
