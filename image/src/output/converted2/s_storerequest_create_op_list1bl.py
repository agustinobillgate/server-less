...
def s_storerequest_create_op_list1bl(pvilanguage:int, p_artnr:int, menge:Decimal, oh_ok:bool, curr_lager:int, transdate:date, lscheinnr:string, bediener_nr:int):
    ...
    op_list_list, Op_list = create_model_like(L_op, {"bezeich":string, "username":string, "onhand":Decimal, "acct_bez":string})
    ...
    def generate_output():
        ...
        return {"oh_ok": oh_ok, "msg_str": msg_str, "op-list1": op_list1_list}
