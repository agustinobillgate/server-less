...
def prepare_invoice_vnptbl():
    ...
    def generate_output():
        nonlocal cidate, from_dept, to_dept, depname1, depname2, t_hoteldpt_list, min_dept, max_dept, hoteldpt, htparam


        nonlocal t_hoteldpt
        nonlocal t_hoteldpt_list

        return {"cidate": cidate, "from_dept": from_dept, "to_dept": to_dept, "depname1": depname1, "depname2": depname2, "t-hoteldpt": t_hoteldpt_list}
