...
def bookengine_ratecodepull_btn_exit_1bl(t_push_list_list:[T_push_list], bookengid:int, user_init:string):
    ...
    for t_push_list in query(t_push_list_list):
        ...
        for outlist in query(outlist_list, filters=(lambda outlist: outlist.key == 163 and outlist.number1 == bookengid)):
