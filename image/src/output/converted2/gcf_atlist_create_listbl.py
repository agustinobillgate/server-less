...
def gcf_atlist_create_listbl():
    ...
    s_list_list, S_list = create_model("S_list", {"ktype":int, "gastnr":int, "segm":int, "code":str, "name":str, "kname":str, "phone":str, "fax":str, "adresse":str, "city":str, "land":str, "zip":str, "sales":str, "email":str, "guest_pr_code":str, "avail_guest_pr":bool, "flag":int, "segmbez":str})
        ...
        for guest in db_session.query(Guest).filter(
            ...
            if guestseg:
                ...
                queasy = db_session.query(Queasy).filter(
                         (Queasy.key == 26) & (Queasy.number1 == s_list.segm)).first()
