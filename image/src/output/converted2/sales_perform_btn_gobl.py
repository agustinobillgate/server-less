...
def sales_perform_btn_gobl(from_date:string, to_date:string, usr_init:string):
    ...
    def generate_output():
        nonlocal its_ok, slist_list, m1, m2, y1, y2, yy, monat, jahr, usr_grp, slist_generated, htparam, bediener, salesbud, salestat, genstat, guest, h_bill, h_artikel, artikel, h_bill_line
        nonlocal from_date, to_date, usr_init


        nonlocal slist, buff_slist
        nonlocal slist_list
    ...
    def check_budget():
        ...
        nonlocal its_ok, slist_list, usr_grp, slist_generated, htparam, bediener, salesbud, salestat, genstat, guest, h_bill, h_artikel, artikel, h_bill_line
        nonlocal from_date, to_date, usr_init
    ...
    def count_total():
        ...
        for buff_slist in query(buff_slist_list, filters=(lambda buff_slist: buff_slist.Yr >= 1 and buff_slist.mnth >= 1)):
    ...
    def include_outlet_fnb():
        ...
        for slist in query(slist_list, sort_by=[("yr",False),("mnth",False)]):
