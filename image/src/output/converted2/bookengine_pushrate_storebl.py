...
updq_list, Updq = create_model("Updq", {"ratecode":string, "vhprates":Decimal, "berates":Decimal, "datum":date, "user_init":string, "sysdate":date, "systime":int})

def bookengine_pushrate_storebl(booken_selected:int, updq_list:[Updq], mode:int):
