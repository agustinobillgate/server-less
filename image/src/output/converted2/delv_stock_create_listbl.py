...
def delv_stock_create_listbl(sname:string, fdate:date, tdate:date, show_price:bool, long_digit:bool):
    ...
    ttstock_list, Ttstock = create_model("Ttstock", {"ddate":date, "ist":int, "sdocument":string, "delivnote":string, "iarticle":int, "sdesc":string, "dquantity":int, "samount":string, "price":Decimal, "itime":string, "ssupplier":string, "snote":string, "imark":int})
