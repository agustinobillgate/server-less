...
t_mathis_list, T_mathis = create_model_like(Mathis, {"remain_budget":Decimal, "init_budget":Decimal})

def fa_mkpo_check_mathis_webbl(art_nr:int, order_date:date, t_mathis_list:[T_mathis]):
    avail_mathis = True
