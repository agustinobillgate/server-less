...
guest_list_list, Guest_list = create_model("Guest_list", {"guest_nr":int, "guest_nr2":int, "guest_name":string, "guest_title":string, "address1":string, "address2":string, "address3":string, "city":string, "zip":string, "country":string, "mastercomp":string, "salesid":string, "salesid_name":string, "refno2":string, "refno3":string, "phone":string, "telefax":string, "email":string, "maincontact":string, "main_fname":string, "main_tittle":string, "main_bday":date, "main_bplace":string, "main_telp":string, "main_ext":string, "main_dept":string, "main_function":string, "main_email":string, "segmentcode":string, "refno4":string, "keyaccount":string, "delflag":bool, "karteityp":int})

def gcf_createbl(user_init:string, guest_list_list:[Guest_list]):
    ...
    def gcf_create():
        ...
        for guest_list in query(guest_list_list, filters=(lambda guest_list: guest_list.guest_nr == 0)):
            guest = Guest()
