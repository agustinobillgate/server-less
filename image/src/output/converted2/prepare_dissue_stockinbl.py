...
def prepare_dissue_stockinbl():
    ...
    q2_list_list, Q2_list = create_model("Q2_list", {"lief_nr":int, "docu_nr":string, "lscheinnr":string, "lager_nr":int, "artnr":int, "bezeich":string, "einzelpreis":Decimal, "anzahl":Decimal, "warenwert":Decimal, "firma":string, "datum":date})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal billdate, q2_list_list, htparam, l_lieferant, l_artikel, l_op, queasy
