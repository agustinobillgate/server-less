...
def gl_adjustment_xlsjourn_post_itbl(g_list_list:[G_list], pvilanguage:int, datum:date, journ_no:str, jour_type:int, journ_name:str, debits:[decimal], credits:[decimal], remains:[decimal]):
    t_jnr = 0
    lvcarea:str = "gl-xlsjourn"
    ...
    def generate_output():
        ...
        nonlocal pvilanguage, datum, journ_no, jour_type, journ_name, debits, credits, remains
