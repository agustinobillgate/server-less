...
def bqtlist_contcbl():
    ...
    t_out_list, T_out = create_model("T_out", {"gastnr":int, "company":string, "anrede":string, "vorname":string, "name":string, "abteilung":string, "religion":string, "geburtdatum1":date, "telefon":string, "durchwahl":string, "email_adr":string})
