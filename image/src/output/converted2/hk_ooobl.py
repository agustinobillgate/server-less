...
def hk_ooobl(om_list_list:[Om_list], fdate:date, tdate:date, disptype:int, sorttype:int, user_init:string):
    ...
    ooo_list_list, Ooo_list = create_model("Ooo_list", {"zinr":string, "gespgrund":string, "gespstart":date, "gespende":date, "userinit":string, "etage":int, "ind":int, "bezeich":string, "betriebsnr":int})
