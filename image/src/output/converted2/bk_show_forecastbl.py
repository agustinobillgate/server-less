...
def bk_show_forecastbl(blockid:string):
    ...
    t_bk_event_list, T_bk_event = create_model("T_bk_event", {"bezeich":string, "amount":Decimal})
    t_bk_room_list, T_bk_room = create_model("T_bk_room", {"bezeich":string, "amount":Decimal})
