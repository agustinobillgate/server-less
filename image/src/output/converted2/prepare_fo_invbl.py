...
def prepare_fo_invbl(bil_flag:int):
    ...
    t_artikel_list, T_artikel = create_model("T_artikel", {"artnr":int, "bezeich":string, "epreis":Decimal, "departement":int, "artart":int, "activeflag":bool, "artgrp":int, "bezaendern":bool, "autosaldo":bool, "pricetab":bool, "betriebsnr":int, "resart":bool, "zwkum":int})
    ...
    def init_var():
        ...
        t_foinv = query(t_foinv_list, first=True)
    ...
    t_artikel_list, t_foinv_list = get_output(prepare_fo_invoicebl(bil_flag))
    init_var()
