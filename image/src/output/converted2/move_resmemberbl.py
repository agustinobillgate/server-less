...
def move_resmemberbl(case_type:int, resno:int, sorttype:int, newresno:int, r_list_list:[R_list]):
    ...
    def generate_output():
        nonlocal done, r_list_list, ci_date, res_line, htparam, master, bill, reservation, counters, gentable, reslin_queasy, res_history, fixleist
