...
def eg_repmaintaincancel_all_locationbl(all_room:bool, tlocation_list:[Tlocation], tmaintask_list:[Tmaintask]):
    ...
    tproperty = tlocation = tmaintask = troom = qbuff1 = comlocat = commain = comroom = None
    ...
    def generate_output():
        ...
        nonlocal tproperty, tlocation, tmaintask, troom, qbuff1, comlocat, commain, comroom
        nonlocal tproperty_list, troom_list
