...
t_l_order_list, T_l_order = create_model_like(L_order, {"rec_id":int, "a_bezeich":string, "lief_einheit":string})
...
def mk_po_of_return_webbl(t_amount:Decimal, t_l_order_list:[T_l_order], disc_list_list:[Disc_list]):
