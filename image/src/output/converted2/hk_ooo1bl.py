...
def hk_ooo1bl(case_type:int, t_outorder_list:[T_outorder], from_date:date, to_date:date, service_flag:bool, zinr:string, user_nr:int, reason:string, dept:int, user_init:string):
