...
def ns_web_open_bill_1bl(bil_recid:int, foreign_rate:bool, double_currency:bool, ba_dept:int):
    ...
    def generate_output():
        nonlocal invno, gname, resname, rescomment, printed, rechnr, balance, balance_foreign, kreditlimit, enbtn_bareserve, guest_taxcode, t_bill_line_list, t_bill_list, curr_select, telbill_flag, babill_flag, curr_gname, curr_invno, curr_b_recid, art_no, bk_reser, guest, htparam, bk_veran, bill_line, bill
        ...
        return {"invno": invno, "gname": gname, "resname": resname, "rescomment": rescomment, "printed": printed, "rechnr": rechnr, "balance": balance, "balance_foreign": balance_foreign, "kreditlimit": kreditlimit, "enbtn_bareserve": enbtn_bareserve, "guest_taxcode": guest_taxcode, "t-bill-line": t_bill_line_list, "t-bill": t_bill_list}
    ...
    def disp_bill_line(read_flag:bool):
        ...
        if read_flag:
            t_bill_line_list = get_output(read_bill_line_cldbl(3, 1, t_bill.rechnr, None, None, None, None, None))
