...
def fo_load_macro_webbl(briefnr:int, excel_list_list:[Excel_list]):
    ...
    def generate_output():
        nonlocal error_list_list, error_flag, n, l, continued, c, ct, ch, curr_str, i, j, counter, counter_i, chcol, mbuff, parameters, briefzei
        nonlocal briefnr
        nonlocal parambuff


        nonlocal excel_list, error_list, brief_list, art_list, t_parameters, parambuff
        nonlocal error_list_list, brief_list_list, art_list_list, t_parameters_list

        return {"error-list": error_list_list, "error_flag": error_flag}

    def create_colom(i:int):

        nonlocal error_list_list, error_flag, n, l, continued, c, ct, ch, curr_str, j, counter, counter_i, chcol, mbuff, parameters, briefzei
        nonlocal briefnr
        nonlocal parambuff
