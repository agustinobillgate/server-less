...
def load_banquet_planbl(curr_view:string, from_date:date):
    ...
    def generate_output():
        nonlocal zugriff, main_exist, curr_resnr, run_beowarning, ba_dept, p_900, ci_date, ba_plan_list, bk_raum
        nonlocal curr_view, from_date


        nonlocal t_bk_raum, ba_plan
        nonlocal t_bk_raum_list, ba_plan_list

        return {"run_beowarning": run_beowarning, "ba_dept": ba_dept, "p_900": p_900, "ci_date": ci_date, "ba-plan": ba_plan_list}
