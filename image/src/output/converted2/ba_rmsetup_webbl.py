...
def ba_rmsetup_webbl():
    ...
    bk_list_list, Bk_list = create_model("Bk_list", {"raum":string, "rset_bezeich":string, "raum_bezeich":string, "setup_bezeich":string, "personen":int, "preis":Decimal, "nebenstelle":string, "vorbereit":int, "vname":string, "setup_id":int, "rec_id":int})
