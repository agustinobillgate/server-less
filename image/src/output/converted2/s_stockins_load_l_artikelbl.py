...
def s_stockins_load_l_artikelbl(icase:int, a_artnr:int, a_bezeich:string):
    ...
    t_l_artikel_list, T_l_artikel = create_model("T_l_artikel", {"artnr":int, "bezeich":string, "ek_aktuell":Decimal, "t_description":string, "lief_einheit":Decimal, "betriebsnr":int, "vk_preis":Decimal, "alkoholgrad":Decimal, "rec_id":int})
