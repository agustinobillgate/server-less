...
payload_list_list, Payload_list = create_model("Payload_list", {"dml_no":string, "dept_no":int, "datum":string, "remark":string})

def dml_header_remark_webbl(payload_list_list:[Payload_list]):
    ...
    response_list_list, Response_list = create_model("Response_list", {"success_flag":bool})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal response_list_list, dml_no, dept_no, datum, datum_date, remark, queasy
