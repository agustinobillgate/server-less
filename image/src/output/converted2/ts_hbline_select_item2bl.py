...
def ts_hbline_select_item2bl(art_list_artnr:int, dept:int):
    ...
    t_h_artikel_list, T_h_artikel = create_model("T_h_artikel", {"bezaendern":bool, "epreis1":Decimal, "departement":int, "aenderwunsch":bool, "bondruckernr":[int,4], "betriebsnr":int})
