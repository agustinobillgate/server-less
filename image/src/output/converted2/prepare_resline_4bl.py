...
def prepare_resline_4bl(pvilanguage:int, res_mode:string, session_date:string, user_init:string, inp_gastnr:int, inp_resnr:int, inp_reslinnr:int, rate_readonly:bool, qci_zinr:string, res_dynarate_list:[Res_dynarate]):
    ...
    def generate_output():
        ...
        nonlocal rline_list_list, reslin_list_list, curr_resline_list, t_history_list, currency_list_list, reschanged_list_list, f_resline_list, nation_list_list, periode_list_list
