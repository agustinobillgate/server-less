...
def ap_list_1bl(from_date:date, to_date:date, lastname:string, sorttype:int, price_decimal:int, check_disp:int):
    ...
    output_list_list, Output_list = create_model("Output_list", {"betriebsnr":int, "ap_recid":int, "curr_pay":Decimal, "lscheinnr":string, "str":string, "steuercode":int, "recv_date":date})
