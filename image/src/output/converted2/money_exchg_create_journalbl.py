...
s_list_list, S_list = create_model("S_list", {"wahrnr":int, "dept":int, "artnr":int, "bezeich":string, "zinr":string, "anzahl":int, "preis":Decimal, "we_buy":Decimal, "we_sell":Decimal, "betrag":Decimal})

def money_exchg_create_journalbl(s_list_list:[S_list], room:string, user_init:string, print_flag:bool):
