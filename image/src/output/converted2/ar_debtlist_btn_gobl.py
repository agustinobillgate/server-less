...
def ar_debtlist_btn_gobl(pvilanguage:int, from_name:string, to_name:string, from_date:date, to_date:date, from_art:int, to_art:int, tot_flag:bool, lesspay:bool, show_inv:bool):
    ...
    output_list_list, Output_list = create_model("Output_list", {"ar_recid":int, "info":string, "wabkurz":string, "maildate":date, "inv_no":string, "str":string, "ref_no1":int, "ref_no2":string, "ci_date":date, "co_date":date, "nights":int})
