...
menu_list_list, Menu_list = create_model("Menu_list", {"nr":int, "rec_id":int, "art_number":int, "art_description":string, "art_qty":int, "art_price":Decimal, "special_request":string})

def selforder_post_itembl(outlet_number:int, table_nr:int, room_number:string, guest_name:string, pax:int, guest_number:int, res_number:int, resline_number:int, order_datetime:datetime, active_order:bool, session_parameter:string, menu_list_list:[Menu_list]):
    ...
    post_menu_list_list, Post_menu_list = create_model("Post_menu_list", {"rec_id":int, "description":string, "qty":int, "price":Decimal, "special_request":string})
    ...
    def post_to_outlet():
        ...
        post_bill_number, post_mess_str = get_output(pos_dashboard_post_menubl(1, post_bill_recid, post_tischnr, post_curr_dept, user_init, post_gname, post_pax, post_guestnr, post_curr_room, post_resnr, post_reslinnr, post_session_param, post_order_no, post_menu_list_list))
    ...
    menu_list = query(menu_list_list, first=True)
