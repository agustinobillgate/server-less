...
def res_dyna_rmrate(resno:int, reslinno:int, markno:int, adult:int, child1:int, child2:int, wahrno:int, argtnr:int, rmtype:string, ankunft:date, abreise:date, prcode:string, user_init:string, res_exrate:Decimal, ebdisc_flag:bool, kbdisc_flag:bool):
    ...
    dynarate_list_list, Dynarate_list = create_model("Dynarate_list", {"s_recid":int, "counter":int, "w_day":int, "rmtype":string, "fr_room":int, "to_room":int, "days1":int, "days2":int, "rcode":string})
    ...
    def create_dynamic_fixrates():
        ...
        for r_qsy in query(r_qsy_list, sort_by=[("date1",False)]):
    ...
    def create_buffers(datum:date):
        ...
        if occ_rooms == 0:
            ...
            dynarate_list = query(dynarate_list_list, filters=(lambda dynarate_list: dynarate_list.dynarate_list.fr_room == 0), first=True)
        ...
        dynarate_list = query(dynarate_list_list, filters=(lambda dynarate_list: dynarate_list.dynarate_list.w_day == w_day and dynarate_list.days1 != 0), first=True)

        if not dynarate_list:

            dynarate_list = query(dynarate_list_list, filters=(lambda dynarate_list: dynarate_list.dynarate_list.w_day == w_day and dynarate_list.days2 != 0), first=True)

        if not dynarate_list:

            dynarate_list = query(dynarate_list_list, filters=(lambda dynarate_list: dynarate_list.dynarate_list.w_day == w_day), first=True)

        if not dynarate_list:

            dynarate_list = query(dynarate_list_list, filters=(lambda dynarate_list: dynarate_list.dynarate_list.w_day == 0 and dynarate_list.days1 != 0), first=True)

        if not dynarate_list:

            dynarate_list = query(dynarate_list_list, filters=(lambda dynarate_list: dynarate_list.dynarate_list.w_day == 0 and dynarate_list.days2 != 0), first=True)

        if not dynarate_list:

            dynarate_list = query(dynarate_list_list, filters=(lambda dynarate_list: dynarate_list.dynarate_list.w_day == 0), first=True)
