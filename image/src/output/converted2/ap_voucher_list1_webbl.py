...
input_paylist_list, Input_paylist = create_model("Input_paylist", {"fdate":string, "tdate":string, "excl_pay":bool})

def ap_voucher_list1_webbl(input_paylist_list:[Input_paylist]):
    ...
    def generate_output():
        nonlocal pay_flag, tot_debit, tot_credit, tot_balance, from_date, to_date, age_list_list, l_kredit, l_lieferant, bediener
        nonlocal b_kredit
    ...
    input_paylist = query(input_paylist_list, first=True)
