...
def ts_restinv_move_tablebl(pax:int, curr_tischnr:int, rec_id:int, curr_dept:int, tischnr:int, bilrecid:int, rechnr:int, curr_waiter:int, new_waiter:int):
    ...
    def generate_output():
        ...
        return {"pax": pax, "bill_date": bill_date, "printed": printed, "balance": balance, "balance_foreign": balance_foreign, "fl_code": fl_code, "fl_code1": fl_code1, "fl_code2": fl_code2, "t-h-bill": t_h_bill_list}
