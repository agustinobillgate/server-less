...
def ts_get_request_text_webbl(article_num:int, dept_num:int):
    ...
    rest_maingroup_list, Rest_maingroup = create_model("Rest_maingroup", {"mg_number":int})
    ...
    def generate_output():
        nonlocal t_queasy_list, art_mgroup, count_i, count_k, param978, str_tmp, curr_tmp, curr_tmp2, queasy, h_artikel, wgrpgen
        nonlocal article_num, dept_num
        nonlocal b_queasy


        nonlocal t_queasy, rest_maingroup, b_queasy
        nonlocal t_queasy_list, rest_maingroup_list
