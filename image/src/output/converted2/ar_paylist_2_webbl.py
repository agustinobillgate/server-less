...
def ar_paylist_2_webbl(comment:string, cledger:bool, ccard:bool, last_sort:int, from_date:date, to_date:date, from_art:int, to_art:int, mi_payment:bool, mi_transfer:bool, show_inv:bool, bill_name:string, bill_nr:int):
    ...
    output_list_list, Output_list = create_model("Output_list", {"artnr":int, "pay_count":int, "flag":int, "pay_amt":Decimal, "dbetrag":Decimal, "sbetrag":string, "inv_no":string, "str":string, "bill_art":int, "debt_counter":int, "art_bezeich":string, "tbetrag":Decimal, "gastname":string, "soa_inv":string, "famt":string, "bill_num":int, "pay_famt":Decimal})
