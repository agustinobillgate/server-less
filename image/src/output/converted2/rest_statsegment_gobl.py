...
def rest_statsegment_gobl(pvilanguage:int, from_date:date, to_date:date, sorttype:int):
    ...
    def generate_output():
        nonlocal output_list_list, price_decimal, black_list, start_month, start_year, long_digit, f_endkum, m_endkum, b_endkum, lvcarea, htparam, h_journal, h_bill, h_artikel, artikel, guest, guestseg, segment
                    ...
                    if artikel:
                        ...
                        if guest:
                            ...
                            if guestseg:
                                ...
                                t_list = query(t_list_list, filters=(lambda t_list: t_list.segm_no == guestseg.segmentcode), first=True)
