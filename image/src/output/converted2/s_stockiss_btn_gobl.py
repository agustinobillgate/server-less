...
def s_stockiss_btn_gobl(op_list_list:[Op_list], f_endkum:int, b_endkum:int, m_endkum:int, lscheinnr:string, billdate:date, curr_lager:int, jobnr:int, lief_nr:int, fb_closedate:date, m_closedate:date, user_init:string, t_amount:Decimal):
