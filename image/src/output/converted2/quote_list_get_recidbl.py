...
t_quote_list, T_quote = create_model("T_quote", {"artnr":int, "lief_nr":int, "docu_nr":string, "from_date":date, "to_date":date})

def quote_list_get_recidbl(t_quote_list:[T_quote]):
