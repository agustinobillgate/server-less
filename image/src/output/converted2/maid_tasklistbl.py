...
def maid_tasklistbl(from_date:date, to_date:date, rpt_flag:int):
    ...
    maid_tasklist_list, Maid_tasklist = create_model("Maid_tasklist", {"datum":date, "maidcode":string, "maidname":string, "roomnumber":string, "roomcateg":string, "starttime":string, "endtime":string, "duration":string, "progrestat":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal maid_tasklist_list, tmp_userinit, queasy, htparam, zimmer, zimkateg, bediener
