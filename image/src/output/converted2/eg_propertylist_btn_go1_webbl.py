...
input_param_list, Input_param = create_model("Input_param", {"rmno":string, "main_nr":int, "sguestflag":bool, "last_nr":int, "item_nr":int}, {"rmno": "0"})

def eg_propertylist_btn_go1_webbl(location:int, input_param_list:[Input_param]):
    ...
    output_list_list, Output_list = create_model("Output_list", {"last_nr":int, "all_data":bool})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal q1_list_list, output_list_list, counter, eg_location, queasy, eg_property
        nonlocal location


        nonlocal q1_list, output_list, input_param
        nonlocal q1_list_list, output_list_list

        return {"location": location, "q1-list": q1_list_list, "output-list": output_list_list}
