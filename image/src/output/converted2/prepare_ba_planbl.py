...
def prepare_ba_planbl():
    ...
    def generate_output():
        nonlocal ci_date, ba_dept, run_beowarning, p_900, t_bk_raum_list, bk_raum, htparam, bk_reser


        nonlocal t_bk_raum
        nonlocal t_bk_raum_list

        return {"ci_date": ci_date, "ba_dept": ba_dept, "run_beowarning": run_beowarning, "p_900": p_900, "t-bk-raum": t_bk_raum_list}
