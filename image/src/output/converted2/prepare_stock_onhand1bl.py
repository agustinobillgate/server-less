...
def prepare_stock_onhand1bl(s_artnr:int):
    ...
    str_list_list, Str_list = create_model("Str_list", {"l_bezeich":string, "str":string})
    soh_list_list, Soh_list = create_model("Soh_list", {"store":int, "bezeich":string, "from_date":string, "init_stock":Decimal, "init_value":Decimal, "in_qty":Decimal, "in_amount":Decimal, "out_qty":Decimal, "out_amount":Decimal, "adjustment":Decimal, "end_qty":Decimal, "end_value":Decimal})
