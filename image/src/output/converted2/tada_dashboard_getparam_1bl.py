...
def tada_dashboard_getparam_1bl(dept:int):
    ...
    def generate_output():
        nonlocal t_dept_list, t_queasy270_list, licensenr, interval_time, cancel_exist, t_status_list, crd_list_list, pax, orderdatetime, gname, room, gastnr, resnr, reslinnr, mess_str, i_str, mess_token, mess_keyword, mess_value, table_no, dtime, queasy, hoteldpt, paramtext
        nonlocal dept
        nonlocal qsy230, session_table, posted_item


        nonlocal t_dept, t_status, crd_list, t_queasy270, qsy230, session_table, posted_item
        nonlocal t_dept_list, t_status_list, crd_list_list, t_queasy270_list

        return {"t-dept": t_dept_list, "t-queasy270": t_queasy270_list, "licensenr": licensenr, "interval_time": interval_time, "cancel_exist": cancel_exist, "t-status": t_status_list, "crd-list": crd_list_list}
