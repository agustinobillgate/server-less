...
def chk_btn_go_res_rmratebl(pvilanguage:int, curr_select:string, max_rate:Decimal, fact1:Decimal, inp_wahrnr:int, inp_zikatnr:int, user_init:string, resnr:int, reslinnr:int, recid_reslin:int, contcode:string, p_list_list:[P_list]):
