...
def prepare_resline_1bl(pvilanguage:int, res_mode:string, session_date:string, user_init:string, inp_gastnr:int, inp_resnr:int, inp_reslinnr:int, rate_readonly:bool, qci_zinr:string, res_dynarate_list:[Res_dynarate]):

    prepare_cache ([Res_line, Zimkateg, Ratecode, Zimmer, Htparam, Bediener, Reservation, Kontline, Queasy, Arrangement, Nation, Prmarket, Paramtext, Waehrung, Katpreis])
    ...
    rline_list = reslin_list = curr_resline = t_history = currency_list = res_dynarate = reschanged_list = f_resline = resline = resbuff = zimkateg1 = rbuff = qci_zimmer = qsy = None
    ...
    def generate_output():
        ...
        nonlocal resline, resbuff, zimkateg1, rbuff, qci_zimmer, qsy


        nonlocal rline_list, reslin_list, curr_resline, t_history, currency_list, res_dynarate, reschanged_list, f_resline, resline, resbuff, zimkateg1, rbuff, qci_zimmer, qsy
        nonlocal rline_list_list, reslin_list_list, curr_resline_list, t_history_list, currency_list_list, reschanged_list_list, f_resline_list
    ...
    def split_resline():
        ...
        nonlocal error_flag, record_use, init_time, init_date, avail_gdpr, f_resline_list, curr_resline_list, reslin_list_list, reschanged_list_list, t_history_list, rline_list_list, weekdays, str, loopi, loopj, str1, foreign_nr, tokcounter, iftask, mestoken, mesvalue, rcode, prevcode, do_it, flag_ok, dayuse_flag, split_modify, logic_p1109, priscilla_active, lvcarea, new_reslinnr, curr_time, res_line, history, zimkateg, ratecode, zimmer, htparam, bediener, master, guest, reslin_queasy, reservation, kontline, gentable, outorder, queasy, arrangement, nation, guest_pr, pricecod, prmarket, fixleist, paramtext, waehrung, katpreis
        nonlocal pvilanguage, res_mode, session_date, user_init, inp_gastnr, inp_resnr, inp_reslinnr, rate_readonly, qci_zinr
        nonlocal resline, resbuff, zimkateg1, rbuff, qci_zimmer, qsy
    ...
    def set_roomrate(direct_change:bool):
        ...
        nonlocal msg_str, error_flag, record_use, init_time, init_date, avail_gdpr, f_resline_list, curr_resline_list, reslin_list_list, reschanged_list_list, t_history_list, rline_list_list, weekdays, str, loopi, loopj, str1, foreign_nr, tokcounter, iftask, mestoken, mesvalue, rcode, prevcode, do_it, flag_ok, dayuse_flag, split_modify, logic_p1109, priscilla_active, lvcarea, new_reslinnr, curr_time, res_line, history, zimkateg, ratecode, zimmer, htparam, bediener, master, guest, reslin_queasy, reservation, kontline, gentable, outorder, queasy, arrangement, nation, guest_pr, pricecod, prmarket, fixleist, paramtext, waehrung, katpreis
        nonlocal pvilanguage, res_mode, session_date, user_init, inp_gastnr, inp_resnr, inp_reslinnr, rate_readonly, qci_zinr
        nonlocal resline, resbuff, zimkateg1, rbuff, qci_zimmer, qsy
