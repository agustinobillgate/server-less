...
def pr_list_btn_go_1bl(po_nr:string, pr_nr:string, curr_dept:int, lief_nr:int, po_type:int, billdate:date, user_init:string, s_list_list:[S_list]):
    ...
    def generate_output():
        ...
        return {"po_nr": po_nr, "pr_nr": pr_nr, "curr_dept": curr_dept, "lief_nr": lief_nr, "s-list": s_list_list}
    ...
    for s_list1 in query(s_list1_list, filters=(lambda s_list1: s_list1.selected  and s_list1.artnr > 0), sort_by=[("docu_nr",False)]):
