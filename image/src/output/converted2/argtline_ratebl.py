...
def argtline_ratebl(prcode:string, marknr:int, argtnr:int, zikatnr:int):
    ...
    t_argtline_rate_list, T_argtline_rate = create_model("T_argtline_rate", {"argt_artnr":int, "bezeich":string, "deci1":Decimal, "deci2":Decimal, "deci3":Decimal, "date1":date, "date2":date, "departement":int, "fakt_modus":int, "key":string, "char1":string, "number1":int, "number2":int, "number3":int, "resnr":int, "reslinnr":int, "artnr":int, "s_recid":int})
