...
def ratecode_adm_fill_ratecodebl(user_init:string, prcode:string, market_nr:int, zikatnr:int, argtnr:int, book_room:int, comp_room:int, max_room:int, early_discount_list:[Early_discount], kickback_discount_list:[Kickback_discount], stay_pay_list:[Stay_pay], p_list_list:[P_list]):
    ...
    child_list_list, Child_list = create_model("Child_list", {"child_code":string, "true_child":bool, "argt_no":int, "zikat_no":int}, {"true_child": True})
    ...
    def generate_output():
        ...
        nonlocal child_list_list, child_ratecode_list, q_list_list, r_list_list
