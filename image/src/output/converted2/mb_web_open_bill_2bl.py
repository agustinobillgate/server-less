...
def mb_web_open_bill_2bl(bil_recid:int, foreign_rate:bool, double_currency:bool, ba_dept:int):
    ...
    def generate_output():
        ...
        return {"invno": invno, "gname": gname, "resname": resname, "rescomment": rescomment, "printed": printed, "rechnr": rechnr, "balance": balance, "balance_foreign": balance_foreign, "kreditlimit": kreditlimit, "enbtn_bareserve": enbtn_bareserve, "guest_taxcode": guest_taxcode, "t-bill-line": t_bill_line_list, "t-bill": t_bill_list, "t-data": t_data_list}
