...
def fo_inv_openbill_list_webbl(bil_flag:int, bil_recid:int, room:string, vipflag:bool, fill_co:bool, double_currency:bool, foreign_rate:bool):
    abreise = None
    resname = ""
    ...
    t_res_line_list, T_res_line = create_model_like(Res_line, {"guest_name":string})
    ...
    def disp_bill_line():
        ...
        t_bill_line_list, spbill_list_list = get_output(fo_invoice_disp_bill_line_cldbl(bil_recid, double_currency))


    abreise, resname, res_exrate, zimmer_bezeich, kreditlimit, master_str, master_rechnr, bill_anzahl, queasy_char1, disp_warning, flag_report, guest_taxcode, t_res_line_list, t_bill_list = get_output(fo_invoice_open_bill_cld_1bl(bil_flag, bil_recid, room, vipflag))
