...
def ratecode_admin_dyna_gobl(curr_select:string, inp_str:string, user_init:string, drbuff_list:[Drbuff]):
    ...
    def generate_output():
        nonlocal dynarate_list_list, error_code, dynarate_list_list, prcode, bookengid, a, i, zimkateg, queasy, ratecode, bediener, res_history, counters, guest, guest_pr
    ...
    def fill_dynamic_ratecode(prcode:string, new_flag:bool):
        ...
        nonlocal dynarate_list_list, error_code, dynarate_list_list, bookengid, a, i, zimkateg, queasy, ratecode, bediener, res_history, counters, guest, guest_pr
        nonlocal curr_select, inp_str, user_init
