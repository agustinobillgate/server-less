...
def prepare_bookengine_config_webbl(bookengid:int):
    ...
    currency_list_list, Currency_list = create_model("Currency_list", {"waehrungsnr":int, "bezeich":string, "wabkurz":string})
    t_list_list, T_list = create_model("T_list", {"autostart":bool, "period":int, "delay":int, "hotelcode":string, "username":string, "password":string, "liveflag":bool, "defcurr":string, "pushrateflag":bool, "pullbookflag":bool, "pushavailflag":bool, "workpath":string, "progavail":string, "progavail1":string, "pushratebypax":bool, "uppercasename":bool, "delayrate":int, "delaypull":int, "delayavail":int, "pushall":bool, "re_calculate":bool, "restriction":bool, "allotment":bool, "pax":int, "bedsetup":bool, "pushbookflag":bool, "delaypushbook":int, "vcwsagent":string, "vcwsagent1":string, "vcwsagent2":string, "vcwsagent3":string, "vcwsagent4":string, "vcwsagent5":string, "vcwebhost":string, "vcwebport":string, "email":string, "dyna_code":string, "incltentative":bool})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal bookeng_name, t_list_list, currency_list_list, i, str, temp_str, queasy, waehrung
        nonlocal bookengid
