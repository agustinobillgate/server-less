...
from functions.fo_journalbl import fo_journalbl

def fo_journal_listbl(from_art:int, to_art:int, from_dept:int, to_dept:int, from_date:date, to_date:date, sorttype:int, exclude_artrans:bool, long_digit:bool, foreign_flag:bool, onlyjournal:bool, excljournal:bool, mi_post:bool):
    ...
    fo_journal_list_list, Fo_journal_list = create_model("Fo_journal_list", {"datum":date, "c":str, "roomnumber":str, "nsflag":str, "mbflag":str, "shift":str, "billno":int, "artno":int, "bezeich":str, "voucher":str, "depart":str, "outlet":str, "qty":int, "amount":decimal, "guestname":str, "billrcvr":str, "zeit":str, "id":str, "sysdate":date, "remark":str})
    ...
    def generate_output():
        ...
        nonlocal from_art, to_art, from_dept, to_dept, from_date, to_date, sorttype, exclude_artrans, long_digit, foreign_flag, onlyjournal, excljournal, mi_post
    ...
    gtot, output_list_list = get_output(fo_journalbl(from_art, to_art, from_dept, to_dept, from_date, to_date, sorttype, exclude_artrans, long_digit, foreign_flag, onlyjournal, excljournal, mi_post))
    ...
    for output_list in query(output_list_list):
        ...
        fo_journal_list.guestname = substring(output_list.str, 166, 25)
