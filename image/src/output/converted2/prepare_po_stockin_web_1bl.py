...
def prepare_po_stockin_web_1bl(lief_nr:int, docu_nr:string, user_init:string):
    ...
    t_l_order_list, T_l_order = create_model_like(L_order, {"rec_id":int, "art_bezeich":string, "jahrgang":int, "alkoholgrad":Decimal, "lief_einheit":Decimal, "curr_disc":int, "curr_disc2":int, "curr_vat":int, "add_vat":Decimal, "addvat_no":int, "addvat_value":Decimal, "amount":Decimal, "masseinheit":string, "traubensorte":string})
