...
def co_guest_1bl(case_type:int, pvilanguage:int, fr_date:date, to_date:date, price_decimal:int):
    ...
    def generate_output():
        nonlocal cl_list_list, tot_rm, tot_deposit, tot_cash, tot_cc, tot_cl, tot_amt, tot_bb, lvcarea, res_line, reservation, bill, billhis, bill_line, artikel, arrangement
