...
def fa_upgradelist_btn_gobl(fdate:date, tdate:date):
    ...
    q1_list_list, Q1_list = create_model("Q1_list", {"mathis_name":string, "mathis_asset":string, "location":string, "warenwert":Decimal, "nr":int, "matbuff_name":string, "matbuff_asset":string, "deleted":date, "did":string, "recid_fa_artikel":int})
