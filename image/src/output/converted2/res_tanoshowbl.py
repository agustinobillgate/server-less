...
def res_tanoshowbl(fdate:date, sorttype:int, fname:string, tname:string):
    ...
    outlist_list, Outlist = create_model("Outlist", {"resnr":int, "name":string, "mnite":int, "pmnite":int, "ynite":int, "pynite":int, "mtu":Decimal, "pmtu":int, "ytu":Decimal, "pytu":int, "wohnort":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal outlist_list, t_mnite, t_ynite, t_mtu, t_ytu, gastnr, rmnite, bdate, tmpint, guest, zimkateg, res_line
