...
def fo_journal_list_web_1bl(from_art:int, to_art:int, from_dept:int, to_dept:int, from_date:date, to_date:date, sorttype:int, exclude_artrans:bool, long_digit:bool, foreign_flag:bool, mi_onlyjournal:bool, mi_excljournal:bool, mi_post:bool, mi_showrelease:bool, mi_break:bool):
    ...
    output_list_list, Output_list = create_model("Output_list", {"bezeich":string, "c":string, "ns":string, "mb":string, "shift":string, "dept":string, "str":string, "remark":string, "gname":string, "descr":string, "voucher":string, "checkin":date, "checkout":date, "guestname":string, "segcode":string, "amt_nett":Decimal, "service":Decimal, "vat":Decimal, "zinr":string, "deptno":int, "nationality":string, "resnr":int, "book_source":string, "resname":string, "datum":date, "billno":int, "artno":int, "depart":string, "outlet":string, "qty":int, "amount":Decimal, "zeit":string, "id":string, "sysdate":date})
    ...
    def generate_output():
        ...
        nonlocal output_list_list, fo_journal_list_list, shift_list_list
    ...
    def custom_record_date():
        ...
        nonlocal fo_journal_list_list, curr_date, descr1, voucher_no, ind, indexing, gdelimiter, serv, vat, netto, temp_str, hoteldept, shift, temp1, temp2, guest, queasy, artikel, htparam, bill, bill_line, res_line, reservation, sourccod, segment, genstat, hoteldpt, billjournal, h_bill, bk_veran, arrangement, argt_line, h_journal
        nonlocal from_art, to_art, from_dept, to_dept, from_date, to_date, sorttype, exclude_artrans, long_digit, foreign_flag, mi_onlyjournal, mi_excljournal, mi_post, mi_showrelease, mi_break
        nonlocal buffguest, gbuff, shift_buff
    ...
    def journal_list():
        ...
        nonlocal fo_journal_list_list, descr1, voucher_no, ind, indexing, gdelimiter, roomnumber, zinrdate, billnumber, curr_str, curr_resnr, serv, vat, netto, temp_str, hoteldept, shift, temp1, temp2, guest, queasy, artikel, htparam, bill, bill_line, res_line, reservation, sourccod, segment, genstat, hoteldpt, billjournal, h_bill, bk_veran, arrangement, argt_line, h_journal
        nonlocal from_art, to_art, from_dept, to_dept, from_date, to_date, sorttype, exclude_artrans, long_digit, foreign_flag, mi_onlyjournal, mi_excljournal, mi_post, mi_showrelease, mi_break
        nonlocal buffguest, gbuff, shift_buff
