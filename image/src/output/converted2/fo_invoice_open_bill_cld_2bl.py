...
def fo_invoice_open_bill_cld_2bl(bil_flag:int, bil_recid:int, room:string, vipflag:bool):
    ...
    def generate_output():
        nonlocal abreise, resname, res_exrate, zimmer_bezeich, kreditlimit, master_str, master_rechnr, bill_anzahl, queasy_char1, disp_warning, flag_report, guest_taxcode, repeat_charge, t_res_line_list, t_bill_list, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, ci_date, g_address, g_wonhort, g_plz, g_land, bill, res_line, guest, htparam, queasy, reslin_queasy, reservation, zimmer, waehrung, master, counters, guestseg
