...
def ba_plan_res_checkout1bl(pvilanguage:int, t_resnr:int, t_reslinnr:int):
    ...
    if resline:
        ...
        msg_str3 = "&Q" + translateExtended ("Do you really want to close the banquet reservation of", lvcarea, "") + chr(10) + gast.name + translateExtended (" - ResNo:", lvcarea, "") + " " + to_string(resline.veran_nr) + " ?"
