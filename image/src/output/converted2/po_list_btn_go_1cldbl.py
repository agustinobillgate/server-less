...
def po_list_btn_go_1cldbl(usrname:string, po_number:string, dml_only:bool, pr_only:bool, excl_dml_pr:bool):
    ...
    def generate_output():
        nonlocal p_267, q2_list_list, p_71, loop, cost_list_bezeich, w_list_wabkurz, l_order, l_artikel, htparam, l_lieferant, l_orderhdr, parameters, waehrung, queasy
        nonlocal usrname, po_number, dml_only, pr_only, excl_dml_pr
