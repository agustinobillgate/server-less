...
def eg_mkreq_btn_go_webbl(request1_list:[Request1], sguestflag:bool, sub_str:string, main_str:string, prop_bezeich:string):
    ...
    def generate_output():
        ...
        nonlocal request1_list, sguestflag, sub_str, main_str, prop_bezeich


        nonlocal request1

        return {"request1": request1_list}
