...
def argt_frate_fill_rate_1bl(icase:int, s_recid:int, argtnr:int, resnr:int, reslinnr:int, ch1_betrag:Decimal, ch2_betrag:Decimal, from_date:date, to_date:date, vt_percnt:int, p_list_list:[P_list]):
