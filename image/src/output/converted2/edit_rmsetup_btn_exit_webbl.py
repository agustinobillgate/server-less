...
def edit_rmsetup_btn_exit_webbl(bk_list_list:[Bk_list], case_type:int, t_bk_raum_raum:str, t_bk_setup_setup_id:int):
    recid_rset = 0
    bk_rset = None
    ...
    def fill_bk_rset():
        ...
        for bk_rset in db_session.query(Bk_rset).order_by(Bk_rset._recid.desc()).all():
