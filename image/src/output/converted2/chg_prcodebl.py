...
def chg_prcodebl(gastnr:int):
    ...
    q1_list_list, Q1_list = create_model("Q1_list", {"char1":string, "char2":string, "logi2":bool, "number3":int, "selected":bool})
    q2_list_list, Q2_list = create_model("Q2_list", {"char1":string, "char2":string, "logi2":bool, "number3":int, "selected":bool})
