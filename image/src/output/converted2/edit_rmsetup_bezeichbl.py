...
def edit_rmsetup_bezeichbl(bk_list_bezeich:str, bk_list_raum:str):
    ...
    bk_rset1 = db_session.query(Bk_rset1).filter(
             (func.lower(Bk_rset1.bezeich) == (bk_list_bezeich).lower()) & (func.lower(Bk_rset1.raum) == (bk_list_raum).lower())).first()
