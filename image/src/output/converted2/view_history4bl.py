...
def view_history4bl(artno:int, rechno:int):
    ...
    debit_list_list, Debit_list = create_model("Debit_list", {"artnr":int, "gname":string, "saldo":Decimal, "vesrdep":Decimal, "betrieb_gastmem":int, "zahlkonto":int, "rgdatum":date, "transzeit":int, "userinit":string, "vesrcod":string, "receiver":string})
