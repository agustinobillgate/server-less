...
def add_room_admin_1bl(pvilanguage:int, case_type:int, zimmer_list_list:[Zimmer_list], rm_feature:string, curr_mode:string, rmno:string, rmcatbez:string, user_init:string):
    ...
    dynarate_list_list, Dynarate_list = create_model("Dynarate_list", {"prcode":string, "to_room":int})
    ...
    def generate_output():
        ...
        nonlocal t_zimmer_list, dynarate_list_list
    ...
    def check_dynarate():
        ...
        for dynarate_list in query(dynarate_list_list, filters=(lambda dynarate_list: dynarate_list.dynarate_list.to_room < zimkateg.maxzimanz)):
