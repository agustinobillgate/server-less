...
def bk_sakesfcast_btn_go_webbl(checklist:bool, sorttype:int, fdate:date, tdate:date, disp_flag:int):
    ...
    f_list_list, F_list = create_model("F_list", {"rstat":string, "bname":string, "room":string, "id":string, "event":string, "cdate":date, "pax":int, "rmrev":Decimal, "fbrev":Decimal, "otrev":Decimal, "totrev":Decimal, "cp":string, "resnr":int, "date_book":date, "in_sales":string, "sales":string, "ev_time":string})
    output_list_list, Output_list = create_model("Output_list", {"flag":string, "bezeich":string, "rstat":string, "room":string, "id":string, "ba_event":string, "datum":date, "pax":int, "rmrev":Decimal, "fbrev":Decimal, "othrev":Decimal, "totrev":Decimal, "cp":string, "resnr":int, "date_book":date, "in_sales":string, "ev_time":string})
