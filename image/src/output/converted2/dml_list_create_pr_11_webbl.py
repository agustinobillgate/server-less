...
def dml_list_create_pr_11_webbl(c_list_list:[C_list], s_list_list:[S_list], curr_dept:int, rec_id:int, dunit_price:bool, selected_date:date, user_init:string, dml_hdr_remark:string):
    ...
    def generate_output():
        nonlocal t_l_orderhdr_list, docu_nr, t_qty, counter, l_orderhdr, bediener, l_order, l_artikel, dml_art, reslin_queasy, dml_artdep
        nonlocal curr_dept, rec_id, dunit_price, selected_date, user_init, dml_hdr_remark
