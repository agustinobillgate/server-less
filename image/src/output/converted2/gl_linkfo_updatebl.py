...
def gl_linkfo_updatebl(pvilanguage:int, remains:decimal, credits:[decimal], debits:[decimal], to_date:date, c_refno:str, c_bezeich:str, g_list_list:[G_list]):
    new_hdr:bool = True
    lvcarea:str = "gl-linkfo"
