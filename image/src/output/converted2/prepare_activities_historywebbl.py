...
def prepare_activities_historywebbl(reshist_action:string):
    ...
    ubuff_list, Ubuff = create_model("Ubuff", {"userinit":string, "username":string})
    t_bediener_list, T_bediener = create_model("T_bediener", {"userinit":string, "username":string})
    ...
    def generate_output():
        ...
        return {"from_date": from_date, "ubuff": ubuff_list, "t-bediener": t_bediener_list, "reshist_action": reshist_action}
