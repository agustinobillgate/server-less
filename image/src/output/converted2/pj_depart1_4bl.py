...
def pj_depart1_4bl(pvilanguage:int, case_type:int, disptype:int, fdate:date, tdate:date, froom:string, troom:string, disp_accompany:bool, setup_list_list:[Setup_list], zikat_list_list:[Zikat_list]):
