...
def fa_artlist_btn_exitbl(flag:int, mathis_nr:int, spec:string, locate:string, picture_file:string, upgrade_part:bool, fibukonto:string, credit_fibu:string, debit_fibu:string, user_init:string, curr_location:string, m_list_list:[M_list], fa_art_list:[Fa_art]):
