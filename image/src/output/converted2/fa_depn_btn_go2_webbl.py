...
def fa_depn_btn_go2_webbl(g_list_list:[G_list], datum:date, refno:string, bezeich:string, debits:Decimal, credits:Decimal, remains:Decimal):
    ...
    def generate_output():
        ...
        return {"g-list": g_list_list, "success_flag": success_flag}
