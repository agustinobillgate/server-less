...
def gcf_merge_webbl(pvilanguage:int, userinit:str, bgastno:int, tlist_list:[Tlist]):
    success_flag = False
    msg_str = ""
    doit:bool = False
    flag1:bool = False
    flag2:bool = False
    lvcarea:str = "gcf-merge-web"
    ...
    def generate_output():
        ...
        nonlocal tlist_list, t_mc_guest_list, t_cl_member_list, t_bk_veran_list, t_guest_pr_list
