...
def prepare_rest_daysalesp2_1_cldbl():
    ...
    buf_art_list, Buf_art = create_model("Buf_art", {"artnr":int, "bezeich":string, "departement":int, "art_type":int})
    usr1_list, Usr1 = create_model_like(Kellner, {"rec_id":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal disc_art1, disc_art2, disc_art3, exchg_rate, str, curr_foreign, serv_taxable, dpt_str, art_str, oth_str, anzahl, curr_dept, dept_name, voucher_art, use_voucher, from_date, to_date, htl_dept_dptnr, err_flag, p_110, p_240, active_deposit, buf_art_list, htl_dept_list, usr1_list, f_cash, i, str_tmp, curr_local, price_decimal, artnr_list, show_option, hoteldpt, kellner, htparam, waehrung, artikel, h_artikel


        nonlocal htl_dept, t_hoteldpt, buf_art, usr1
        nonlocal htl_dept_list, t_hoteldpt_list, buf_art_list, usr1_list

        return {"disc_art1": disc_art1, "disc_art2": disc_art2, "disc_art3": disc_art3, "exchg_rate": exchg_rate, "str": str, "curr_foreign": curr_foreign, "serv_taxable": serv_taxable, "dpt_str": dpt_str, "art_str": art_str, "oth_str": oth_str, "anzahl": anzahl, "curr_dept": curr_dept, "dept_name": dept_name, "voucher_art": voucher_art, "use_voucher": use_voucher, "from_date": from_date, "to_date": to_date, "htl_dept_dptnr": htl_dept_dptnr, "err_flag": err_flag, "p_110": p_110, "p_240": p_240, "active_deposit": active_deposit, "buf-art": buf_art_list, "htl-dept": htl_dept_list, "usr1": usr1_list}
