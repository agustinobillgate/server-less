...
g_list_list, G_list = create_model_like(Gc_giro, {"acctno":string, "s_recid":int})

def gc_giroadmin_btn_gobl(pvilanguage:int, case_type:int, s_recid:int, user_init:string, g_list_list:[G_list]):
