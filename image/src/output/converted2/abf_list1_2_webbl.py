...
def abf_list1_2_webbl(fdate:date, bfast_artnr:int, bfast_dept:int, zikat_list_list:[Zikat_list]):
    ...
    def generate_output():
        nonlocal abf_list_list, diffcidate, p_87, num_of_day, res_line, genstat, arrangement, artikel, argt_line, reslin_queasy, fixleist, guest, reservation, segment, ratecode, mc_guest, mc_types, mealcoup, bill, master
