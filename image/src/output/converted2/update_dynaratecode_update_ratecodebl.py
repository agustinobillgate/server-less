...
def update_dynaratecode_update_ratecodebl(rate_list1_list:[Rate_list1], rmtype:string, from_date:date, to_date:date, inp_str:string, user_init:string):
    ...
    def generate_output():
        ...
        nonlocal rate_list1_list, rmtype, from_date, to_date, inp_str, user_init
        nonlocal buffqueasy
