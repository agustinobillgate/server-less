...
def rsv_list_create_list_webbl(from_date:date, to_date:date, inp_room:string, stat_screen_value:string, mi_created_chk:bool, mi_event_chk:bool, mi_engager_chk:bool, mi_room_chk:bool, mi_sales_chk:bool, mi_segment_chk:bool, mi_cutoff_chk:bool):
    ...
    output_list_list, Output_list = create_model("Output_list", {"bk_stat":string, "bk_datum":date, "engager":string, "contact":string, "bk_event":string, "venue":string, "bk_time":string, "pax":int, "tablesetup":string, "room_rev":Decimal, "fb_rev":Decimal, "other_rev":Decimal, "total_rev":Decimal, "cm_id":string, "sales":string, "crdate":date, "cutoff":date, "segment":string, "sob":string, "resnr":int, "reslinnr":int, "remark":string, "resstatus":int, "datum":date, "gastnr":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal gastnr, output_list_list, total_estrev, total_paid, troomrev, tfbrev, tothrev, ttrev, do_it, bk_veran, bk_func, bk_rart, bk_reser, guest, queasy
        ...
        return {"gastnr": gastnr, "output-list": output_list_list}
