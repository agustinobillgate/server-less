...
def bill_balance2_webbl(pvilanguage:int, co_today:bool, room:string, zero_flag:bool, cash_basis:bool, gname:string, billdate:date, menu_nsbill:bool, menu_msbill:bool, menu_fobill:bool):
    ...
    prepare_cache ([Guest, Htparam, Bill, Bill_line, Hoteldpt, Res_line, Queasy, History])
    ...
    billbalance_list_list, Billbalance_list = create_model("Billbalance_list", {"flag":string, "departnem":string, "zinr":string, "resstatus":int, "zipreis":Decimal, "rechnr":int, "receiver":string, "ankunft":date, "abreise":date, "saldo":Decimal, "name":string, "bill_inst":string, "idcard":string, "nat":string, "datum":date, "fsort":string, "remarks":string, "bill_remark":string}, {"ankunft": None, "abreise": None})
