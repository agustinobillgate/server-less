...
def ap_list_2_webbl(from_date:date, to_date:date, lastname:string, sorttype:int, price_decimal:int, check_disp:int, voucher_only:bool):
    ...
    output_list_list, Output_list = create_model("Output_list", {"betriebsnr":int, "ap_recid":int, "curr_pay":Decimal, "lscheinnr":string, "str":string, "firma":string, "billdate":date, "docunr":string, "delivnote":string, "amount":Decimal, "paid_amount":Decimal, "paiddate":string, "balance":Decimal, "duedate":date, "desc1":string, "steuercode":int, "recv_date":date, "rechnr":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal output_list_list, t_ap, t_pay, t_bal, tot_ap, tot_pay, tot_bal, i, stauer_code1, stauer_code2, sorttype1, sorttype2, l_kredit, l_lieferant, queasy
        nonlocal from_date, to_date, lastname, sorttype, price_decimal, check_disp, voucher_only
    ...
    def disp_it1():
        ...
        if lastname == " ":
            ...
            if check_disp == 0:
                ...
                for l_kredit.counter, l_kredit.rechnr, l_kredit.betriebsnr, l_kredit._recid, l_kredit.rgdatum, l_kredit.name, l_kredit.lscheinnr, l_kredit.netto, l_kredit.ziel, l_kredit.bemerk, l_kredit.steuercode, l_kredit.lief_nr, l_kredit.opart, l_kredit.saldo, l_lieferant.segment1, l_lieferant.firma, l_lieferant.lief_nr, l_lieferant._recid in db_session.query(L_kredit.counter, L_kredit.rechnr, L_kredit.betriebsnr, L_kredit._recid, L_kredit.rgdatum, L_kredit.name, L_kredit.lscheinnr, L_kredit.netto, L_kredit.ziel, L_kredit.bemerk, L_kredit.steuercode, L_kredit.lief_nr, L_kredit.opart, L_kredit.saldo, L_lieferant.segment1, L_lieferant.firma, L_lieferant.lief_nr, L_lieferant._recid).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
                    ...
                    if do_it:
                        ...
                        output_list.rechnr = l_kredit.rechnr
    ...
    def disp_it2():
        ...
        if lastname == " ":
            ...
            if check_disp == 0:
                ...
                l_lieferant = L_lieferant()
                for l_kredit.counter, l_kredit.rechnr, l_kredit.betriebsnr, l_kredit._recid, l_kredit.rgdatum, l_kredit.name, l_kredit.lscheinnr, l_kredit.netto, l_kredit.ziel, l_kredit.bemerk, l_kredit.steuercode, l_kredit.lief_nr, l_kredit.opart, l_kredit.saldo, l_lieferant.segment1, l_lieferant.firma, l_lieferant.lief_nr, l_lieferant._recid in db_session.query(L_kredit.counter, L_kredit.rechnr, L_kredit.betriebsnr, L_kredit._recid, L_kredit.rgdatum, L_kredit.name, L_kredit.lscheinnr, L_kredit.netto, L_kredit.ziel, L_kredit.bemerk, L_kredit.steuercode, L_kredit.lief_nr, L_kredit.opart, L_kredit.saldo, L_lieferant.segment1, L_lieferant.firma, L_lieferant.lief_nr, L_lieferant._recid).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
                         (L_kredit.rechnr != 0) & (L_kredit.zahlkonto == 0) & (L_kredit.opart >= sorttype1) & (L_kredit.opart <= sorttype2) & (L_kredit.rgdatum >= from_date) & (L_kredit.rgdatum <= to_date) & (L_kredit.counter >= 0) & (L_kredit.netto != 0)).order_by(L_kredit.rechnr, L_lieferant.firma, L_kredit.rgdatum).all():
                    if l_kredit_obj_list.get(l_kredit._recid):
                        continue
                    else:
                        l_kredit_obj_list[l_kredit._recid] = True
                    ...
                    if do_it:
                        ...
                        if curr_rechnr == 0:
                            curr_rechnr = l_kredit.rechnr

                        if curr_rechnr != l_kredit.rechnr:
                            output_list = Output_list()
                            output_list_list.append(output_list)
                ...
                l_lieferant = L_lieferant()
                for l_kredit.counter, l_kredit.rechnr, l_kredit.betriebsnr, l_kredit._recid, l_kredit.rgdatum, l_kredit.name, l_kredit.lscheinnr, l_kredit.netto, l_kredit.ziel, l_kredit.bemerk, l_kredit.steuercode, l_kredit.lief_nr, l_kredit.opart, l_kredit.saldo, l_lieferant.segment1, l_lieferant.firma, l_lieferant.lief_nr, l_lieferant._recid in db_session.query(L_kredit.counter, L_kredit.rechnr, L_kredit.betriebsnr, L_kredit._recid, L_kredit.rgdatum, L_kredit.name, L_kredit.lscheinnr, L_kredit.netto, L_kredit.ziel, L_kredit.bemerk, L_kredit.steuercode, L_kredit.lief_nr, L_kredit.opart, L_kredit.saldo, L_lieferant.segment1, L_lieferant.firma, L_lieferant.lief_nr, L_lieferant._recid).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
                         (L_kredit.rechnr != 0) & (L_kredit.lief_nr > 0) & (L_kredit.zahlkonto == 0) & (L_kredit.opart >= sorttype1) & (L_kredit.opart <= sorttype2) & (L_kredit.rgdatum >= from_date) & (L_kredit.rgdatum <= to_date) & (L_kredit.counter >= 0) & (L_kredit.netto != 0) & (L_kredit.steuercode == 1)).order_by(L_kredit.rechnr, L_lieferant.firma, L_kredit.rgdatum).all():
                    if l_kredit_obj_list.get(l_kredit._recid):
                        continue
                    else:
                        l_kredit_obj_list[l_kredit._recid] = True
                ...
                l_lieferant = L_lieferant()
                for l_kredit.counter, l_kredit.rechnr, l_kredit.betriebsnr, l_kredit._recid, l_kredit.rgdatum, l_kredit.name, l_kredit.lscheinnr, l_kredit.netto, l_kredit.ziel, l_kredit.bemerk, l_kredit.steuercode, l_kredit.lief_nr, l_kredit.opart, l_kredit.saldo, l_lieferant.segment1, l_lieferant.firma, l_lieferant.lief_nr, l_lieferant._recid in db_session.query(L_kredit.counter, L_kredit.rechnr, L_kredit.betriebsnr, L_kredit._recid, L_kredit.rgdatum, L_kredit.name, L_kredit.lscheinnr, L_kredit.netto, L_kredit.ziel, L_kredit.bemerk, L_kredit.steuercode, L_kredit.lief_nr, L_kredit.opart, L_kredit.saldo, L_lieferant.segment1, L_lieferant.firma, L_lieferant.lief_nr, L_lieferant._recid).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
                         (L_kredit.rechnr != 0) & (L_kredit.lief_nr > 0) & (L_kredit.zahlkonto == 0) & (L_kredit.opart >= sorttype1) & (L_kredit.opart <= sorttype2) & (L_kredit.rgdatum >= from_date) & (L_kredit.rgdatum <= to_date) & (L_kredit.counter >= 0) & (L_kredit.netto != 0) & (L_kredit.steuercode == 0)).order_by(L_kredit.rechnr, L_lieferant.firma, L_kredit.rgdatum).all():
                    if l_kredit_obj_list.get(l_kredit._recid):
                        continue
                    else:
                        l_kredit_obj_list[l_kredit._recid] = True
            ...
            if doit:
                ...
                for l_kredit in db_session.query(L_kredit).filter(
                         (L_kredit.rechnr != 0) & (L_kredit.lief_nr == l_lieferant.lief_nr) & (L_kredit.zahlkonto == 0) & (L_kredit.opart >= sorttype1) & (L_kredit.opart <= sorttype2) & (L_kredit.rgdatum >= from_date) & (L_kredit.rgdatum <= to_date) & (L_kredit.counter >= 0) & (L_kredit.netto != 0)).order_by(L_kredit.rechnr, l_lieferant.firma, L_kredit.rgdatum).all():
                    do_it = True
