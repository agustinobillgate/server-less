...
def fo_invoice_update_bill2bl(pvilanguage:int, b_rechnr:int, b_artnr:int, bil_flag:int, amount:Decimal, amount_foreign:Decimal, price_decimal:int, double_currency:bool, foreign_rate:bool, bill_date:date, transdate:date, billart:int, description:string, qty:int, curr_room:string, user_init:string, artnr:int, price:Decimal, cancel_str:string, currzeit:int, voucher_nr:string, exchg_rate:Decimal, bil_recid:int, curr_department:int):
    ...
    def generate_output():
        nonlocal msg_str, balance, balance_foreign, cancel_flag, void_approve, flag1, flag2, flag3, rechnr, t_bill_list, r_recid, na_running, gastnrmember, lvcarea, bill, artikel, htparam, counters, res_line, bill_line, arrangement, umsatz, billjournal, debitor, reservation, guest, bediener, argt_line
    ...
    def inv_ar(curr_art:int, zinr:string, gastnr:int, gastnrmember:int, rechnr:int, saldo:Decimal, saldo_foreign:Decimal, bill_date:date, billname:string, userinit:string, voucher_nr:string):
        ...
        nonlocal msg_str, balance, balance_foreign, cancel_flag, void_approve, flag1, flag2, flag3, t_bill_list, r_recid, na_running, lvcarea, bill, artikel, htparam, counters, res_line, bill_line, arrangement, umsatz, billjournal, debitor, reservation, guest, bediener, argt_line
