...
def direct_autodeductbl(bill_date:date):
    ...
    s_list_list, S_list = create_model("S_list", {"dept":int, "store":int, "artnr":int, "price":Decimal, "qty":Decimal, "fibukonto":string}, {"fibukonto": "0000000000"})
    t_list_list, T_list = create_model("T_list", {"dept":int, "rechnr":int, "pay":Decimal, "rmtrans":Decimal, "compli":Decimal, "coupon":Decimal, "fibukonto":string}, {"fibukonto": "0000000000"})
