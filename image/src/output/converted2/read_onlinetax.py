...
def read_onlinetax(curr_date:date):
    ...
    def generate_output():
        nonlocal already_read, online_tax_list, bill_date, reihenfolge, nitehist, nightaudit
        nonlocal curr_date
        nonlocal nbuff
        ...
        return {"already_read": already_read, "online-tax": online_tax_list}
    ...
    for nitehist in db_session.query(Nitehist).filter(
        ...
        online_tax_list.append(online_tax)
