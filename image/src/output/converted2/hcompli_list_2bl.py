...
def hcompli_list_2bl(pvilanguage:int, gname:string, sorttype:int, from_dept:int, to_dept:int, from_date:date, to_date:date, double_currency:bool, exchg_rate:Decimal, billdate:date, mi_detail1:bool, sm_disp1:bool, foreign_nr:int, artnr:int):
    ...
    def journal_list():
        ...
        if mi_detail1 == False:
            ...
            for c1_list in query(c1_list_list, filters=(lambda c1_list: c1_list.betrag != 0), sort_by=[("rechnr",False),("name",False),("datum",False),("dept",True)]):
        ...
        if mi_detail1 :
            ...
            for c1_list in query(c1_list_list, filters=(lambda c1_list: c1_list.betrag != 0), sort_by=[("rechnr",False),("p_artnr",False),("name",False),("datum",False),("dept",False),("artnr",True)]):
    ...
    def journal_list1():
        ...
        if mi_detail1 == False:
            ...
            for c1_list in query(c1_list_list, filters=(lambda c1_list: c1_list.betrag != 0), sort_by=[("p_artnr",False),("dept",False),("datum",False),("dept",False),("rechnr",False),("artnr",True)]):
        ...
        if mi_detail1 :
            ...
            for c1_list in query(c1_list_list, filters=(lambda c1_list: c1_list.betrag != 0), sort_by=[("rechnr",False),("p_artnr",False),("dept",False),("datum",False),("dept",False),("artnr",True)]):
