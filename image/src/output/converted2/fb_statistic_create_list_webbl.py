...
def fb_statistic_create_list_webbl(pvilanguage:int, fdept:int, tdept:int, fdate:date, tdate:date, price_decimal:int):
    ...
    cl_list_list, Cl_list = create_model("Cl_list", {"dept":int, "deptname":string, "typ":int, "descrip":string, "grev":Decimal, "gpax":int, "gproz":Decimal, "gcost":Decimal, "gavg":Decimal, "wrev":Decimal, "wpax":int, "wproz":Decimal, "wcost":Decimal, "wavg":Decimal, "totpax":int, "totrev":Decimal, "totcost":Decimal})
    ...
    def create_list():
        ...
        for hoteldpt in db_session.query(Hoteldpt).filter(
            ...
            for fbstat in db_session.query(Fbstat).filter(
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 1 and cl_list.descrip.lower()  == ("Breakfast").lower()), first=True)
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 1 and cl_list.descrip.lower()  == ("Lunch").lower()), first=True)
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 1 and cl_list.descrip.lower()  == ("Dinner").lower()), first=True)
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 1 and cl_list.descrip.lower()  == ("Supper").lower()), first=True)
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 2 and cl_list.descrip.lower()  == ("Breakfast").lower()), first=True)
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 2 and cl_list.descrip.lower()  == ("Lunch").lower()), first=True)
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 2 and cl_list.descrip.lower()  == ("Dinner").lower()), first=True)
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 2 and cl_list.descrip.lower()  == ("Supper").lower()), first=True)
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 3 and cl_list.descrip.lower()  == ("Breakfast").lower()), first=True)
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 3 and cl_list.descrip.lower()  == ("Lunch").lower()), first=True)
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 3 and cl_list.descrip.lower()  == ("Dinner").lower()), first=True)
                ...
                cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 3 and cl_list.descrip.lower()  == ("Supper").lower()), first=True)
            ...
            cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 1 and cl_list.descrip.lower()  == ("FOOD TOTAL").lower()), first=True)
            ...
            cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 2 and cl_list.descrip.lower()  == ("BEV TOTAL").lower()), first=True)
            ...
            cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.typ == 3 and cl_list.descrip.lower()  == ("OTHER TOTAL").lower()), first=True)
            ...
            cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.dept == hoteldpt.num and cl_list.descrip.lower()  == ("TOTAL").lower()), first=True)
