...
def pos_dashboard_odcancelbl(from_date:date, to_date:date, from_dept:int, to_dept:int):
    ...
    cancellation_list_list, Cancellation_list = create_model("Cancellation_list", {"bill_date":date, "table_no":int, "bill_no":int, "order_no":int, "article_no":int, "article_name":string, "cancel_reason":string, "qty":int, "amount":Decimal, "dept_name":string, "cancel_time":string, "cancel_id":string})
