...
def prepare_gl_detailincomingbl(fibu:string, from_date:date, bemerk:string):
    ...
    s_list_list, S_list = create_model("S_list", {"datum":date, "lager_nr":int, "artnr":int, "bezeich":string, "einzelpreis":Decimal, "anzahl":Decimal, "warenwert":Decimal, "firma":string, "docu_nr":string, "lscheinnr":string, "fibu":string, "lief_nr":int, "lflag":bool, "avail_l_ord":bool})
