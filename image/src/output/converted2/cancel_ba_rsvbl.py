...
def cancel_ba_rsvbl(case_type:int, curr_room:str, curr_status:int, curr_i:int, language_code:int, rml_resnr:int, rml_reslinnr:int, answer_msgstr2:bool, answer_msgstr3:bool, cancel_str:str, user_init:str):
    msg_str1 = ""
    msg_str2 = ""
    msg_str3 = ""
    mess_result = ""
    ...
    waiting_list_list, Waiting_list = create_model("Waiting_list", {"veran_nr":int, "name":str, "von_zeit":str, "bis_zeit":str, "raum":str, "rec_id":int})
    ...
    def check_waitinglist(datum:date, raum:str, von_zeit:str, bis_zeit:str, resstatus:int):
