...
def abf_list1_2bl(fdate:date, bfast_artnr:int, bfast_dept:int, zikat_list_list:[Zikat_list]):
    ...
    def generate_output():
        nonlocal abf_list_list, res_line, genstat, arrangement, artikel, argt_line, reslin_queasy, fixleist, guest, reservation, segment, ratecode, bill, master
