...
def dml_list_create_logbl(curr_flag:string, bediener_nr:int, curr_dept:int, curr_date:date, prev_qty:int, prev_amt:int, c_list_list:[C_list]):
    ...
    if curr_flag.lower()  == ("new").lower() :
        ...
        for c_list in query(c_list_list, filters=(lambda c_list: c_list.qty != 0 or c_list.a_qty != 0)):
