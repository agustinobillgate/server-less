...
def hums_cost_btn_go1bl(language_code:int, sorttype:int, detailed:bool, from_dept:int, to_dept:int, from_date:date, to_date:date, fact1:int, short_flag:bool, mi_compli_checked:bool):
    ...
    fb_cost_report_list, Fb_cost_report = create_model("Fb_cost_report", {"departement":string, "qty":string, "sales":string, "cost":string, "qty2":string, "compliment":string, "t_cost":string, "ratio":string, "m_qty":string, "m_sales":string, "m_cost":string, "m_qty2":string, "compliment2":string, "t_cost2":string, "ratio2":string})
    output_list_list, Output_list = create_model("Output_list", {"anz":int, "m_anz":int, "comanz":int, "m_comanz":int, "s":string})
