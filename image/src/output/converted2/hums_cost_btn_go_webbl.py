...
def hums_cost_btn_go_webbl(sorttype:int, detailed:bool, from_dept:int, to_dept:int, from_date:date, to_date:date, fact1:int, mi_compli_checked:bool):
    ...
    h_list_list, H_list = create_model("H_list", {"artnr":int, "dept":int, "num":int, "depart":string, "anz":int, "m_anz":int, "sales":Decimal, "t_sales":Decimal, "comanz":int, "compli":Decimal, "t_compli":Decimal, "t_comanz":int, "cost":Decimal, "t_cost":Decimal, "ncost":Decimal, "t_ncost":Decimal, "proz":Decimal, "t_proz":Decimal, "anz_cost":int, "manz_cost":int})
    output_list_list, Output_list = create_model("Output_list", {"num":int, "bezeich":string, "anz":int, "sales":Decimal, "ncost":Decimal, "comanz":int, "compli":Decimal, "cost":Decimal, "proz":Decimal, "m_anz":int, "t_sales":Decimal, "t_ncost":Decimal, "m_comanz":int, "t_compli":Decimal, "t_cost":Decimal, "t_proz":Decimal, "anz_cost":int, "manz_cost":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal output_list_list, exchg_rate, double_currency, foreign_nr, dd_gsales, dd_gcompli, dd_gcost, dd_ncost, tot_gsales, tot_gcompli, tot_gcost, tot_ncost, dd_anz, dd_comanz, tm_anz, tm_comanz, htparam, waehrung, h_artikel, hoteldpt, umsatz, artikel, h_compli, h_cost, h_journal, h_umsatz, exrate
    ...
    def create_h_umsatz11():
        ...
        nonlocal output_list_list, exchg_rate, double_currency, foreign_nr, htparam, waehrung, h_artikel, hoteldpt, umsatz, artikel, h_compli, h_cost, h_journal, h_umsatz, exrate
        nonlocal sorttype, detailed, from_dept, to_dept, from_date, to_date, fact1, mi_compli_checked
