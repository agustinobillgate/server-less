...
payload_list_list, Payload_list = create_model("Payload_list", {"from_date":date, "to_date":date, "location":int, "show_all":bool, "asset_name":string, "remark":string, "asset_number":string, "sorttype":int, "last_nr":int, "last_artname":string, "last_remark":string, "last_asset_number":string, "mode":int, "num_data":int})

def prepare_fa_artlist2_webbl(payload_list_list:[Payload_list]):
    ...
    output_list_list, Output_list = create_model("Output_list", {"curr_nr":int, "curr_loc":int, "curr_artname":string, "curr_remark":string, "curr_asset_number":string, "is_already_six_digit":bool})
    t_moving_list, T_moving = create_model_like(Mathis, {"curr_nr":int, "curr_loc":int, "curr_artname":string, "curr_remark":string, "curr_asset_number":string})
    t_upgrade_list, T_upgrade = create_model("T_upgrade", {"curr_nr":int, "curr_loc":int, "curr_artname":string, "curr_remark":string, "curr_asset_number":string})
    t_prepare_creatpo_list, T_prepare_creatpo = create_model("T_prepare_creatpo", {"curr_nr":int, "curr_loc":int, "curr_artname":string, "curr_remark":string, "curr_asset_number":string})
    ...
    def generate_output():
        nonlocal p_881, q1_list_list, fibu_list_list, output_list_list, t_moving_list, t_upgrade_list, t_prepare_creatpo_list, sort_loc, counter, counter_num_data, mathis, fa_grup, fa_artikel, fa_lager, fa_kateg, gl_acct
        nonlocal bfa_grup


        nonlocal q1_list, fibu_list, payload_list, output_list, t_moving, t_upgrade, t_prepare_creatpo, bfa_grup
        nonlocal q1_list_list, fibu_list_list, output_list_list, t_moving_list, t_upgrade_list, t_prepare_creatpo_list

        return {"p_881": p_881, "q1-list": q1_list_list, "fibu-list": fibu_list_list, "output-list": output_list_list, "t-moving": t_moving_list, "t-upgrade": t_upgrade_list, "t-prepare-creatPO": t_prepare_creatpo_list}
