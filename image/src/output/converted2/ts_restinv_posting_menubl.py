...
def ts_restinv_posting_menubl(case_type:int, pvilanguage:int, tischnr:int, curr_dept:int, cancel_reason:string, double_currency:bool, exchg_rate:Decimal, price_decimal:int, transdate:date, foreign_rate:bool, deptname:string, cancel_order:bool, order_taker:int, curr_waiter:int, gname:string, pax:int, kreditlimit:Decimal, change_str:string, cc_comment:string, hoga_card:string, print_to_kitchen:bool, from_acct:bool, pay_type:int, guestnr:int, transfer_zinr:string, curedept_flag:bool, curr_room:string, user_init:string, hoga_resnr:int, hoga_reslinnr:int, incl_vat:bool, get_price:int, mc_str:string, tp_bediener_list:[Tp_bediener], submenu_list_list:[Submenu_list], cancel_flag:bool, menu_list_list:[Menu_list], t_h_bill_list:[T_h_bill]):
    avail_bill = False
    not_access = False
    not_access1 = False
    bill_date = None
    ...
    def update_bill(h_artart:int, h_artnrfront:int):
        ...
        nonlocal avail_bill, not_access, not_access1, bill_date, mwst, mwst_foreign, rechnr, balance, bcol, balance_foreign, fl_code, fl_code1, fl_code2, fl_code3, fl_code4, fl_code5, p_88, amount, kellner1_list, t_h_artikel_list, menurecid, add_zeit, billart, req_str, voucher_str, request_str, perm, zugriff, loopn, description, qty, price, cancel_str, amount_foreign, curr_zeit, krecid, h_artikel, h_bill, kellner, bediener
        nonlocal case_type, pvilanguage, tischnr, curr_dept, cancel_reason, double_currency, exchg_rate, price_decimal, transdate, foreign_rate, deptname, cancel_order, order_taker, curr_waiter, gname, pax, kreditlimit, change_str, cc_comment, hoga_card, print_to_kitchen, from_acct, pay_type, guestnr, transfer_zinr, curedept_flag, curr_room, user_init, hoga_resnr, hoga_reslinnr, incl_vat, get_price, mc_str, cancel_flag
