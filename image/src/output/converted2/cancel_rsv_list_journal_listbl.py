...
def cancel_rsv_list_journal_listbl(from_date:date, to_date:date):
    ...
    output_list_list, Output_list = create_model("Output_list", {"str":string, "cperson":string, "tevent":string, "venue":string, "pax":string})
    t_out_list, T_out = create_model("T_out", {"rsv_date":string, "b_date":string, "rsv_no":string, "resline":string, "engager":string, "cperson":string, "tevent":string, "venue":string, "pax":string, "reason":string, "id":string, "room_rev":string, "fb_rev":string, "other_rev":string, "tot_rev":string, "f_empty":string})
