...
nation_list, Nation = create_model("Nation", {"nr":int, "nation_code":string, "nation_name":string, "nation_iso2":string, "nation_iso3":string})

def exportghs_webbl(nation_list:[Nation], currdate:date, propid:string, tax_incl:bool):
    ...
    def generate_output():
        ...
        nonlocal p_list_list, x_list_list, r_list_list
