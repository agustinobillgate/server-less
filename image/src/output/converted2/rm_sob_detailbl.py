...
def rm_sob_detailbl(sob:string, ytdflag:int, f_date:date, t_date:date, to_date:date):
    ...
    genlist_list, Genlist = create_model_like(Genstat, {"rsv_name":string, "nat_str":string, "ctry_str":string, "source_str":string, "rec_gen":int, "arr_date":date, "depart_date":date, "guest_name":string})
    ...
    def generate_output():
        nonlocal genlist_list, from_date, mm, yy, genstat, guest, sourccod, nation
