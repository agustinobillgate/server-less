...
def gl_transf_headoffice2bl(lic_nr:string, t_gl_jouhdr_list:[T_gl_jouhdr], t_gl_journal_list:[T_gl_journal]):
    ...
    for t_gl_jouhdr in query(t_gl_jouhdr_list, sort_by=[("jnr",False)]):
