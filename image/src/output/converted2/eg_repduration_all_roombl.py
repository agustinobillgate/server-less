...
def eg_repduration_all_roombl(all_room:bool, tlocation_list:[Tlocation], tmaintask_list:[Tmaintask], troom_list:[Troom]):
    ...
    tmaintask = troom = tproperty = tlocation = comlocat = commain = comroom = None
    ...
    def generate_output():
        ...
        nonlocal tmaintask, troom, tproperty, tlocation, comlocat, commain, comroom
        nonlocal tproperty_list
