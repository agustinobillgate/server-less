...
def kitchen_display_reportbl(from_date:date, to_date:date, dept:int, kds_number:int):
    ...
    def generate_output():
        nonlocal kds_list, count_i, nr, spreq, starttime, endtime, inttime, deptname, currdate, orig_char, queasy, h_bill_line, h_artikel, h_journal, hoteldpt, printer
