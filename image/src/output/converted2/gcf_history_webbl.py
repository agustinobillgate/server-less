...
def gcf_history_webbl(gastnr:int, fdate:date, tdate:date, vkey:int, gastnr:int, fdate:date, tdate:date, vkey:int):
    ...
    ghistory_list, Ghistory = create_model("Ghistory", {"gastnr":int, "ankunft":date, "abreise":date, "zimmeranz":int, "zikateg":string, "zinr":string, "erwachs":int, "kind":[int,2], "gratis":int, "zipreis":Decimal, "arrangement":string, "gesamtumsatz":Decimal, "bemerk":string, "logisumsatz":Decimal, "argtumsatz":Decimal, "f_b_umsatz":Decimal, "sonst_umsatz":Decimal, "gastinfo":string, "zahlungsart":int, "com_logis":Decimal, "com_argt":Decimal, "com_f_b":Decimal, "com_sonst":Decimal, "guestnrcom":int, "abreisezeit":string, "segmentcode":int, "zi_wechsel":bool, "resnr":int, "ums_kurz":Decimal, "ums_lang":Decimal, "reslinnr":int, "hname":string, "gname":string, "address":string, "s_recid":int, "vcrnr":string, "mblnr":string, "email":string})
    ...
    def generate_output():
        nonlocal ghistory_list, summ_list_list, htl_name, str, i, ghistory_list, summ_list_list, htl_name, str, i, history, paramtext, res_line, guest
        nonlocal gastnr, fdate, tdate, vkey, gastnr, fdate, tdate, vkey
        ...
        return {"ghistory": ghistory_list, "summ-list": summ_list_list, "ghistory": ghistory_list, "summ-list": summ_list_list}
