...
def nsargt_admin_btn_gobl(p_list_list:[P_list], q1_recid:int, q2_recid:int, curr_select:string, argt_artnr:int, argt_dept:int, q1_list_argtnr:int, argt_price:Decimal, argt_proz:Decimal, comments:string):
