...
def fo_journal_cld_2bl(from_art:int, to_art:int, from_dept:int, to_dept:int, from_date:date, to_date:date, sorttype:int, exclude_artrans:bool, long_digit:bool, foreign_flag:bool, mi_onlyjournal:bool, mi_excljournal:bool, mi_post:bool, mi_showrelease:bool, mi_break:bool):
    ...
    def custom_record():
        ...
        nonlocal gtot, output_list_list, curr_date, descr1, voucher_no, ind, indexing, gdelimiter, serv, vat, netto, temp_str, hoteldept, shift, temp1, temp2, guest, queasy, htparam, bill, bill_line, res_line, reservation, sourccod, segment, artikel, genstat, hoteldpt, billjournal, h_bill, bk_veran, arrangement, argt_line, h_journal
        nonlocal from_art, to_art, from_dept, to_dept, from_date, to_date, sorttype, exclude_artrans, long_digit, foreign_flag, mi_onlyjournal, mi_excljournal, mi_post, mi_showrelease, mi_break
        nonlocal buffguest, gbuff, shift_buff
