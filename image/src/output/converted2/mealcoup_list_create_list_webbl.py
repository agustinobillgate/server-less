...
def mealcoup_list_create_list_webbl(curr_month:int, curr_year:int):
    ...
    def generate_output():
        nonlocal mlist_list, total_used, total_coupday, count_i, mealcoup, h_bill, h_artikel, h_journal, res_line
    ...
    def create_list():
        ...
        mlist = query(mlist_list, first=True)
