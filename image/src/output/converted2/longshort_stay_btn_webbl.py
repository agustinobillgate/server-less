...
def longshort_stay_btn_webbl(sorttype:int, to_date:date, from_date:date, long_stay:int):
    ...
    def generate_output():
        nonlocal tot_rm, tot_a, tot_c, tot_co, tot_avail, inactive, cl_list_list, s_list_list, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, htparam, zimmer, paramtext, guest, zimkateg, reservation, res_line, guestseg, nation, genstat
