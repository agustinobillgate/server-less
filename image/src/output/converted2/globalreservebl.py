...
def globalreservebl(case_type:int, k_list_list:[K_list], rmcat:string, gastnr:int, curr_mode:string, last_code:string, argt:string, comments:string, user_init:string):
    ...
    def generate_output():
        ...
        nonlocal allot_list_list, z_list_list, globalreserve_list_list
