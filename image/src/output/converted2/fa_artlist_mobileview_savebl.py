...
fa_article_list_list, Fa_article_list = create_model("Fa_article_list", {"mathis_number":int, "fa_art_name":string, "fa_art_group":int, "fa_art_subgroup":int, "fa_art_category":int, "fa_art_mark":string, "fa_art_model":string, "fa_art_spec":string, "fa_art_remark":string})

def fa_artlist_mobileview_savebl(v_key:int, fa_article_list_list:[Fa_article_list]):
    ...
    fa_article_list = query(fa_article_list_list, first=True)
