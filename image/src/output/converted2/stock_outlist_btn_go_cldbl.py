...
def stock_outlist_btn_go_cldbl(trans_code:string, from_grp:int, mi_alloc:bool, mi_article:bool, mi_docu:bool, mi_date:bool, mattype:int, from_lager:int, to_lager:int, from_date:date, to_date:date, from_art:int, to_art:int, show_price:bool, cost_acct:string, deptno:int):
    ...
    str_list_list, Str_list = create_model("Str_list", {"billdate":date, "fibu":string, "other_fibu":bool, "op_recid":int, "lscheinnr":string, "s":string, "id":string, "masseinheit":string, "gldept":string, "amount":Decimal, "avrg_price":Decimal, "remark_artikel":string})
    s_list_list, S_list = create_model("S_list", {"fibu":string, "cost_center":string, "bezeich":string, "cost":Decimal, "subgroup":string, "anzahl":Decimal})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal it_exist, tot_anz, tot_amount, str_list_list, preis, wert, i, do_it, mi_subgroup, gl_acct, l_lager, l_ophdr, gl_department, l_artikel, l_op, parameters, queasy, l_untergrup, bediener
    ...
    def create_list_trans():
        ...
        nonlocal it_exist, tot_anz, tot_amount, str_list_list, preis, wert, i, mi_subgroup, gl_acct, l_lager, l_ophdr, gl_department, l_artikel, l_op, parameters, queasy, l_untergrup, bediener
        nonlocal trans_code, from_grp, mi_alloc, mi_article, mi_docu, mi_date, mattype, from_lager, to_lager, from_date, to_date, from_art, to_art, show_price, cost_acct, deptno
