...
def fa_mkpo_btn_gobl(tfa_order_list:[Tfa_order], cmb_curr_screen_value:string, local_nr:int, order_nr:string, pr_nr:string, order_date:date, order_type:string, order_name:string, comments:string, supplier_nr:int, dept_nr:int, credit_term:int, paymentdate:date, expected_delivery:date, user_init:string, billdate:date, t_amount:Decimal, appr_1:bool, answer:bool):
