...
pay_list_list, Pay_list = create_model("Pay_list", {"dummy":string, "artnr":int, "bezeich":string, "proz":Decimal, "betrag":Decimal})
...
def ap_debtpay_settle_payment_1bl(pay_list_list:[Pay_list], age_list_list:[Age_list], user_init:string, outstand:Decimal, outstand1:Decimal, rundung:int, pay_date:date, remark:string):
