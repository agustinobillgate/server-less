...
def deposit_list1bl(fdate:date, tdate:date):
    ...
    depo_list_list, Depo_list = create_model("Depo_list", {"group_str":string, "resnr":int, "reserve_name":string, "grpname":string, "guestname":string, "ankunft":date, "depositgef":Decimal, "limitdate":date, "bal":Decimal, "depo1":Decimal, "depositbez":Decimal, "datum1":date, "depo2":Decimal, "depositbez2":Decimal, "datum2":date, "status_rsv":string})
