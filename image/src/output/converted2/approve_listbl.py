...
def approve_listbl():
    ...
    approve_list_list, Approve_list = create_model("Approve_list", {"datum":date, "zeit":string, "keywrd":string, "usrid":string, "billno":int, "gastnr":int, "resnr":int, "reslinnr":int, "gname":string, "remarks":string, "keystr":string, "outstand":Decimal, "crlimit":Decimal, "max_comp":int, "com_rm":int, "pswd":string, "bl_recid":int, "trecid":int, "karteityp":int})
