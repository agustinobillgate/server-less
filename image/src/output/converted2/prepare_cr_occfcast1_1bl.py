...
def prepare_cr_occfcast1_1bl(pvilanguage:int, vhp_limited:bool):
    ...
    def generate_output():
        nonlocal curr_date, segm_list_list, argt_list_list, zikat_list_list, t_buff_queasy_list, outlook_list_list, lvcarea, queasy, htparam, paramtext, segment, arrangement, zimkateg
        ...
        return {"curr_date": curr_date, "segm-list": segm_list_list, "argt-list": argt_list_list, "zikat-list": zikat_list_list, "t-buff-queasy": t_buff_queasy_list, "outlook-list": outlook_list_list}
