...
def rm_productrate_create_umsatz1_webbl_fitria(disptype:int, mi_ftd:bool, f_date:date, t_date:date, to_date:date, cardtype:int, incl_comp:bool, sales_id:string):
    ...
    buff_list_list, Buff_list = create_model_like(To_list)
    ...
    def generate_output():
        ...
        nonlocal to_list_list, buff_list_list
    ...
    def create_umsatz1():
        ...
        for buff_list in query(buff_list_list):
            to_list = To_list()
            to_list_list.append(to_list)
