...
def earlyco_glistbl(from_date:date, to_date:date):
    ...
    earlycog_list_list, Earlycog_list = create_model("Earlycog_list", {"datum":date, "zinr":string, "resname":string, "name":string, "zimmeranz":int, "pax":int, "ankunft":date, "abreise":date, "origdate":date, "zipreis":string, "curr":string, "reason":string, "country":string, "sex":string})
    cl_list_list, Cl_list = create_model("Cl_list", {"bezeich":string, "zimmeranz":int, "pax":int})
