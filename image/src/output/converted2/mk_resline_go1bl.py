...
def mk_resline_go1bl(pvilanguage:int, user_init:string, specrequest:bool, c_apply:string, curr_resline_list:[Curr_resline]):
    ...
    def generate_output():
        ...
        nonlocal t_resline_list, member_list_list, zwunsch_rline_list, zwunsch_rmember_list
