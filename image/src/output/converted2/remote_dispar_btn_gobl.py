...
def remote_dispar_btn_gobl(guestno:int, from_art:int, to_art:int, from_name:string, to_name:string, to_date:date, day1:int, day2:int, day3:int, detailed:bool):
    ...
    age_list_list, Age_list = create_model("Age_list", {"artnr":int, "rechnr":int, "counter":int, "gastnr":int, "rgdatum":date, "gastname":string, "p_bal":Decimal, "debit":Decimal, "credit":Decimal, "saldo":Decimal, "debt0":Decimal, "debt1":Decimal, "debt2":Decimal, "debt3":Decimal, "tot_debt":Decimal})
    ...
    output_list_list, Output_list = create_model("Output_list", {"age1":string, "age2":string, "age3":string, "age4":string, "rechnr":string, "str":string})
    output_list1_list, Output_list1 = create_model("Output_list1", {"str_counter":string, "cust_name":string, "prev_balance":Decimal, "debit":Decimal, "credit":Decimal, "end_balance":Decimal, "age1":Decimal, "age2":Decimal, "age3":Decimal, "age4":Decimal, "rechnr":int, "str_pbalance":string, "str_debit":string, "str_credit":string, "str_ebalance":string, "str_age1":string, "str_age2":string, "str_age3":string, "str_age4":string, "str_rechnr":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal output_list1_list, from_date, curr_bezeich, guest_name, outlist, billname, bill_number, long_digit, debitor, artikel, guest, htparam
        ...
        nonlocal age_list_list, ledger_list, output_list_list, output_list1_list

        return {"output-list1": output_list1_list}
