...
report_list_list, Report_list = create_model("Report_list", {"nr":int, "report_name":string, "activate_flag":bool, "activate_date":date})

def vhp_rms_configbl(case_type:int, report_list_list:[Report_list]):
    ...
    def generate_output():
        ...
        return {"report-list": report_list_list}
    ...
    if case_type == 1:
        ...
        for report_list in query(report_list_list):
