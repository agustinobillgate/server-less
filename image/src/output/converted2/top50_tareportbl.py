...
def top50_tareportbl(pvilanguage:int, curr_date:string, curr_month:int, sorttype:int):
    ...
    if sorttype == 0:
        ...
        for top50_list in query(top50_list_list, filters=(lambda top50_list: top50_list.ytd != 0), sort_by=[("ytd",True),("bezeich",False)]):
            i = i + 1
            top50_list.nr = i
            top50_list.num = i
        ...
        for top50_list in query(top50_list_list, filters=(lambda top50_list: top50_list.mtd != 0), sort_by=[("mtd",True),("bezeich",False)]):
            i = i + 1
            top50_list.nr = i
            top50_list.num = i
