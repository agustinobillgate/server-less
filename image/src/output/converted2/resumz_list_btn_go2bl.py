...
def resumz_list_btn_go2bl(ldry_flag:bool, ldry:int, dstore:int, from_dept:int, to_dept:int, from_date:date, to_date:date, detailed:bool, long_digit:bool):
    ...
    output_list_list, Output_list = create_model("Output_list", {"dqty":int, "mqty":int, "yqty":int, "bezeich":string, "str":string})
    turn_reportlist_list, Turn_reportlist = create_model("Turn_reportlist", {"artno":int, "descr":string, "day_net":Decimal, "day_gros":Decimal, "day_proz":Decimal, "todate_mnet":Decimal, "todate_mgros":Decimal, "todate_mproz":Decimal, "todate_ynet":Decimal, "todate_ygros":Decimal, "todate_yproz":Decimal, "dqty":int, "mqty":int, "yqty":int})
    cl_list_list, Cl_list = create_model("Cl_list", {"flag":string, "artnr":int, "dept":int, "bezeich":string, "dnet":Decimal, "proz1":Decimal, "dgros":Decimal, "proz2":Decimal, "dqty":int, "mqty":int, "mnet":Decimal, "proz3":Decimal, "mgros":Decimal, "proz4":Decimal, "yqty":int, "ynet":Decimal, "proz5":Decimal, "ygros":Decimal, "proz6":Decimal})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal turn_reportlist_list, htparam, hoteldpt, h_artikel, h_umsatz
        ...
        nonlocal output_list_list, turn_reportlist_list, cl_list_list
