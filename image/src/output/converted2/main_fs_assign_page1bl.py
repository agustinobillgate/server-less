...
def main_fs_assign_page1bl(bkf_list:[Bkf], fsl_list:[Fsl], resnr:int, resline:int, bill_gastnr:int, en_gastnr:int, bkf_veran_nr:int, q3_list_veran_nr:int, q3_list_veran_seite:int, rsvsort:int, user_init:string, glist_list:[Glist]):
    ...
    def generate_output():
        ...
        return {"total_depo": total_depo, "glist": glist_list}
