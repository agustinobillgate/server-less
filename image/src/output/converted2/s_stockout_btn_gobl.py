...
def s_stockout_btn_gobl(op_list_list:[Op_list], pvilanguage:int, out_type:int, rec_id:int, curr_lager:int, jobnr:int, cost_acct:string, transdate:date, t_datum:date, transfered:bool, t_lschein:string, to_stock:int, lscheinnr:string, bediener_nr:int, qty:Decimal, t_amount:Decimal):
