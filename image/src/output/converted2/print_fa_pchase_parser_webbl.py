...
def print_fa_pchase_parser_webbl(docu_nr:string):
    ...
    def generate_output():
        nonlocal err, supplier_name, bill_recv, address1, address2, order_date, deliv_date, telefon, fax, pr_nr, op_list_list, l_artikel, fa_ordheader, l_lieferant, fa_order, mathis
        nonlocal docu_nr
        ...
        return {"err": err, "supplier_name": supplier_name, "bill_recv": bill_recv, "address1": address1, "address2": address2, "order_date": order_date, "deliv_date": deliv_date, "telefon": telefon, "fax": fax, "pr_nr": pr_nr, "op-list": op_list_list}
