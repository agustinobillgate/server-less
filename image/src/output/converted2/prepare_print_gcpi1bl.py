...
def prepare_print_gcpi1bl(docu_nr:string, user_init:string, printer_nr:int):
    ...
    output_list_list, Output_list = create_model("Output_list", {"docu_nr":string, "bemerk":string, "betrag":Decimal, "amount_array":[Decimal,10], "bez_array":[string,10], "b_username":string, "u_username":string, "bezeich":string, "avail_gc_pitype":bool})
