...
def ap_debtlistbl(duedate_flag:bool, from_lief:int, to_lief:int, paid_flag:bool, excl_apmanual:bool, from_date:date, to_date:date, from_supp:string, to_supp:string, only_apmanual:bool, taxcode_list_list:[Taxcode_list]):
    ...
    output_list_list, Output_list = create_model("Output_list", {"paid":string, "ap_recid":int, "str":string, "lscheinnr":string, "gstid":string, "tax_code":string, "tax_amount":string, "tot_amt":string})
    ...
    def create_list0a():
        ...
        for l_kredit.rgdatum, l_kredit.ziel, l_kredit._recid, l_kredit.name, l_kredit.lscheinnr, l_kredit.netto, l_kredit.bediener_nr, l_kredit.bemerk, l_kredit.steuercode, l_kredit.opart, l_lieferant.segment1, l_lieferant.firma, l_lieferant.plz, l_lieferant._recid in db_session.query(L_kredit.rgdatum, L_kredit.ziel, L_kredit._recid, L_kredit.name, L_kredit.lscheinnr, L_kredit.netto, L_kredit.bediener_nr, L_kredit.bemerk, L_kredit.steuercode, L_kredit.opart, L_lieferant.segment1, L_lieferant.firma, L_lieferant.plz, L_lieferant._recid).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
    ...
    def create_lista():
        ...
        l_lieferant = L_lieferant()
        l_kredit = L_kredit()
        for l_lieferant.segment1, l_lieferant.firma, l_lieferant.plz, l_lieferant._recid, l_kredit.rgdatum, l_kredit.ziel, l_kredit._recid, l_kredit.name, l_kredit.lscheinnr, l_kredit.netto, l_kredit.bediener_nr, l_kredit.bemerk, l_kredit.steuercode, l_kredit.opart in db_session.query(L_lieferant.segment1, L_lieferant.firma, L_lieferant.plz, L_lieferant._recid, L_kredit.rgdatum, L_kredit.ziel, L_kredit._recid, L_kredit.name, L_kredit.lscheinnr, L_kredit.netto, L_kredit.bediener_nr, L_kredit.bemerk, L_kredit.steuercode, L_kredit.opart).join(L_kredit,(L_kredit.rgdatum >= from_date) & (L_kredit.rgdatum <= to_date) & (L_kredit.zahlkonto == 0) & (L_kredit.lief_nr == L_lieferant.lief_nr) & (L_kredit.steuercode >= code1) & (L_kredit.steuercode <= code2)).filter(
