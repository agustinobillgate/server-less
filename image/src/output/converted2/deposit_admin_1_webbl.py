...
def deposit_admin_1_webbl(case_type:int, depo_foreign:bool, lname:string, deposittype:int, sorttype:int, lresnr:int, fdate:date, exrate:Decimal, bill_date:date, depo_curr:int, flag:int, tdate:date):
    ...
    xrate_change:Decimal = to_decimal("0.0")
    ...
    def generate_output():
        nonlocal total_saldo, arriv_saldo, depo_list_list, b1_list_list, b1_print_list, grpstr, xrate_change, res_line, reservation, exrate, waehrung, arrangement, zimkateg, fixleist
    ...
    def create_itlist():
        ...
        if case_type == 1:
            ...
            if depo_foreign:
                ...
                total_saldo =  to_decimal(total_saldo) * to_decimal(xrate_change)
                arriv_saldo =  to_decimal(arriv_saldo) * to_decimal(xrate_change)
