...
def dml_list_create_it_2_webbl(curr_dept:int, selected_date:date, dml_no:string):
    ...
    def generate_output():
        nonlocal dml_hdr_remark, supply_list_list, c_list_list, dml_counter, fill_dml_nr, dml_no_remark, dml_artdep, reslin_queasy, queasy, dml_art, l_artikel, l_untergrup, l_bestand, l_lieferant
        ...
        return {"dml_hdr_remark": dml_hdr_remark, "supply-list": supply_list_list, "c-list": c_list_list}
