...
def web_fo_journal_list_2_webbl(from_art:int, to_art:int, from_dept:int, to_dept:int, from_date:date, to_date:date, sorttype:int, exclude_artrans:bool, long_digit:bool, foreign_flag:bool, onlyjournal:bool, excljournal:bool, mi_post:bool, mi_showrelease:bool, mi_break:bool, id_flag:string):
    ...
    def generate_output():
        nonlocal fo_journal_list_list, done_flag, gtot, queasy, artikel, htparam
        ...
        return {"fo-journal-list": fo_journal_list_list, "done_flag": done_flag}
    ...
    pass
    gtot, output_list_list = get_output(fo_journal_cld_3bl(from_art, to_art, from_dept, to_dept, from_date, to_date, sorttype, exclude_artrans, long_digit, foreign_flag, onlyjournal, excljournal, mi_post, mi_showrelease, mi_break, id_flag))
