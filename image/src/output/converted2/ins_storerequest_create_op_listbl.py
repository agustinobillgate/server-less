...
def ins_storerequest_create_op_listbl(out_list_list:[Out_list], op_list_list:[Op_list], amount:Decimal, t_amount:Decimal, pvilanguage:int, user_init:string, s_artnr:int, qty:Decimal, transfered:bool, cost_acct:string, curr_lager:int, price:Decimal, transdate:date, lscheinnr:string):
    ...
    def generate_output():
        ...
        nonlocal op_list1_list

        return {"out-list": out_list_list, "op-list": op_list_list, "amount": amount, "t_amount": t_amount, "err_flag2": err_flag2, "err_flag1": err_flag1, "err_flag": err_flag, "oh_ok": oh_ok, "msg_str2": msg_str2}
