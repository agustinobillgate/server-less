...
def dml_list_copy_articles_11_webbl(user_init:string, curr_dept:int, selected_date:date, dml_no:string):
    ...
    def generate_output():
        nonlocal approve_flag, c_list_list, supply_list_list, dml_counter, copy_mode, liefno, dml_art, dml_artdep, reslin_queasy, queasy, l_artikel, l_untergrup, l_bestand, l_lieferant
    ...
    def copy_articles():
        ...
        nonlocal approve_flag, c_list_list, supply_list_list, dml_counter, copy_mode, dml_art, dml_artdep, reslin_queasy, queasy, l_artikel, l_untergrup, l_bestand, l_lieferant
        nonlocal user_init, curr_dept, selected_date, dml_no
        nonlocal d_art, d_artdep, breslin, buff_queasy
