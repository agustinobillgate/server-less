...
payload_list_list, Payload_list = create_model("Payload_list", {"artnr":int, "lscheinnr":string, "remark":string, "einzelpreis":Decimal})

def inv_manage_remarkbl(payload_list_list:[Payload_list]):
