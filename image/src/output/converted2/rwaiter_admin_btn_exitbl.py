...
def rwaiter_admin_btn_exitbl(t_list_list:[T_list], case_type:int, dept:int, curr_mode:string, kzahl_nr1:int, kumsatz_nr1:int, r_kellner:int, r_kellne1:int):
    ...
    def fill_new_kellner():
        ...
        kellner.departement = dept_number
        ...
        if curr_mode.lower()  == ("chg").lower() :
            ...
            waiter1.departement = dept_number
    ...
    if case_type == 1:
        ...
        if kellner:
            ...
            if kellne1:
                ...
                pass
                pass
    q1_list_list, t_kellner_list = get_output(prepare_rwaiter_adminbl(dept_number))
