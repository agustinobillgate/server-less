...
def gl_linkstock2bl(pvilanguage:int, link_in:bool, to_date:date, remains:Decimal, credits:Decimal, debits:Decimal, refno:string, datum:date, bezeich:string, jtype:int, g_list_list:[G_list]):
