...
def ts_restinv_close_shift_btn_exitbl(pvilanguage:int, shift_list_list:[Shift_list], all_user:bool, curr_dept:int, billdate:date, kellner_kellner_nr:int, shift:int, user_init:string):
    ...
    def generate_output():
        ...
        return {"shift-list": shift_list_list, "flag": flag}
