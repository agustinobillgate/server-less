...
def hk_statadmin_chg_zistatusbl(bline_list_list:[Bline_list], om_list_list:[Om_list], pvilanguage:int, ci_date:date, chgsort:int, t_zinr:string, user_init:string, user_nr:int):
