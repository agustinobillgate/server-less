...
def dml_list_create_listbl(curr_dept:int, selected_date:date):
    ...
    dml_list_list, Dml_list = create_model("Dml_list", {"counter":int, "dml_nr":string, "dept":string, "id":string, "approved":bool})
    ...
    def generate_output():
        nonlocal dml_list_list, nr, reslin_queasy, hoteldpt, dml_art, dml_artdep
