...
def check_totpbl(username:string, userotp:string, checking_flag:int):
    ...
    def generate_output():
        nonlocal totpok, epoch_signature, signature_list_list, secretkey, generatedotp, cmd, result, returnstatus, foldername, filename, bediener, queasy, res_history, paramtext
        ...
        return {"totpok": totpok, "epoch_signature": epoch_signature, "signature-list": signature_list_list}
