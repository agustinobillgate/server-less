...
def prepare_chg_sarticle_webbl(artnr:int, changed:bool):
    ...
    t_message_list_list, T_message_list = create_model("T_message_list", {"lock_flag1":bool, "lock_flag2":bool})
    ...
    def generate_output():
        nonlocal fibukonto, dml_art, bez_aend, s_unit, tt_artnr_list, tt_content_list, tt_bezeich_list, pict_file, recipe_bez, firma1, firma2, firma3, zw_bezeich, end_bezeich, set_disp1, set_disp2, set_disp3, set_disp4, artnr_ok, param89, f_endkum, b_endkum, o_endkum, l_art_list, t_l_art_list, ttguestbook_list, t_message_list_list, ss_artnr, ss_content, ss_bezeich, i_counter, strartnr, lp_price, count_lophis, count_lop, l_artikel, guestbook, htparam, l_bestand, l_ophis, h_rezept, l_lieferant, l_untergrup, l_hauptgrp, l_op, h_rezlin, queasy
        nonlocal artnr, changed
        nonlocal lbuff


        nonlocal l_art, t_l_art, tt_artnr, tt_content, tt_bezeich, t_message_list, ttguestbook, lbuff
        nonlocal l_art_list, t_l_art_list, tt_artnr_list, tt_content_list, tt_bezeich_list, t_message_list_list, ttguestbook_list

        return {"fibukonto": fibukonto, "dml_art": dml_art, "bez_aend": bez_aend, "s_unit": s_unit, "tt-artnr": tt_artnr_list, "tt-content": tt_content_list, "tt-bezeich": tt_bezeich_list, "pict_file": pict_file, "recipe_bez": recipe_bez, "firma1": firma1, "firma2": firma2, "firma3": firma3, "zw_bezeich": zw_bezeich, "end_bezeich": end_bezeich, "set_disp1": set_disp1, "set_disp2": set_disp2, "set_disp3": set_disp3, "set_disp4": set_disp4, "artnr_ok": artnr_ok, "param89": param89, "f_endkum": f_endkum, "b_endkum": b_endkum, "o_endkum": o_endkum, "l-art": l_art_list, "t-l-art": t_l_art_list, "ttGuestBook": ttguestbook_list, "t-message-list": t_message_list_list}
    ...
    t_message_list_list.append(t_message_list)
