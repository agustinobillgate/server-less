...
def prepare_res_rmrate_3bl(pvilanguage:int, user_init:string, reslin_list_list:[Reslin_list]):
    ...
    def generate_output():
        ...
        nonlocal dynarate_list_list, ratecode_list_list, output_list_list, t_waehrung_list, q2_reslin_queasy_list, curr_add_last_list, p_list_list

        return {"rate_found": rate_found, "ci_date": ci_date, "output-list": output_list_list, "p-list": p_list_list, "curr-add-last": curr_add_last_list, "t-waehrung": t_waehrung_list, "q2-reslin-queasy": q2_reslin_queasy_list, "ratecode-list": ratecode_list_list, "rate_flag": rate_flag, "split_price": split_price, "repeat_charge": repeat_charge}
    ...
    queasy = get_cache (Queasy, {"key": [(eq, 301)],"number1": [(eq, res_line.resnr)]})
