...
def eg_rephistoryroom_disp2_webbl(room_nr:string, fdate:date, tdate:date, prop_nr:int):
    ...
    t_hisroom_list, T_hisroom = create_model("T_hisroom", {"itemno":string, "bezeich":string, "reqno":string, "opend":string, "processd":string, "doned":string, "subtask":string, "reqstat":string, "flag":string})
