...
def get_print_rc_lnlbl(resno:int, reslino:int):
    ...
    def generate_output():
        nonlocal print_rc_list_list, temp_zimmerwusch, anz, wi_gastnr, ind_gastnr, cc_str, cc_nr, ccard, mm, yy, cc_valid, guest, res_line, reservation, bill, queasy, zimkateg, sourccod, mc_guest, mc_types, htparam, segment
        nonlocal resno, reslino
        nonlocal rsvguest


        nonlocal print_rc_list, rsvguest
        nonlocal print_rc_list_list

        return {"print-rc-list": print_rc_list_list}
