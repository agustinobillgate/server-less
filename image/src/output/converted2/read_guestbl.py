...
def read_guestbl(case_type:int, gastno:int, gname:string, fname:string):
    ...
    if case_type == 1:
        ...
        guest = get_cache (Guest, {"name": [(eq, gname)],"anredefirma ": [(eq, fname)],"gastnr": [(gt, 0)]})
    elif case_type == 3:
        ...
        guest = get_cache (Guest, {"name": [(eq, gname)],"anredefirma ": [(eq, fname)],"karteityp": [(eq, gastno)],"gastnr": [(gt, 0)]})
    elif case_type == 7:
