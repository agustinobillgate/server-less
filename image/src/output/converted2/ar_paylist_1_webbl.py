...
def ar_paylist_1_webbl(comment:string, cledger:bool, ccard:bool, last_sort:int, from_date:date, to_date:date, from_art:int, to_art:int, mi_payment:bool, mi_transfer:bool, show_inv:bool, bill_name:string):
    ...
    s_list_list, S_list = create_model("S_list", {"artnr":int, "bezeich":string, "betrag":Decimal})
    t_list_list, T_list = create_model("T_list", {"artnr":int, "bezeich":string, "betrag":Decimal})
    output_list_list, Output_list = create_model("Output_list", {"artnr":int, "pay_count":int, "flag":int, "pay_amt":Decimal, "dbetrag":Decimal, "sbetrag":string, "inv_no":string, "str":string, "bill_art":int, "debt_counter":int, "art_bezeich":string, "tbetrag":Decimal, "gastname":string, "soa_inv":string, "famt":string})
    t_ar_paylist_list, T_ar_paylist = create_model("T_ar_paylist", {"bill_date":string, "bill_num":string, "inv_num":string, "bill_rcv":string, "debt_amt":string, "pay_amt":string, "pay_famt":string, "curr":string, "pay_art":string, "pay_date":string, "uid":string, "pay_comment":string, "tot_pay":string, "artno":string, "debt_counter":string, "art_bezeich":string, "tbetrag":string, "gastname":string, "soa_inv":string, "famt":string})
    ...
    def generate_output():
        nonlocal r_no, s_list_list, t_list_list, t_ar_paylist_list, long_digit, htparam, guest, debitor, artikel, bill, bediener, waehrung
        nonlocal comment, cledger, ccard, last_sort, from_date, to_date, from_art, to_art, mi_payment, mi_transfer, show_inv, bill_name
