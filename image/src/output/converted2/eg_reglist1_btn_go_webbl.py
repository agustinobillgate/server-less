...
def eg_reglist1_btn_go_webbl(location:int, rmno:string, main_nr:int, reqstatus:int, sguestflag:bool, from_date:date, to_date:date, pvilanguage:int, tpic_list:[Tpic]):
    ...
    def generate_output():
        ...
        nonlocal copyrequest_list, tcategory_list, tsource_list, tsubtask_list, tmaintask_list, tlocation_list, troom_list, tstatus_list

        return {"location": location, "rmno": rmno, "main_nr": main_nr, "reqstatus": reqstatus, "copyRequest": copyrequest_list}
