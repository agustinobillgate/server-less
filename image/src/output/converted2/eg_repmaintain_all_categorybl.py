...
def eg_repmaintain_all_categorybl(all_room:bool, tcategory_list:[Tcategory], tlocation_list:[Tlocation], troom_list:[Troom]):
    ...
    def generate_output():
        ...
        nonlocal tproperty_list, tmaintask_list
