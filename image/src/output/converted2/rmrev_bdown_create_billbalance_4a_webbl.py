...
def rmrev_bdown_create_billbalance_4a_webbl(exc_taxserv:bool, pvilanguage:int, new_contrate:bool, foreign_rate:bool, price_decimal:int, curr_date:date, sorttype:int):
    ...
    def generate_output():
        nonlocal msg_str, msg_warning, cl_list_list, currency_list_list, sum_list_list, s_list_list, argt_list_list, exchg_rate, frate, post_it, total_rev, rm_rate, pax, price, lvcarea, waehrung, guest, artikel, htparam, res_line, zimmer, arrangement, reservation, bill, zimkateg, segment, reslin_queasy, queasy, katpreis, guest_pr, pricecod, argt_line, fixleist, zwkum
        ...
        nonlocal sum_list_list, currency_list_list, cl_list_list, s_list_list, argt_list_list, argt6_list_list
    ...
    def get_argtline_rate(contcode:string, argt_recid:int):
        ...
        if qty > 0:
            ...
            if argtline.fakt_modus == 1:
                ...
                argt6_list = query(argt6_list_list, filters=(lambda argt6_list: argt6_list.argtnr == argtline.argtnr and argt6_list.departement == argtline.departement and argt6_list.argt_artnr == argtline.argt_artnr and argt6_list.vt_percnt == argtline.vt_percnt and argt6_list.resnr == res_line.resnr and argt6_list.reslinnr == res_line.reslinnr and argt6_list.is_charged == 0), first=True)
