...
def gc_pilistbl(sorttype:int, notclearing:bool, fromname:string, toname:string, fromdate:date, todate:date):
    ...
    b1_list_list, B1_list = create_model("B1_list", {"username":string, "userinit":string, "datum":date, "bezeich":string, "docu_nr":string, "betrag":Decimal, "pay_datum":date, "postdate":date, "chequeno":string, "datum2":date, "pay_type":int, "returnamt":Decimal, "bemerk":string, "pi_status":int, "rcvid":string})
