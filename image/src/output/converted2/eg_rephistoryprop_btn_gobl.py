...
def eg_rephistoryprop_btn_gobl(prop_nr:int, fdate:date, tdate:date):
    ...
    tbrowse_list, Tbrowse = create_model("Tbrowse", {"desc1":string, "desc2":string, "reqno":string, "opend":string, "processd":string, "doned":string, "subtask":string, "reqstat":string, "tflag":string})
    ...
    def generate_output():
        nonlocal tbrowse_list, atotal, btotal, tot, int_str, l_artikel, eg_request, eg_subtask, eg_queasy, eg_vperform, eg_vendor
