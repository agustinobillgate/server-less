...
def prepare_copy_bares_webbl(resnr:int, reslinnr:int):
    ...
    room_list_list, Room_list = create_model("Room_list", {"room_id":string, "room_name":string, "prep_time":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal datum, ftime, ttime, from_date, to_date, gname, raum, raum1, statsort, room_list_list, bk_reser, bk_func, bk_raum
        ...
        return {"datum": datum, "ftime": ftime, "ttime": ttime, "from_date": from_date, "to_date": to_date, "gname": gname, "raum": raum, "raum1": raum1, "statsort": statsort, "room-list": room_list_list}
