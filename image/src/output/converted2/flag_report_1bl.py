...
s_list_list, S_list = create_model("S_list", {"newflag":bool, "id":string, "frdate":date, "datum":date, "note":string, "urgent":bool, "done":bool, "dept":string, "ciflag":bool, "coflag":bool, "rsv_detail":bool, "bill_flag":bool}, {"newflag": True})

def flag_report_1bl(case_type:int, n:int, resnr:int, reslinnr:int, user_init:string, s_list_list:[S_list]):
