...
def sel_itemloc_create_categobjectbl(chrzinr:string, intlocation:int):
    ...
    categobjectlist_list, Categobjectlist = create_model("Categobjectlist", {"categ_nr":int, "categ_nm":string, "object_nr":int, "object_nm":string, "item_nr":int, "item_nm":string})
    cobjectlist_list, Cobjectlist = create_model("Cobjectlist", {"categ_nr":int, "object_nr":int, "object_nm":string})
    categlist_list, Categlist = create_model("Categlist", {"categ_nr":int, "categ_nm":string})
                ...
                if quesbuff:
                    ...
                    if quesbuff1:
                        ...
                        if intcategex_nr == 0:
                            ...
                            if intcategex_nr != quesbuff1.number1:
                                ...
                                categlist = query(categlist_list, filters=(lambda categlist: categlist.categList.categ_nr == quesbuff1.number1), first=True)
                    ...
                    if intobjectex_nr == 0:
                        ...
                        if intobjectex_nr != quesbuff.number1:
                            ...
                            cobjectlist = query(cobjectlist_list, filters=(lambda cobjectlist: cobjectlist.cObjectList.Object_nr == quesbuff.number1), first=True)
