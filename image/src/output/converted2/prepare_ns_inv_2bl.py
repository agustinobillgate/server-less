...
def prepare_ns_inv_2bl(inp_rechnr:int, curr_department:int, combo_pf_file1:string, combo_pf_file2:string, combo_gastnr:int, combo_ledger:int):
    ...
    def generate_output():
        ...
        return {"cashless_license": cashless_license, "cashless_minsaldo": cashless_minsaldo, "ns_useraccess": ns_useraccess, "f-foinv": f_foinv_list, "t-bill": t_bill_list, "t-guest": t_guest_list, "combo_pf_file1": combo_pf_file1, "combo_pf_file2": combo_pf_file2, "combo_gastnr": combo_gastnr, "combo_ledger": combo_ledger}
