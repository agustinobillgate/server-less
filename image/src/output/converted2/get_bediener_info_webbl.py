...
def get_bediener_info_webbl(user_name:string, user_init:string):
    ...
    def generate_output():
        nonlocal epoch_signature, bediener, bediener_info_list, signature_list_list, dept_name, queasy, bediener, paramtext
        ...
        nonlocal bediener_info_list, value_list_list, signature_list_list

        return {"epoch_signature": epoch_signature, "bediener": bediener, "bediener-info": bediener_info_list, "signature-list": signature_list_list}
    ...
    def create_signature(user_name:string, value_list_list:[Value_list]):
        ...
        nonlocal bediener_info, value_list, signature_list, buff_user, bdept, totpdata
        nonlocal bediener_info_list, signature_list_list
