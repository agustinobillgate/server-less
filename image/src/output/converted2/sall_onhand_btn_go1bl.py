...
def sall_onhand_btn_go1bl(all_flag:bool, show_price:bool, zero_flag:bool, from_grp:int, sub_grp:int, from_lager:int, to_lager:int, sorttype:int, mattype:int):
    ...
    soh_list_list, Soh_list = create_model("Soh_list", {"artnr":int, "bezeich":string, "unit":string, "act_qty":Decimal, "act_val":Decimal, "cont1":string, "d_unit":string, "cont2":string, "last_price":Decimal, "act_price":Decimal, "avrg_price":Decimal})
