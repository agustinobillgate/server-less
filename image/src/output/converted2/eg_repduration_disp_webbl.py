...
def eg_repduration_disp_webbl(all_room:bool, all_property:bool, all_pic:bool, all_subtask:bool, all_source:bool, all_category:bool, all_location:bool, all_maintask:bool, cmb_operand:int, fdate:date, tdate:date, calctime:int, calctime1:int, tpic_list:[Tpic], tsubtask_list:[Tsubtask], tsource_list:[Tsource], tcategory_list:[Tcategory], tlocation_list:[Tlocation], tmaintask_list:[Tmaintask]):
    ...
    srequest_list, Srequest = create_model("Srequest", {"reqnr":int, "opendate":date, "status_str":string, "source_str":string, "source_name":string, "process_date":date, "closed_date":date, "urgency":string, "category_str":string, "deptnum":int, "pmaintask":int, "maintask":string, "plocation":int, "location":string, "zinr":string, "property":int, "property_nm":string, "pic_str":string, "sub_str":string, "ex_finishdate":date, "ex_finishtime":string, "ex_finish":string, "done_date":date, "done_time":string, "done":string, "memo":string, "task_def":string, "task_solv":string, "source":int, "category":int, "reqstatus":int, "sub_task":string, "assign_to":int, "reason":string})
    copyrequest_list, Copyrequest = create_model("Copyrequest", {"reqnr":int, "opendate":date, "status_str":string, "source_str":string, "source_name":string, "process_date":date, "closed_date":date, "urgency":string, "category_str":string, "deptnum":int, "pmaintask":int, "maintask":string, "plocation":int, "location":string, "zinr":string, "property":int, "property_nm":string, "pic_str":string, "sub_str":string, "ex_finishdate":date, "ex_finishtime":string, "ex_finish":string, "done_date":date, "done_time":string, "done":string, "memo":string, "task_def":string, "task_solv":string, "source":int, "category":int, "reqstatus":int, "sub_task":string, "assign_to":int, "reason":string, "str":string})
    ...
    def generate_output():
        ...
        nonlocal t_eg_request_list, srequest_list, copyrequest_list, tproperty_list, troom_list

        return {"tpic": tpic_list, "tsubtask": tsubtask_list, "tsource": tsource_list, "tcategory": tcategory_list, "tLocation": tlocation_list, "tMaintask": tmaintask_list, "tproperty": tproperty_list, "troom": troom_list, "copyRequest": copyrequest_list}
    ...
    def open_query():
        ...
        full_finish:string = ""
        full_done:string = ""
        troom_list, tproperty_list = get_output(eg_repduration_all_locationbl(all_room, tlocation_list, tmaintask_list))
