...
payable_list_list, Payable_list = create_model("Payable_list", {"ct":int, "descr":string, "departement":int, "t_day":Decimal, "dper":Decimal, "mtd":Decimal, "mtd_per":Decimal, "mtd_budget":Decimal, "variance":Decimal, "ytd":Decimal, "ytd_budget":Decimal, "ytd_per":Decimal, "flag":string, "flag_grup":bool})
...
payment_list_list, Payment_list = create_model("Payment_list", {"ct":int, "descr":string, "departement":int, "t_day":Decimal, "mtd":Decimal, "mtd_budget":Decimal, "variance":Decimal, "ytd":Decimal, "ytd_budget":Decimal, "flag":string})
...
fb_sales_beverage_list, Fb_sales_beverage = create_model("Fb_sales_beverage", {"ct":int, "artnr":int, "departement":int, "descr":string, "tday_cov":Decimal, "tday_avg":Decimal, "tday_rev":Decimal, "mtd_cov":Decimal, "mtd_avg":Decimal, "mtd_rev":Decimal, "ytd_cov":Decimal, "ytd_avg":Decimal, "ytd_rev":Decimal, "flag":string})
fb_sales_other_list, Fb_sales_other = create_model("Fb_sales_other", {"ct":int, "artnr":int, "departement":int, "descr":string, "tday_cov":Decimal, "tday_avg":Decimal, "tday_rev":Decimal, "mtd_cov":Decimal, "mtd_avg":Decimal, "mtd_rev":Decimal, "ytd_cov":Decimal, "ytd_avg":Decimal, "ytd_rev":Decimal, "flag":string})
fb_sales_tot_list, Fb_sales_tot = create_model("Fb_sales_tot", {"ct":int, "artnr":int, "departement":int, "descr":string, "tday_cov":Decimal, "tday_avg":Decimal, "tday_rev":Decimal, "mtd_cov":Decimal, "mtd_avg":Decimal, "mtd_rev":Decimal, "ytd_cov":Decimal, "ytd_avg":Decimal, "ytd_rev":Decimal, "flag":string})
rev_seg_list1_list, Rev_seg_list1 = create_model_like(Rev_seg_list)
fb_sales_material_list, Fb_sales_material = create_model("Fb_sales_material", {"ct":int, "artnr":int, "departement":int, "descr":string, "tday_cov":Decimal, "tday_avg":Decimal, "tday_rev":Decimal, "mtd_cov":Decimal, "mtd_avg":Decimal, "mtd_rev":Decimal, "ytd_cov":Decimal, "ytd_avg":Decimal, "ytd_rev":Decimal, "flag":string})

def new_drr_create_gsheet_webbl(from_date:date, to_date:date, gsheet_link:string, rev_seg_list_list:[Rev_seg_list], rev_list_list:[Rev_list], payable_list_list:[Payable_list], stat_list_list:[Stat_list], payment_list_list:[Payment_list], gl_list_list:[Gl_list], fb_sales_food_list:[Fb_sales_food], fb_sales_beverage_list:[Fb_sales_beverage], fb_sales_other_list:[Fb_sales_other], fb_sales_tot_list:[Fb_sales_tot], rev_seg_list1_list:[Rev_seg_list1], fb_sales_material_list:[Fb_sales_material]):
    shared = None
    ...
    tot_list_list, Tot_list = create_model("Tot_list", {"ct":int, "descr":string, "departement":int, "t_day":Decimal, "dper":Decimal, "mtd":Decimal, "mtd_per":Decimal, "mtd_budget":Decimal, "variance":Decimal, "ytd":Decimal, "ytd_budget":Decimal, "ytd_per":Decimal, "flag":string, "flag_grup":bool})
