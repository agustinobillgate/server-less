...
def fo_cashgjourn_listbl(pvilanguage:int, case_type:int, curr_shift:int, summary_flag:bool, from_date:date, bline_list_list:[Bline_list]):
    ...
    from_date, double_currency, foreign_curr, bline_list_list, output_list_list = get_output(fo_cashgjournbl(pvilanguage, case_type, curr_shift, summary_flag, from_date, bline_list_list))
