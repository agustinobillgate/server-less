...
def dml_list_create_po_11_webbl(s_list_list:[S_list], c_list_list:[C_list], l_orderhdr_recid:int, l_lieferant_recid:int, lief_nr:int, currdate:date, selected_date:date, bediener_username:string, crterm:int, local_nr:int, curr_dept:int, dunit_price:bool, dml_hdr_remark:string):
