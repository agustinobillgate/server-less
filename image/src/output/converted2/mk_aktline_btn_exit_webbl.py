...
def mk_aktline_btn_exit_webbl(akt_line1_list:[Akt_line1], prior:string, case_type:int, base64file:string, user_init:string):
    ...
    def generate_output():
        ...
        nonlocal akt_line1_list, prior, case_type, base64file, user_init
