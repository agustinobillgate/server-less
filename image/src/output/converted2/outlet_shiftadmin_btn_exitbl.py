...
p_list_list, P_list = create_model("P_list", {"bezeich":string, "zeit1":int, "zeit2":int, "shift":int})

def outlet_shiftadmin_btn_exitbl(p_list_list:[P_list], case_type:int, rec_id:int):
