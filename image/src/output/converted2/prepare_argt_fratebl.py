...
def prepare_argt_fratebl(pvilanguage:int, resnr:int, reslinnr:int, argt:string, ankunft:date, abreise:date):
    ...
    argt_list_list, Argt_list = create_model("Argt_list", {"argt_artnr":int, "bezeich":string, "departement":int, "deci1":Decimal, "date1":date, "date2":date, "deci2":Decimal, "deci3":Decimal, "post_type":string, "pers_type":string, "fakt_modus":int, "vt_percnt":int, "s_recid":int})
