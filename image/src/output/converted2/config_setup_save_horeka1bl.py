...
def config_setup_save_horeka1bl(userinit:string, custid:string, username:string, password:string, url_push:string, url_notif:string, storage:int, push_dml:bool, art_deposit:int, api_key:string, supplier:string, coa_apdeposit:string, coa_apclearence:string, artikel_apclearence:int, usr_id:int):
