...
def hk_count_webbl(pvilanguage:int):
    ...
    def init_var():
        ...
        res_line = Res_line()
        zimmer = Zimmer()
        for res_line.gastnrmember, res_line.zinr, res_line.erwachs, res_line.gratis, res_line.kind1, res_line.kind2, res_line.l_zuordnung, res_line.abreise, res_line.zipreis, res_line.resstatus, res_line.bemerk, res_line.ankzeit, res_line.zikatnr, res_line.zimmeranz, res_line.zimmer_wunsch, res_line.ankunft, res_line._recid, zimmer.zikatnr, zimmer.zinr, zimmer.zistatus, zimmer.sleeping, zimmer._recid in db_session.query(Res_line.gastnrmember, Res_line.zinr, Res_line.erwachs, Res_line.gratis, Res_line.kind1, Res_line.kind2, Res_line.l_zuordnung, Res_line.abreise, Res_line.zipreis, Res_line.resstatus, Res_line.bemerk, Res_line.ankzeit, Res_line.zikatnr, Res_line.zimmeranz, Res_line.zimmer_wunsch, Res_line.ankunft, Res_line._recid, Zimmer.zikatnr, Zimmer.zinr, Zimmer.zistatus, Zimmer.sleeping, Zimmer._recid).join(Zimmer,(Zimmer.zinr == Res_line.zinr)).filter(
