...
def prepare_rmcat_ratebl():
    ...
    t_arrangement_list, T_arrangement = create_model("T_arrangement", {"arrangement":string, "argtnr":int})
    t_zimkateg_list, T_zimkateg = create_model_like(Zimkateg)
    q1_list_list, Q1_list = create_model("Q1_list", {"betriebsnr":int, "kurzbez":string, "arrangement":string, "startperiode":date, "endperiode":date, "perspreis1":Decimal, "perspreis2":Decimal, "perspreis3":Decimal, "perspreis4":Decimal, "kindpreis1":Decimal, "kindpreis2":Decimal, "zikatnr":int, "argtnr":int, "katpreis_recid":int})
    ...
    def generate_output():
        ...
        return {"q1-list": q1_list_list, "t-zimkateg": t_zimkateg_list, "t-arrangement": t_arrangement_list}
