...
adhoc_list, Adhoc = create_model("Adhoc", {"acode":string, "artnr":int, "deptnr":int, "bezeich":string, "amount":Decimal, "child1":Decimal, "child2":Decimal, "post_type":int})

def argt_frate_fill_adhocbl(pvilanguage:int, adhoc_code:string, argtnr:int, resnr:int, reslinnr:int, from_date:date, to_date:date, adhoc_list:[Adhoc]):
    ...
    argt_list_list, Argt_list = create_model("Argt_list", {"argt_artnr":int, "bezeich":string, "departement":int, "deci1":Decimal, "date1":date, "date2":date, "deci2":Decimal, "deci3":Decimal, "post_type":string, "pers_type":string, "fakt_modus":int, "s_recid":int})
