...
def eg_rephistoryprop_detail_webbl(case_type:int, reqno:int):
    ...
    t_artikel_cost_list, T_artikel_cost = create_model("T_artikel_cost", {"reqno":string, "art_no":string, "art_desc":string, "art_qty":string, "art_price":string, "art_total":string, "tflag":string})
    t_vendor_cost_list, T_vendor_cost = create_model("T_vendor_cost", {"reqno":string, "vend_no":string, "vend_desc":string, "vend_start":string, "vend_finish":string, "vend_price":string, "tflag":string})
