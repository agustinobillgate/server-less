...
def rest_billjourn_journal_list1_webbl(from_art:int, from_dept:int, to_dept:int, from_date:date, to_date:date, price_decimal:int, excl_paydisc:bool):
    ...
    def generate_output():
        nonlocal booking_journbill_list_list, disc_art1, disc_art2, disc_art3, guest, htparam, h_journal, hoteldpt, h_artikel, h_bill, res_line
