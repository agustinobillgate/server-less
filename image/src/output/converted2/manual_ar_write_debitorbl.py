...
def manual_ar_write_debitorbl(case_type:int, t_debitor_list:[T_debitor]):
    ...
    t_debitor = query(t_debitor_list, first=True)
    ...
    if case_type == 1:
        ...
        debitor = get_cache (Debitor, {"_recid": [(eq, t_debitor.tb_recid)]})
