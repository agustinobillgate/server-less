...
s_list_list, S_list = create_model("S_list", {"grpname":string, "ankunft":date, "abreise":date, "anzahl":int})

def create_group_seriesbl(pvilanguage:int, resno:int, user_init:string, s_list_list:[S_list]):
