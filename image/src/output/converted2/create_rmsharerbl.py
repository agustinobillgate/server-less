...
s_list_list, S_list = create_model("S_list", {"name":string, "nat":string, "ankunft":date, "abreise":date, "sharerflag":bool, "accompflag":bool, "added":bool, "gastnr":int})

def create_rmsharerbl(s_list_list:[S_list], user_init:string, lname:string, fname:string, ftitle:string, mresnr:int, mreslinnr:int):
