...
def ts_hbline_get_taxservice_webbl(vmode:int, menu_nr:int, dept:int, artnr:int, price:Decimal, anzahl:int, incl_vat:bool, amount:Decimal, t_amount_list_list:[T_amount_list]):
    ...
    def generate_output():
        ...
        return {"amount": amount, "t-amount-list": t_amount_list_list}
