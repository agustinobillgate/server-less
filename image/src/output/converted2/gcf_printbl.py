...
def gcf_printbl(pvilanguage:int, fl_list:bool, city:string, sorttype:int, from_name:string, to_name:string, segm_all:bool, paytype:int, prtype:int, fl_email:bool, segmentcode:int):
    ...
    gcf_print2_list, Gcf_print2 = create_model_like(Guest, {"ratecode":string, "memberno":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal output_list_list, gcf_print2_list, anzahl, lvcarea, guest, guestseg, guest_pr, mc_guest
