...
def prepare_tada_mapping_1bl(dept:int):
    ...
    crd_list_list, Crd_list = create_model("Crd_list", {"deptno":int, "uname":string, "pass":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal t_dept_list, t_queasy270_list, vhp_art_list, t_article_list, crd_list_list, queasy, hoteldpt, h_artikel
        nonlocal dept


        nonlocal t_dept, t_queasy270, vhp_art, t_article, crd_list
        nonlocal t_dept_list, t_queasy270_list, vhp_art_list, t_article_list, crd_list_list

        return {"t-dept": t_dept_list, "t-queasy270": t_queasy270_list, "vhp-art": vhp_art_list, "t-article": t_article_list, "crd-list": crd_list_list}
