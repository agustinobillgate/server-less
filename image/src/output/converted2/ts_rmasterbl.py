...
def ts_rmasterbl(h_recid:int):
    ...
    q1_list_list, Q1_list = create_model("Q1_list", {"rechnr":int, "gastnr":int, "bill_name":string, "name":string, "anredefirma":string, "groupname":string, "saldo":Decimal, "rec_id":int})
