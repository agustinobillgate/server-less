...
def inv_adjustlist_btn_gobl(sorttype:int, curr_lager:int, from_grp:int, transdate:date):
    ...
    c_list_list, C_list = create_model("C_list", {"artnr":int, "bezeich":string, "munit":string, "inhalt":Decimal, "zwkum":int, "endkum":int, "qty":Decimal, "qty1":Decimal, "amount":Decimal, "avrg_amount":Decimal, "fibukonto":string, "cost_center":string, "variance":Decimal}, {"fibukonto": "0000000000"})
