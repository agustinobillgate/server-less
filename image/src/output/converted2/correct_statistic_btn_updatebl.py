...
genlist_list, Genlist = create_model_like(Genstat, {"rsv_name":string, "nat_str":string, "ctry_str":string, "source_str":string, "segment_str":string, "rec_gen":int})

def correct_statistic_btn_updatebl(genlist_list:[Genlist], rec_gen:int, user_init:string):
