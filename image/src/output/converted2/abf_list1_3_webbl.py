...
def abf_list1_3_webbl(fdate:date, bfast_artnr:int, bfast_dept:int, show_bfast_rate:bool, zikat_list_list:[Zikat_list]):
    ...
    def generate_output():
        nonlocal abf_list_list, diffcidate, p_87, num_of_day, exchg_rate, res_line, genstat, arrangement, artikel, argt_line, reslin_queasy, fixleist, guest, reservation, segment, ratecode, mc_guest, mc_types, mealcoup, waehrung, bill, master
