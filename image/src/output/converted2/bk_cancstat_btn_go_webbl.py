...
def bk_cancstat_btn_go_webbl(sorttype:int, fdate:date, tdate:date):
    ...
    f_list_list, F_list = create_model("F_list", {"bname":string, "room":string, "id":string, "event":string, "cdate":date, "cancel":date, "pax":int, "rmrev":Decimal, "fbrev":Decimal, "otrev":Decimal, "totrev":Decimal})
    output_list_list, Output_list = create_model("Output_list", {"flag":string, "bezeich":string, "room":string, "id":string, "ba_event":string, "datum":date, "cancel":date, "pax":int, "rmrev":Decimal, "fbrev":Decimal, "othrev":Decimal, "totrev":Decimal})
    ...
    def generate_output():
        nonlocal output_list_list, str1, totrmrev, totfbrev, totother, totrev, totpax, subrmrev, subfbrev, subother, subrev, subpax, guest, bediener, bk_raum, ba_typ, bk_stat
