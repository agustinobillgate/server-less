...
def selforder_viewordered_itembl(user_init:string, dept:int, table_no:int, session_parameter:string):
    ...
    for ordered_item in query(ordered_item_list, sort_by=[("order_nr",False)]):
    ...
    for ordered_item in query(ordered_item_list, filters=(lambda ordered_item: ordered_item.count_amount), sort_by=[("order_nr",False)]):
