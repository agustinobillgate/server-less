...
def pj_inhouse2_btn_go_2_webbl(sorttype:int, datum:date, curr_date:date, curr_gastnr:int, froom:string, troom:string, exc_depart:bool, incl_gcomment:bool, incl_rsvcomment:bool, prog_name:string, disp_accompany:bool, disp_exclinact:bool):
    output_list_list = []
    summary_list1_list = []
    summary_list2_list = []
    summary_list3_list = []
    ...
    output_list_list, Output_list = create_model("Output_list", {"flag":int, "karteityp":int, "nr":int, "vip":string, "resnr":int, "name":string, "groupname":string, "rmno":string, "qty":int, "arrive":date, "depart":date, "rmcat":string, "ratecode":string, "zipreis":Decimal, "kurzbez":string, "bezeich":string, "a":int, "c":int, "co":int, "pax":string, "nat":string, "nation":string, "argt":string, "company":string, "flight":string, "etd":string, "paym":int, "segm":string, "telefon":string, "mobil_tel":string, "created":date, "createid":string, "bemerk":string, "bemerk01":string, "bemerk02":string, "bemerk03":string, "bemerk04":string, "bemerk05":string, "bemerk06":string, "bemerk07":string, "bemerk08":string, "bemerk1":string, "ci_time":string, "curr":string, "spreq":string, "tot_bfast":int, "local_reg":string, "memberno":string, "membertype":string, "email":string, "ac":string, "stay":int})
    ...
    def generate_output():
        ...
        nonlocal sorttype, datum, curr_date, curr_gastnr, froom, troom, exc_depart, incl_gcomment, incl_rsvcomment, prog_name, disp_accompany, disp_exclinact
    ...
    def create_inhouse_v2():
        ...
        tot_payrm, tot_rm, tot_a, tot_c, tot_co, tot_avail, tot_rmqty, inactive, cl_list_list, s_list_list, t_buff_queasy_list = get_output(pj_inhouse2_btn_go_2bl(sorttype, datum, curr_date, curr_gastnr, froom, troom, exc_depart, incl_gcomment, incl_rsvcomment, "PJ-inhouse2", disp_accompany, disp_exclinact))
        C_list = Cl_list
