...
op_list_list, Op_list = create_model_like(Fa_op, {"name":string, "location":string})

def fa_stin_btn_gobl(op_list_list:[Op_list], billdate:date, user_init:string, lscheinnr:string, lief_nr:int):
