...
def abf_list3_webbl(fdate:date, bfast_artnr:int, bfast_dept:int, incl_accom:bool, incl_guarantee:bool, zikat_list_list:[Zikat_list]):
    ...
    def generate_output():
        nonlocal abf_list_list, mxtime_dayuse, param_561, diffcidate, p_87, num_of_day, htparam, res_line, arrangement, artikel, argt_line, reslin_queasy, fixleist, guest, reservation, segment, ratecode, mc_guest, mc_types, mealcoup, bill, master
