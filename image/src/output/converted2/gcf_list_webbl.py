...
def gcf_list_webbl(case_type:int, sorttype:int, lname:string, fname:string, num1:int):
    ...
    def generate_output():
        nonlocal first_gastnr, curr_lname, curr_fname, total_record, t_guest_list, counter, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, vipnr10, priority_flag, guest, akt_kont, mc_guest, segment, guestseg, cl_member, guest_pr, ratecode, htparam
