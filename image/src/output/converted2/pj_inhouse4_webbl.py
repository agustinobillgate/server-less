...
def pj_inhouse4_webbl(sorttype:int, from_date:date, to_date:date, froom:string, troom:string, exc_depart:bool, incl_gcomment:bool, incl_rsvcomment:bool, disp_accompany:bool, idflag:string):
    ...
    def generate_output():
        ...
        nonlocal inhouse_guest_list_list, output_list_list, s_list_list, zikat_list_list, t_buff_queasy_list
    ...
    inhouse_guest_list = query(inhouse_guest_list_list, first=True)
    while None != inhouse_guest_list:
        ...
        inhouse_guest_list = query(inhouse_guest_list_list, next=True)
