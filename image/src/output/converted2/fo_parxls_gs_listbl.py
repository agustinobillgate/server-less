...
def fo_parxls_gs_listbl(pvilanguage:int, briefnr:int, from_date:date, to_date:date, link:string):
    ...
    if prog_error:
        ...
        return generate_output()
    msg_str, error_nr = get_output(fo_parxls_gsbl(pvilanguage, ytd_flag, jan1, ljan1, lfrom_date, lto_date, pfrom_date, pto_date, from_date, to_date, start_date, lytd_flag, lmtd_flag, pmtd_flag, lytoday_flag, lytoday, foreign_flag, budget_flag, foreign_nr, price_decimal, briefnr, link, budget_all, w1_list, w2_list))
