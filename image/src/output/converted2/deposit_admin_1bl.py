...
def deposit_admin_1bl(case_type:int, depo_foreign:bool, lname:string, deposittype:int, sorttype:int, lresnr:int, fdate:date, ex_rate:Decimal, bill_date:date, depo_curr:int):
    ...
    def generate_output():
        nonlocal total_saldo, arriv_saldo, depo_list_list, b1_list_list, b1_print_list, grpstr, res_line, exrate, reservation, waehrung, arrangement, zimkateg, fixleist
