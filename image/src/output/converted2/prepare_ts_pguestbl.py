...
def prepare_ts_pguestbl():
    ...
    pguest_list_list, Pguest_list = create_model("Pguest_list", {"ankunft":date, "abreise":date, "nation1":string, "zinr":string, "gname":string, "pin_code":string, "kreditlimit":Decimal, "saldo":Decimal, "s_recid":int})
