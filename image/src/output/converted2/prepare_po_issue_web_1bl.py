...
def prepare_po_issue_web_1bl(pvilanguage:int, lief_nr:int, user_init:string, docu_nr:string):
    ...
    t_l_order_list, T_l_order = create_model_like(L_order, {"rec_id":int, "a_bezeich":string, "jahrgang":int, "alkoholgrad":Decimal, "curr_disc":int, "curr_disc2":int, "curr_vat":int, "add_vat":Decimal, "addvat_no":int, "addvat_value":Decimal, "amount":Decimal, "traubensorte":string, "masseinheit":string})
