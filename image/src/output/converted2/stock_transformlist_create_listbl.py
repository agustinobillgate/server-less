...
def stock_transformlist_create_listbl(from_date:date, to_date:date, from_art:int, to_art:int):
    ...
    t_list_list, T_list = create_model("T_list", {"datum":date, "lscheinnr":string, "f_bezeich":string, "t_bezeich":string, "artnr":string, "bezeich":string, "einheit":string, "content":Decimal, "price":string, "qty":Decimal, "s_qty":string, "op_art":int, "val":Decimal})
