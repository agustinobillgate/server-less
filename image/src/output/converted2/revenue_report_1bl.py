...
def revenue_report_1bl(sorttype:int, long_digit:bool, short_flag:bool, from_date:date, to_date:date):
    ...
    output_list_list, Output_list = create_model("Output_list", {"flag":string, "str":string, "bezeich":string, "tnett":Decimal, "mtd":Decimal, "mtd_budget":Decimal, "ytd_budget":Decimal, "lmon_mtd":Decimal, "lyear_mtd":Decimal, "lyear_ytd":Decimal})
