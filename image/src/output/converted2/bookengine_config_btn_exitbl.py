...
def bookengine_config_btn_exitbl(user_init:string, bookengid:int, autostart:bool, period:int, delay:int, hotelcode:string, username:string, password:string, liveflag:bool, defcurr:string, pushrateflag:bool, pullbookflag:bool, pushavailflag:bool, workpath:string, progavail:string):
    ...
    t_list_list, T_list = create_model("T_list", {"autostart":bool, "period":int, "delay":int, "hotelcode":string, "username":string, "password":string, "liveflag":bool, "defcurr":string, "pushrateflag":bool, "pullbookflag":bool, "pushavailflag":bool, "workpath":string, "progavail":string, "prog_avail_update":string, "dyna_code":string, "pushratebypax":bool, "uppercasename":bool, "delayrate":int, "delaypull":int, "delayavail":int, "pushall":bool, "re_calculate":bool, "restriction":bool, "allotment":bool, "pax":int, "bedsetup":bool, "pushbookflag":bool, "delaypushbook":int, "vcwsagent":string, "vcwsagent2":string, "vcwsagent3":string, "vcwsagent4":string, "vcwebhost":string, "vcwebport":string, "email":string, "vcwsagent5":string, "incl_tentative":bool, "restrictionfullsync":bool, "crm_combo":bool})
