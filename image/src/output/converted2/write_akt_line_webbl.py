...
def write_akt_line_webbl(case_type:int, file_mode:int, base64file:string, user_init:string, akt_line1_list:[Akt_line1]):
    success_flag = False
    result_message = ""
    curr_counter:int = 0
    akt_line = None
    ...
    def generate_output():
        ...
        nonlocal case_type, file_mode, base64file, user_init, akt_line1_list
