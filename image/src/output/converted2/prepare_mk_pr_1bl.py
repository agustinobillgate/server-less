...
def prepare_mk_pr_1bl(docu_nr:string, tp_bediener_user_group:int, tp_bediener_username:string, dml_flag:bool, dml_grp:int, dml_datum:date, cost_acct:string):
    ...
    t_l_artikel_list, T_l_artikel = create_model("T_l_artikel", {"rec_id":int, "artnr":int, "bezeich":string, "betriebsnr":int, "traubensort":string, "lief_einheit":Decimal, "jahrgang":int, "inhalt":Decimal, "masseinheit":string, "zwkum":int, "soh":Decimal})
    ...
    def generate_output():
        ...
        return {"docu_nr": docu_nr, "billdate": billdate, "eng_dept": eng_dept, "pos": pos, "dml_created": dml_created, "p_370": p_370, "t-l-orderhdr": t_l_orderhdr_list, "s-list": s_list_list, "t-l-artikel": t_l_artikel_list, "t-parameters": t_parameters_list}
