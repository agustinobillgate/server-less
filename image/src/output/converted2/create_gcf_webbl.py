...
def create_gcf_webbl(gnat:str, gland:str, def_natcode:str, gastid:str, name:str, fname:str, ftitle:str, user_init:str, gphone:str, gastno:int, selected_gastnr:int, res_nr:int):
    ...
    def create_gcf():
        ...
        reservation = db_session.query(Reservation).filter(
                 (Reservation.resnr == res_nr)).first()
        curr_gastnr = 0
