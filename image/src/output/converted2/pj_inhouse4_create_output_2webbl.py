...
def pj_inhouse4_create_output_2webbl(idflag:string, inhouse_guest_list_list:[Inhouse_guest_list]):
    ...
    tot_list_list, Tot_list = create_model("Tot_list", {"tot_payrm":string, "tot_rm":string, "tot_a":string, "tot_c":string, "tot_co":string, "tot_avail":string, "inactive":string, "tot_keycard":string})
    ...
    def generate_output():
        nonlocal doneflag, summary_roomtype_list, summary_nation_list, summary_revenue_list, summary_segment_list, tot_list_list, summary_list4_list, counter, htl_no, temp_char, queasy, paramtext
        nonlocal idflag
        ...
        nonlocal summary_roomtype_list, summary_nation_list, summary_revenue_list, summary_segment_list, summary_list4_list, sum_list_list, tot_list_list

        return {"doneflag": doneflag, "summary-roomtype": summary_roomtype_list, "summary-nation": summary_nation_list, "summary-revenue": summary_revenue_list, "summary-segment": summary_segment_list, "tot-list": tot_list_list, "summary-list4": summary_list4_list, "inhouse-guest-list": inhouse_guest_list_list}
