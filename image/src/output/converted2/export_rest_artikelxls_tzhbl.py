...
def export_rest_artikelxls_tzhbl():
    ...
    rest_maingroup_list_list, Rest_maingroup_list = create_model("Rest_maingroup_list", {"maingroup_no":int, "maingroup_desc":string})
    rest_subgroup_list_list, Rest_subgroup_list = create_model("Rest_subgroup_list", {"dept_no":int, "dept_name":string, "subgroup_no":int, "subgroup_desc":string, "subgroup_prior":int, "subgroup_bgcol":int})
