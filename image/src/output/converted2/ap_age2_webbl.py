...
def ap_age2_webbl(pvilanguage:int, to_date:date, from_name:str, to_name:str, mi_bill:bool, segm:int, curr_disp:int, round_zero:bool):
    apage_list_list = []
    tt_no:str = ""
    tt_supp:str = ""
    tt_saldo:str = ""
    ...
    apage_list_list, Apage_list = create_model("Apage_list", {"docu_nr":str, "lschein":str, "rgdatum":str, "rechnr":str, "ag_datum":str, "overdue":str, "term_pay":str})
    age_list_list, Age_list = create_model("Age_list", {"artnr":int, "rechnr":str, "lschein":str, "counter":int, "lief_nr":int, "rgdatum":date, "firma":str, "voucher_no":int, "p_bal":decimal, "debit":decimal, "credit":decimal, "saldo":decimal, "debt0":decimal, "debt1":decimal, "debt2":decimal, "debt3":decimal, "tot_debt":decimal, "ap_term":int})
            ...
            if do_it:
                ...
                if queasy:
                    ...
                    l_orderhdr = db_session.query(L_orderhdr).filter(
                             (L_orderhdr.docu_nr == l_kredit.name)).first()
    ...
    def fill_in_list(fill_billno:bool, curr_po:str, curr_lschein:str, curr_rgdatum:str, voucher_no:str, agdatum:str, overdatum:str, termof_pay:str):
