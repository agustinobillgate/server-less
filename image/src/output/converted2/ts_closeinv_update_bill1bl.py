...
def ts_closeinv_update_bill1bl(amount:Decimal, amount_foreign:Decimal, rec_kellner:int, rec_h_bill:int, double_currency:bool, exchg_rate:Decimal, bilrecid:int, value_sign:int, user_init:string, bill_date:date, curr_select:int, price_decimal:int):
    ...
    def generate_output():
        ...
        return {"amount": amount, "amount_foreign": amount_foreign, "billart": billart, "qty": qty, "description": description, "cancel_str": cancel_str, "t-h-bill": t_h_bill_list}
    ...
    def cal_vat_amount():
        ...
        nonlocal billart, qty, description, cancel_str, t_h_bill_list, vat_amount, h_bill, kellner, htparam, artikel, bill, counters, bill_line, billjournal, h_bill_line, h_artikel, h_journal
    ...
    def cal_vatamt(value_sign:int, vatproz:Decimal):
        ...
        nonlocal billart, description, cancel_str, t_h_bill_list, multi_vat, vat_amount, h_bill, kellner, htparam, artikel, bill, counters, bill_line, billjournal, h_bill_line, h_artikel, h_journal
