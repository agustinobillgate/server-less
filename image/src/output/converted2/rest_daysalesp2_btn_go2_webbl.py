...
from functions.rest_daysalesp2_btn_go_5_cldbl import rest_daysalesp2_btn_go_5_cldbl
...
def rest_daysalesp2_btn_go2_webbl(bline_list_list:[Bline_list], buf_art_list:[Buf_art], disc_art1:int, disc_art2:int, disc_art3:int, curr_dept:int, all_user:bool, shift:int, from_date:date, to_date:date, art_str:string, voucher_art:int, zero_vat_compli:bool, show_fbodisc:bool, exclude_compli:bool, incl_move_table:bool, v_wig:bool, v_inhouse:bool):
    errcode = ""
    ...
    def generate_output():
        ...
        nonlocal disc_art1, disc_art2, disc_art3, curr_dept, all_user, shift, from_date, to_date, art_str, voucher_art, zero_vat_compli, show_fbodisc, exclude_compli, incl_move_table, v_wig, v_inhouse


        nonlocal bline_list, outstand_list, pay_list, turnover, t_tot_betrag, t_nt_betrag, buf_art, summ_list
        nonlocal outstand_list_list, pay_list_list, turnover_list, t_tot_betrag_list, t_nt_betrag_list, summ_list_list
    ...
    if bline_list:
        turnover_list.clear()
        t_betrag, t_foreign, exchg_rate, tot_serv, tot_tax, tot_debit, tot_cash, tot_cash1, tot_trans, tot_ledger, tot_cover, nt_cover, tot_other, nt_other, nt_serv, nt_tax, nt_debit, nt_cash, nt_cash1, nt_trans, nt_ledger, tot_vat, nt_vat, avail_outstand_list, turnover_list, t_tot_betrag_list, t_nt_betrag_list, outstand_list_list, pay_list_list, summ_list_list = get_output(rest_daysalesp2_btn_go_5_cldbl(bline_list_list, buf_art_list, disc_art1, disc_art2, disc_art3, curr_dept, all_user, shift, from_date, to_date, art_str, voucher_art, zero_vat_compli, exclude_compli, show_fbodisc, curr_dept, incl_move_table, v_wig, v_inhouse))
