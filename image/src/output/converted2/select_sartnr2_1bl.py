...
def select_sartnr2_1bl(curr_lager:int, recipe:bool, sorttype:int, s_artnr:int, s_bezeich:string):
    ...
    sartnr_list_list, Sartnr_list = create_model("Sartnr_list", {"artnr":int, "bezeich":string, "anz_anf_best":Decimal, "anz_eingang":Decimal, "anz_ausgang":Decimal, "masseinheit":string, "is_receipt":bool, "hrecipe_nr":int})
