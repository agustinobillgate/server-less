...
def sls_bystage_btn_go_listbl(pvilanguage:int, next_date:date, to_date:date, all_flag:bool, usr_init:string):
    ...
    p_list_list, P_list = create_model("P_list", {"pnr":int, "sflag":int, "code_name":string, "pcomp":string, "pcont":string, "pname":string, "pntot":string, "pnam1":string, "pnam2":string, "pnam3":string, "pnam4":string, "pamt":Decimal, "pamt1":Decimal, "pamt2":Decimal, "pamt3":Decimal, "pamt4":Decimal, "patot":Decimal, "pamt_str":string, "stage":int, "proz":string, "popen":date, "pfnsh":date, "pmain1":string, "pmain2":string, "pmain3":string, "reason":string, "refer":string, "pid":string, "pcid":string, "ctotal":int})
    slstage_list_list, Slstage_list = create_model("Slstage_list", {"pnr":int, "sflag":int, "code_name":string, "pcomp":string, "pcont":string, "pname":string, "pntot":string, "pnam1":string, "pnam2":string, "pnam3":string, "pnam4":string, "pamt":Decimal, "pamt1":Decimal, "pamt2":Decimal, "pamt3":Decimal, "pamt4":Decimal, "patot":Decimal, "pamt_str":string, "stage":int, "proz":string, "popen":date, "pfnsh":date, "pmain1":string, "pmain2":string, "pmain3":string, "reason":string, "refer":string, "pid":string, "pcid":string, "ctotal":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal slstage_list_list, lvcarea, akt_code, guest, akthdr, akt_kont
        nonlocal pvilanguage, next_date, to_date, all_flag, usr_init


        nonlocal p_list, slstage_list
        nonlocal p_list_list, slstage_list_list

        return {"slstage-list": slstage_list_list}
    ...
    def fill_stage():
        ...
        for p_list in query(p_list_list):
            ...
            slstage_list_list.append(slstage_list)
