...
def ar_age1_1_webbl(pvilanguage:int, case_type:int, mtd_flag:bool, to_date:date, fdate:date, tdate:date, from_art:int, to_art:int, from_name:string, to_name:string, disptype:int, mi_bill:bool, day1:int, day2:int, day3:int, detailed:bool):
    ...
    arage_balance_list_list, Arage_balance_list = create_model("Arage_balance_list", {"strdate":string, "curr":string, "gastnr":int, "artnr":int, "age1":string, "age2":string, "age3":string, "age4":string, "rechnr":string, "num":string, "cust_nm":string, "p_bal":string, "debit":string, "credit":string, "end_bal":string})
    arage_list_list, Arage_list = create_model("Arage_list", {"strdate":string, "curr":string, "gastnr":int, "artnr":int, "age1":string, "age2":string, "age3":string, "age4":string, "rechnr":string, "str":string})
    age_list_list, Age_list = create_model("Age_list", {"fcurr":string, "artnr":int, "rechnr":int, "counter":int, "gastnr":int, "rgdatum":date, "gastname":string, "p_bal":Decimal, "debit":Decimal, "credit":Decimal, "saldo":Decimal, "debt0":Decimal, "debt1":Decimal, "debt2":Decimal, "debt3":Decimal, "tot_debt":Decimal})
    ...
    for arage_list in query(arage_list_list, filters=(lambda arage_list: arage_list.substring(arage_list.str, 0, 7) != ("-------").lower())):
