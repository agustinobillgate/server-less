...
def sel_copymaintenance_btn_okbl(property_list:[Property], maintain_nr:int, all_main:bool, all_only:bool, fdate:date, tdate:date, stnumber:int, lsnumber:int, user_init:string, blcpy:int, lsno:int, stno:int):
