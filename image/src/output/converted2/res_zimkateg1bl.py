...
def res_zimkateg1bl(datum:date, origcode:string, prcode:string, curr_marknr:int):
    ...
    s_list_list, S_list = create_model("S_list", {"zikatnr":int, "kurzbez":string, "bezeichnung":string, "reihenfolge":int, "flag":int, "marknr":int, "market":string, "contcode":string, "kurzbez1":string, "setup":string, "nr":int})
    ...
    def generate_output():
        ...
        return {"prcode": prcode, "s-list": s_list_list}
