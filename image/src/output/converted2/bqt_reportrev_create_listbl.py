...
def bqt_reportrev_create_listbl(from_date:date, to_date:date):
    ...
    output_list_list, Output_list = create_model("Output_list", {"company":string, "booker":string, "datum":date, "room":string, "resnr":int, "sales":string, "cmid":string, "rm_rev":Decimal, "fb_rev":Decimal, "other_rev":Decimal, "tot_rev":Decimal})
