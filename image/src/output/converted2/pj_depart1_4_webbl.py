...
def pj_depart1_4_webbl(pvilanguage:int, case_type:int, disptype:int, fdate:date, tdate:date, froom:string, troom:string, disp_accompany:bool, ota_only:bool, setup_list_list:[Setup_list], zikat_list_list:[Zikat_list]):
    ...
    def generate_output():
        nonlocal tot_rm, tot_a, tot_c, tot_co, str_list_list, s_list_list, cl_list_list, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, all_remark, curr_zinr, lvcarea, guest, reservation, res_line, history, guestseg, reslin_queasy, nation, bill, mc_guest, mc_types
        nonlocal pvilanguage, case_type, disptype, fdate, tdate, froom, troom, disp_accompany, ota_only
