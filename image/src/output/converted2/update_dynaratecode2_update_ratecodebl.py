...
def update_dynaratecode2_update_ratecodebl(rate_list1_list:[Rate_list1], avail_room:string, chg_wday:int, from_date:date, f_date:date, to_date:date, inp_str:string, contrate_value:string, rmtype:string, user_init:string):
    ...
    def generate_output():
        ...
        nonlocal rate_list1_list, avail_room, chg_wday, from_date, f_date, to_date, inp_str, contrate_value, rmtype, user_init
