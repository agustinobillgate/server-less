...
def segmstat_1_listbl(from_date:date, to_date:date):
    ...
    t_segmstat_list_list, T_segmstat_list = create_model("T_segmstat_list", {"descrip":string, "room_ytd":int, "budget_ytd":int, "percent_ytd":string, "g_room_ytd":int, "g_budget_ytd":int, "g_percent_ytd":string, "t_room_ytd":Decimal, "t_budget_ytd":Decimal, "t_percent_ytd":string})
    ...
    for t_segmstat_list in query(t_segmstat_list_list):
        segmstat_list = query(segmstat_list_list, (lambda segmstat_list: segmstat_list.descrip == t_segmstat_list.descrip), first=True)
