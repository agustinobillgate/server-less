...
def eg_chgreq_create_actionbl(intmaintask:int, treqdetail_list:[Treqdetail]):
    ...
    taction_list, Taction = create_model("Taction", {"act_nr":int, "act_nm":string, "selected":bool, "str_sel":string})
