...
def gcjour_listbl(case_type:int, from_refno:string, sorttype:int, journaltype:int, jtype1:int, from_date:date, to_date:date):
    ...
    gl_jouhdr_list_list, Gl_jouhdr_list = create_model("Gl_jouhdr_list", {"datum":date, "refno":string, "bezeich":string, "debit":Decimal, "credit":Decimal, "remain":Decimal, "jnr":int, "activeflag":int})
