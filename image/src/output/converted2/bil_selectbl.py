...
def bil_selectbl(pvilanguage:int, sorttype:int, zinr:string, bil_int:int, curr_gastnr:int, ci_date:date, gastname:string, to_name:string, rechnr:int):
    ...
    b1_list_list, B1_list = create_model("B1_list", {"zinr":string, "billnr":int, "rechnr":int, "name":string, "saldo":Decimal, "resnr":int, "reslinnr":int, "datum":date, "printnr":int, "vesrcod":string, "rec_id":int, "fg_col":bool, "resname":string, "address":string, "city":string, "b_comments":string, "guest_name":string})
