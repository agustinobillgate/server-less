...
def mk_po_btn_go1_web_1bl(t_l_orderhdr_list:[T_l_orderhdr], t_l_order_list:[T_l_order], docu_nr:string, lief_nr:int, billdate:date, create_new:bool, pr:string, globaldisc:Decimal, currency_screen_value:string, zeroprice_flag:bool):
