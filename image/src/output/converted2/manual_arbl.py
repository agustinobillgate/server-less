...
s_list_list, S_list = create_model("S_list", {"fibukonto":string, "debit":Decimal, "credit":Decimal}, {"fibukonto": "000000000000"})

def manual_arbl(pvilanguage:int, s_list_list:[S_list], rgdatum:date, firma:string, art_fibukonto:string, user_init:string, invoice:int, saldo:Decimal, refno:string):
