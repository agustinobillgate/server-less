...
def gcf_listbl(case_type:int, sorttype:int, lname:string, fname:string, num1:int):
    ...
    def generate_output():
        nonlocal first_gastnr, curr_lname, curr_fname, t_guest_list, counter, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, htplogic, htparam, guest, mc_guest, segment, guestseg, cl_member, guest_pr, ratecode
