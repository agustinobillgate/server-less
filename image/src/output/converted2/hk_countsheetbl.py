...
def hk_countsheetbl(pvilanguage:int):
    ...
    out_list_list, Out_list = create_model("Out_list", {"seq":int, "etage":int, "stat":int, "i":int, "flag":int, "anz":int, "name":string, "str":string, "sum":int, "str1":string, "room":string, "pax":string})
