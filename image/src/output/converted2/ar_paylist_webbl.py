...
def ar_paylist_webbl(comment:string, cledger:bool, ccard:bool, last_sort:int, from_date:date, to_date:date, from_art:int, to_art:int, mi_payment:bool, mi_transfer:bool, show_inv:bool):
    ...
    output_list_list, Output_list = create_model("Output_list", {"artnr":int, "pay_count":int, "flag":int, "pay_amt":Decimal, "dbetrag":Decimal, "sbetrag":string, "inv_no":string, "str":string, "bill_art":int, "debt_counter":int})
    t_ar_paylist_list, T_ar_paylist = create_model("T_ar_paylist", {"bill_date":string, "bill_num":string, "inv_num":string, "bill_rcv":string, "debt_amt":string, "pay_amt":string, "pay_famt":string, "curr":string, "pay_art":string, "pay_date":string, "uid":string, "pay_comment":string, "tot_pay":string, "artno":string, "debt_counter":string})
