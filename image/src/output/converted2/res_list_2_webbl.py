...
def res_list_2_webbl(case_type:int, from_date:date, to_date:date, resnr:int, gastnr:int, search_resno:int, search_voucher:string, search_prcode:string):
    ...
    def generate_output():
        nonlocal curr_select, res_listmain_list, res_listmember_list, vip_nr, res_bemerk, loopk, prcode, i, htparam, zimkateg, res_line, guest, reservation, segment, sourccod, reslin_queasy, guestseg
