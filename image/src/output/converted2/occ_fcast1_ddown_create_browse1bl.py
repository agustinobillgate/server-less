...
def occ_fcast1_ddown_create_browse1bl(case_type:int, datum:date, curr_date:date, to_date:date, all_segm:bool, all_argt:bool, all_zikat:bool, incl_tent:bool, exclooo:bool, argt_list_list:[Argt_list], segm_list_list:[Segm_list], zikat_list_list:[Zikat_list]):
