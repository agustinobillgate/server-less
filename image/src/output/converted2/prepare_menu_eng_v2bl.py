...
def prepare_menu_eng_v2bl(from_dept:int, to_dept:int):
    ...
    def generate_output():
        ...
        return {"from_dept": from_dept, "to_dept": to_dept, "to_date": to_date, "from_date": from_date, "vat_included": vat_included, "depname1": depname1, "depname2": depname2, "ldry_dept": ldry_dept, "double_currency": double_currency, "exchg_rate": exchg_rate, "t-hoteldpt": t_hoteldpt_list, "t-wgrpdep": t_wgrpdep_list}
