...
def disable_totpbl(user_init:string, user_init_will_disable:string, userotp:string, reason:string):
    ...
    def generate_output():
        nonlocal result_message, totpok, epoch_signature, signature_list_list, secretkey, generatedotp, cmd, result, returnstatus, foldername, filename, bediener, queasy, res_history, paramtext
        ...
        return {"result_message": result_message, "totpok": totpok, "epoch_signature": epoch_signature, "signature-list": signature_list_list}
    ...
    if opr_bediener:
        ...
        if matches(opr_bediener.username,r"*sindata*"):
            ...
            if bediener:
                ...
                epoch_signature, signature_list_list = create_signature(opr_bediener.username, value_list_list)
        else:
        ...
        epoch_signature, signature_list_list = create_signature("", value_list_list)
