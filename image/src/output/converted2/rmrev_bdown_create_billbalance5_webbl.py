...
input_list_list, Input_list = create_model("Input_list", {"exc_taxserv":bool, "pvilanguage":int, "new_contrate":bool, "foreign_rate":bool, "price_decimal":int, "fdate":date, "tdate":date, "srttype":int, "id_flag":string})

def rmrev_bdown_create_billbalance5_webbl(input_list_list:[Input_list]):
    ...
    def generate_output():
        nonlocal cl_list_list, currency_list_list, sum_list_list, s_list_list, argt_list_list, done_flag, exchg_rate, frate, post_it, total_rev, argt_line, waehrung, queasy
        ...
        return {"cl-list": cl_list_list, "currency-list": currency_list_list, "sum-list": sum_list_list, "s-list": s_list_list, "argt-list": argt_list_list, "done_flag": done_flag}
