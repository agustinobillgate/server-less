...
def stock_outlist_print_outgoingbl(s_op_recid:int, from_grp:int, show_price:bool):
    ...
    print_list_list, Print_list = create_model("Print_list", {"datum":date, "lager_nr":int, "artnr":int, "bezeich":string, "anzahl":Decimal, "gl_bezeich":string, "preis":Decimal, "wert":Decimal})
