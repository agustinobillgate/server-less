...
def ts_splitbill_move_tablebl(temp_list:[Temp], rhbline_list:[Rhbline], tableno:int, bilrecid:int, new_waiter:int, rec_id:int, curr_waiter:int, dept:int, tischnr:int):
    ...
    def move_table():
        ...
        for temp in query(temp_list):
            ...
            rhbline = query(rhbline_list, filters=(lambda rhbline: rhbline.Rhbline.nr == temp.pos), first=True)
