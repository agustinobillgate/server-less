...
def prepare_fa_artlist_create_output_webbl(idflag:string, q1_list_list:[Q1_list], fibu_list_list:[Fibu_list]):
    doneflag = False
    counter:int = 0
    htl_no:string = ""
    temp_char:string = ""
    ...
    def generate_output():
        ...
        nonlocal idflag, q1_list_list
        nonlocal bqueasy, pqueasy, tqueasy


        nonlocal q1_list, fibu_list, bqueasy, pqueasy, tqueasy

        return {"doneflag": doneflag, "q1-list": q1_list_list, "fibu-list": fibu_list_list}
