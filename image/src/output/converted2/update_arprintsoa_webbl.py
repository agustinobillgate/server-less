...
t_payload_list_list, T_payload_list = create_model("T_payload_list", {"user_init":string})

def update_arprintsoa_webbl(guestno:int, bill_list_list:[Bill_list], t_payload_list_list:[T_payload_list]):
    ...
    def update_bill_list():
        ...
        for bill_list in query(bill_list_list, filters=(lambda bill_list: bill_list.do_release), sort_by=[("billref",False)]):
