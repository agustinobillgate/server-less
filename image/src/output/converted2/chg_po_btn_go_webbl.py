...
def chg_po_btn_go_webbl(t_l_orderhdr_list:[T_l_orderhdr], s_order_list:[S_order], disc_list_list:[Disc_list], lief_nr:int, pr:string, tp_bediener_username:string):
