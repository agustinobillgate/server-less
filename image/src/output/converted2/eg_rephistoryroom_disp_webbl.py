...
def eg_rephistoryroom_disp_webbl(room_nr:string, fdate:date, tdate:date, prop_nr:int):
    ...
    t_hisroom_head_list, T_hisroom_head = create_model("T_hisroom_head", {"itemno":string, "bezeich":string, "flag":string})
    t_hisroom_line_list, T_hisroom_line = create_model("T_hisroom_line", {"itemno":string, "bezeich":string, "reqno":string, "opend":string, "processd":string, "doned":string, "subtask":string, "reqstat":string, "flag":string})
    t_hisroom_line_cost_list, T_hisroom_line_cost = create_model("T_hisroom_line_cost", {"itemno":string, "bezeich":string, "reqno":string, "flag":string, "artno":string, "bezeich2":string, "qty":string, "price":string, "tot_dtl":string})
    t_hisroom_line_vendor_list, T_hisroom_line_vendor = create_model("T_hisroom_line_vendor", {"itemno":string, "bezeich":string, "reqno":string, "flag":string, "outsource":string, "vendor_nm":string, "startdate":string, "finishdate":string, "price":string, "tot_dtl":string})
    tprop_list, Tprop = create_model("Tprop", {"nr":int, "nm":string})
