...
def fa_polist_btn_gobl(from_date:date, to_date:date, billdate:date, stat_order:int, lnumber:int, all_supp:bool, po_number:string, cost_list_list:[Cost_list], w_list_list:[W_list], username_list:[Username]):
