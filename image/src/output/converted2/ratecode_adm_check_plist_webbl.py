...
p_list_list, P_list = create_model_like(Ratecode, {"s_recid":int, "rmcat_str":string, "wday_str":string, "adult_str":string, "child_str":string})

def ratecode_adm_check_plist_webbl(pvilanguage:int, curr_select:string, prcode:string, market:string, prlist_zikatnr:int, prlist_argtnr:int, market_nr:int, tb3_srecid:int, p_list_list:[P_list]):
    msg_str = ""
    child_error = False
    error_msg = ""
