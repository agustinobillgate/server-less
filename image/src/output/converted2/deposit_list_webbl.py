...
def deposit_list_webbl(from_date:date, to_date:date, sorttype:int):
    ...
    output_list_list, Output_list = create_model("Output_list", {"gname":string, "resno":int, "deposit":Decimal, "payment":Decimal, "limit":date})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal output_list_list, guest, bk_veran
