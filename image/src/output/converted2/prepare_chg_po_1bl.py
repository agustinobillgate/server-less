...
def prepare_chg_po_1bl(pvilanguage:int, docu_nr:string, lief_nr:int):
    ...
    s_order_list, S_order = create_model_like(L_order, {"rec_id":int, "lief_einheit":Decimal, "addvat_value":Decimal, "amount":Decimal, "addvat_no":int})
    ...
    t_l_order_list, T_l_order = create_model_like(L_order, {"rec_id":int, "addvat_value":Decimal, "amount":Decimal, "addvat_no":int})
