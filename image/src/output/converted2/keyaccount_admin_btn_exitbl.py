...
temp_list_list, Temp_list = create_model_like(Queasy)

def keyaccount_admin_btn_exitbl(temp_list_list:[Temp_list], icase:int, user_init:string):
    ...
    if icase == 1:
        ...
        if bediener:
            ...
            res_history.aenderung = "Add KeyAccount, Name: " + category
        ...
        queasy = get_cache (Queasy, {"key": [(eq, 211)],"number1": [(eq, temp_list.number1)]})
        ...
        if queasy:
            ...
            if bediener:
                ...
                res_history.datum = get_current_date()
                res_history.zeit = get_current_time_in_seconds()
                res_history.aenderung = "Change KeyAccount, From: " + category + " To: " + category2
                res_history.action = "Key Account"
