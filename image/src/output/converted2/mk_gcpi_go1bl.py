...
def mk_gcpi_go1bl(pbuff_list:[Pbuff], billdate:date, rcvname:string, pi_type:string, bemerk:string, pi_acctno:string):
    ...
    def generate_output():
        ...
        return {"pbuff": pbuff_list, "pi_docuno": pi_docuno}
