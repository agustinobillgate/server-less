...
def roomplan2_1bl(from_room:string, curr_date:date, ci_date:date):
    ...
    t_res_line2_list, T_res_line2 = create_model("T_res_line2", {"zinr":string, "name":string, "rec_id":int, "ziwech_zeit":int, "ankunft":date, "abreise":date})
    ...
    def generate_output():
        nonlocal do_it, to_date, t_res_line_list, t_res_line2_list, t_outorder_list, t_outorder1_list, room_list_list, t_res_line3_list, stat_list, a, res_line, outorder, zimmer, zimkateg, history
