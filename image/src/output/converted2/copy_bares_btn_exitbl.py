...
s_list_list, S_list = create_model("S_list", {"datum":date, "ftime":string, "ttime":string, "raum":string, "wday":string, "raum1":string, "resstatus":int})

def copy_bares_btn_exitbl(s_list_list:[S_list], resnr:int, reslinnr:int, res_flag:bool, user_init:string):
