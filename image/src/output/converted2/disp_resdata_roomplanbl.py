...
def disp_resdata_roomplanbl(pvilanguage:int, curr_date:date, i:int, zinr:str, gstatus:int, recid1:int):
    ...
    lvcarea:str = "disp-resdata-roomplan"
    ...
    def disp_res_data():
        ...
        if i == 0:
            ...
            n_edit = ""
            c_edit = translateExtended ("Out-of-order Reason:", lvcarea, "") + chr (10)
            ...
            outorder = db_session.query(Outorder).filter(
                     (Outorder._recid == recid1)).first()
            n_edit = ""
            c_edit = translateExtended ("Out-of-Service Reason:", lvcarea, "") + chr (10)
            ...
            if outorder:
                ...
                n_edit = ""
                c_edit = translateExtended ("Off-Market Reason:", lvcarea, "") + chr (10) + outorder.gespgrund + chr (10)
