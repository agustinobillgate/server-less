...
def company_glist_2bl(sort_rmcat:bool, fr_date:date, to_date:date, curr_gastnr:int):
    ...
    def generate_output():
        nonlocal output_list_list, curr_date, datum, todate, zikatnr, tot_nr, tot_zipreis, tot_amount, tot_night, tot_lodging, tot_bfast, tot_adroom, tot_exbed, gr_zipreis, gr_amount, gr_night, gr_lodging, gr_bfast, gr_adroom, gr_exbed, ct, take_it, contcode, f_betrag, argt_betrag, qty, bfast_art, lunch_art, dinner_art, lundin_art, fb_dept, exchg_rate, frate, argt_rate, add_it, delta, start_date, actflag1, actflag2, serv2, vat2, vat3, vat4, fact2, find__code, pr_code, i, a, bill, guest, htparam, artikel, res_line, waehrung, zimkateg, genstat, guest_pr, arrangement, argt_line, fixleist, reslin_queasy
    ...
    def get_argtline_rate(contcode:string, argt_recid:int):
        ...
        nonlocal output_list_list, curr_date, datum, todate, zikatnr, tot_nr, tot_zipreis, tot_amount, tot_night, tot_lodging, tot_bfast, tot_adroom, tot_exbed, gr_zipreis, gr_amount, gr_night, gr_lodging, gr_bfast, gr_adroom, gr_exbed, ct, take_it, f_betrag, argt_betrag, qty, bfast_art, lunch_art, dinner_art, lundin_art, fb_dept, exchg_rate, frate, argt_rate, add_it, delta, start_date, actflag1, actflag2, serv2, vat2, vat3, vat4, fact2, find__code, pr_code, i, a, bill, guest, htparam, artikel, res_line, waehrung, zimkateg, genstat, guest_pr, arrangement, argt_line, fixleist, reslin_queasy
        nonlocal sort_rmcat, fr_date, to_date, curr_gastnr
        nonlocal t_output, tbill, rguest, argtline
