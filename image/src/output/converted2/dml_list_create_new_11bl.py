...
def dml_list_create_new_11bl(user_init:string, curr_dept:int):
    ...
    def create_new():
        ...
        for l_artikel.artnr, l_artikel.bezeich, l_artikel.ek_aktuell, l_artikel.ek_letzter, l_artikel.traubensorte, l_artikel.inhalt, l_artikel._recid, l_untergrup.bezeich, l_untergrup.zwkum, l_untergrup._recid in db_session.query(L_artikel.artnr, L_artikel.bezeich, L_artikel.ek_aktuell, L_artikel.ek_letzter, L_artikel.traubensorte, L_artikel.inhalt, L_artikel._recid, L_untergrup.bezeich, L_untergrup.zwkum, L_untergrup._recid).join(L_untergrup,(L_untergrup.zwkum == L_artikel.zwkum)).filter(
