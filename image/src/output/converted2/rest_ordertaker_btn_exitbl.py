...
p_list_list, P_list = create_model("P_list", {"bezeich":string, "code":string, "num":int, "usr_init":string})

def rest_ordertaker_btn_exitbl(p_list_list:[P_list], case_type:int, rec_id:int):
