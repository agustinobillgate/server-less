...
def disc_listbl(to_date:date):
    ...
    disc_list_list, Disc_list = create_model("Disc_list", {"flag":string, "dept_no":string, "dept_name":string, "artnr":string, "day_disc":string, "day_percent":string, "mtd_disc":string, "mtd_percent":string, "ytd_disc":string, "ytd_percent":string})
    art_list_list, Art_list = create_model("Art_list", {"artnr":int, "dept":int, "name":string})
    disc_list1_list, Disc_list1 = create_model("Disc_list1", {"flag":string, "dept_no":int, "dept_name":string, "artnr":int, "day_disc":Decimal, "day_percent":Decimal, "mtd_disc":Decimal, "mtd_percent":Decimal, "ytd_disc":Decimal, "ytd_percent":Decimal})
