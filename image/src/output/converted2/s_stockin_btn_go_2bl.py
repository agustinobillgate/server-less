...
op_list_list, Op_list = create_model_like(L_op, {"a_bezeich":string, "mess_unit":Decimal, "d_unit":Decimal, "vat_no":int, "vat_value":Decimal, "disc_amount":Decimal, "disc_amount2":Decimal, "tax_percent":Decimal, "discamt_flag":bool, "addvat_amount":Decimal})

def s_stockin_btn_go_2bl(s_artnr:int, qty:Decimal, op_list_list:[Op_list], f_endkum:int, b_endkum:int, m_endkum:int, lief_nr:int, lscheinnr:string, billdate:date, curr_lager:int, fb_closedate:date, m_closedate:date, bediener_nr:int, bediener_userinit:string):
