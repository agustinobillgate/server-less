...
def ap_age_btn_go_2_webbl(pvilanguage:int, to_date:date, from_name:string, to_name:string, day1:int, day2:int, day3:int, curr_disp:int, round_zero:bool, segm:int):
    ...
    output_list1_list, Output_list1 = create_model("Output_list1", {"str":string, "nr":string, "cust_name":string, "outstanding":string, "day":string, "day1":string, "day2":string, "day3":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal output_list1_list, lvcarea, outlist, supplier, curr_name, curr_liefnr, counter, price_decimal, t_saldo, t_debt0, t_debt1, t_debt2, t_debt3, debt0, debt1, debt2, debt3, tot_debt, t_debet, t_credit, t_comm, t_adjust, l_kredit, l_lieferant, queasy
        ...
        nonlocal age_list_list, output_list_list, output_list1_list
    ...
    def create_outputlist1():
        ...
        for output_list in query(output_list_list, filters=(lambda output_list: not matches(output_list.str,r"*---*"))):
