...
def chgrmrate_report_1bl(fdate:date, tdate:date, resno:int):
    ...
    def generate_output():
        nonlocal res_log_list, akuntf, abreise, date1, date2, loopi, str, reslin_queasy, guest, res_line, zimkateg
