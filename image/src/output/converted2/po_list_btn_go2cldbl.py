...
def po_list_btn_go2cldbl(t_liefno:int, last_docu_nr:string, sorttype:int, deptnr:int, all_supp:bool, stattype:int, usrname:string, from_date:date, to_date:date, billdate:date, dml_only:bool, app_sort:string):
    ...
    def generate_output():
        nonlocal first_docu_nr, curr_docu_nr, p_267, last_docu_nr1, q2_list_list, counter, curr_counter, last_to_sort, temp_docu_nr, temp_counter_nr, approval, p_71, loop, app_lvl, l_order, l_lieferant, l_artikel, queasy, htparam, l_orderhdr, parameters, waehrung
