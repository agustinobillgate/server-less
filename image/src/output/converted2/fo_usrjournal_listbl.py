...
def fo_usrjournal_listbl(incl_trans:bool, excl_trans:bool, trans_only:bool, from_date:date, to_date:date, from_dept:int, to_dept:int, from_art:int, to_art:int, usr_init:string, long_digit:bool, foreign_flag:bool):
    ...
    fo_usrjourn_list_list, Fo_usrjourn_list = create_model("Fo_usrjourn_list", {"rec_id":int, "datum":date, "zinr":string, "rechnr":int, "artnr":int, "bezeich":string, "dept":string, "qty":int, "amount":Decimal, "gname":string, "zeit":string, "id":string, "sysdate":date})
