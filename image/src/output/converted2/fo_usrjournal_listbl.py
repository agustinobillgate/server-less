...
def fo_usrjournal_listbl(incl_trans:bool, excl_trans:bool, trans_only:bool, from_date:date, to_date:date, from_dept:int, to_dept:int, from_art:int, to_art:int, usr_init:str, long_digit:bool, foreign_flag:bool):
    ...
    output_list_list = get_output(fo_usrjournal_cldbl(incl_trans, excl_trans, trans_only, from_date, to_date, from_dept, to_dept, from_art, to_art, usr_init, long_digit, foreign_flag))
