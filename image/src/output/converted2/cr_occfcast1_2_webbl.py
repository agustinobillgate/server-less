...
def cr_occfcast1_2_webbl(segm_list_list:[Segm_list], argt_list_list:[Argt_list], zikat_list_list:[Zikat_list], outlook_list_list:[Outlook_list], pvilanguage:int, op_type:int, flag_i:int, curr_date:date, to_date:date, all_segm:bool, all_argt:bool, all_zikat:bool, exclooo:bool, incl_tent:bool, show_rev:int, vhp_limited:bool, excl_compl:bool, all_outlook:bool, incl_oth:bool):
    ...
    argt6_list_list, Argt6_list = create_model("Argt6_list", {"argtnr":int, "argt_artnr":int, "resnr":int, "reslinnr":int, "departement":int, "is_charged":int, "period":int, "vt_percnt":int})
    ...
    def generate_output():
        ...
        nonlocal room_list_list, print_list_list, print_list2_list, print_list3_list, argt6_list_list, active_rm_list_list, dayuse_list_list
                                ...
                                if arrangement:
                                    ...
                                    for argt_line in db_session.query(Argt_line).filter(
                                        ...
                                        if argt_line.fakt_modus == 6:
                                            ...
                                            argt6_list = query(argt6_list_list, filters=(lambda argt6_list: argt6_list.argtnr == argt_line.argtnr and argt6_list.departement == argt_line.departement and argt6_list.argt_artnr == argt_line.argt_artnr and argt6_list.vt_percnt == argt_line.vt_percnt and argt6_list.resnr == res_line.resnr and argt6_list.reslinnr == res_line.reslinnr and argt6_list.is_charged == 1), first=True)

                                            if not argt6_list:
                                                argt6_list = Argt6_list()
                                                argt6_list_list.append(argt6_list)
