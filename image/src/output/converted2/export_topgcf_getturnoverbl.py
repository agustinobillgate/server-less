...
def export_topgcf_getturnoverbl(cardtype:int, sort_type:int, curr_sort1:int, fdate:date, tdate:date, check_ftd:bool, currency:string, excl_other:bool, curr_sort2:int):
    ...
    def generate_output():
        ...
        return {"curr_sort2": curr_sort2, "cust-list": cust_list_list}

    def create_forecast():

        nonlocal cust_list_list, bfast_art, lunch_art, dinner_art, lundin_art, service, vat, end_date, net_lodg, fnet_lodg, tot_breakfast, tot_lunch, tot_dinner, tot_other, tot_rmrev, tot_vat, tot_service, curr_i, i, found, ly_fdate, ly_tdate, ci_date, pos, curr_gastnr, t_logiernachte, t_argtumsatz, t_fb_umsatz, t_sonst_umsatz, t_ba_umsatz, t_gesamtumsatz, tot_logiernachte, tot_argtumsatz, tot_fb_umsatz, tot_sonst_umsatz, tot_ba_umsatz, tot_gesamtumsatz, tot_stayno, loopj, found_it, exratenr, exrate, curr_resnr2, curr_reslinnr2, curr_resnr1, curr_reslinnr1, waehrung, genstat, guest, htparam, nation, queasy, artikel, exrate, bill, bill_line, guest_queasy, res_line, reservation, sourccod, segment, arrangement, zimmer
        nonlocal cardtype, sort_type, curr_sort1, fdate, tdate, check_ftd, currency, excl_other, curr_sort2
        nonlocal t_genstat, blist, glist, clist
    ...
    def cr_ftd():
        ...
        nonlocal cust_list_list, bfast_art, lunch_art, dinner_art, lundin_art, service, vat, datum, end_date, net_lodg, fnet_lodg, tot_breakfast, tot_lunch, tot_dinner, tot_other, tot_rmrev, tot_vat, tot_service, curr_i, i, found, ly_fdate, ly_tdate, ci_date, pos, curr_gastnr, t_logiernachte, t_fb_umsatz, t_sonst_umsatz, t_ba_umsatz, t_gesamtumsatz, tot_logiernachte, tot_argtumsatz, tot_fb_umsatz, tot_sonst_umsatz, tot_ba_umsatz, tot_gesamtumsatz, tot_stayno, loopj, found_it, exratenr, exrate, curr_resnr2, curr_reslinnr2, curr_resnr1, curr_reslinnr1, waehrung, genstat, guest, htparam, nation, queasy, artikel, exrate, bill, bill_line, guest_queasy, res_line, reservation, sourccod, segment, arrangement, zimmer
        nonlocal cardtype, sort_type, curr_sort1, fdate, tdate, check_ftd, currency, excl_other, curr_sort2
        nonlocal t_genstat, blist, glist, clist
        ...
        for cust_list2 in query(cust_list2_list, sort_by=[("gesamtumsatz",True),("logiernachte",True),("cust_name",False)]):
            cust_list = Cust_list()
            cust_list_list.append(cust_list)
