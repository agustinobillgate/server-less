...
def s_transform_get_recipebl(pvilanguage:int, hrecipe_nr:int, qty:Decimal, curr_lager:int, transdate:date, bediener_nr:int, lscheinnr:string, t_op_list_list:[T_op_list]):
