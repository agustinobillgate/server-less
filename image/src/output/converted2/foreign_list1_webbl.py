...
def foreign_list1_webbl(dtype:int, fdate:date, from_date:date, to_date:date, ci_date:date, all_nat:bool, sorttype:int, def_nat:string):
    ...
    t_foreign_list_list, T_foreign_list = create_model("T_foreign_list", {"resnr":int, "reslinnr":int, "name":string, "nation1":string, "ausweis_nr1":string, "geburtdatum1":date, "zinr":string, "ankunft":date, "abreise":date, "adresse1":string, "wohnort":string, "land":string, "email_adr":string, "ankzeit":int, "abreisezeit":int, "resstatus":int, "erwachs":int, "kind1":int, "gratis":int, "remark":string, "i_purpose":string, "gender":string, "telefon":string, "guest_stat":int, "rm_qty":int})
    t_queasy_list, T_queasy = create_model_like(Queasy)
    summary_list_list, Summary_list = create_model("Summary_list", {"summ_str":string, "nation":string, "pax":int, "nation_remark":string, "pax_inhouse":int, "pax_depart":int, "pax_arrival":int, "pax_arrived":int, "pax_departed":int, "anz_inhouse":int, "anz_depart":int, "anz_arrival":int, "anz_arrived":int, "anz_departed":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal tot_pax_inhouse, tot_pax_depart, tot_pax_arrival, tot_pax_arrived, tot_pax_departed, tot_anz_inhouse, tot_anz_depart, tot_anz_arrival, tot_anz_arrived, tot_anz_departed, curr_status, curr_date, tot_local, tot_foreign, t_foreign_list_list, summary_list_list, pax, queasy, guest, res_line, nation, genstat, zimmer, history
        nonlocal dtype, fdate, from_date, to_date, ci_date, all_nat, sorttype, def_nat


        nonlocal t_foreign_list, t_queasy, summary_list
        nonlocal t_foreign_list_list, t_queasy_list, summary_list_list

        return {"t-foreign-list": t_foreign_list_list, "summary-list": summary_list_list}

    def create_foreign_arrived_today():

        nonlocal tot_pax_inhouse, tot_pax_depart, tot_pax_arrival, tot_pax_arrived, tot_pax_departed, tot_anz_inhouse, tot_anz_depart, tot_anz_arrival, tot_anz_arrived, tot_anz_departed, curr_status, tot_local, tot_foreign, t_foreign_list_list, summary_list_list, pax, queasy, guest, res_line, nation, genstat, zimmer, history
        nonlocal dtype, fdate, from_date, to_date, ci_date, all_nat, sorttype, def_nat
    ...
    def create_foreign_departed_today():
        ...
        if not all_nat:
            ...
            for res_line.resstatus, res_line.zimmeranz, res_line.erwachs, res_line.gratis, res_line.kind1, res_line.kind2, res_line.zimmerfix, res_line.zinr, res_line.resnr, res_line.ankunft, res_line.abreise, res_line.reslinnr, res_line.name, res_line.ankzeit, res_line.abreisezeit, res_line.zimmer_wunsch, res_line._recid, guest.nation1, guest.ausweis_nr1, guest.geburtdatum1, guest.adresse1, guest.wohnort, guest.land, guest.email_adr, guest.bemerkung, guest.telefon, guest._recid in db_session.query(Res_line.resstatus, Res_line.zimmeranz, Res_line.erwachs, Res_line.gratis, Res_line.kind1, Res_line.kind2, Res_line.zimmerfix, Res_line.zinr, Res_line.resnr, Res_line.ankunft, Res_line.abreise, Res_line.reslinnr, Res_line.name, Res_line.ankzeit, Res_line.abreisezeit, Res_line.zimmer_wunsch, Res_line._recid, Guest.nation1, Guest.ausweis_nr1, Guest.geburtdatum1, Guest.adresse1, Guest.wohnort, Guest.land, Guest.email_adr, Guest.bemerkung, Guest.telefon, Guest._recid).join(Guest,(Guest.gastnr == Res_line.gastnrmember) & (Guest.nation1 != (def_nat).lower())).filter(
                     (Res_line.resstatus == 8) & (Res_line.active_flag == 2) & (Res_line.abreise >= from_date) & (Res_line.abreise <= to_date)).order_by(Guest.nation1, Res_line.name, Res_line.zinr, Res_line.abreise).all():
    ...
    def create_foreign_departure():
        ...
        if not all_nat:
            ...
            guest = Guest()
            for res_line.resstatus, res_line.zimmeranz, res_line.erwachs, res_line.gratis, res_line.kind1, res_line.kind2, res_line.zimmerfix, res_line.zinr, res_line.resnr, res_line.ankunft, res_line.abreise, res_line.reslinnr, res_line.name, res_line.ankzeit, res_line.abreisezeit, res_line.zimmer_wunsch, res_line._recid, guest.nation1, guest.ausweis_nr1, guest.geburtdatum1, guest.adresse1, guest.wohnort, guest.land, guest.email_adr, guest.bemerkung, guest.telefon, guest._recid in db_session.query(Res_line.resstatus, Res_line.zimmeranz, Res_line.erwachs, Res_line.gratis, Res_line.kind1, Res_line.kind2, Res_line.zimmerfix, Res_line.zinr, Res_line.resnr, Res_line.ankunft, Res_line.abreise, Res_line.reslinnr, Res_line.name, Res_line.ankzeit, Res_line.abreisezeit, Res_line.zimmer_wunsch, Res_line._recid, Guest.nation1, Guest.ausweis_nr1, Guest.geburtdatum1, Guest.adresse1, Guest.wohnort, Guest.land, Guest.email_adr, Guest.bemerkung, Guest.telefon, Guest._recid).join(Guest,(Guest.gastnr == Res_line.gastnrmember) & (Guest.nation1 != (def_nat).lower())).filter(
                     (Res_line.active_flag == 1) & ((Res_line.resstatus == 6) | (Res_line.resstatus == 13) | (Res_line.resstatus == 11)) & (Res_line.abreise == to_date)).order_by(Res_line._recid).all():
                if res_line_obj_list.get(res_line._recid):
                    continue
                else:
                    res_line_obj_list[res_line._recid] = True
    ...
    def create_inhouse():
        ...
        if not all_nat:
            ...
            guest = Guest()
            for res_line.resstatus, res_line.zimmeranz, res_line.erwachs, res_line.gratis, res_line.kind1, res_line.kind2, res_line.zimmerfix, res_line.zinr, res_line.resnr, res_line.ankunft, res_line.abreise, res_line.reslinnr, res_line.name, res_line.ankzeit, res_line.abreisezeit, res_line.zimmer_wunsch, res_line._recid, guest.nation1, guest.ausweis_nr1, guest.geburtdatum1, guest.adresse1, guest.wohnort, guest.land, guest.email_adr, guest.bemerkung, guest.telefon, guest._recid in db_session.query(Res_line.resstatus, Res_line.zimmeranz, Res_line.erwachs, Res_line.gratis, Res_line.kind1, Res_line.kind2, Res_line.zimmerfix, Res_line.zinr, Res_line.resnr, Res_line.ankunft, Res_line.abreise, Res_line.reslinnr, Res_line.name, Res_line.ankzeit, Res_line.abreisezeit, Res_line.zimmer_wunsch, Res_line._recid, Guest.nation1, Guest.ausweis_nr1, Guest.geburtdatum1, Guest.adresse1, Guest.wohnort, Guest.land, Guest.email_adr, Guest.bemerkung, Guest.telefon, Guest._recid).join(Guest,(Guest.gastnr == Res_line.gastnrmember) & (Guest.nation1 != (def_nat).lower())).filter(
                     (Res_line.active_flag >= actflag1) & (Res_line.active_flag <= actflag2) & (Res_line.resstatus != 9) & (Res_line.resstatus != 10) & (Res_line.resstatus != 12) & (Res_line.ankunft <= to_date) & (Res_line.abreise >= to_date)).order_by(Guest.nation1, Res_line.name, Res_line.zinr).all():
                if res_line_obj_list.get(res_line._recid):
                    continue
                else:
                    res_line_obj_list[res_line._recid] = True
    ...
    def create_inhouse2():
        ...
        if not all_nat:
            ...
            for genstat.resstatus, genstat.resnr, genstat.res_int, genstat.erwachs, genstat.gratis, genstat.kind1, genstat.kind2, genstat.kind3, genstat.zinr, genstat.gastnr, genstat.zipreis, genstat.res_date, genstat._recid, guest.nation1, guest.ausweis_nr1, guest.geburtdatum1, guest.adresse1, guest.wohnort, guest.land, guest.email_adr, guest.bemerkung, guest.telefon, guest._recid in db_session.query(Genstat.resstatus, Genstat.resnr, Genstat.res_int, Genstat.erwachs, Genstat.gratis, Genstat.kind1, Genstat.kind2, Genstat.kind3, Genstat.zinr, Genstat.gastnr, Genstat.zipreis, Genstat.res_date, Genstat._recid, Guest.nation1, Guest.ausweis_nr1, Guest.geburtdatum1, Guest.adresse1, Guest.wohnort, Guest.land, Guest.email_adr, Guest.bemerkung, Guest.telefon, Guest._recid).join(Guest,(Guest.gastnr == Genstat.gastnrmember) & (Guest.nation1 != (def_nat).lower())).filter(
                     (Genstat.datum == to_date)).order_by(Guest.nation1, Genstat.zinr).all():
    ...
    def create_arrival(curr_date:date):
        ...
        if not all_nat:
            ...
            guest = Guest()
            for res_line.resstatus, res_line.zimmeranz, res_line.erwachs, res_line.gratis, res_line.kind1, res_line.kind2, res_line.zimmerfix, res_line.zinr, res_line.resnr, res_line.ankunft, res_line.abreise, res_line.reslinnr, res_line.name, res_line.ankzeit, res_line.abreisezeit, res_line.zimmer_wunsch, res_line._recid, guest.nation1, guest.ausweis_nr1, guest.geburtdatum1, guest.adresse1, guest.wohnort, guest.land, guest.email_adr, guest.bemerkung, guest.telefon, guest._recid in db_session.query(Res_line.resstatus, Res_line.zimmeranz, Res_line.erwachs, Res_line.gratis, Res_line.kind1, Res_line.kind2, Res_line.zimmerfix, Res_line.zinr, Res_line.resnr, Res_line.ankunft, Res_line.abreise, Res_line.reslinnr, Res_line.name, Res_line.ankzeit, Res_line.abreisezeit, Res_line.zimmer_wunsch, Res_line._recid, Guest.nation1, Guest.ausweis_nr1, Guest.geburtdatum1, Guest.adresse1, Guest.wohnort, Guest.land, Guest.email_adr, Guest.bemerkung, Guest.telefon, Guest._recid).join(Guest,(Guest.gastnr == Res_line.gastnrmember) & (Guest.nation1 != (def_nat).lower())).filter(
                     (Res_line.active_flag <= 1) & (Res_line.resstatus != 12) & (Res_line.resstatus != 3) & (Res_line.ankunft == curr_date)).order_by(Guest.nation1, Res_line.name, Res_line.zinr).all():
                if res_line_obj_list.get(res_line._recid):
                    continue
                else:
                    res_line_obj_list[res_line._recid] = True
    ...
    for t_foreign_list in query(t_foreign_list_list, sort_by=[("nation1",False)]):

        if t_foreign_list.nation1 == None or t_foreign_list.nation1 == "":
            t_foreign_list.nation1 = "?"

        summary_list = query(summary_list_list, filters=(lambda summary_list: summary_list.nation == t_foreign_list.nation1), first=True)
        ...
        if t_foreign_list.guest_stat == 1:
            ...
            summary_list.pax_inhouse = summary_list.pax_inhouse + t_foreign_list.erwachs
            tot_pax_inhouse = tot_pax_inhouse + t_foreign_list.erwachs
            ...
            if t_foreign_list.resstatus != 11 and t_foreign_list.resstatus != 13:
                ...
                tot_anz_arrival = tot_anz_arrival + t_foreign_list.rm_qty


            tot_pax_arrival = tot_pax_arrival + t_foreign_list.erwachs * t_foreign_list.rm_qty
            ...
            summary_list.anz_inhouse = summary_list.anz_inhouse + t_foreign_list.rm_qty
            tot_anz_inhouse = tot_anz_inhouse + t_foreign_list.rm_qty
            summary_list.pax_inhouse = summary_list.pax_inhouse + t_foreign_list.erwachs * t_foreign_list.rm_qty
            tot_pax_inhouse = tot_pax_inhouse + t_foreign_list.erwachs * t_foreign_list.rm_qty
