...
def cust_turnover_list_webbl(cardtype:int, sort_type:int, curr_sort1:int, fdate:date, tdate:date, check_ftd:bool, currency:string, excl_other:bool, curr_sort2:int, idflag:string):
    ...
    pass
    curr_sort2, sort1, cust_list_list = get_output(cust_turnover_listbl(cardtype, sort_type, curr_sort1, fdate, tdate, check_ftd, currency, excl_other, curr_sort2))

    for cust_list in query(cust_list_list):
