...
def prepare_rarticle_adminbl(dept:int):
    ...
    q1_list_list, Q1_list = create_model_like(H_artikel, {"bez":string, "zknr":int, "bezeich2":string, "zk_bezeich":string, "ek_bezeich":string, "fart_bezeich":string, "fo_dept":int})
