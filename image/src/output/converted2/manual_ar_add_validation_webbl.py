...
payload_list_list, Payload_list = create_model("Payload_list", {"refno":string})

def manual_ar_add_validation_webbl(payload_list_list:[Payload_list]):
    response_list_list = []
    refno:string = ""
    ...
    response_list_list, Response_list = create_model("Response_list", {"success_flag":bool, "err_msg":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal response_list_list, refno, gl_jouhdr, gl_jhdrhis
