...
def eg_maincalendar_all_categorybl(all_room:bool, tcategory_list:[Tcategory], tlocation_list:[Tlocation], troom_list:[Troom]):
    ...
    tproperty = troom = tlocation = tcategory = tmaintask = comcategory = comlocat = commain = comroom = None
    ...
    def generate_output():
        ...
        nonlocal tproperty, troom, tlocation, tcategory, tmaintask, comcategory, comlocat, commain, comroom
