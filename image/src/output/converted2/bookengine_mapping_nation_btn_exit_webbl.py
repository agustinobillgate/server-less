...
def bookengine_mapping_nation_btn_exit_webbl(t_mapping_nation_list:[T_mapping_nation], bookengid:int, user_init:string):
    ...
    t_mapping_nation = query(t_mapping_nation_list, first=True)
    ...
    for t_mapping_nation in query(t_mapping_nation_list):
