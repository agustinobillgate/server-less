...
def prepare_fa_newpobl(order_nr:string):
    ...
    t_mathis_list, T_mathis = create_model("T_mathis", {"artnr":int, "asset_name":string, "asset_number":string})
    ...
    def generate_output():
        nonlocal err_no, local_nr, billdate, add_first_waehrung_wabkurz, t_add_last_list, t_mathis_list, t_lief_list_list, t_dept_list_list, l_lieferant, mathis, parameters, htparam, waehrung, fa_ordheader, fa_counter
        nonlocal order_nr


        nonlocal t_add_last, t_mathis, t_lief_list, t_dept_list
        nonlocal t_add_last_list, t_mathis_list, t_lief_list_list, t_dept_list_list

        return {"order_nr": order_nr, "err_no": err_no, "local_nr": local_nr, "billdate": billdate, "add_first_waehrung_wabkurz": add_first_waehrung_wabkurz, "t-add-last": t_add_last_list, "t-mathis": t_mathis_list, "t-lief-list": t_lief_list_list, "t-dept-list": t_dept_list_list}
