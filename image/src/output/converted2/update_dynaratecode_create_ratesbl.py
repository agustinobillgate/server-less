...
dynarate_list_list, Dynarate_list = create_model("Dynarate_list", {"counter":int, "rcode":string, "w_day":int, "fr_room":int, "to_room":int, "days1":int, "days2":int, "rmtype":string, "s_recid":int})

def update_dynaratecode_create_ratesbl(dynarate_list_list:[Dynarate_list], rmtype:string, currcode:string, from_date:date, to_date:date, market_number:int):
