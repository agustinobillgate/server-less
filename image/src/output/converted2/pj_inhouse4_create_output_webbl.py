...
def pj_inhouse4_create_output_webbl(idflag:string, inhouse_guest_list_list:[Inhouse_guest_list]):
    ...
    def generate_output():
        ...
        return {"doneflag": doneflag, "inhouse-guest-list": inhouse_guest_list_list}
