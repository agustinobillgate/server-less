...
def s_storerequest_btn_gobl(op_list_list:[Op_list], recid_l_ophdr:int, transdate:date, curr_lager:int, transfered:bool, cost_acct:string, deptno:int, to_stock:int, lscheinnr:string, user_init:string):
    ...
    def generate_output():
        ...
        return {"op-list": op_list_list, "s_artnr": s_artnr, "qty": qty, "price": price, "created": created}
