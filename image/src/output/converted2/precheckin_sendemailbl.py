...
rsv_list_list, Rsv_list = create_model("Rsv_list", {"resnr":int, "reslinnr":int, "gastnr":int, "rsv_name":string, "zinr":string, "resline_name":string, "ankunft":date, "abreise":date, "email":string, "idcard_flag":bool, "selected":bool, "status_msg":string, "mci_flag":bool, "pci_flag":bool, "email_sent":bool})

def precheckin_sendemailbl(rsv_list_list:[Rsv_list]):
