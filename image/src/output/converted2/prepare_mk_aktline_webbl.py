...
def prepare_mk_aktline_webbl(aktnr:int, inp_gastnr:int, user_init:string):
    ...
    def generate_output():
        nonlocal lname, guest_gastnr, p_400, p_405, p_406, p_407, zeit, dauer, t_akthdr_list, t_akt_code_list, akt_line1_list, akthdr, akt_code, akt_line, akt_kont, guest, htparam
        nonlocal aktnr, inp_gastnr, user_init


        nonlocal t_akthdr, t_akt_code, akt_line1
        nonlocal t_akthdr_list, t_akt_code_list, akt_line1_list

        return {"lname": lname, "guest_gastnr": guest_gastnr, "p_400": p_400, "p_405": p_405, "p_406": p_406, "p_407": p_407, "zeit": zeit, "dauer": dauer, "t-akthdr": t_akthdr_list, "t-akt-code": t_akt_code_list, "akt-line1": akt_line1_list}
    ...
    p_407 = htparam.fchar
    akt_line1 = Akt_line1()
    akt_line1_list.append(akt_line1)


    if aktnr != 0:

        for t_akthdr in query(t_akthdr_list):
