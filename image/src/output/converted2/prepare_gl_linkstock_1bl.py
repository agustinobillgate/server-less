...
def prepare_gl_linkstock_1bl(link_in:bool):
    ...
    def generate_output():
        nonlocal f_int, jtype, last_acctdate, acct_date, close_year, msg_str, l_hauptgrp_list_list, last_acct_period, tmpdate, htparam, l_hauptgrp
        nonlocal link_in
        ...
        return {"f_int": f_int, "jtype": jtype, "last_acctdate": last_acctdate, "acct_date": acct_date, "close_year": close_year, "msg_str": msg_str, "l-hauptgrp-list": l_hauptgrp_list_list}
