...
def mk_hmenu_create_menubl(hmenu_list_list:[Hmenu_list], menu_list_list:[Menu_list], menu_nr:int, dept:int, h_artnr:int):
    ...
    def generate_output():
        ...
        return {"hmenu-list": hmenu_list_list, "menu-list": menu_list_list, "menu_nr": menu_nr, "done": done}
