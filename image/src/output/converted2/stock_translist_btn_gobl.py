...
def stock_translist_btn_gobl(main_grp:int, sorttype:int, mattype:int, from_lager:int, to_lager:int, from_art:int, to_art:int, from_date:date, to_date:date):
    ...
    t_list_list, T_list = create_model("T_list", {"nr":int, "f_lager":int, "t_lager":int, "f_bezeich":string, "t_bezeich":string, "artnr":string, "subgr":int, "sub_bezeich":string, "bezeich":string, "qty":Decimal, "val":Decimal, "t_qty":Decimal, "t_val":Decimal})
