...
def pj_inhouse4_create_output_1webbl(idflag:string, inhouse_guest_list_list:[Inhouse_guest_list]):
    ...
    def generate_output():
        nonlocal doneflag, summary_roomtype_list, summary_nation_list, summary_revenue_list, summary_segment_list, tot_list_list, counter, htl_no, temp_char, queasy, paramtext
        nonlocal idflag
        ...
        nonlocal summary_roomtype_list, summary_nation_list, summary_revenue_list, summary_segment_list, sum_list_list, tot_list_list

        return {"doneflag": doneflag, "summary-roomtype": summary_roomtype_list, "summary-nation": summary_nation_list, "summary-revenue": summary_revenue_list, "summary-segment": summary_segment_list, "tot-list": tot_list_list, "inhouse-guest-list": inhouse_guest_list_list}
