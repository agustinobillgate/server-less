...
def rm_rev1bl(pvilanguage:int, from_date:date, to_date:date, rmno:string):
    ...
    t_list_list, T_list = create_model("T_list", {"flag":int, "bezeich":string, "anz":int, "pax":int, "net":Decimal, "proz":Decimal, "manz":int, "mpax":int, "mnet":Decimal, "proz1":Decimal, "yanz":int, "ypax":int, "ynet":Decimal, "proz2":Decimal})
