...
def chg_sarticle_btn_gobl(pvilanguage:int, tt_artnr_list:[Tt_artnr], tt_content_list:[Tt_content], s_unit:string, artnr:int, t_recid:int, fibukonto:string, dml_art_inp:bool, bez_aend:bool, picture_file:string, original_art:int, user_init:string, l_art_list:[L_art]):
