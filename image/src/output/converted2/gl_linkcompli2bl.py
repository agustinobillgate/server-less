...
def gl_linkcompli2bl(pvilanguage:int, remains:Decimal, credits:Decimal, debits:Decimal, to_date:date, refno:string, datum:date, bezeich:string, g_list_list:[G_list]):
