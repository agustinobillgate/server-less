...
def sall_onhand_btn_go_1bl(all_flag:bool, show_price:bool, zero_flag:bool, from_grp:int, sub_grp:int, from_lager:int, to_lager:int, sorttype:int, mattype:int, minoh_flag:bool):
    ...
    def generate_output():
        nonlocal str_list_list, curr_best, long_digit, i, j, tot_anz, tot_val, t_anz, t_val, t_value, tt_value, avrg_price, zwkum, bezeich, grp1, grp2, must_order, tt_val, qty, wert, tot_bezeich, l_bestand, htparam, l_lager, l_artikel, l_untergrup
