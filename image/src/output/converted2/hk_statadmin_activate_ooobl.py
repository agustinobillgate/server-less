...
def hk_statadmin_activate_ooobl(bline_list_list:[Bline_list], om_list_list:[Om_list], pvilanguage:int, from_date:date, to_date:date, ci_date:date, dept:int, reason:string, service_flag:bool, user_nr:int):
    ...
    def generate_output():
        ...
        return {"bline-list": bline_list_list, "om-list": om_list_list, "flag": flag, "msg_str": msg_str, "z-list": z_list_list}
