...
def dml_issue_btn_gobl(op_list_list:[Op_list], billdate:date, closedate:date, curr_lager:int, curr_dept:int, cost_acct:string, lief_nr:int, lscheinnr:string, user_init:string, t_amount:Decimal):
    ...
    def generate_output():
        ...
        return {"op-list": op_list_list, "curr_pos": curr_pos, "s_artnr": s_artnr, "qty": qty, "price": price, "created": created}
