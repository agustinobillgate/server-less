...
def pj_inhouse4_summary_cldbl(sorttype:int, from_date:date, to_date:date, curr_date:date, curr_gastnr:int, froom:string, troom:string, exc_depart:bool, incl_gcomment:bool, incl_rsvcomment:bool, prog_name:string, disp_accompany:bool, zikat_list_list:[Zikat_list]):
    ...
    zinr_list_list, Zinr_list = create_model("Zinr_list", {"resnr":int, "reslinnr":int, "zinr":string, "datum":date, "arrival":date, "departed":date})
    ...
    def generate_output():
        ...
        nonlocal setup_list_list, cl_list_list, s_list_list, zinr_list_list, t_buff_queasy_list
