...
def gacct_balance_btn_go_list_create_output_webbl(idflag:string, gacct_balance_list_list:[Gacct_balance_list]):
    ...
    def generate_output():
        ...
        return {"doneflag": doneflag, "gacct-balance-list": gacct_balance_list_list}
