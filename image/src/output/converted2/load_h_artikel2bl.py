...
def load_h_artikel2bl(case_type:int, dept:int, arttype:int):
    ...
    t_h_menu_list, T_h_menu = create_model_like(H_menu)
    ...
    def generate_output():
        nonlocal t_h_artikel_list, t_wgrpdep_list, t_h_menu_list, h_artikel, wgrpdep, h_menu
        nonlocal case_type, dept, arttype
        nonlocal hart


        nonlocal t_h_artikel, t_wgrpdep, t_h_menu, hart
        nonlocal t_h_artikel_list, t_wgrpdep_list, t_h_menu_list

        return {"t-h-artikel": t_h_artikel_list, "t-wgrpdep": t_wgrpdep_list, "t-h-menu": t_h_menu_list}
