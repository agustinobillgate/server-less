...
def prepare_rm_product_1bl():
    ...
    t_argt_list, T_argt = create_model("T_argt", {"code":string, "name":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal price_decimal, foreign_nr, f_log, t_argt_list, htparam, waehrung, arrangement


        nonlocal t_argt
        nonlocal t_argt_list

        return {"price_decimal": price_decimal, "foreign_nr": foreign_nr, "f_log": f_log, "t-argt": t_argt_list}
