...
def new_drr_gsbl(from_date:date, to_date:date, gsheet_link:string, rev_seg_list_list:[Rev_seg_list], rev_list_list:[Rev_list], payable_list_list:[Payable_list], stat_list_list:[Stat_list], payment_list_list:[Payment_list], gl_list_list:[Gl_list], fb_sales_food_list:[Fb_sales_food], fb_sales_beverage_list:[Fb_sales_beverage], fb_sales_other_list:[Fb_sales_other], fb_sales_tot_list:[Fb_sales_tot], rev_seg_list1_list:[Rev_seg_list1], fb_sales_material_list:[Fb_sales_material]):
    ...
    for rev_seg_list1 in query(rev_seg_list1_list, sort_by=[("flag",False)]):
        ct_row = ct_row + 1
        stream_list = Stream_list()
        stream_list_list.append(stream_list)
    ...
    for fb_sales_material in query(fb_sales_material_list):
        ct_row2 = ct_row2 + 1
        stream_list = Stream_list()
        stream_list_list.append(stream_list)
