...
payload_list_list, Payload_list = create_model("Payload_list", {"show_breakdown_comphu":bool})

def rm_revenue_3_webbl(m_ftd:bool, m_ytd:bool, f_date:date, t_date:date, to_date:date, rm_no:string, sorttype:int, lod__rev:bool, excl_compl:bool, payload_list_list:[Payload_list]):
    ...
    output_list_list, Output_list = create_model("Output_list", {"rmno":string, "flag":string, "str":string, "rmno1":string, "rmtype":string, "rm":int, "pax":int, "com_rm":int, "com_pax":int, "hu_rm":int, "hu_pax":int, "rm_rev":Decimal, "percent":Decimal, "mtdrm":int, "pax1":int, "com_mtdrm":int, "com_pax1":int, "hu_mtdrm":int, "hu_pax1":int, "rm_rev1":Decimal, "percent1":Decimal, "ftdrm":int, "pax2":int, "com_ftdrm":int, "com_pax2":int, "hu_ftdrm":int, "hu_pax2":int, "rm_rev2":Decimal, "percent3":Decimal})
