...
def get_po_list_webbl(usrname:string, po_number:string, last_doc_nr:string, app_sort:string, dml_only:bool, t_liefno:int, deptnr:int, all_supp:bool, stattype:int, sorttype:int, from_date:date, to_date:date, billdate:date, pr_only:bool, excl_dml_pr:bool):
    ...
    def generate_output():
        nonlocal p_267, first_docu_nr, curr_docu_nr, last_docu_nr, q2_list_list, param267, loeschflag, l_order, gl_acct, l_artikel
    ...
    if po_number != "":
        param267, t_list_list = get_output(po_list_btn_go_1cldbl(usrname, po_number, dml_only, pr_only, excl_dml_pr))
    else:
        first_docu_nr, curr_docu_nr, param267, last_docu_nr, t_list_list = get_output(po_list_btn_go2_1cldbl(t_liefno, last_doc_nr, sorttype, deptnr, all_supp, stattype, usrname, from_date, to_date, billdate, dml_only, app_sort, pr_only, excl_dml_pr))
