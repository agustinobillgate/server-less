...
def bil_select1_2bl(bil_flag:int, sorttype:int, gastname:string, dept:int, ba_dept:int, rechnr:int):
    ...
    b1_list_list, B1_list = create_model("B1_list", {"resnr":int, "rechnr":int, "name":string, "vorname1":string, "anrede1":string, "saldo":Decimal, "printnr":int, "datum":date, "b_recid":int, "adresse1":string, "wohnort":string, "bemerk":string, "plz":string, "bill_datum":date, "vesrdepot2":string})
