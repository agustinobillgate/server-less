...
def prepare_select_ratecodebl(gastnr:int):
    ...
    t_ratecode_list, T_ratecode = create_model("T_ratecode", {"code":string, "bez":string, "startdate":date, "enddate":date, "zikatnr":int, "roomtype":string, "argt":string})
