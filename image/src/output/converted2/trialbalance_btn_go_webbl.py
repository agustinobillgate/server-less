...
def trialbalance_btn_go_webbl(acct_type:int, from_fibu:string, to_fibu:string, sorttype:int, from_dept:int, from_date:date, to_date:date, close_month:int, close_date:date, pnl_acct:string, close_year:date, prev_month:int, show_longbal:bool, pbal_flag:bool, asremoteflag:bool):
    ...
    output_list_list, Output_list = create_model("Output_list", {"gop_flag":bool, "nr":int, "str":string, "budget":Decimal, "proz":Decimal, "mark":bool, "ch":string})
    output_listhis_list, Output_listhis = create_model("Output_listhis", {"gop_flag":bool, "nr":int, "str":string, "budget":Decimal, "proz":Decimal, "mark":bool, "ch":string})
    result_list_list, Result_list = create_model("Result_list", {"gop_flag":bool, "nr":int, "str":string, "budget":Decimal, "proz":Decimal, "mark":bool, "ch":string})
    t_res_list_list, T_res_list = create_model("T_res_list", {"grp_nr":string, "acc_no":string, "t_date":date, "f1":string, "f2":string, "f3":int, "f4":int, "f5":int, "f6":int, "f7":int, "f8":int, "f9":int, "f10":int, "note":string})
    t_res_listhis_list, T_res_listhis = create_model("T_res_listhis", {"grp_nr":string, "acc_no":string, "t_date":date, "f1":string, "f2":string, "f3":int, "f4":int, "f5":int, "f6":int, "f7":int, "f8":int, "f9":int, "f10":int, "note":string})
    g_list_list, G_list = create_model("G_list", {"datum":date, "grecid":int, "fibu":string}, {"datum": None})
    g_listpre_list, G_listpre = create_model("G_listpre", {"datum":date, "grecid":int, "fibu":string}, {"datum": None})
    g_listhis_list, G_listhis = create_model("G_listhis", {"datum":date, "grecid":int, "fibu":string}, {"datum": None})
