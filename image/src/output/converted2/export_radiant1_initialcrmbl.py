...
def export_radiant1_initialcrmbl(fdate:date, tdate:date):
    ...
    data_list_list, Data_list = create_model("Data_list", {"resstatus":string, "bookchannel":string, "bookername":string, "resnr":int, "reslinnr":int, "totalprice":Decimal, "bookdate":string, "ankunft":string, "abreise":string, "staydate":string, "countryname":string, "currencycode":string, "firstname":string, "lastname":string, "roomtypename":string, "roomtypecode":string, "ratecode":string, "argt":string, "countrycode":string, "segment":string, "nationalname":string, "nationalcode":string, "remark":string})
