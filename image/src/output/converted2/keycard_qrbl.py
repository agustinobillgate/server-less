...
def keycard_qrbl(room:string, res_nr:int, reslin_nr:int, checkoutdate:date):
    ...
    def assign_it():
        ...
        if guestbook:
            ...
            img_idcard_list.append(img_idcard)
