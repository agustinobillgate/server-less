...
def prepare_auto_checkinbl(pvilanguage:int, resnr:int):
    ...
    res_list_list, Res_list = create_model("Res_list", {"gastnr":int, "zinr":string, "name":string, "resnr":int, "reslinnr":int, "activeflag":int, "resstatus":int, "sysdate":date, "zeit":int, "selflag":bool})
