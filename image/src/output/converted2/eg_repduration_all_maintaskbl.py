...
def eg_repduration_all_maintaskbl(all_room:bool, all_maintask:bool, tlocation_list:[Tlocation], tmaintask_list:[Tmaintask], troom_list:[Troom]):
    ...
    tsubtask = tproperty = troom = tmaintask = tlocation = comlocat = commain = comroom = None
    ...
    def generate_output():
        ...
        nonlocal all_room, all_maintask


        nonlocal tsubtask, tproperty, troom, tmaintask, tlocation, comlocat, commain, comroom
        nonlocal tsubtask_list, tproperty_list
