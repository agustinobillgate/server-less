...
def group_cobl(case_type:int, ci_date:date):
    ...
    mainres_list_list, Mainres_list = create_model("Mainres_list", {"resnr":int, "gastnr":int, "name":string, "zimanz":int, "arr":int, "co":int, "res":int, "dep":int, "groupname":string, "res_address":string, "res_city":string, "res_bemerk":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal mainres_list_list, res_line, guest, reservation
