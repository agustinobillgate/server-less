...
def vip_list_disp_arlist1_webbl(show_rate:bool, sorttype:int, fdate:date, lname:string, room:string, ci_date:date, tdate:date, by_period:bool):
    ...
    def disp_arlist():
        ...
        if sorttype == 1:
            ...
            res_line_obj_list = {}
            for res_line, zimkateg, guestseg, segment in db_session.query(Res_line, Zimkateg, Guestseg, Segment).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Guestseg,(Guestseg.gastnr == Res_line.gastnrmember) & ((Guestseg.segmentcode == vip_nr[0]) | (Guestseg.segmentcode == vip_nr[1]) | (Guestseg.segmentcode == vip_nr[2]) | (Guestseg.segmentcode == vip_nr[3]) | (Guestseg.segmentcode == vip_nr[4]) | (Guestseg.segmentcode == vip_nr[5]) | (Guestseg.segmentcode == vip_nr[6]) | (Guestseg.segmentcode == vip_nr[7]) | (Guestseg.segmentcode == vip_nr[8]) | (Guestseg.segmentcode == vip_nr[9]))).join(Segment,(Segment.segmentcode == Guestseg.segmentcode)).filter(
                     ((Res_line.resstatus <= 5) | (Res_line.resstatus == 11)) & (Res_line.name >= (lname).lower()) & (Res_line.zinr >= (room).lower()) & (Res_line.ankunft == ci_date)).order_by(Res_line.name).all():
                if res_line_obj_list.get(res_line._recid):
                    continue
                else:
                    res_line_obj_list[res_line._recid] = True
            ...
            res_line_obj_list = {}
            for res_line, zimkateg, guestseg, segment in db_session.query(Res_line, Zimkateg, Guestseg, Segment).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Guestseg,(Guestseg.gastnr == Res_line.gastnrmember) & ((Guestseg.segmentcode == vip_nr[0]) | (Guestseg.segmentcode == vip_nr[1]) | (Guestseg.segmentcode == vip_nr[2]) | (Guestseg.segmentcode == vip_nr[3]) | (Guestseg.segmentcode == vip_nr[4]) | (Guestseg.segmentcode == vip_nr[5]) | (Guestseg.segmentcode == vip_nr[6]) | (Guestseg.segmentcode == vip_nr[7]) | (Guestseg.segmentcode == vip_nr[8]) | (Guestseg.segmentcode == vip_nr[9]))).join(Segment,(Segment.segmentcode == Guestseg.segmentcode)).filter(
                     ((Res_line.resstatus == 6) | (Res_line.resstatus == 13)) & (Res_line.name >= (lname).lower()) & (Res_line.zinr >= (room).lower()) & (Res_line.abreise == ci_date)).order_by(Res_line.name).all():
                if res_line_obj_list.get(res_line._recid):
                    continue
                else:
                    res_line_obj_list[res_line._recid] = True
            ...
            if fdate != None:
                ...
                if by_period :
                    ...
                    res_line_obj_list = {}
                    for res_line, zimkateg, guestseg, segment in db_session.query(Res_line, Zimkateg, Guestseg, Segment).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Guestseg,(Guestseg.gastnr == Res_line.gastnrmember) & ((Guestseg.segmentcode == vip_nr[0]) | (Guestseg.segmentcode == vip_nr[1]) | (Guestseg.segmentcode == vip_nr[2]) | (Guestseg.segmentcode == vip_nr[3]) | (Guestseg.segmentcode == vip_nr[4]) | (Guestseg.segmentcode == vip_nr[5]) | (Guestseg.segmentcode == vip_nr[6]) | (Guestseg.segmentcode == vip_nr[7]) | (Guestseg.segmentcode == vip_nr[8]) | (Guestseg.segmentcode == vip_nr[9]))).join(Segment,(Segment.segmentcode == Guestseg.segmentcode)).filter(
                             (((Res_line.active_flag == 0) & (Res_line.ankunft >= fdate) & (Res_line.ankunft <= tdate) & (Res_line.name >= (lname).lower()) & (Res_line.zinr >= (room).lower())) | ((Res_line.active_flag == 1) & (Res_line.abreise >= fdate) & (Res_line.name >= (lname).lower()) & (Res_line.zinr >= (room).lower()))) & (Res_line.resstatus != 12)).order_by(Res_line.name).all():
                        if res_line_obj_list.get(res_line._recid):
                            continue
                        else:
                            res_line_obj_list[res_line._recid] = True
                    ...
                    res_line_obj_list = {}
                    for res_line, zimkateg, guestseg, segment in db_session.query(Res_line, Zimkateg, Guestseg, Segment).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Guestseg,(Guestseg.gastnr == Res_line.gastnrmember) & ((Guestseg.segmentcode == vip_nr[0]) | (Guestseg.segmentcode == vip_nr[1]) | (Guestseg.segmentcode == vip_nr[2]) | (Guestseg.segmentcode == vip_nr[3]) | (Guestseg.segmentcode == vip_nr[4]) | (Guestseg.segmentcode == vip_nr[5]) | (Guestseg.segmentcode == vip_nr[6]) | (Guestseg.segmentcode == vip_nr[7]) | (Guestseg.segmentcode == vip_nr[8]) | (Guestseg.segmentcode == vip_nr[9]))).join(Segment,(Segment.segmentcode == Guestseg.segmentcode)).filter(
                             (((Res_line.active_flag == 0) & (Res_line.ankunft >= fdate) & (Res_line.name >= (lname).lower()) & (Res_line.zinr >= (room).lower())) | ((Res_line.active_flag == 1) & (Res_line.abreise >= fdate) & (Res_line.name >= (lname).lower()) & (Res_line.zinr >= (room).lower()))) & (Res_line.resstatus != 12)).order_by(Res_line.name).all():
                        if res_line_obj_list.get(res_line._recid):
                            continue
                        else:
                            res_line_obj_list[res_line._recid] = True
                ...
                res_line_obj_list = {}
                for res_line, zimkateg, guestseg, segment in db_session.query(Res_line, Zimkateg, Guestseg, Segment).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Guestseg,(Guestseg.gastnr == Res_line.gastnrmember) & ((Guestseg.segmentcode == vip_nr[0]) | (Guestseg.segmentcode == vip_nr[1]) | (Guestseg.segmentcode == vip_nr[2]) | (Guestseg.segmentcode == vip_nr[3]) | (Guestseg.segmentcode == vip_nr[4]) | (Guestseg.segmentcode == vip_nr[5]) | (Guestseg.segmentcode == vip_nr[6]) | (Guestseg.segmentcode == vip_nr[7]) | (Guestseg.segmentcode == vip_nr[8]) | (Guestseg.segmentcode == vip_nr[9]))).join(Segment,(Segment.segmentcode == Guestseg.segmentcode)).filter(
                         (Res_line.resstatus != 9) & (Res_line.resstatus != 10) & (Res_line.resstatus != 12) & (Res_line.name >= (lname).lower())).order_by(Res_line.name).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
            ...
            if by_period :
                ...
                res_line_obj_list = {}
                for res_line, zimkateg, guestseg, segment in db_session.query(Res_line, Zimkateg, Guestseg, Segment).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Guestseg,(Guestseg.gastnr == Res_line.gastnrmember) & ((Guestseg.segmentcode == vip_nr[0]) | (Guestseg.segmentcode == vip_nr[1]) | (Guestseg.segmentcode == vip_nr[2]) | (Guestseg.segmentcode == vip_nr[3]) | (Guestseg.segmentcode == vip_nr[4]) | (Guestseg.segmentcode == vip_nr[5]) | (Guestseg.segmentcode == vip_nr[6]) | (Guestseg.segmentcode == vip_nr[7]) | (Guestseg.segmentcode == vip_nr[8]) | (Guestseg.segmentcode == vip_nr[9]))).join(Segment,(Segment.segmentcode == Guestseg.segmentcode)).filter(
                         (((Res_line.active_flag == 0) & (Res_line.ankunft >= fdate) & (Res_line.ankunft <= tdate) & (matches(Res_line.name,("*" + lname + "*"))) & (Res_line.zinr >= (room).lower())) | ((Res_line.active_flag == 1) & (Res_line.abreise >= fdate) & (matches(Res_line.name,("*" + lname + "*"))) & (Res_line.zinr >= (room).lower()))) & (Res_line.resstatus != 12)).order_by(Res_line.ankunft).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
                ...
                res_line_obj_list = {}
                for res_line, zimkateg, guestseg, segment in db_session.query(Res_line, Zimkateg, Guestseg, Segment).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Guestseg,(Guestseg.gastnr == Res_line.gastnrmember) & ((Guestseg.segmentcode == vip_nr[0]) | (Guestseg.segmentcode == vip_nr[1]) | (Guestseg.segmentcode == vip_nr[2]) | (Guestseg.segmentcode == vip_nr[3]) | (Guestseg.segmentcode == vip_nr[4]) | (Guestseg.segmentcode == vip_nr[5]) | (Guestseg.segmentcode == vip_nr[6]) | (Guestseg.segmentcode == vip_nr[7]) | (Guestseg.segmentcode == vip_nr[8]) | (Guestseg.segmentcode == vip_nr[9]))).join(Segment,(Segment.segmentcode == Guestseg.segmentcode)).filter(
                         (((Res_line.active_flag == 0) & (Res_line.ankunft >= fdate) & (matches(Res_line.name,("*" + lname + "*"))) & (Res_line.zinr >= (room).lower())) | ((Res_line.active_flag == 1) & (Res_line.abreise >= fdate) & (matches(Res_line.name,("*" + lname + "*"))) & (Res_line.zinr >= (room).lower()))) & (Res_line.resstatus != 12)).order_by(Res_line.ankunft).all():
                    if res_line_obj_list.get(res_line._recid):
                        continue
                    else:
                        res_line_obj_list[res_line._recid] = True
