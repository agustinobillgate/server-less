...
def gl_transf_headoffice11bl(pvilanguage:int, close_month:date, close_year:date):
    ...
    def generate_output():
        ...
        nonlocal t_gl_acct_list, t_gl_accthis_list
    ...
    success_flag = get_output(gl_transf_headoffice22bl(htl_code, close_month, close_year, t_gl_acct_list, t_gl_accthis_list))
