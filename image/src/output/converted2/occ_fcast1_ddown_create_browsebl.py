...
def occ_fcast1_ddown_create_browsebl(case_type:int, datum:date, curr_date:date, to_date:date, all_segm:bool, all_argt:bool, all_zikat:bool, argt_list_list:[Argt_list], segm_list_list:[Segm_list], zikat_list_list:[Zikat_list]):

    prepare_cache ([Zimmer, Guest, Zimkateg, Waehrung, Res_line, Segment, Genstat, Zinrstat, Outorder])
    ...
    def generate_output():
        ...
        nonlocal room_list_list, rmcat_list_list
