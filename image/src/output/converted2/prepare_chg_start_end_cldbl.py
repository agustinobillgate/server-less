...
def prepare_chg_start_end_cldbl(resnr:int, reslinnr:int, curr_date:date):
    ...
    t_rsv_table_list, T_rsv_table = create_model_like(Bk_reser, {"rec_id":int, "t_vorbereit":int})
    ...
    def generate_output():
        nonlocal chg_date, ci_date, update_ok, begin_i2, ending_i2, begin_time, begin_i, ending_time, ending_i, msg, t_rsv_table_list, t_bk_reser_list, i, s, bk_reser, htparam, bk_raum
        nonlocal resnr, reslinnr, curr_date
        nonlocal rsv_table


        nonlocal t_rsv_table, t_bk_reser, rsv_table
        nonlocal t_rsv_table_list, t_bk_reser_list

        return {"chg_date": chg_date, "ci_date": ci_date, "update_ok": update_ok, "begin_i2": begin_i2, "ending_i2": ending_i2, "begin_time": begin_time, "begin_i": begin_i, "ending_time": ending_time, "ending_i": ending_i, "msg": msg, "t-rsv-table": t_rsv_table_list, "t-bk-reser": t_bk_reser_list}
