...
def prepare_pr_list_1bl():
    ...
    t_l_artikel_list, T_l_artikel = create_model("T_l_artikel", {"rec_id":int, "artnr":int, "traubensort":string, "lief_einheit":Decimal, "bezeich":string, "jahrgang":int, "ek_aktuell":Decimal, "min_bestand":Decimal, "anzverbrauch":Decimal})
