...
def leadtime_rsv_4bl(fromdate:date, todate:date, from_rsv:string, to_rsv:string, exclude:bool, rm_sharer:bool, check_cdate:bool):
    ...
    def create_browse():
        ...
        if check_cdate:
            ...
            for output_list in query(output_list_list, filters=(lambda output_list: output_list.check_flag2), sort_by=[("rsvname",False),("create_date",False)]):
            ...
            for output_list in query(output_list_list, filters=(lambda output_list: output_list.check_flag1), sort_by=[("rsvname",False),("create_date",False)]):
                counter = counter + 1
            ...
            for output_list in query(output_list_list, filters=(lambda output_list: output_list.check_flag2)):
            ...
            for output_list in query(output_list_list, filters=(lambda output_list: output_list.check_flag1), sort_by=[("gastnr",False)]):
                counter = counter + 1
    ...
    def create_browse_exclude():
        ...
        if check_cdate:
            ...
            for output_list in query(output_list_list, filters=(lambda output_list: output_list.check_flag2), sort_by=[("create_date",False)]):
            ...
            for output_list in query(output_list_list, filters=(lambda output_list: output_list.check_flag1), sort_by=[("rsvname",False),("create_date",False),("gastnr",False)]):
                counter = counter + 1
    ...
    def create_browse_exclude1():
        ...
        if check_cdate:
            ...
            for output_list in query(output_list_list, filters=(lambda output_list: output_list.check_flag1), sort_by=[("create_date",False),("gastnr",False)]):
                counter = counter + 1
    ...
    for output_list in query(output_list_list, filters=(lambda output_list: output_list.check_flag)):
