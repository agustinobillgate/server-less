...
def modify_allotmentbl(i_case:int, user_init:string, reslin_list_list:[Reslin_list], s_list_list:[S_list]):
    ...
    def generate_output():
        ...
        return {"overbook": overbook, "allotcode": allotcode, "s-list": s_list_list}
    ...
    def check_slist():
        ...
        for s_list in query(s_list_list, sort_by=[("datum",False)]):
            create_it = True
