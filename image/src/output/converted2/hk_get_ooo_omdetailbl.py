...
def hk_get_ooo_omdetailbl(roomnumber:string, resnumber:int, fromdate:date, todate:date):
    ...
    def generate_output():
        ...
        nonlocal t_outorder_list, t_res_line_list

        return {"roomno": roomno, "resno": resno, "resname": resname, "from_date": from_date, "to_date": to_date, "reason": reason}

    t_outorder_list = get_output(read_outorderbl(99, roomnumber, resnumber, fromdate, todate))
    t_res_line_list = get_output(read_res_linebl(24, resnumber, None, None, None, roomnumber, None, None, None, None, ""))
