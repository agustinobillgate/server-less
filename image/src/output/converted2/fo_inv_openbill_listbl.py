...
def fo_inv_openbill_listbl(bil_flag:int, bil_recid:int, room:string, vipflag:bool, fill_co:bool, double_currency:bool, foreign_rate:bool):
    ...
    abreise, resname, res_exrate, zimmer_bezeich, kreditlimit, master_str, master_rechnr, bill_anzahl, queasy_char1, disp_warning, flag_report, t_res_line_list, t_bill_list = get_output(fo_invoice_open_bill_cldbl(bil_flag, bil_recid, room, vipflag))
