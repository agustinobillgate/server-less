...
def mobile_reportbl(case_type:int, from_date:date, to_date:date):
    ...
    rlist_list, Rlist = create_model("Rlist", {"gastnr":int, "gname":string, "arrive":date, "depart":date, "ci_mobile":string, "ci_fda":string, "scan_mobile":string, "scan_fda":string, "sign_mobile":string, "sign_fda":string, "rc_mobile":string, "rc_fda":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal rlist_list, loopi, str1, tot_cimb, tot_cifda, tot_scanmb, tot_scanfda, tot_signmb, tot_signfda, tot_rcmb, tot_rcfda, res_line
