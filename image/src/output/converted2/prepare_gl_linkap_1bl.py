...
def prepare_gl_linkap_1bl():
    ...
    def generate_output():
        nonlocal f_int, last_acctdate, acct_date, close_year, msg_str, gl_jouhdr_list_list, last_acct_period, tmpdate, htparam, gl_jouhdr


        nonlocal gl_jouhdr_list
        nonlocal gl_jouhdr_list_list

        return {"f_int": f_int, "last_acctdate": last_acctdate, "acct_date": acct_date, "close_year": close_year, "msg_str": msg_str, "gl-jouhdr-list": gl_jouhdr_list_list}
