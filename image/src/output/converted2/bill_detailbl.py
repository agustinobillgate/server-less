...
def bill_detailbl(resno:int, reslinno:int):
    ...
    b_detail_list, B_detail = create_model("B_detail", {"resno":Decimal, "erwachs":int, "kind1":int, "kind2":int, "gratis":int, "nama":string, "rt":string, "arg":string, "room":string, "arr":date, "dep":date})
