...
def gcf_btn_go_2bl(icase:int, pvilanguage:int, user_init:string, refno4:string, t_guest_list:[T_guest]):
    ...
    tlist_list, Tlist = create_model("Tlist", {"tfield":string, "tcount":int})
