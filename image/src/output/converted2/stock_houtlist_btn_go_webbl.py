...
def stock_houtlist_btn_go_webbl(pvilanguage:int, trans_code:string, from_grp:int, mi_alloc_chk:bool, mi_article_chk:bool, mi_docu_chk:bool, mi_date_chk:bool, from_lager:int, to_lager:int, from_date:date, to_date:date, from_art:int, to_art:int, deptno:int, long_digit:bool, cost_acct:string, mattype:int, mi_sub_group:bool):
    ...
    s_list_list, S_list = create_model("S_list", {"fibu":string, "cost_center":string, "bezeich":string, "cost":Decimal})
    str_list_list, Str_list = create_model("Str_list", {"fibu":string, "other_fibu":bool, "op_recid":int, "lscheinnr":string, "s":string, "mark":string, "gldept":string, "masseinheit":string, "datum":string, "bezeich":string, "artnr":string, "description":string, "anzahl":string, "einzelpreis":string, "warenwert":string, "remark_artikel":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal it_exist, str_list_list, tot_anz, tot_amount, i, lvcarea, gl_acct, l_lager, l_ophhis, gl_department, l_artikel, l_ophis, parameters, queasy, l_untergrup
    ...
    def create_lista():
        ...
        for l_lager in db_session.query(L_lager).filter(
            ...
            if CONNECTED ("vhparch"):
                ...
                l_ophis_obj_list = {}
                for l_ophis, l_ophhis, gl_acct, gl_department, l_artikel in db_session.query(L_ophis, L_ophhis, Gl_acct, Gl_department, L_artikel).join(L_ophhis,(L_ophhis.op_typ == ("STT").lower()) & (L_ophhis.lscheinnr == L_ophis.lscheinnr) & (L_ophhis.fibukonto != "")).join(Gl_acct,(Gl_acct.fibukonto == L_ophis.fibukonto)).join(Gl_department,(Gl_department.nr == Gl_acct.deptnr)).join(L_artikel,(L_artikel.artnr == L_ophis.artnr)).filter(
                         (L_ophis.lager_nr == l_lager.lager_nr) & (L_ophis.datum >= from_date) & (L_ophis.datum <= to_date) & (L_ophis.artnr >= from_art) & (L_ophis.artnr <= to_art) & (L_ophis.anzahl != 0) & (L_ophis.op_art == 3)).order_by(L_ophis.datum, L_ophis.lscheinnr, L_ophis.artnr).all():
                    ...
                    if create_it:
                        ...
                        if not long_digit:
                            ...
                            if l_ophis.einzelpreis > 9999999:
                                str_list.datum = to_string(l_ophis.datum)
    ...
    def create_listb():
        ...
        for l_lager in db_session.query(L_lager).filter(
            ...
            if CONNECTED ("vhparch"):
                ...
                l_ophis_obj_list = {}
                for l_ophis, l_ophhis, gl_acct, gl_department, l_artikel in db_session.query(L_ophis, L_ophhis, Gl_acct, Gl_department, L_artikel).join(L_ophhis,(L_ophhis.op_typ == ("STT").lower()) & (L_ophhis.lscheinnr == L_ophis.lscheinnr) & (L_ophhis.fibukonto != "")).join(Gl_acct,(Gl_acct.fibukonto == L_ophis.fibukonto)).join(Gl_department,(Gl_department.nr == Gl_acct.deptnr)).join(L_artikel,(L_artikel.artnr == L_ophis.artnr)).filter(
                         (L_ophis.lager_nr == l_lager.lager_nr) & (L_ophis.datum >= from_date) & (L_ophis.datum <= to_date) & (L_ophis.artnr >= from_art) & (L_ophis.artnr <= to_art) & (L_ophis.anzahl != 0) & (L_ophis.op_art == 3)).order_by(L_ophis.lscheinnr, L_ophis.artnr).all():
                    if l_ophis_obj_list.get(l_ophis._recid):
                        continue
                    else:
                        l_ophis_obj_list[l_ophis._recid] = True
        ...
        str_list.bezeich = to_string("", "x(8)") +\
                to_string(translateExtended ("SUMMARY OF EXPENSES", lvcarea, "") , "x(30)")
        str_list.mark = "Summary"
    ...
    def create_listc():
        ...
        for l_lager in db_session.query(L_lager).filter(
            ...
            if CONNECTED ("vhparch"):
                ...
                l_ophis_obj_list = {}
                for l_ophis, l_ophhis, gl_acct, gl_department, l_artikel in db_session.query(L_ophis, L_ophhis, Gl_acct, Gl_department, L_artikel).join(L_ophhis,(L_ophhis.op_typ == ("STT").lower()) & (L_ophhis.lscheinnr == L_ophis.lscheinnr) & (L_ophhis.fibukonto != "")).join(Gl_acct,(Gl_acct.fibukonto == L_ophis.fibukonto)).join(Gl_department,(Gl_department.nr == Gl_acct.deptnr)).join(L_artikel,(L_artikel.artnr == L_ophis.artnr)).filter(
                         (L_ophis.lager_nr == l_lager.lager_nr) & (L_ophis.datum >= from_date) & (L_ophis.datum <= to_date) & (L_ophis.artnr >= from_art) & (L_ophis.artnr <= to_art) & (L_ophis.anzahl != 0) & (L_ophis.op_art == 3)).order_by(L_ophis.datum, L_ophis.artnr).all():
                    if l_ophis_obj_list.get(l_ophis._recid):
                        continue
                    else:
                        l_ophis_obj_list[l_ophis._recid] = True
    ...
    def create_list():
        ...
        for l_lager in db_session.query(L_lager).filter(
            ...
            if CONNECTED ("vhparch"):
                ...
                l_ophis_obj_list = {}
                for l_ophis, l_ophhis, gl_acct, gl_department, l_artikel in db_session.query(L_ophis, L_ophhis, Gl_acct, Gl_department, L_artikel).join(L_ophhis,(L_ophhis.op_typ == ("STT").lower()) & (L_ophhis.lscheinnr == L_ophis.lscheinnr) & (L_ophhis.fibukonto != "")).join(Gl_acct,(Gl_acct.fibukonto == L_ophis.fibukonto)).join(Gl_department,(Gl_department.nr == Gl_acct.deptnr)).join(L_artikel,(L_artikel.artnr == L_ophis.artnr)).filter(
                         (L_ophis.lager_nr == l_lager.lager_nr) & (L_ophis.datum >= from_date) & (L_ophis.datum <= to_date) & (L_ophis.artnr >= from_art) & (L_ophis.artnr <= to_art) & (L_ophis.anzahl != 0) & (L_ophis.op_art == 3)).order_by(L_ophis.fibukonto, L_ophis.datum, L_ophis.artnr).all():
                    if l_ophis_obj_list.get(l_ophis._recid):
                        continue
                    else:
                        l_ophis_obj_list[l_ophis._recid] = True
    ...
    def create_list1():
        ...
        for l_lager in db_session.query(L_lager).filter(
            ...
            if CONNECTED ("vhparch"):
                ...
                l_ophis_obj_list = {}
                for l_ophis, l_ophhis, gl_acct, gl_department, l_artikel, l_untergrup in db_session.query(L_ophis, L_ophhis, Gl_acct, Gl_department, L_artikel, L_untergrup).join(L_ophhis,(L_ophhis.op_typ == ("STT").lower()) & (L_ophhis.lscheinnr == L_ophis.lscheinnr) & (L_ophhis.fibukonto != "")).join(Gl_acct,(Gl_acct.fibukonto == L_ophis.fibukonto)).join(Gl_department,(Gl_department.nr == Gl_acct.deptnr)).join(L_artikel,(L_artikel.artnr == L_ophis.artnr) & (L_artikel.endkum == from_grp)).join(L_untergrup,(L_untergrup.zwkum == L_artikel.zwkum) & ((L_untergrup.betriebsnr >= grp1) & (L_untergrup.betriebsnr <= grp2))).filter(
                         (L_ophis.lager_nr == l_lager.lager_nr) & (L_ophis.datum >= from_date) & (L_ophis.datum <= to_date) & (L_ophis.artnr >= from_art) & (L_ophis.artnr <= to_art) & (L_ophis.anzahl != 0) & (L_ophis.op_art == 3)).order_by(L_ophis.fibukonto, L_ophhis.fibukonto, L_ophis.datum, L_ophis.artnr).all():
                    if l_ophis_obj_list.get(l_ophis._recid):
                        continue
                    else:
                        l_ophis_obj_list[l_ophis._recid] = True
    ...
    def create_list1a():
        ...
        for l_lager in db_session.query(L_lager).filter(
            ...
            if CONNECTED ("vhparch"):
                ...
                l_ophis_obj_list = {}
                for l_ophis, l_artikel, l_ophhis, gl_acct, gl_department, l_untergrup in db_session.query(L_ophis, L_artikel, L_ophhis, Gl_acct, Gl_department, L_untergrup).join(L_artikel,(L_artikel.artnr == L_ophis.artnr) & (L_artikel.endkum == from_grp)).join(L_ophhis,(L_ophhis.op_typ == ("STT").lower()) & (L_ophhis.lscheinnr == L_ophis.lscheinnr) & (L_ophhis.fibukonto != "")).join(Gl_acct,(Gl_acct.fibukonto == L_ophis.fibukonto)).join(Gl_department,(Gl_department.nr == Gl_acct.deptnr)).join(L_untergrup,(L_untergrup.zwkum == L_artikel.zwkum) & ((L_untergrup.betriebsnr >= grp1) & (L_untergrup.betriebsnr <= grp2))).filter(
                         (L_ophis.lager_nr == l_lager.lager_nr) & (L_ophis.datum >= from_date) & (L_ophis.datum <= to_date) & (L_ophis.artnr >= from_art) & (L_ophis.artnr <= to_art) & (L_ophis.anzahl != 0) & (L_ophis.op_art == 3)).order_by(L_ophis.datum, L_ophis.lscheinnr, L_ophis.artnr).all():
                    if l_ophis_obj_list.get(l_ophis._recid):
                        continue
                    else:
    ...
    def create_listd():
        ...
        for l_lager in db_session.query(L_lager).filter(
            ...
            if CONNECTED ("vhparch"):
                ...
                l_ophis_obj_list = {}
                for l_ophis, l_ophhis, gl_acct, gl_department, l_artikel, l_untergrup in db_session.query(L_ophis, L_ophhis, Gl_acct, Gl_department, L_artikel, L_untergrup).join(L_ophhis,(L_ophhis.op_typ == ("STT").lower()) & (L_ophhis.lscheinnr == L_ophis.lscheinnr) & (L_ophhis.fibukonto != "")).join(Gl_acct,(Gl_acct.fibukonto == L_ophis.fibukonto)).join(Gl_department,(Gl_department.nr == Gl_acct.deptnr)).join(L_artikel,(L_artikel.artnr == L_ophis.artnr)).join(L_untergrup,(L_untergrup.zwkum == L_artikel.zwkum) & ((L_untergrup.betriebsnr >= grp1) & (L_untergrup.betriebsnr <= grp2))).filter(
                         (L_ophis.lager_nr == l_lager.lager_nr) & (L_ophis.datum >= from_date) & (L_ophis.datum <= to_date) & (L_ophis.artnr >= from_art) & (L_ophis.artnr <= to_art) & (L_ophis.anzahl != 0) & (L_ophis.op_art == 3)).order_by(L_untergrup.bezeich, L_ophis.datum, L_ophis.artnr).all():
                    if l_ophis_obj_list.get(l_ophis._recid):
                        continue
                    else:
                        l_ophis_obj_list[l_ophis._recid] = True
