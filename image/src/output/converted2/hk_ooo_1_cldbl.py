...
def hk_ooo_1_cldbl(om_list_list:[Om_list], fdate:date, tdate:date, disptype:int, sorttype:int, user_init:string):
    ...
    def assign_it():
        ...
        ooo_list.rec_id = outorder._recid
