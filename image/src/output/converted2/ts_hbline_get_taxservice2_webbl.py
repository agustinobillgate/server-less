...
t_amount_list_list, T_amount_list = create_model("T_amount_list", {"nr":int, "anzahl":int, "menu_recid":int, "amount":Decimal})

def ts_hbline_get_taxservice2_webbl(vmode:int, hbill_recid:int, menu_nr:int, dept:int, artnr:int, price:Decimal, anzahl:int, incl_vat:bool, balance:Decimal, t_amount_list_list:[T_amount_list]):
    ...
    def generate_output():
        ...
        return {"amount": amount, "balance": balance, "t-amount-list": t_amount_list_list}
