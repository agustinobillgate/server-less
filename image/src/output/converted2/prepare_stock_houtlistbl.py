...
def prepare_stock_houtlistbl(lnl_filepath:string, lnl_prog:string):
    ...
    def generate_output():
        ...
        return {"lnl_filepath": lnl_filepath, "long_digit": long_digit, "avail_l_untergrup": avail_l_untergrup, "t-l-hauptgrp": t_l_hauptgrp_list, "t-parameters": t_parameters_list}
