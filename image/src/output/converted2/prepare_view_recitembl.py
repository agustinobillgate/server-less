...
def prepare_view_recitembl(artnr:int, curr_i:int):
    ...
    h_list_list, H_list = create_model("H_list", {"str":string, "portion":int, "artnr":int, "bezeich":string, "lostfact":Decimal, "menge":Decimal, "cost":Decimal, "r_artnr":int, "r_flag":bool, "costportion":Decimal})
