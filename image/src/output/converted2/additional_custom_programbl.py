...
def additional_custom_programbl(prog_name:string, prog_title:string, prog_description:string, prog_type:int, prog_flag:bool, case_type:int, prog_number:int, prog_hotel_code:string, prog_password:string):
    ...
    program_list_list, Program_list = create_model("Program_list", {"prog_number":int, "prog_hotel_code":string, "prog_name":string, "prog_title":string, "prog_description":string, "prog_type":int, "prog_flag":bool, "prog_password":string, "prog_hashpassword":string})
