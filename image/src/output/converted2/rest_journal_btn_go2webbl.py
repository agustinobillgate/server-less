...
def rest_journal_btn_go2webbl(od_taker:string, from_art:int, to_art:int, from_dept:int, to_dept:int, from_date:date, to_date:date, sorttype:int, long_digit:bool):
    ...
    output_list_list, Output_list = create_model("Output_list", {"date1":date, "tableno":int, "billno":int, "artno":int, "bezeich":string, "depart":string, "qty":int, "amount":string, "zeit":int, "id":string, "guestname":string, "h_recid":int, "order_taker":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal output_list_list, disc_art1, disc_art2, disc_art3, curr_time, counter, counter2, htparam, queasy, hoteldpt, h_journal, h_bill, res_line, guest, h_artikel
    ...
    def journal_list():
        ...
        nonlocal output_list_list, disc_art1, disc_art2, disc_art3, counter, counter2, htparam, queasy, hoteldpt, h_journal, h_bill, res_line, guest, h_artikel
        nonlocal od_taker, from_art, to_art, from_dept, to_dept, from_date, to_date, sorttype, long_digit
