...
def print_bill_lnlbl(t_spbill_list_list:[T_spbill_list], pvilanguage:int, curr_status:string, briefnr:int, resnr:int, reslinnr:int, inv_type:int, rechnr:int, curr_program:string, gastnr:int, spbill_flag:bool, user_init:string, lnldelimeter:string):
    ...
    sum_tbl_list, Sum_tbl = create_model("Sum_tbl", {"mwst_code":int, "sum_date":string, "sum_roomnr":string, "sum_desc":string, "sum_amount":Decimal, "sum_id":string, "sum_amount_bef_tax":Decimal}, {"sum_date": "", "sum_roomnr": "", "sum_desc": "", "sum_id": ""})
    t_str3_list, T_str3 = create_model("T_str3", {"str3":string})
    bl_guest_list, bl_guest = create_model("bl_guest", {"zinr":string, "curr_guest":string})
    ...
    def generate_output():
        ...
        nonlocal bline_list_list, sum_tbl_list, t_str3_list, bl_guest_list, bline_vatlist_list
