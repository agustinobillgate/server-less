...
payload_list_list, Payload_list = create_model("Payload_list", {"user_init":string, "reason":string, "lscheinnr":string})

def storereq_list_unapprove_webbl(payload_list_list:[Payload_list]):
    ...
    response_list_list, Response_list = create_model("Response_list", {"success_status":bool, "msg_str":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal response_list_list, user_init, reason, lscheinnr, success_status, msg_str, log_msg, l_op, htparam, l_ophdr, bediener, res_history
