...
def prepare_print_receiving_cld_1bl(pvilanguage:int, docu_nr:string, user_init:string, po_nr:string, lief_nr:int, store:int, to_date:date):
    ...
    str_list_list, Str_list = create_model("Str_list", {"artnr":string, "qty":Decimal, "warenwert":string, "munit":string, "fibu":string, "fibu_ze":string, "addvat_value":Decimal, "bezeich":string, "lscheinnr":string, "unit_price":string})
    ...
    def create_list():
        ...
        if b_lop:
            ...
            l_op = L_op()
            l_artikel = L_artikel()
            for l_op.lscheinnr, l_op.lager_nr, l_op.anzahl, l_op.warenwert, l_op.einzelpreis, l_op.artnr, l_op.stornogrund, l_op.docu_nr, l_op._recid, l_artikel.masseinheit, l_artikel.bezeich, l_artikel._recid in db_session.query(L_op.lscheinnr, L_op.lager_nr, L_op.anzahl, L_op.warenwert, L_op.einzelpreis, L_op.artnr, L_op.stornogrund, L_op.docu_nr, L_op._recid, L_artikel.masseinheit, L_artikel.bezeich, L_artikel._recid).join(L_artikel,(L_artikel.artnr == L_op.artnr)).filter(
                ...
                if l_op.stornogrund != "":
                    ...
                    str_list = query(str_list_list, filters=(lambda str_list: str_list.artnr == to_string(l_op.artnr, ">>>>>>>>")), first=True)
                ...
                if not create_it:
                    ...
                    str_list.unit_price = to_string(unit_price, "->>>,>>>,>>>,>>9.99")
            ...
            for l_ophis.lscheinnr, l_ophis.lager_nr, l_ophis.anzahl, l_ophis.warenwert, l_ophis.einzelpreis, l_ophis.artnr, l_ophis.fibukonto, l_ophis.docu_nr, l_ophis._recid, l_artikel.masseinheit, l_artikel.bezeich, l_artikel._recid in db_session.query(L_ophis.lscheinnr, L_ophis.lager_nr, L_ophis.anzahl, L_ophis.warenwert, L_ophis.einzelpreis, L_ophis.artnr, L_ophis.fibukonto, L_ophis.docu_nr, L_ophis._recid, L_artikel.masseinheit, L_artikel.bezeich, L_artikel._recid).join(L_artikel,(L_artikel.artnr == L_ophis.artnr)).filter(
                ...
                str_list = query(str_list_list, filters=(lambda str_list: str_list.to_int(str_list.artnr) == l_ophis.artnr), first=True)
                create_it = not None != str_list
        ...
        if b_lop:
            ...
            for l_op.lscheinnr, l_op.lager_nr, l_op.anzahl, l_op.warenwert, l_op.einzelpreis, l_op.artnr, l_op.stornogrund, l_op.docu_nr, l_op._recid, l_artikel.masseinheit, l_artikel.bezeich, l_artikel._recid in db_session.query(L_op.lscheinnr, L_op.lager_nr, L_op.anzahl, L_op.warenwert, L_op.einzelpreis, L_op.artnr, L_op.stornogrund, L_op.docu_nr, L_op._recid, L_artikel.masseinheit, L_artikel.bezeich, L_artikel._recid).join(L_artikel,(L_artikel.artnr == L_op.artnr)).filter(
                ...
                if l_op.stornogrund != "":
                    ...
                    str_list = query(str_list_list, filters=(lambda str_list: str_list.to_int(str_list.artnr) == l_op.artnr), first=True)
                    create_it = not None != str_list
