...
def po_invoice_btn_gobl(pvilanguage:int, s_list_list:[S_list], f_endkum:int, b_endkum:int, m_endkum:int, fb_closedate:date, m_closedate:date, lscheinnr:string):
    ...
    def generate_output():
        ...
        return {"s-list": s_list_list, "tot_amt": tot_amt, "tot_disc": tot_disc, "tot_disc2": tot_disc2, "tot_vat": tot_vat, "tot_val": tot_val, "confirm_flag": confirm_flag, "msg_str": msg_str, "msg_str2": msg_str2}
