...
def main_fs_proc_btn_stopbl(fsl_list:[Fsl], resnr:int, resline:int, curr_gastnr:int, curr_amd:string, user_init:string):
    ...
    def generate_output():
        nonlocal bstorno_list, bk_func, b_storno
        nonlocal resnr, resline, curr_gastnr, curr_amd, user_init


        nonlocal fsl, bstorno
        nonlocal bstorno_list

        return {"bstorno": bstorno_list}
