...
def mk_resline_go1_1bl(pvilanguage:int, user_init:string, specrequest:bool, c_apply:string, incl_gname:bool, incl_ginhouse:bool, curr_resline_list:[Curr_resline]):
    ...
    zwunsch_rline_list, Zwunsch_rline = create_model("Zwunsch_rline", {"s_label":string, "s_value1":string, "s_value2":string, "used":bool})
    zwunsch_rmember_list, Zwunsch_rmember = create_model("Zwunsch_rmember", {"s_label":string, "s_value2":string})
    update_fixrate_list, Update_fixrate = create_model("Update_fixrate", {"date1":date, "date2":date, "argt":string})
    ...
    def generate_output():
        ...
        nonlocal t_resline_list, member_list_list, zwunsch_rline_list, zwunsch_rmember_list, update_fixrate_list
    ...
    def check_fixrates_changes():
        ...
        for reslin_queasy in db_session.query(Reslin_queasy).filter(
            ...
            if reslin_queasy.date1 < reslin_queasy.date2:
                ...
                update_fixrate = query(update_fixrate_list, filters=(lambda update_fixrate: update_fixrate.date1 == rqsy.date1 and update_fixrate.date2 == rqsy.date2), first=True)

                if not update_fixrate:
                    update_fixrate = Update_fixrate()
                    update_fixrate_list.append(update_fixrate)
    ...
    for i in range(1,num_entries(res_line.zimmer_wunsch, ";") - 1 + 1) :
        ...
        if substring(str, 0, 7) == ("voucher").lower() :
            ...
            zwunsch_rline = query(zwunsch_rline_list, filters=(lambda zwunsch_rline: zwunsch_rline.s_label.lower()  == ("voucher").lower()), first=True)
            ...
            zwunsch_rline = query(zwunsch_rline_list, filters=(lambda zwunsch_rline: zwunsch_rline.s_label.lower()  == ("ChAge").lower()), first=True)
            ...
            zwunsch_rline = query(zwunsch_rline_list, filters=(lambda zwunsch_rline: zwunsch_rline.s_label.lower()  == ("&CODE$").lower()), first=True)
            ...
            zwunsch_rline = query(zwunsch_rline_list, filters=(lambda zwunsch_rline: zwunsch_rline.s_label.lower()  == ("DATE,").lower()), first=True)
            ...
            zwunsch_rline = query(zwunsch_rline_list, filters=(lambda zwunsch_rline: zwunsch_rline.s_label.lower()  == ("SEGM_PUR").lower()), first=True)
            ...
            zwunsch_rline = query(zwunsch_rline_list, filters=(lambda zwunsch_rline: zwunsch_rline.s_label.lower()  == ("ebdisc").lower()), first=True)
            ...
            zwunsch_rline = query(zwunsch_rline_list, filters=(lambda zwunsch_rline: zwunsch_rline.s_label.lower()  == ("kbdisx").lower()), first=True)
            ...
            zwunsch_rline = query(zwunsch_rline_list, filters=(lambda zwunsch_rline: zwunsch_rline.s_label.lower()  == ("restricted").lower()), first=True)
            ...
            zwunsch_rline = query(zwunsch_rline_list, filters=(lambda zwunsch_rline: zwunsch_rline.s_label.lower()  == ("pickup").lower()), first=True)
            ...
            zwunsch_rline = query(zwunsch_rline_list, filters=(lambda zwunsch_rline: zwunsch_rline.s_label.lower()  == ("drop-passanger").lower()), first=True)
            ...
            zwunsch_rline = query(zwunsch_rline_list, filters=(lambda zwunsch_rline: zwunsch_rline.s_label.lower()  == ("WCI-req").lower()), first=True)
