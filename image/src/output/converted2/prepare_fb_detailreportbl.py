...
def prepare_fb_detailreportbl(from_dept:int, to_dept:int):
    ...
    def generate_output():
        nonlocal to_date, from_date, depname1, depname2, t_hoteldpt_list, t_htpchar, hoteldpt
        ...
        return {"from_dept": from_dept, "to_dept": to_dept, "to_date": to_date, "from_date": from_date, "depname1": depname1, "depname2": depname2, "t-hoteldpt": t_hoteldpt_list}
