        ...
        if rm_bcol != 15 and reslin_list.zinr == "":
            ...
            if outorder and outorder.gespstart < outorder.gespend:
                ...
                if from_date != to_date:
                    ...
                    rline = get_cache (Res_line, {"active_flag": [(le, 1)],"resnr": [(ne, reslin_list.resnr)],"ankunft": [(lt, from_date)],"abreise ": [(gt, from_date)],"zinr": [(eq, reslin_list.zinr)]})
