...
def s_transform_btn_go_1bl(op_list_list:[Op_list], rec_id:int, curr_lager:int, curr_pos:int, transdate:date, wip_acct:string, to_stock:int, s_artnr1:int, qty1:Decimal, bediener_nr:int, lscheinnr:string):
