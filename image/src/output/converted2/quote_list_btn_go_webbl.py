...
t_quote_list, T_quote = create_model("T_quote", {"artnr":int, "lief_nr":int, "supname":string, "artname":string, "devunit":string, "content":Decimal, "unitprice":Decimal, "curr":string, "from_date":date, "to_date":date, "remark":string, "filname":string, "activeflag":bool, "docu_nr":string, "minqty":Decimal, "delivday":int, "disc":Decimal, "avl":bool}, {"avl": True})
t_quote1_list, T_quote1 = create_model("T_quote1", {"artnr":int, "lief_nr":int, "supname":string, "artname":string, "devunit":string, "content":Decimal, "unitprice":Decimal, "curr":string, "from_date":date, "to_date":date, "remark":string, "filname":string, "activeflag":bool, "docu_nr":string, "minqty":Decimal, "delivday":int, "disc":Decimal, "avl":bool}, {"avl": True})

def quote_list_btn_go_webbl(pvilanguage:int, curr_type:string, user_init:string, base64image:string, t_quote_list:[T_quote], t_quote1_list:[T_quote1]):
    ...
    def generate_output():
        ...
        nonlocal pvilanguage, curr_type, user_init, base64image, t_quote1_list
        nonlocal b_lquote
