...
def ar_debtlistbl(from_name:str, to_name:str, from_date:date, to_date:date, from_art:int, to_art:int, tot_flag:bool, lesspay:bool, show_inv:bool, case_type:int):
    d_rechnr = 0
    output_list_list = []
    edit_list_list = []
    ...
    output_list_list, Output_list = create_model("Output_list", {"ar_recid":int, "info":str, "wabkurz":str, "maildate":date, "inv_no":str, "datum":date, "mflag":str, "bill_no":int, "rm_no":str, "receiver":str, "saldo":decimal, "fsaldo":decimal, "userinit":str, "vesrcod":str, "ref_no1":int, "ref_no2":str, "ci_date":date, "co_date":date, "nights":int, "verstat":int, "selected":bool, "ref_no3":int})
            ...
            if saldo != 0:
                ...
                if debitor.betriebsnr == 0:
                    ...
                    if bill:
                        ...
                        if debitor.vesrcod != " " and re.match(r".*Deposit Payment.*",debitor.vesrcod, re.IGNORECASE):
