...
def pj_arrive1_webbl(pvilanguage:int, from_date:date, to_date:date, ci_date:date, disptype:int, incl_tentative:bool, sorttype:int, comment_type:int, incl_accompany:bool, split_rsv_print:bool, total_flag:bool):
    ...
    def generate_output():
        nonlocal tot_rm, tot_a, tot_c, tot_co, s_list_list, t_cl_list_list, lvcarea, curr_date, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, ol_gastnr, sms_gastnr, wg_gastnr, indi_gastnr, nr, vip_flag, i, dummy_flag, do_it, last_gcf, tentres, all_remark, stat_list, guest, htparam, zimkateg, reservation, sourccod, res_line, guestseg, segment, zimmer, nation, mc_guest, mc_types, queasy, reslin_queasy, history, paramtext
        ...
        return {"tot_rm": tot_rm, "tot_a": tot_a, "tot_c": tot_c, "tot_co": tot_co, "s-list": s_list_list, "t-cl-list": t_cl_list_list}

    def create_arrival(curr_date:date):

        nonlocal tot_rm, tot_a, tot_c, tot_co, s_list_list, t_cl_list_list, lvcarea, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, ol_gastnr, sms_gastnr, wg_gastnr, indi_gastnr, nr, vip_flag, i, dummy_flag, do_it, last_gcf, tentres, all_remark, stat_list, guest, htparam, zimkateg, reservation, sourccod, res_line, guestseg, segment, zimmer, nation, mc_guest, mc_types, queasy, reslin_queasy, history, paramtext
        nonlocal pvilanguage, from_date, to_date, ci_date, disptype, incl_tentative, sorttype, comment_type, incl_accompany, split_rsv_print, total_flag
        nonlocal gmember, gbuff
        ...
        if sorttype == 1:
            ...
            for res_line.zinr, res_line.resnr, res_line.ankunft, res_line.gastnr, res_line.setup, res_line.zimmer_wunsch, res_line.name, res_line.zipreis, res_line.zimmeranz, res_line.abreise, res_line.erwachs, res_line.kind1, res_line.kind2, res_line.gratis, res_line.arrangement, res_line.flight_nr, res_line.cancelled_id, res_line.ankzeit, res_line.resstatus, res_line.bemerk, res_line.gastnrmember, res_line.reslinnr, res_line._recid, zimkateg.kurzbez, zimkateg.bezeichnung, zimkateg._recid, reservation.segmentcode, reservation.groupname, reservation.resdat, reservation.useridanlage, reservation.bemerk, reservation._recid, sourccod.bezeich, sourccod._recid, guest.name, guest.vorname1, guest.anrede1, guest.anredefirma, guest.bemerkung, guest.karteityp, guest._recid, guest.gastnr, guest.nation1, guest.aufenthalte, guest.email_adr, guest.wohnort, guest.geburtdatum1, guest.telefon, guest.nation2, gmember.name, gmember.vorname1, gmember.anrede1, gmember.anredefirma, gmember.bemerkung, gmember.karteityp, gmember._recid, gmember.gastnr, gmember.nation1, gmember.aufenthalte, gmember.email_adr, gmember.wohnort, gmember.geburtdatum1, gmember.telefon, gmember.nation2 in db_session.query(Res_line.zinr, Res_line.resnr, Res_line.ankunft, Res_line.gastnr, Res_line.setup, Res_line.zimmer_wunsch, Res_line.name, Res_line.zipreis, Res_line.zimmeranz, Res_line.abreise, Res_line.erwachs, Res_line.kind1, Res_line.kind2, Res_line.gratis, Res_line.arrangement, Res_line.flight_nr, Res_line.cancelled_id, Res_line.ankzeit, Res_line.resstatus, Res_line.bemerk, Res_line.gastnrmember, Res_line.reslinnr, Res_line._recid, Zimkateg.kurzbez, Zimkateg.bezeichnung, Zimkateg._recid, Reservation.segmentcode, Reservation.groupname, Reservation.resdat, Reservation.useridanlage, Reservation.bemerk, Reservation._recid, Sourccod.bezeich, Sourccod._recid, Guest.name, Guest.vorname1, Guest.anrede1, Guest.anredefirma, Guest.bemerkung, Guest.karteityp, Guest._recid, Guest.gastnr, Guest.nation1, Guest.aufenthalte, Guest.email_adr, Guest.wohnort, Guest.geburtdatum1, Guest.telefon, Guest.nation2, Gmember.name, Gmember.vorname1, Gmember.anrede1, Gmember.anredefirma, Gmember.bemerkung, Gmember.karteityp, Gmember._recid, Gmember.gastnr, Gmember.nation1, Gmember.aufenthalte, Gmember.email_adr, Gmember.wohnort, Gmember.geburtdatum1, Gmember.telefon, Gmember.nation2).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Sourccod,(Sourccod.source_code == Reservation.resart)).join(Guest,(Guest.gastnr == Reservation.gastnr)).join(Gmember,(Gmember.gastnr == Res_line.gastnrmember)).filter(
                ...
                if not incl_accompany:
                    ...
                    cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.rmno == res_line.zinr and cl_list.resnr == res_line.resnr and date_mdy(cl_list.arrival) == res_line.ankunft and to_decimal(cl_list.zipreis) == 0 and cl_list.a == 0 and (cl_list.res_stat == 11 or cl_list.res_stat == 13) and cl_list.co < 1), first=True)
    ...
    def add_cllist():
        ...
        cl_list.rmcat = zimkateg.kurzbez + schar
        ...
        if res_line.abreise > res_line.ankunft:
            cl_list.night = (res_line.abreise - res_line.ankunft).days
        ...
        if gmember.telefon != "" and gmember.telefon != None:
            cl_list.phonenum = gmember.telefon
        ...
        if mc_guest:
            ...
            if mc_types:
                cl_list.memberno = mc_guest.cardnum
                cl_list.member_typ = mc_types.bezeich
        ...
        if sorttype == 1:
            ...
            for res_line.zinr, res_line.resnr, res_line.ankunft, res_line.gastnr, res_line.setup, res_line.zimmer_wunsch, res_line.name, res_line.zipreis, res_line.zimmeranz, res_line.abreise, res_line.erwachs, res_line.kind1, res_line.kind2, res_line.gratis, res_line.arrangement, res_line.flight_nr, res_line.cancelled_id, res_line.ankzeit, res_line.resstatus, res_line.bemerk, res_line.gastnrmember, res_line.reslinnr, res_line._recid, zimkateg.kurzbez, zimkateg.bezeichnung, zimkateg._recid, reservation.segmentcode, reservation.groupname, reservation.resdat, reservation.useridanlage, reservation.bemerk, reservation._recid, sourccod.bezeich, sourccod._recid, guest.name, guest.vorname1, guest.anrede1, guest.anredefirma, guest.bemerkung, guest.karteityp, guest._recid, guest.gastnr, guest.nation1, guest.aufenthalte, guest.email_adr, guest.wohnort, guest.geburtdatum1, guest.telefon, guest.nation2, gmember.name, gmember.vorname1, gmember.anrede1, gmember.anredefirma, gmember.bemerkung, gmember.karteityp, gmember._recid, gmember.gastnr, gmember.nation1, gmember.aufenthalte, gmember.email_adr, gmember.wohnort, gmember.geburtdatum1, gmember.telefon, gmember.nation2 in db_session.query(Res_line.zinr, Res_line.resnr, Res_line.ankunft, Res_line.gastnr, Res_line.setup, Res_line.zimmer_wunsch, Res_line.name, Res_line.zipreis, Res_line.zimmeranz, Res_line.abreise, Res_line.erwachs, Res_line.kind1, Res_line.kind2, Res_line.gratis, Res_line.arrangement, Res_line.flight_nr, Res_line.cancelled_id, Res_line.ankzeit, Res_line.resstatus, Res_line.bemerk, Res_line.gastnrmember, Res_line.reslinnr, Res_line._recid, Zimkateg.kurzbez, Zimkateg.bezeichnung, Zimkateg._recid, Reservation.segmentcode, Reservation.groupname, Reservation.resdat, Reservation.useridanlage, Reservation.bemerk, Reservation._recid, Sourccod.bezeich, Sourccod._recid, Guest.name, Guest.vorname1, Guest.anrede1, Guest.anredefirma, Guest.bemerkung, Guest.karteityp, Guest._recid, Guest.gastnr, Guest.nation1, Guest.aufenthalte, Guest.email_adr, Guest.wohnort, Guest.geburtdatum1, Guest.telefon, Guest.nation2, Gmember.name, Gmember.vorname1, Gmember.anrede1, Gmember.anredefirma, Gmember.bemerkung, Gmember.karteityp, Gmember._recid, Gmember.gastnr, Gmember.nation1, Gmember.aufenthalte, Gmember.email_adr, Gmember.wohnort, Gmember.geburtdatum1, Gmember.telefon, Gmember.nation2).join(Zimkateg,(Zimkateg.zikatnr == Res_line.zikatnr)).join(Reservation,(Reservation.resnr == Res_line.resnr)).join(Sourccod,(Sourccod.source_code == Reservation.resart)).join(Guest,(Guest.gastnr == Reservation.gastnr)).join(Gmember,(Gmember.gastnr == Res_line.gastnrmember)).filter(
                ...
                if not incl_accompany:
                    ...
                    cl_list = query(cl_list_list, filters=(lambda cl_list: cl_list.rmno == res_line.zinr and cl_list.resnr == res_line.resnr and date_mdy(cl_list.arrival) == res_line.ankunft and to_decimal(cl_list.zipreis) == 0 and cl_list.a == 0 and (cl_list.res_stat == 8 or cl_list.res_stat == 11 or cl_list.res_stat == 13) and cl_list.co < 1), first=True)
    ...
    def create_browse():
        ...
        for cl_list in query(cl_list_list):
            ...
            t_cl_list.ci_id = cl_list.ci_id
            t_cl_list.stat_flag = cl_list.stat_flag
            t_cl_list.datum = cl_list.datum
            t_cl_list.flag = cl_list.flag
            t_cl_list.nr = cl_list.nr
            t_cl_list.vip = cl_list.vip
            t_cl_list.gastnr = cl_list.gastnr
            t_cl_list.resnr = cl_list.resnr
            t_cl_list.name = t_cl_list.name
            t_cl_list.groupname = cl_list.groupname
            t_cl_list.zimmeranz = cl_list.zimmeranz
            t_cl_list.rmno = cl_list.rmno
            t_cl_list.qty = cl_list.qty
            t_cl_list.zipreis = cl_list.zipreis
            t_cl_list.arrival = cl_list.arrival
            t_cl_list.depart = cl_list.depart
            t_cl_list.rmcat = cl_list.rmcat
            t_cl_list.kurzbez = cl_list.kurzbez
            t_cl_list.bezeich = cl_list.bezeich
            t_cl_list.a = cl_list.a
            t_cl_list.c = cl_list.c
            t_cl_list.co = cl_list.co
            t_cl_list.pax = cl_list.pax
            t_cl_list.nat = cl_list.nat
            t_cl_list.nation = cl_list.nation
            t_cl_list.argt = cl_list.argt
            t_cl_list.company = cl_list.company
            t_cl_list.flight = cl_list.flight
            t_cl_list.etd = cl_list.etd
            t_cl_list.stay = cl_list.stay
            t_cl_list.segment = cl_list.segment
            t_cl_list.rate_code = cl_list.rate_code
            t_cl_list.eta = cl_list.eta
            t_cl_list.email = cl_list.email
            t_cl_list.bemerk = cl_list.bemerk
            t_cl_list.bemerk01 = cl_list.bemerk01
            t_cl_list.bemerk02 = cl_list.bemerk02
            t_cl_list.bemerk03 = cl_list.bemerk03
            t_cl_list.bemerk04 = cl_list.bemerk04
            t_cl_list.bemerk05 = cl_list.bemerk05
            t_cl_list.bemerk06 = cl_list.bemerk06
            t_cl_list.bemerk07 = cl_list.bemerk07
            t_cl_list.bemerk08 = cl_list.bemerk08
            t_cl_list.spreq = cl_list.spreq
            t_cl_list.memberno = cl_list.memberno
            t_cl_list.resdate = cl_list.resdate
            t_cl_list.sob = cl_list.sob
            t_cl_list.created_by = cl_list.created_by
            t_cl_list.ci_time = cl_list.ci_time
            t_cl_list.city = cl_list.city
            t_cl_list.res_stat = cl_list.res_stat
            t_cl_list.res_stat_str = cl_list.res_stat_str
            t_cl_list.nation2 = cl_list.nation2
            t_cl_list.birthdate = cl_list.birthdate
            t_cl_list.rsv_comment = cl_list.rsv_comment
            t_cl_list.other_comment = cl_list.other_comment
            t_cl_list.g_comment = cl_list.g_comment
            t_cl_list.zinr_bez = cl_list.zinr_bez
            t_cl_list.flag_guest = cl_list.flag_guest
            t_cl_list.night = cl_list.night
            t_cl_list.phonenum = cl_list.phonenum
            t_cl_list.member_typ = cl_list.member_typ
