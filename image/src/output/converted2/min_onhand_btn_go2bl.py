...
def min_onhand_btn_go2bl(sorttype:int, main_grp:int, from_store3:int, to_store3:int, show_price:bool):
    ...
    min_onhand_list_list, Min_onhand_list = create_model("Min_onhand_list", {"artnr":int, "name":string, "min_oh":Decimal, "curr_oh":Decimal, "avrgprice":Decimal, "ek_aktuell":Decimal, "datum":date})
