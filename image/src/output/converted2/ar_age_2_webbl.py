...
def ar_age_2_webbl(pvilanguage:int, from_art:int, to_art:int, to_date:date, from_name:string, to_name:string, disptype:int, cvt_flag:bool, dollar_rate:Decimal):
    ...
    arage_list_list, Arage_list = create_model("Arage_list", {"curr":string, "gastnr":int, "number_str":string, "customer_name":string, "outstanding":string, "age1":string, "age2":string, "age3":string, "age4":string, "creditlimit":Decimal, "balance":Decimal, "creditlimit_str":string, "balance_str":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal outlist, arage_list_list, tmpdays, lvcarea, default_fcurr, day1, day2, day3, price_decimal, long_digit, htparam, debitor, artikel, guest, waehrung
        ...
        nonlocal ledger_list, age_list_list, arage_list_list

        return {"outlist": outlist, "arage-list": arage_list_list}
