...
input_list_list, Input_list = create_model("Input_list", {"sorttype":int, "segmcode":int, "start_jan":date, "from_date":date, "to_date":date, "excl_tax":bool})

def rest_stat2_webbl(input_list_list:[Input_list]):
                    ...
                    if artikel:
                        ...
                        if input_list.segmcode == segm_no:
                            ...
                            if not t_list:
                                ...
                                guest = get_cache (Guest, {"gastnr": [(eq, guest_no)],"guest_no": [(ne, 0)]})
