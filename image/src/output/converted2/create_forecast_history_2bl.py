...
def create_forecast_history_2bl(fr_date:date, to_date:date, excl_comp:bool, vhp_limited:bool, scin:bool):
    ...
    def generate_output():
        nonlocal t_list_list, ci_date, htparam, res_line, kontline, guest, nation, genstat, segment, sourccod, arrangement, waehrung, reservation, bill_line, zimmer, queasy, reslin_queasy
