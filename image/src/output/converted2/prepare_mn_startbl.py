...
def prepare_mn_startbl(case_type:int, pvilanguage:int):
    ...
    na_list_list, Na_list = create_model("Na_list", {"reihenfolge":int, "flag":int, "anz":int, "bezeich":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal mn_stopped, stop_it, arrival_guest, msg_str, mess_str, crm_license, banquet_license, na_list_list, lvcarea, ci_date, new_contrate, contcode, created_date, wd_array, htparam, bill, res_line, guest, reslin_queasy, res_history, waehrung, reservation, arrangement, artikel, guest_pr, queasy, segment, zimkateg, fixleist, katpreis, pricecod, argt_line, pricegrp, resplan, zimplan, zimmer, outorder
    ...
    def update_rmstatus():
        ...
        nonlocal mn_stopped, stop_it, arrival_guest, msg_str, mess_str, crm_license, banquet_license, na_list_list, lvcarea, new_contrate, contcode, created_date, wd_array, htparam, bill, res_line, guest, reslin_queasy, res_history, waehrung, reservation, arrangement, artikel, guest_pr, queasy, segment, zimkateg, fixleist, katpreis, pricecod, argt_line, pricegrp, resplan, zimplan, zimmer, outorder
        nonlocal case_type, pvilanguage
