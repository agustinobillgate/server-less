...
def prepare_gl_linkarbl(combo_pf_file1:string, combo_pf_file2:string, combo_gastnr:int, combo_ledger:int, combo_gl_link:bool):
    ...
    def generate_output():
        ...
        return {"f_int": f_int, "last_acctdate": last_acctdate, "from_date": from_date, "acct_date": acct_date, "close_year": close_year, "combo_pf_file1": combo_pf_file1, "combo_pf_file2": combo_pf_file2, "combo_gastnr": combo_gastnr, "combo_ledger": combo_ledger, "combo_gl_link": combo_gl_link}
