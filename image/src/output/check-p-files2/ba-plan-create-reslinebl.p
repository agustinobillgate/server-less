...
FIND FIRST guest WHERE guest.gastnr = guest-gastnr NO-LOCK.
...
ELSE bk-reser.von-zeit = STRING(ftime,"99") + "30". 
IF round((bkl-ttime / 2) - 0.1, 0) * 2 LT bkl-ttime THEN 
bk-reser.bis-zeit = STRING(ttime,"99") + "30". 
ELSE bk-reser.bis-zeit = STRING(ttime + 1,"99") + "00". 
ASSIGN
...
CREATE bk-func. 
ASSIGN 
    bk-func.veran-nr = bk-reser.veran-nr
    bk-func.veran-seite = reslinnr
    bk-func.resstatus = bk-reser.resstatus 
    bk-func.datum = bk-reser.datum
    bk-func.bis-datum = bk-reser.bis-datum 
    bk-func.uhrzeit = STRING(bk-reser.von-zeit,"99:99" ) + " - " + STRING(bk-reser.bis-zeit,"99:99")
    ...
    bk-func.veranstalteranschrift[1] = adresse1
    bk-func.veranstalteranschrift[2] = adresse2 
    bk-func.veranstalteranschrift[3] = adresse3 
    ...
    bk-func.resnr[1] = bk-reser.veran-resnr 
    bk-func.r-resstatus[1] = bk-reser.resstatus
...
DO: 
    ...
    ASSIGN
      ...
      bk-veran.veran-nr = bk-reser.veran-nr 
      bk-veran.resnr = bk-reser.veran-resnr 
      bk-veran.bediener-nr = bediener-nr
      bk-veran.resstatus = bk-reser.resstatus 
      bk-veran.departement = ba-dept
      bk-veran.kontaktfirst = ci-date
      bk-veran.resdat = bk-reser.bis-datum 
      bk-veran.limit-date = bk-reser.datum
...
CREATE t-bk-reser1.
ASSIGN
    t-bk-reser1.veran-nr    = bk-reser.veran-nr
    t-bk-reser1.resstatus   = bk-reser.resstatus
    t-bk-reser1.datum       = bk-reser.datum
    t-bk-reser1.bis-datum   = bk-reser.bis-datum
    t-bk-reser1.raum        = bk-reser.raum
    t-bk-reser1.von-zeit    = bk-reser.von-zeit
    t-bk-reser1.bis-zeit    = bk-reser.bis-zeit
    t-bk-reser1.veran-resnr = bk-reser.veran-resnr.
