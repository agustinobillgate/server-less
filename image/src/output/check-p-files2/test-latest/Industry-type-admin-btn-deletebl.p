...
FIND FIRST queasy WHERE queasy.KEY = 281
    AND queasy.number1 = number1 NO-LOCK NO-ERROR.
IF AVAILABLE queasy THEN
DO:
    FIND CURRENT queasy EXCLUSIVE-LOCK.
    FIND FIRST q212 WHERE q212.KEY EQ 282 AND q212.number1 EQ queasy.number1 NO-LOCK NO-ERROR.
    IF AVAILABLE q212 THEN
    DO:
        str-msg = "Member entries exist, deleting Industry Type Profile not possible".
    END.
    ELSE
    DO:
        str-msg = "".
