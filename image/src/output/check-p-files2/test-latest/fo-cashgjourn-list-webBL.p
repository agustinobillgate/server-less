...
/* Oscar (09/01/25) - 5CA701 - add filter to separate payment from FO and Outlet*/
...
/* Oscar (09/01/25) - 5CA701 - change file name from bl to cld bl and add new parameter */
RUN fo-cashgjourn-cldbl.p (pvILanguage, case-type, curr-shift, summary-flag, onlyjournal, excljournal, INPUT-OUTPUT from-date, 
    OUTPUT double-currency, OUTPUT foreign-curr, INPUT-OUTPUT TABLE bline-list, OUTPUT TABLE output-list).
