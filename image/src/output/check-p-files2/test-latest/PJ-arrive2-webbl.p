...
DEFINE TEMP-TABLE zikat-list 
  FIELD selected AS LOGICAL INITIAL FALSE 
...
DEFINE TEMP-TABLE arrangement-list 
  FIELD selected AS LOGICAL INITIAL FALSE
...
DEFINE INPUT PARAMETER TABLE FOR zikat-list. /*bernatd*/
DEFINE INPUT PARAMETER TABLE FOR segm1-list. /*bernatd*/
DEFINE INPUT PARAMETER TABLE FOR arrangement-list. /*bernatd*/
...
PROCEDURE create-arrival: 
 DEFINE INPUT PARAMETER curr-date AS DATE.
  ...
  FOR EACH res-line WHERE res-line.active-flag LE 1 
    ...
    AND zikat-list.SELECTED = TRUE NO-LOCK,
    FIRST arrangement-list WHERE arrangement-list.argt = res-line.arrangement 
    AND arrangement-list.SELECTED = TRUE NO-LOCK,
    ...
    AND segm1-list.SELECTED = TRUE NO-LOCK, 
...
PROCEDURE add-cllist:
    ...
    ASSIGN 
      ...
      cl-list.co        = res-line.gratis 
       ...
       cl-list.argt     = arrangement-list.argt 
    ...
    FOR EACH t-cl-list BY t-cl-list.datum BY t-cl-list.nr:
      ...
      DO:
        ...
        DO loopi = 1 TO NUM-ENTRIES(t-list.counter,";"):
            ...
            IF INT(counter-str) = t-cl-list.resnr THEN found = TRUE.
        END.
        IF NOT found THEN
