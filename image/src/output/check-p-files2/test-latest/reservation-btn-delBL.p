...
IF NOT AVAILABLE res-line THEN RETURN. /* Malik serverless 406 */
...
DEFINE BUFFER resline1     FOR res-line. 
  ...
  IF deposit AND reservation1.bestat-datum = ? /* guest mot checked-in yet */ THEN /* Malik Serverless 406 : reservation1.bestat-dat -> reservation1.bestat-datum */
  DO: 
