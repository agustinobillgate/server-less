...
DO:
    ...
    DO: 
        ...
        RUN func-food-to-bev(fl-eknr, bl-eknr).                 /* Rulita 160525 | Fixing serverless name proc from food-bev to func-food-to-bev issue git 642 */
...
PROCEDURE beverage-to-food: 
    ...
    IF AVAILABLE gl-acct THEN                                                       /* Rulita 080625 | If Avail issue git 642 */
    DO:
...
/* Rulita 160525 | Fixing serverless name proc from food-bev to func-food-to-bev issue git 642 */
PROCEDURE func-food-to-bev: 
    DEFINE INPUT PARAMETER fl-eknr AS INTEGER. 
    DEFINE INPUT PARAMETER bl-eknr AS INTEGER. 
