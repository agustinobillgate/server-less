...
FOR EACH output-list:
    ...
    DO:
        IF NOT output-list.str MATCHES ("*T O T A L*") 
            OR NOT output-list.str MATCHES ("*Grand Total*") THEN
        /*output-list.gname = guest.name + ", " + guest.vorname1 + " " + guest.anrede1.*/
              ...
              DO: 
                  ...
                  DO:
                      ...
                      DO:
                          ...
                          DO:
                              ...
                              DO:
                                  FIND FIRST gbuff WHERE gbuff.gastnr = res-line.gastnrmember USE-INDEX gastnr_index
                                      NO-LOCK NO-ERROR.
                                  IF AVAILABLE gbuff THEN
                                  DO:
                                    output-list.gname = gbuff.name + ", " + gbuff.vorname1 + " "
                ...
                DO:
                  ...
                  DO:
                    ...
                    lvcs = SUBSTR(billjournal.bezeich, INDEX(billjournal.bezeich,"[#") + 2).
                    lviresnr = INTEGER(ENTRY(1,lvcs," ")) NO-ERROR.
                    FIND FIRST res-line WHERE res-line.resnr = lviresnr
                        NO-LOCK NO-ERROR.
                    IF AVAILABLE res-line THEN
                    DO:
...
DEFINE BUFFER gbuff FOR guest.
  ...
  END. 
  CREATE output-list. 
  IF NOT long-digit THEN STR = STRING("", "x(49)") 
  + STRING("Grand TOTAL ", "x(12)") 
  + STRING("", "x(6)")
  + STRING(gqty, "-9999") 
  + STRING(tot, "->,>>>,>>>,>>9.99"). 
