  ...
  DO: 
    ...
    DO: 
      ...
      ELSE IF curr-cmd = 85  OR curr-cmd = 86 
        ...
        OR curr-cmd = 7194 
        OR curr-cmd = 7195 OR curr-cmd = 7196
...
RUN fo-parxls-gs_1bl.p
    (pvILanguage, ytd-flag, jan1, Ljan1, Lfrom-date, Lto-date,
     ...
     budget-flag, foreign-nr, price-decimal,briefnr,link,budget-all,user-init,
     TABLE w1,TABLE w2, OUTPUT msg-str, OUTPUT error-nr).
