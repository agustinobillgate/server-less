...
DEFINE TEMP-TABLE temp-outlist 
  FIELD ankunft   LIKE res-line.ankunft 
  FIELD abreise   LIKE res-line.abreise COLUMN-LABEL "Departure" 
  FIELD zinr      LIKE res-line.zinr FORMAT " x(6)" COLUMN-LABEL "RmNo"     /*MT 25/07/12 */
  FIELD resnr     LIKE res-line.resnr 
...
/*FDL Feb 16, 2024 => Ticket F7924B*/
DEFINE VARIABLE curr-resno      AS INTEGER.
DEFINE VARIABLE curr-reslinno   AS INTEGER.
DEFINE VARIABLE curr-rmno       AS CHARACTER.
...
IF sort-rmcat = YES THEN DO: /*sorting rmcat*/
    ...
    DO:
      FOR EACH genstat WHERE genstat.datum GE fr-date AND genstat.datum LE to-date 
        ...
        /*FDL Feb 16, 2024 => Ticket F7924B*/
        do-it = NO.
        FIND FIRST output-list WHERE output-list.resnr EQ genstat.resnr
          AND output-list.zinr EQ genstat.zinr NO-LOCK NO-ERROR.
        IF NOT AVAILABLE output-list THEN do-it = YES.
        ...
        DO:        
          ...
          FOR EACH fixleist WHERE fixleist.resnr = res-line.resnr 
            ...
            ASSIGN 
              output-list.amount  = output-list.zipreis * output-list.night    /*FDL 17 Oct, 2023 => Ticket 7D74F1*/
...
/*FDL 17 Oct, 2023 => Ticket 7D74F1 => Move Above
FOR EACH output-list NO-LOCK:
    output-list.amount = output-list.zipreis * output-list.night.
END.
*/
