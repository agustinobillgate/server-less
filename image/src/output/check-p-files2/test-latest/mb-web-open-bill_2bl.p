...
FIND FIRST t-bill No-LOCK NO-ERROR. /* Malik Serverless : NO-LOCK -> No-LOCK NO-ERROR */

IF NOT AVAILABLE t-bill THEN RETURN.
ASSIGN
...
FOR EACH b1-list:
    ...
    DO:
        gname = gname + b1-list.NAME + "  " + "#" + b1-list.zinr + "  " + "#" + STRING(b1-list.ankunft) + "-" + STRING(b1-list.abreise) + "|".
    END.
