...
DEFINE INPUT PARAMETER argt-nr      AS INTEGER  NO-UNDO.
DEFINE INPUT PARAMETER vt-percnt    AS INTEGER  NO-UNDO.
...
CASE case-type :
    ...
    DO: 
        ...
        DO:
          FOR EACH argt-line WHERE argt-line.argtnr = argtNo
              AND argt-line.vt-percnt = vt-percnt NO-LOCK:
            CREATE t-argt-line.
            BUFFER-COPY argt-line TO t-argt-line.
          END.
          RETURN.
        ...
        FIND FIRST argt-line WHERE argt-line.argtnr = argtNo 
            AND argt-line.argt-artnr = artNo 
            AND argt-line.departement = dept
            AND argt-line.vt-percnt = vt-percnt NO-LOCK NO-ERROR.
        IF AVAILABLE argt-line THEN
        DO:
          CREATE t-argt-line.
          BUFFER-COPY argt-line TO t-argt-line.
    ...
    DO: 
        IF artNo = ? THEN
        DO:
          FOR EACH argt-line WHERE argt-line.argtnr = argt-nr
              AND argt-line.vt-percnt = vt-percnt NO-LOCK:
            CREATE t-argt-line.
            BUFFER-COPY argt-line TO t-argt-line.
          END.
        ...
        FIND FIRST argt-line WHERE argt-line.argtnr = argt-nr 
            AND argt-line.argt-artnr = artNo 
            AND argt-line.departement = dept
            AND argt-line.vt-percnt = vt-percnt NO-LOCK NO-ERROR.
        IF AVAILABLE argt-line THEN
