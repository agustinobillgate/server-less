        ...
        DO: 
            ...
            FOR EACH s-list WHERE s-list.datum NE ? AND i LT (k + 3) 
                ...
                DO: 
                    ...
                    . 
                    IF NUM-ENTRIES(s-list.id, CHR(2)) GT 1 THEN
                    ASSIGN reslin-queasy.char1 = reslin-queasy.char1 
                                               + CHR(2) + ENTRY(2, s-list.id, CHR(2)).
                END.
                ...
                DO: 
                    ...
                    . 
                    IF NUM-ENTRIES(s-list.id, CHR(2)) GT 1 THEN
                    ASSIGN reslin-queasy.char2 = reslin-queasy.char2 
                                               + CHR(2) + ENTRY(2, s-list.id, CHR(2)).
                END. 
                IF i = (k + 2) THEN 
                DO: 
                    ...
                    . 
                    IF NUM-ENTRIES(s-list.id, CHR(2)) GT 1 THEN
                    ASSIGN reslin-queasy.char3 = reslin-queasy.char3 
                                               + CHR(2) + ENTRY(2, s-list.id, CHR(2)).
                END.
            END.
        END.
