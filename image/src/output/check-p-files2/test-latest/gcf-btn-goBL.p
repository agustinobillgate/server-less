...
PROCEDURE update-record:
  ...
  DO:
    ...
    DO:
      ...
      res-history.aenderung = res-history.aenderung + "Changed Picture file from "      
                            + guest.vornamekind[1].
    END.
...
PROCEDURE new-record:
  ...
  /* tambahan untuk ChronDigital GuestProfile Chrondigital (Damien Lee) CRG 23Nov18 */
  IF guest.karteityp GT 0 THEN
      RUN intevent-1.p(36, "", "newgcf", guest.gastnr, guest.karteityp).
