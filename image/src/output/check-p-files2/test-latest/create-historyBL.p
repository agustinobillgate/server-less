...
DEFINE VARIABLE usr-id AS CHAR FORMAT "x(5)".
...
DO: 
  ...
  history.bemerk = STRING(htparam.fdate) 
    + ": Moved to" + " " + res-line.zinr
    + CHR(10) + ziwechsel-str.

  history.bemerk = history.bemerk + CHR(2) + user-init.
