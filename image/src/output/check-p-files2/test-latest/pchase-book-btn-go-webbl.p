DEFINE TEMP-TABLE pchase-list
    ...
    FIELD anzahl        AS DECIMAL /* Oscar (06/03/2025) - 7AB3C7 - Change data type from integer to decimal to fix auto rounding */  
    FIELD einzelpreis   AS DECIMAL  
    FIELD warenwert     AS DECIMAL  
    FIELD remark        AS CHAR    
    FIELD artnr         AS INTEGER 
    FIELD bezeich       AS CHAR 
    FIELD deliv-note    AS CHAR /* Naufal Afthar - 2107C0*/
    .
    ...
    DO:
      FOR EACH l-pprice WHERE l-pprice.bestelldatum GE f-date 
          ...
          ASSIGN pchase-list.bestelldatum  = l-pprice.bestelldatum 
                 ...
                 pchase-list.deliv-note    = l-pprice.docu-nr /* Naufal Afthar - 2107C0*/
          ...
          /* Naufal Afthar - 2107C0*/
          FIND FIRST l-op WHERE l-op.lscheinnr EQ l-pprice.docu-nr
              AND l-op.lief-nr EQ l-pprice.lief-nr
              AND l-op.artnr EQ s-artnr 
              AND l-op.datum EQ l-pprice.bestelldatum NO-LOCK NO-ERROR.
          IF NOT AVAILABLE l-op THEN 
              FIND FIRST l-op WHERE l-op.docu-nr EQ l-pprice.docu-nr
                  AND l-op.lief-nr EQ l-pprice.lief-nr
                  AND l-op.artnr EQ s-artnr 
                  AND l-op.datum EQ l-pprice.bestelldatum NO-LOCK NO-ERROR.
          ...
          DO:
              IF l-op.docu-nr EQ l-op.lscheinnr THEN pchase-list.docu-nr = "Direct Purchase   ".
              ELSE 
                  ASSIGN
                      pchase-list.docu-nr = l-op.docu-nr
                      pchase-list.deliv-note = l-op.lscheinnr.
          END.
          ELSE pchase-list.docu-nr = l-pprice.docu-nr.
          /* end Naufal Afthar*/
      END.  
    END.
   ...
   DO:
     FOR EACH l-pprice WHERE l-pprice.bestelldatum GE f-date AND l-pprice.bestelldatum LE t-date NO-LOCK,
         ...
         /*end sis*/
          ...
          FIND FIRST l-op WHERE l-op.lscheinnr EQ l-pprice.docu-nr
              AND l-op.lief-nr EQ l-pprice.lief-nr
              AND l-op.artnr EQ l-pprice.artnr 
              AND l-op.datum EQ l-pprice.bestelldatum NO-LOCK NO-ERROR.
          IF NOT AVAILABLE l-op THEN 
              FIND FIRST l-op WHERE l-op.docu-nr EQ l-pprice.docu-nr
                  AND l-op.lief-nr EQ l-pprice.lief-nr
