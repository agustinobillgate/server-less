...
DEFINE TEMP-TABLE esign-print NO-UNDO
    ...
    FIELD sign-position AS CHARACTER
    .

DEFINE TEMP-TABLE reorder-esign-print LIKE esign-print.
...
DO:
    ...
    DO:
        ...
        /* Oscar (21/02/25) - 883ED5 - fix e-sign PO shifting when there is blank e-sign */
        DO i = 1 TO 4:
            FIND FIRST esign-print WHERE esign-print.sign-nr EQ i NO-LOCK NO-ERROR.
            IF AVAILABLE esign-print THEN
            DO:
                CREATE reorder-esign-print.
                BUFFER-COPY esign-print TO reorder-esign-print.
            END.
            ELSE
            DO:
                CREATE reorder-esign-print.
                reorder-esign-print.sign-nr = i.
            END.
        END.
        
        FOR EACH esign-print:
            DELETE esign-print.
        END.
        
        FOR EACH reorder-esign-print:
            CREATE esign-print.
            BUFFER-COPY reorder-esign-print TO esign-print.
        END.
    END.
END.
