...
DO:
    ...
    DO: 
        FIND FIRST artikel WHERE artikel.departement EQ 0 AND artikel.artnr EQ guest.zahlungsart NO-LOCK NO-ERROR. /* Malik Serverless : departement -> WHERE artikel.departement EQ 0 */
