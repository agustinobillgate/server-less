...
RUN fo-journalbl.p (from-art, to-art, from-dept, to-dept, from-date, to-date,
    sorttype, exclude-ARTrans, long-digit, foreign-flag,
    onlyjournal, excljournal, mi-post, OUTPUT gtot, OUTPUT TABLE output-list).
...
FOR EACH output-list:
    ...
    ASSIGN 
        ...
        fo-journal-list.guestname  = SUBSTRING(output-list.STR,167,25) 
