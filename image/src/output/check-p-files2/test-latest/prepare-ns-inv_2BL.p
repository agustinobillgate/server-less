...
DEFINE OUTPUT PARAMETER cashless-license    AS LOGICAL INITIAL NO. /*FDL - Cashless Payment Feature*/
DEFINE OUTPUT PARAMETER cashless-minsaldo   AS DECIMAL. /*FDL - Cashless Payment Feature*/
DEFINE OUTPUT PARAMETER ns-useraccess       AS LOGICAL INITIAL NO. /*FDL - March 20, 2023 => Ticket 61B212*/
...
FIND FIRST htparam WHERE htparam.paramnr EQ 1022
    AND htparam.bezeichnung NE "not used" /* Malik serverless : htparam.bezeich -> htparam.bezeichnung */
...
RUN htplogic.p (589, OUTPUT ns-useraccess).
