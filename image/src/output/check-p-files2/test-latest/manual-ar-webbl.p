...
DEF VAR user-remark  AS CHAR INITIAL "".
...
FOR EACH sbuff WHERE DECIMAL(sbuff.fibukonto) NE 0:
    ...
    /* Oscar (04/03/25) - FB3160 - adjust to add user-remark */
    IF sbuff.remark EQ ? OR sbuff.remark EQ "" THEN
        user-remark = "".
    ELSE
        user-remark = " - " + sbuff.remark.
    ...
    ASSIGN 
         ...
         gl-journal.userinit = user-init 
         gl-journal.zeit = TIME 
         gl-journal.bemerk = STRING(invoice) + user-remark
