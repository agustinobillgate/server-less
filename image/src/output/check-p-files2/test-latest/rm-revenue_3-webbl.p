DEFINE TEMP-TABLE output-list
  ...
  FIELD com-pax     AS INTEGER
  FIELD hu-rm       AS INTEGER
  FIELD hu-pax      AS INTEGER
  FIELD rm-rev      AS DECIMAL 
  FIELD percent     AS DECIMAL 
  FIELD mtdrm       AS INTEGER
  FIELD pax1        AS INTEGER
  FIELD com-mtdrm   AS INTEGER
  FIELD com-pax1    AS INTEGER
  FIELD hu-mtdrm    AS INTEGER
  FIELD hu-pax1     AS INTEGER
  FIELD rm-rev1     AS DECIMAL 
  FIELD percent1    AS DECIMAL
  FIELD ftdrm       AS INTEGER
  FIELD pax2        AS INTEGER
  FIELD com-ftdrm   AS INTEGER
  FIELD com-pax2    AS INTEGER
  FIELD hu-ftdrm    AS INTEGER
  FIELD hu-pax2     AS INTEGER
...
DEFINE TEMP-TABLE cl-list 
  ...
  FIELD com-anz     AS INTEGER FORMAT ">>9" 
  FIELD com-pax     AS INTEGER FORMAT ">>9"
  FIELD hu-anz      AS INTEGER FORMAT ">>9" 
  FIELD hu-pax      AS INTEGER FORMAT ">>9"
  ...
  FIELD com-manz    AS INTEGER FORMAT /*">>,>>9"*/  ">>>>9"
  FIELD com-mpax    AS INTEGER FORMAT ">>,>>9" 
  FIELD hu-manz     AS INTEGER FORMAT /*">>,>>9"*/  ">>>>9"
  FIELD hu-mpax     AS INTEGER FORMAT ">>,>>9" 
  ...
  FIELD com-yanz    AS INTEGER FORMAT ">>>,>>9"
  FIELD com-ypax    AS INTEGER FORMAT ">>>,>>9"
  FIELD hu-yanz     AS INTEGER FORMAT ">>>,>>9"
  FIELD hu-ypax     AS INTEGER FORMAT ">>>,>>9"
  FIELD ynet        AS DECIMAL FORMAT "->>>,>>>,>>9.99" INITIAL 0 
  FIELD proz2       AS DECIMAL FORMAT "->>9.99" INITIAL 0. 

DEFINE TEMP-TABLE payload-list
  FIELD show-breakdown-comphu AS LOGICAL.
...
DEFINE VARIABLE com-anz             AS INTEGER FORMAT ">>9". 
DEFINE VARIABLE com-manz            AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE com-yanz            AS INTEGER FORMAT ">>>,>>9".
DEFINE VARIABLE hu-anz              AS INTEGER FORMAT ">>9". 
DEFINE VARIABLE hu-manz             AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE hu-yanz             AS INTEGER FORMAT ">>>,>>9". 
DEFINE VARIABLE pax                 AS INTEGER FORMAT ">>9". 
DEFINE VARIABLE mpax                AS INTEGER FORMAT ">>,>>9". 
DEFINE VARIABLE ypax                AS INTEGER FORMAT ">>>,>>9". 
DEFINE VARIABLE com-pax             AS INTEGER FORMAT ">>9". 
DEFINE VARIABLE com-mpax            AS INTEGER FORMAT ">>,>>9". 
DEFINE VARIABLE com-ypax            AS INTEGER FORMAT ">>>,>>9".
DEFINE VARIABLE hu-pax              AS INTEGER FORMAT ">>9". 
DEFINE VARIABLE hu-mpax             AS INTEGER FORMAT ">>,>>9". 
DEFINE VARIABLE hu-ypax             AS INTEGER FORMAT ">>>,>>9".
...
DEFINE VARIABLE t-com-anz           AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE t-com-pax           AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE t-com-manz          AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE t-com-mpax          AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE t-com-yanz          AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE t-com-ypax          AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE t-hu-anz            AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE t-hu-pax            AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE t-hu-manz           AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE t-hu-mpax           AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE t-hu-yanz           AS INTEGER FORMAT ">>,>>9".
DEFINE VARIABLE t-hu-ypax           AS INTEGER FORMAT ">>,>>9".
...
/*FDL March 07, 2025: 031FCA*/
FIND FIRST payload-list NO-LOCK NO-ERROR.
IF AVAILABLE payload-list THEN
DO:
    IF payload-list.show-breakdown-comphu EQ ? THEN payload-list.show-breakdown-comphu = NO.
    IF excl-compl THEN payload-list.show-breakdown-comphu = NO.
    IF payload-list.show-breakdown-comphu THEN excl-compl = NO.
END.

IF (NOT excl-compl AND NOT payload-list.show-breakdown-comphu) 
    OR excl-compl AND NOT payload-list.show-breakdown-comphu THEN
DO:
    ...
    END.
END.
ELSE IF NOT excl-compl AND payload-list.show-breakdown-comphu THEN /*FDL March 07, 2025: 031FCA*/
DO:
    IF m-ftd AND f-date GE ci-date AND t-date GE ci-date THEN /*FDL June 10, 2024 => Ticket 23EAEE*/
    DO:
        RUN create-resline2.
    ...
    ELSE 
    DO:
        IF lod_rev = YES THEN RUN create-genstat2. 
        ELSE RUN create-zinrstat2.
    END.
END.
...
PROCEDURE create-resline2:
    ...
    DO:
        ...
        FOR EACH res-line WHERE (res-line.active-flag LE 1 
            ...
            DO:
                ...
                DO:
                    IF segment.betriebsnr EQ 1 THEN compli-flag = YES.
                    ELSE IF segment.betriebsnr EQ 2 THEN hu-flag = YES.
                END.
                ...
                DO datum = s-datum TO e-datum:
                    ...
                    DO:                        
                        IF compli-flag THEN
                        DO: 
                            cl-list.com-anz = cl-list.com-anz + res-line.zimmeranz.
                            cl-list.com-pax = cl-list.com-pax + res-line.erwachs + res-line.gratis +
                                res-line.kind1 + res-line.kind2.
                            com-anz         = com-anz + res-line.zimmeranz.
                            com-pax         = com-pax + res-line.erwachs + res-line.gratis +
                                res-line.kind1 + res-line.kind2.      
                        END.
                        ELSE IF hu-flag THEN
                        DO:
                            cl-list.hu-anz = cl-list.hu-anz + res-line.zimmeranz.
                            cl-list.hu-pax = cl-list.hu-pax + res-line.erwachs + res-line.gratis +
                                res-line.kind1 + res-line.kind2.
                            hu-anz         = hu-anz + res-line.zimmeranz.
                            hu-pax         = hu-pax + res-line.erwachs + res-line.gratis +
                                res-line.kind1 + res-line.kind2.   
                        END.
                        ELSE
                        DO:
                    ...
                    IF compli-flag THEN
                    DO: 
                        cl-list.com-manz = cl-list.com-manz + res-line.zimmeranz.
                        cl-list.com-mpax = cl-list.com-mpax + res-line.erwachs + res-line.gratis +
                            res-line.kind1 + res-line.kind2.
                        com-manz         = com-manz + res-line.zimmeranz.
                        com-mpax         = com-mpax + res-line.erwachs + res-line.gratis +
                            res-line.kind1 + res-line.kind2.
                    END.
                    ELSE IF hu-flag THEN
                    DO:
                        cl-list.hu-manz = cl-list.hu-manz + res-line.zimmeranz.
                        cl-list.hu-mpax = cl-list.hu-mpax + res-line.erwachs + res-line.gratis +
                            res-line.kind1 + res-line.kind2.
                        hu-manz         = hu-manz + res-line.zimmeranz.
                        hu-mpax         = hu-mpax + res-line.erwachs + res-line.gratis +
                            res-line.kind1 + res-line.kind2.
                    END.
                    ELSE
                    DO:
                ...
                DO:
                    ...
                    DO:
                        ...
                        ASSIGN
                            ...
                            cl-list.ypax        = t-mnet
                            cl-list.ynet        = t-mpax
                            cl-list.com-anz     = t-com-anz
                            cl-list.com-pax     = t-com-pax
                            cl-list.hu-anz      = t-hu-anz
                            cl-list.hu-pax      = t-hu-pax
                            cl-list.com-manz    = t-com-manz
                            cl-list.com-mpax    = t-com-mpax
                            cl-list.hu-manz     = t-hu-manz
                            cl-list.hu-mpax     = t-hu-mpax
                            cl-list.com-yanz    = t-com-manz
                            cl-list.com-ypax    = t-com-mpax
                            cl-list.hu-yanz     = t-hu-manz 
                            cl-list.hu-ypax     = t-hu-mpax 
                            t-anz       = 0
                            t-pax       = 0
                            t-net       = 0
                            t-manz      = 0
                    ...
                    DO datum = s-datum TO e-datum:
                        ...
                        DO:
                            ...
                            DO: 
                                ...
                                cl-list.com-pax = cl-list.com-pax + res-line.erwachs + res-line.gratis +
                                    res-line.kind1 + res-line.kind2.
                                t-com-anz       = t-com-anz + res-line.zimmeranz.
                                t-com-pax       = t-com-pax + res-line.erwachs + res-line.gratis +
                                    res-line.kind1 + res-line.kind2.  
                                com-anz         = com-anz + res-line.zimmeranz.
                                com-pax         = com-pax + res-line.erwachs + res-line.gratis +
                                    res-line.kind1 + res-line.kind2.   
                            ...
                            DO:
                                ...
                                cl-list.hu-pax = cl-list.hu-pax + res-line.erwachs + res-line.gratis +
                                    res-line.kind1 + res-line.kind2.
                                t-hu-anz       = t-hu-anz + res-line.zimmeranz.
                                t-hu-pax       = t-hu-pax + res-line.erwachs + res-line.gratis +
                                    res-line.kind1 + res-line.kind2.  
                                hu-anz         = hu-anz + res-line.zimmeranz.
                                hu-pax         = hu-pax + res-line.erwachs + res-line.gratis +
                                    res-line.kind1 + res-line.kind2.   
                        ...
                        DO: 
                            ...
                            cl-list.com-mpax = cl-list.com-mpax + res-line.erwachs + res-line.gratis +
                                res-line.kind1 + res-line.kind2.
                            t-com-manz       = t-com-manz + res-line.zimmeranz.
                            t-com-mpax       = t-com-mpax + res-line.erwachs + res-line.gratis +
                                res-line.kind1 + res-line.kind2.  
                            com-manz         = com-manz + res-line.zimmeranz.
                            com-mpax         = com-mpax + res-line.erwachs + res-line.gratis +
                                res-line.kind1 + res-line.kind2.   
                        ...
                        DO:
                            ...
                            cl-list.hu-mpax = cl-list.hu-mpax + res-line.erwachs + res-line.gratis +
                                res-line.kind1 + res-line.kind2.
                            t-hu-manz       = t-hu-manz + res-line.zimmeranz.
                            t-hu-mpax       = t-hu-mpax + res-line.erwachs + res-line.gratis +
                                res-line.kind1 + res-line.kind2.  
                            hu-manz         = hu-manz + res-line.zimmeranz.
                            hu-mpax         = hu-mpax + res-line.erwachs + res-line.gratis +
                                res-line.kind1 + res-line.kind2.   
    ...
    cl-list.pax   = pax.
    cl-list.net   = net.
    cl-list.com-anz = com-anz.
    cl-list.com-pax = com-pax.
    cl-list.hu-anz  = hu-anz. 
    cl-list.hu-pax  = hu-pax.
    IF net NE 0 THEN cl-list.proz = 100.
    cl-list.manz  = manz. 
    cl-list.mpax  = mpax. 
    cl-list.mnet  = mnet. 
    cl-list.com-manz = com-manz.
    cl-list.com-mpax = com-mpax.
    cl-list.hu-manz  = hu-manz. 
    cl-list.hu-mpax  = hu-mpax.
    IF mnet NE 0 THEN cl-list.proz1 = 100. 
    cl-list.yanz  = manz. 
    cl-list.ypax  = mpax. 
    cl-list.ynet  = mnet. 
    ...
    FOR EACH cl-list NO-LOCK:
        ...
        ASSIGN 
            ...
            output-list.rm          = cl-list.anz 
            output-list.pax         = cl-list.pax
            output-list.com-rm      = cl-list.com-anz 
            output-list.com-pax     = cl-list.com-pax
            output-list.hu-rm       = cl-list.hu-anz 
            output-list.hu-pax      = cl-list.hu-pax
            output-list.rm-rev      = cl-list.net 
            output-list.percent     = cl-list.proz
            output-list.mtdrm       = cl-list.manz 
            output-list.pax1        = cl-list.mpax
            output-list.com-mtdrm   = cl-list.com-manz 
            output-list.com-pax1    = cl-list.com-mpax
            output-list.hu-mtdrm    = cl-list.hu-manz 
            output-list.hu-pax1     = cl-list.hu-mpax
            output-list.rm-rev1     = cl-list.mnet 
            output-list.percent1    = cl-list.proz1
            output-list.ftdrm       = cl-list.manz 
            output-list.pax2        = cl-list.mpax
...
PROCEDURE create-zinrstat2:
                ...
                DO:                    
                    ...
                    DO:
                        ...
                        DO:
                            IF compli-flag THEN
                            DO: 
                                cl-list.com-anz = cl-list.com-anz + zinrstat.zimmeranz.
                                cl-list.com-pax = cl-list.com-pax + zinrstat.person.
                                com-anz         = com-anz + zinrstat.zimmeranz.
                                com-pax         = com-pax + zinrstat.person.      
                            END.
                            ELSE IF hu-flag THEN
                            DO:
                                cl-list.hu-anz = cl-list.hu-anz + zinrstat.zimmeranz.
                                cl-list.hu-pax = cl-list.hu-pax + zinrstat.person.
                                hu-anz         = hu-anz + zinrstat.zimmeranz.
                                hu-pax         = hu-pax + zinrstat.person.   
                            END.
                            ELSE
                            DO:
                                cl-list.anz = cl-list.anz + zinrstat.zimmeranz.
                        ...
                        DO:
                            IF compli-flag THEN
                            DO: 
                                cl-list.com-manz = cl-list.com-manz + zinrstat.zimmeranz.
                                cl-list.com-mpax = cl-list.com-mpax + zinrstat.person.
                                com-manz         = com-manz + zinrstat.zimmeranz.
                                com-mpax         = com-mpax + zinrstat.person.
                            END.
                            ELSE IF hu-flag THEN
                            DO:
                                cl-list.hu-manz = cl-list.hu-manz + zinrstat.zimmeranz.
                                cl-list.hu-mpax = cl-list.hu-mpax + zinrstat.person.
                                hu-manz         = hu-manz + zinrstat.zimmeranz.
                                hu-mpax         = hu-mpax + zinrstat.person.
                            END.
                            ELSE
                            DO:
                                cl-list.manz    = cl-list.manz + zinrstat.zimmeranz. 
                        ...
                        IF compli-flag THEN
                        DO: 
                            cl-list.com-yanz = cl-list.com-yanz + zinrstat.zimmeranz.
                            cl-list.com-ypax = cl-list.com-ypax + zinrstat.person.
                            com-yanz         = com-yanz + zinrstat.zimmeranz.
                            com-ypax         = com-ypax + zinrstat.person.   
                        END.
                        ELSE IF hu-flag THEN
                        DO:
                            cl-list.hu-yanz = cl-list.hu-yanz + zinrstat.zimmeranz.
                            cl-list.hu-ypax = cl-list.hu-ypax + zinrstat.person.
                            hu-yanz         = hu-yanz + zinrstat.zimmeranz.
                            hu-ypax         = hu-ypax + zinrstat.person.   
                        END.
                        ELSE
                        DO:
                            cl-list.yanz = cl-list.yanz + zinrstat.zimmeranz. 
            ...
            FOR EACH zimmer /*WHERE zimmer.sleeping = YES*/ NO-LOCK,
                ...
                DO:
                    ...
                    ASSIGN 
                        ...
                        cl-list.hu-manz     = t-hu-manz
                        cl-list.hu-mpax     = t-hu-mpax
                        cl-list.com-yanz    = t-com-yanz
                        cl-list.com-ypax    = t-com-ypax
                        cl-list.hu-yanz     = t-hu-yanz
                        cl-list.hu-ypax     = t-hu-ypax.
                    ASSIGN
                        t-anz       = 0
                        t-pax       = 0
                        t-net       = 0
                        ...
                        DO:
                            ...
                            DO:
                                ...
                                DO: 
                                    cl-list.com-anz = cl-list.com-anz + zinrstat.zimmeranz.
                                    cl-list.com-pax = cl-list.com-pax + zinrstat.person.
                                    t-com-anz       = t-com-anz + zinrstat.zimmeranz.
                                    t-com-pax       = t-com-pax + zinrstat.person.  
                                    com-anz         = com-anz + zinrstat.zimmeranz.
                                    com-pax         = com-pax + zinrstat.person.   
                                END.
                                ELSE IF hu-flag THEN
                                DO:
                                    cl-list.hu-anz = cl-list.hu-anz + zinrstat.zimmeranz.
                                    cl-list.hu-pax = cl-list.hu-pax + zinrstat.person.
                                    t-hu-anz       = t-hu-anz + zinrstat.zimmeranz.
                                    t-hu-pax       = t-hu-pax + zinrstat.person.  
                                    hu-anz         = hu-anz + zinrstat.zimmeranz.
                                    hu-pax         = hu-pax + zinrstat.person.   
                                END.
                                ELSE
                            ...
                            DO:
                                ...
                                DO: 
                                    cl-list.com-manz = cl-list.com-manz + zinrstat.zimmeranz.
                                    cl-list.com-mpax = cl-list.com-mpax + zinrstat.person.
                                    t-com-manz       = t-com-manz + zinrstat.zimmeranz.
                                    t-com-mpax       = t-com-mpax + zinrstat.person.  
                                    com-manz         = com-manz + zinrstat.zimmeranz.
                                    com-mpax         = com-mpax + zinrstat.person.   
                                END.
                                ELSE IF hu-flag THEN
                                DO:
                                    cl-list.hu-manz = cl-list.hu-manz + zinrstat.zimmeranz.
                                    cl-list.hu-mpax = cl-list.hu-mpax + zinrstat.person.
                                    t-hu-manz       = t-hu-manz + zinrstat.zimmeranz.
                                    t-hu-mpax       = t-hu-mpax + zinrstat.person.  
                                    hu-manz         = hu-manz + zinrstat.zimmeranz.
                                    hu-mpax         = hu-mpax + zinrstat.person.   
                                END.
                                ELSE
                            ...
                            DO: 
                                cl-list.com-yanz = cl-list.com-yanz + zinrstat.zimmeranz.
                                cl-list.com-ypax = cl-list.com-ypax + zinrstat.person.
                                t-com-yanz       = t-com-yanz + zinrstat.zimmeranz.
                                t-com-ypax       = t-com-ypax + zinrstat.person.  
                                com-yanz         = com-yanz + zinrstat.zimmeranz.
                                com-ypax         = com-ypax + zinrstat.person.   
                            END.
                            ELSE IF hu-flag THEN
                            DO:
                                cl-list.hu-yanz = cl-list.hu-yanz + zinrstat.zimmeranz.
                                cl-list.hu-ypax = cl-list.hu-ypax + zinrstat.person.
                                t-hu-yanz       = t-hu-yanz + zinrstat.zimmeranz.
                                t-hu-ypax       = t-hu-ypax + zinrstat.person. 
                                hu-yanz         = hu-yanz + zinrstat.zimmeranz.
                                hu-ypax         = hu-ypax + zinrstat.person.   
                            END.
                            cl-list.yanz = cl-list.yanz + zinrstat.zimmeranz. 
    ...
    cl-list.ypax  = ypax. 
    cl-list.ynet  = ynet. 
    cl-list.com-yanz = com-yanz.
    cl-list.com-ypax = com-ypax.
    cl-list.hu-yanz  = hu-yanz. 
    cl-list.hu-ypax  = hu-ypax.     
    IF ynet NE 0 THEN cl-list.proz2 = 100. 
    ...
    FOR EACH cl-list NO-LOCK:
        ...
        DO:
            ASSIGN 
                ...
                output-list.ftdrm       = cl-list.yanz 
                output-list.pax2        = cl-list.ypax
                output-list.com-ftdrm   = cl-list.com-yanz 
                output-list.com-pax2    = cl-list.com-ypax
                output-list.hu-ftdrm    = cl-list.hu-yanz 
                output-list.hu-pax2     = cl-list.hu-ypax
                output-list.rm-rev2     = cl-list.ynet 
                output-list.percent3    = cl-list.proz2.
        END.
    END.
            ...
            DO datum = from-date TO to-date:
                FOR EACH genstat WHERE genstat.zinr = rm-no AND genstat.datum = datum 
                    ...
                    DO:
                        ...
                        compli-flag = NO.
                        hu-flag = NO.
                        IF genstat.zikatnr EQ zimmer.zikatnr AND genstat.zipreis EQ 0
                            AND genstat.gratis NE 0 THEN
                        DO:
                            FIND FIRST segment WHERE segment.segmentcode = genstat.segmentcode
                                AND (segment.betriebsnr EQ 1 OR segment.betriebsnr EQ 2) NO-LOCK NO-ERROR.
                            IF AVAILABLE segment THEN
                        ...
                        DO:
                            IF compli-flag THEN
                            DO:
                                cl-list.com-anz = cl-list.com-anz + 1.
                                cl-list.com-pax = cl-list.com-pax + genstat.erwachs + genstat.gratis +
                                    genstat.kind1 + genstat.kind2 + genstat.kind3.
                                com-anz = cl-list.com-anz + 1.
                                com-pax = cl-list.com-pax + genstat.erwachs + genstat.gratis +
                                    genstat.kind1 + genstat.kind2 + genstat.kind3.
                            END.
                            ELSE IF hu-flag THEN
                            DO:
                                cl-list.hu-anz = cl-list.hu-anz + 1.
                                cl-list.hu-pax = cl-list.hu-pax + genstat.erwachs + genstat.gratis +
                                    genstat.kind1 + genstat.kind2 + genstat.kind3.
                                hu-anz         = hu-anz + 1.
                                hu-pax         = hu-pax + genstat.erwachs + genstat.gratis +
                                    genstat.kind1 + genstat.kind2 + genstat.kind3. 
                            END.
                            ELSE
                            DO:
                        ...
                        DO:
                            IF compli-flag THEN
                            DO:
                                cl-list.com-manz = cl-list.com-manz + 1.
                                cl-list.com-mpax = cl-list.com-mpax + genstat.erwachs + genstat.gratis +
                                    genstat.kind1 + genstat.kind2 + genstat.kind3.
                                com-manz         = com-manz + 1.
                                com-mpax         = com-mpax + genstat.erwachs + genstat.gratis +
                                    genstat.kind1 + genstat.kind2 + genstat.kind3.
                            END.
                            ELSE IF hu-flag THEN
                            DO:
                                cl-list.hu-manz = cl-list.hu-manz + 1.
                                cl-list.hu-mpax = cl-list.hu-mpax + genstat.erwachs + genstat.gratis +
                                    genstat.kind1 + genstat.kind2 + genstat.kind3.
                                hu-manz         = hu-manz + 1.
                                hu-mpax         = hu-mpax + genstat.erwachs + genstat.gratis +
                                    genstat.kind1 + genstat.kind2 + genstat.kind3.
                            END.
                            ELSE
                            DO:
                        ...
                        IF compli-flag THEN
                        DO:
                            cl-list.com-yanz = cl-list.com-yanz + 1.
                            cl-list.com-ypax = cl-list.com-ypax + genstat.erwachs + genstat.gratis +
                                genstat.kind1 + genstat.kind2 + genstat.kind3.
                            com-yanz         = com-yanz + 1.
                            com-ypax         = com-ypax + genstat.erwachs + genstat.gratis +
                                genstat.kind1 + genstat.kind2 + genstat.kind3.
                        END.
                        ELSE IF hu-flag THEN
                        DO:
                            cl-list.hu-yanz = cl-list.hu-yanz + 1.
                            cl-list.hu-ypax = cl-list.hu-ypax + genstat.erwachs + genstat.gratis +
                                genstat.kind1 + genstat.kind2 + genstat.kind3.
                            hu-yanz         = hu-yanz + 1.
                            hu-ypax         = hu-ypax + genstat.erwachs + genstat.gratis +
                                genstat.kind1 + genstat.kind2 + genstat.kind3.
                        END.
                        ELSE
                        DO:
                        ...
                        DO:
                            ...
                            DO:
                                ...
                                DO:
                                    ...
                                    cl-list.com-pax = cl-list.com-pax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.
                                    t-com-anz       = t-com-anz + 1.
                                    t-com-pax       = t-com-pax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.  
                                    com-anz         = com-anz + 1.
                                    com-pax         = com-pax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.
                                END.
                                ELSE IF hu-flag THEN
                                DO:
                                    ...
                                    cl-list.hu-pax = cl-list.hu-pax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.
                                    t-hu-anz       = t-hu-anz + 1.
                                    t-hu-pax       = t-hu-pax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.  
                                    hu-anz         = hu-anz + 1.
                                    hu-pax         = hu-pax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.
                            ...
                            DO:
                                ...
                                DO: 
                                    ...
                                    cl-list.com-mpax = cl-list.com-mpax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.
                                    t-com-manz       = t-com-manz + 1.
                                    t-com-mpax       = t-com-mpax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.  
                                    com-manz         = com-manz + 1.
                                    com-mpax         = com-mpax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.   
                                ...
                                DO:
                                    ...
                                    cl-list.hu-mpax = cl-list.hu-mpax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.
                                    t-hu-manz       = t-hu-manz + 1.
                                    t-hu-mpax       = t-hu-mpax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.  
                                    hu-manz         = hu-manz + 1.
                                    hu-mpax         = hu-mpax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.   
                            ...
                            DO: 
                                ...
                                cl-list.com-ypax = cl-list.com-ypax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.
                                t-com-yanz       = t-com-yanz + 1.
                                t-com-ypax       = t-com-ypax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.  
                                com-yanz         = com-yanz + 1.
                                com-ypax         = com-ypax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.   
                            ...
                            DO:
                                ...
                                cl-list.hu-ypax = cl-list.hu-ypax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.
                                t-hu-yanz       = t-hu-yanz + 1.
                                t-hu-ypax       = t-hu-ypax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3. 
                                hu-yanz         = hu-yanz + 1.
                                hu-ypax         = hu-ypax + genstat.erwachs + genstat.gratis 
                                        + genstat.kind1 + genstat.kind2 + genstat.kind3.   
