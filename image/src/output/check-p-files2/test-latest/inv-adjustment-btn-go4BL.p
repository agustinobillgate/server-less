...
DEFINE TEMP-TABLE c-list 
    ...
    FIELD cost-center AS CHAR FORMAT "x(50)" LABEL "Cost Allocation"
    FIELD flag-coa AS LOGICAL INITIAL NO
    .  
    ...
    DO:
        FOR EACH l-bestand WHERE l-bestand.lager-nr = curr-lager NO-LOCK, 
            ...
            ASSIGN 
                ...
                c-list.qty          = l-bestand.anz-anf-best + l-bestand.anz-eingang - l-bestand.anz-ausgang /*Alder - Serverless - Issue 652*/
                c-list.qty1         = l-bestand.anz-anf-best + l-bestand.anz-eingang - l-bestand.anz-ausgang /*Alder - Serverless - Issue 652*/
