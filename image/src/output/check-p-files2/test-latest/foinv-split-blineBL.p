...
/*FIND FIRST bill-line WHERE RECID(bill-line) = rec-id. Malik serverless 783 move query inside procedure*/
RUN split-bill-line.
...
PROCEDURE split-bill-line: 
  ...
  FIND FIRST bill-line WHERE RECID(bill-line) = rec-id NO-LOCK NO-ERROR. /* Malik Serverless 783 add if available */
