...
RUN stock-outlist-btn-go-cldbl.p
...
FOR EACH str-list:
    ...
    ASSIGN             
       ...
       stock-outlist.docu-nr        = SUBSTRING(str-list.s,110,12)
       ...
       /* Oscar - handling invalid conversion from string to decimal */      
       /* stock-outlist.avrg-price  = DECIMAL(SUBSTRING(str-list.s,110,14))        
       stock-outlist.amount         = DECIMAL(SUBSTRING(str-list.s,124,17))  */ 
       stock-outlist.avrg-price     = str-list.avrg-price
       stock-outlist.amount         = str-list.amount
       ...
       stock-outlist.masseinheit    = str-list.masseinheit
       stock-outlist.gldept         = str-list.gldept
       stock-outlist.remark-artikel = str-list.remark-artikel
    .
END.
