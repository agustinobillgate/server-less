...
/*Alder - Serverless - Issue 781 - Start*/
FIND FIRST reservation WHERE reservation.resnr EQ resnr NO-LOCK NO-ERROR.
...
DO:
    ...
    DO:
        ...
        DO:
            ...
            DO:
                IF htparam.fchar NE "" AND htparam.fchar NE guest.land THEN
                DO:
                    ASSIGN default-nat = guest.land.
                END.
            END.
        END.
    END.
END.
/*Alder - Serverless - Issue 781 - End*/
