...
FIND FIRST pqueasy WHERE pqueasy.KEY = 280 AND pqueasy.char1 = "General Ledger"
    AND pqueasy.char3 = "PROCESS" NO-LOCK NO-ERROR.
IF AVAILABLE pqueasy THEN ASSIGN doneFlag = NO.
ELSE DO:
    FIND FIRST tqueasy WHERE tqueasy.KEY = 285 
        AND tqueasy.char1 = "General Ledger" AND tqueasy.number1 = 1 NO-LOCK NO-ERROR.
