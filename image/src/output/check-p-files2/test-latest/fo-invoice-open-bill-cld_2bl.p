...
DEF OUTPUT PARAMETER guest-taxcode  AS CHAR. /*ragung add guest-taxcode for web*/
DEF OUTPUT PARAMETER repeat-charge  AS LOGICAL.
...
/* ci-date  = fdate. */       /* Rulita 181024 | Fising for serverless */
...
/*ITA : Leasing*/
 FIND FIRST queasy WHERE queasy.KEY = 301 
        AND queasy.number1 = res-line.resnr AND queasy.logi1 = YES NO-LOCK NO-ERROR.
 IF AVAILABLE queasy THEN ASSIGN repeat-charge = queasy.logi1.
