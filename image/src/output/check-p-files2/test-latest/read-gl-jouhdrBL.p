...
CASE case-type:
    ...
    DO:
        FIND FIRST gl-jouhdr WHERE gl-jouhdr.refno = char1 
            AND gl-jouhdr.jtype = int1 NO-LOCK NO-ERROR.
    ...
    WHEN 4 THEN
    DO:
        FOR EACH gl-jouhdr WHERE gl-jouhdr.activeflag = int1 NO-LOCK :
            CREATE t-gl-jouhdr.
            BUFFER-COPY gl-jouhdr TO t-gl-jouhdr.
        END.
    END.
    WHEN 5 THEN
    DO:
        FIND FIRST gl-jouhdr WHERE gl-jouhdr.jtype = int1 AND 
            gl-jouhdr.datum GT date1 AND gl-jouhdr.activeflag = int2 
            NO-LOCK NO-ERROR. 
        IF AVAILABLE gl-jouhdr THEN
        DO:
            CREATE t-gl-jouhdr.
    ...
    DO:
        FIND FIRST gl-jouhdr WHERE gl-jouhdr.refno = char1
            AND gl-jouhdr.datum = date1 AND gl-jouhdr.batch = NO
            AND gl-jouhdr.activeflag = int2 NO-LOCK NO-ERROR.
        IF AVAILABLE gl-jouhdr THEN
        DO:
            CREATE t-gl-jouhdr.
            BUFFER-COPY gl-jouhdr TO t-gl-jouhdr.
