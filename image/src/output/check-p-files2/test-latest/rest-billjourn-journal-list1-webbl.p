...
DEFINE TEMP-TABLE booking-journbill-list
    ...
    /*Dzikri A77441 - req resname and resnr */
...
PROCEDURE journal-list: 
    ...
    /*Dzikri A77441 - req resname and resnr */
    DEFINE VARIABLE curr-compTA AS CHARACTER.
        ...
        DO curr-date = from-date TO to-date: 
            ...
            FOR EACH h-journal WHERE h-journal.bill-datum = curr-date 
                    ...
                    DO:
                        ...
                        DO:
                            ...
                            */
                            ...
                            ASSIGN
                                curr-guest  = guest.name + ", " + guest.vorname1 + " " + guest.anrede1
                                curr-room   = res-line.zinr
                            ...
                            DO:
                                curr-compTA = gbuff.name + ", " + gbuff.vorname1 + " " + gbuff.anrede1 + gbuff.anredefirma.
                            END.
                        END.         
                ...
                DO:
                    ...
                    .       
                    /*Dzikri A77441 - req resname and resnr */
                    IF curr-resnr NE 0 THEN
                    ASSIGN
                        booking-journbill-list.resname  = curr-compTA
                        booking-journbill-list.resnr    = curr-resnr
                    .
                    /*Dzikri A77441 - END */
