...
FIND FIRST outorder WHERE outorder.zinr = ooo-list2.zinr 
    ...
    AND outorder.gespende = ooo-list2.gespende NO-LOCK NO-ERROR. 
IF AVAILABLE outorder THEN /*Alder - Serverless - Issue 815*/
DO:
    ...
    DELETE outorder. 
    RELEASE outorder. /*Alder - Serverless - Issue 815*/
    ...
    /*Alder - Serverless - Issue 815 - Start*/
    FIND FIRST zimmer WHERE zimmer.zinr EQ ooo-list2.zinr NO-LOCK NO-ERROR.
    IF AVAILABLE zimmer THEN
    DO:
        FIND CURRENT zimmer EXCLUSIVE-LOCK.
        IF zimmer.zistatus EQ 6 THEN zimmer.zistatus = 2.
        zimmer.bediener-nr-stat = user-nr.
        FIND CURRENT zimmer NO-LOCK.
        RELEASE zimmer.
    END.
    /*Alder - Serverless - Issue 815 - End*/
END.
