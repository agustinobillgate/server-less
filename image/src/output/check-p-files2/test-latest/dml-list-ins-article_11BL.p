DEFINE TEMP-TABLE c-list 
    ...
    FIELD supplier AS CHAR FORMAT "x(24)" LABEL "Supplier"
    ...
    FIELD remark   AS CHAR FORMAT "x(50)" LABEL "Remark"
    /*NAUFAL 170321 - add field for stock oh value*/
...
PROCEDURE ins-article:
    ...
    /*NAUFAL 170321 - add validation for add stock oh value*/
    ...
    IF AVAILABLE l-bestand THEN
        /*NAUFAL 170321 - assign value for stock oh*/
