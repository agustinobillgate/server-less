...
DEF TEMP-TABLE tqueasy LIKE queasy.
...
DEF OUTPUT PARAMETER TABLE FOR tqueasy.
...
FIND FIRST queasy WHERE queasy.KEY = 231 AND queasy.number1 = gastnr NO-LOCK NO-ERROR.
