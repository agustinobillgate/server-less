...
DEF INPUT PARAMETER dml-hdr-remark AS CHARACTER. /* Oscar (25/02/25) - A36EF3 - save dml header remark */
...
PROCEDURE create-pr:
    ...
    DO TRANSACTION: 
        ...
        ASSIGN 
            ...
            l-orderhdr.lief-fax[3]      = dml-hdr-remark /* Oscar (06/03/25) - A36EF3 - Save remark from dml to PR */
        ...
        FOR EACH s1-list WHERE s1-list.selected = YES: 
            ...
            ASSIGN 
                ...
                l-order.flag         = YES
                l-order.warenwert    = s1-list.qty * s1-list.price /* Oscar (05/06/2025) - 5B3BE7 - fix amount for PR */
