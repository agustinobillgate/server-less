...
RUN fo-invoice-open-bill-cld_1bl.p(bil-flag, bil-recid, room, vipflag, OUTPUT abreise,
         ...
         OUTPUT flag-report, OUTPUT guest-taxcode, OUTPUT TABLE t-res-line,
         OUTPUT TABLE t-bill).
...
/* Rulita 021224 | move  */
FIND FIRST t-bill NO-LOCK.
/* Rulita 021224 | Fixing serverless issue 152  */
