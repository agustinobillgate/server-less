    ...
    FOR EACH bline-list WHERE bline-list.SELECTED = YES BY bline-list.NAME:
        ...
        FOR EACH cash-art BY pos-nr:
            ...
            DO:
                ...
                */
                ASSIGN
                    cash-art.amount = summary1.amount
                    cash-art.tamount = cash-art.tamount + summary1.amount.
                    .
            END.  
        END. /*each cash-art*/
        /* FDL #632 Serverless - Change cbuff to cash-art*/
        FIND FIRST cash-art WHERE cash-art.amount NE 0 NO-LOCK NO-ERROR.
        IF AVAILABLE cash-art THEN
        DO:
            CREATE summary-list.
