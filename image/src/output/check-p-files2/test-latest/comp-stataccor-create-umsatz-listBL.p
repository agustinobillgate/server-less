...
IF NOT show-ytd THEN RUN create-umsatz.
...
PROCEDURE create-umsatz:
   ...
   RUN get-totalhtl.
    ...
    END.
        ...
        .
        /*MESSAGE DEC((tocc-rm / tsale ) * 100)
            VIEW-AS ALERT-BOX INFO BUTTONS OK.
        MESSAGE tocc-proz tocc-rm tsale
            VIEW-AS ALERT-BOX INFO BUTTONS OK.*/
    ...
    FOR EACH cl-list:
        ...
        /*MESSAGE cl-list.mpi cl-list.occ-proz "/" tocc-proz "=" (cl-list.occ-proz / tocc-proz)
            VIEW-AS ALERT-BOX INFO BUTTONS OK.*/
        ...
        IF cl-list.saleable1 NE 0 THEN
            ASSIGN cl-list.mpi1 = cl-list.occ-proz1 / tocc-proz1.
        ...
        /*naufal 090420 - add if ? then value = 0.00*/
        IF cl-list.mpi  = ? THEN cl-list.mpi  = 0.00.
        IF cl-list.mpi1 = ? THEN cl-list.mpi1 = 0.00.
        IF cl-list.rgi  = ? THEN cl-list.rgi  = 0.00.
        IF cl-list.rgi1 = ? THEN cl-list.rgi1 = 0.00.
        /*end*/
        ASSIGN
