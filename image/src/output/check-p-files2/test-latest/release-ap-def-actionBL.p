...
IF NOT AVAILABLE debt THEN RETURN. /*FT serverless*/
...
DO TRANSACTION: 
    ...
    ELSE DO:
        FOR EACH debt WHERE debt.counter = i-counter 
          AND debt.zahlkonto GT 0 AND debt.opart = 1 NO-LOCK: 
          it-exist = YES. 
    ...
    DO: 
      /*FIND CURRENT l-kredit EXCLUSIVE-LOCK. FT serverless*/
      l-kredit.counter = 0. 
      /*FIND CURRENT l-kredit NO-LOCK. FT serverless*/
    END. 
