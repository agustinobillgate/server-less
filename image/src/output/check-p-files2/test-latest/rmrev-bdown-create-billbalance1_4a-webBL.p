...
PROCEDURE create-billbalance1: 
  ...
  /* DEFINE VARIABLE argt-bezeich AS CHARACTER.          /* Rulita 241124 | Fixing serverless issue 162 */ */
     ...
     BY res-line.resname: 
      ...
      IF NOT AVAILABLE argt-list THEN DO:
          ...
          ASSIGN 
              ...
              /* argt-list.bezeich   = argt-bez */                  /* Rulita 241124 | Error convertion tool serverless argt-bez convert to L_verbrauch.wert_verbrau */
              argt-list.bezeich   = arrangement.argt-bez            /* Rulita 261124 | Fixing serverless Issue 162 */
              argt-list.room      = 1
...
DEF INPUT        PARAMETER f-rate       AS DECIMAL.     /* Rulita 241124 | Fixing serverless issue 162 */
...
IF genstat.res-char[4] = "" THEN RETURN.
  DO tokcounter = 1 TO NUM-ENTRIES(genstat.res-char[4], ";"):
    ...
    DO:
      ...
      DO:
        ASSIGN argt-betrag = a-betrag * x-betrag / f-rate.
        RETURN.
      END.
    END.
  END.
