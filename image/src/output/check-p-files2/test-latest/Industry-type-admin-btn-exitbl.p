...
DO:
    ...
    DO:
        ...
        ASSIGN
            ...
            res-history.aenderung   = "Add Industry Type Profile, Name: " + category
            res-history.action      = "Industry Type Profile".
...
ELSE
DO:
    FIND FIRST queasy WHERE queasy.KEY = 281 AND 
    ...
    DO:
        ...
        DO:
            ...
            ASSIGN
                ...
                res-history.datum       = TODAY
                res-history.zeit        = TIME
                res-history.aenderung   = "Change Industry Type Profile, From: " + category + " To: " + category2
                res-history.action      = "Industry Type Profile".
            FIND CURRENT res-history NO-LOCK.
            RELEASE res-history.
        END.
