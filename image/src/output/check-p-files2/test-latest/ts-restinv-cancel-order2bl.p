...
FIND FIRST h-bill-line WHERE RECID(h-bill-line) = rec-id-hbline NO-LOCK NO-ERROR. /* Malik Serverless 395 : NO-LOCK NO-ERROR */
IF NOT AVAILABLE h-bill-line THEN RETURN. /* Malik Serverless 395 */
answer = NO. 
cancel-flag = YES. 
DO: 
