...
DEFINE TEMP-TABLE b1-list
    ...
    FIELD bemerk    LIKE guest1.bemerkung /*Alder - Serverless - Issue 822*/
...
DEFINE VARIABLE to-name AS CHAR. 
  ...
  DO: 
    ...
    comments = guest1.bemerkung. /*Alder - Serverless - Issue 822*/
...
PROCEDURE assign-it:
    ...
    b1-list.bemerk    = guest1.bemerkung /*Alder - Serverless - Issue 822*/
