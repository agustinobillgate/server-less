...
FOR EACH c-list WHERE /*c-list.fibukonto NE "00000000"
    AND c-list.fibukonto NE "0000000000"    
    AND*/ c-list.fibukonto NE "" 
    AND c-list.fibukonto NE ?
    /*AND INT(c-list.fibukonto) NE 0*/ : /*agung

        IF TRIM(c-list.fibukonto) EQ "00000000" 
           OR TRIM(c-list.fibukonto) EQ "0000000000"
           OR TRIM(c-list.fibukonto) EQ "000000000000"   */   
        /* Dzikri 539E73 - COA not found problem for zeros, prevent resurfacing problem */       
