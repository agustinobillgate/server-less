...
DEF VAR tmp-time AS INT. /* Malik Serverless */
DEF VAR tmp-today AS INT. /* Malik Serverless */
DEF VAR con-day AS DATE. /* Malik Serverless */


IF name-table EQ ? THEN RETURN. /* Malik serverless */
...
DO:
    ...
    DO:
        con-day = TODAY.
        /* Malik Serverless */
        tmp-time = TIME - INTEGER(queasy.number1).
        ASSIGN
            tmp-today = con-day - queasy.date1
            tmp-today = tmp-today * 24 * 3600.

        delta-time = tmp-time + tmp-today.
        /* END Malik */
        /*
