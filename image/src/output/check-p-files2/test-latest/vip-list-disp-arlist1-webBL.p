...
PROCEDURE disp-arlist:
  ...
  */
  ...
  DO: 
      ...
      /* Naufal Afthar - E25F5E -> add filter todate and period date*/
  ...
  DO:
      ...
      END.
  END.
  /* Dzikri C24DB1 - Add New sort type */
  ELSE IF sorttype EQ 7 THEN /* Expected Departure Date*/
  DO:
      IF by-period EQ YES THEN
      DO:
          FOR EACH res-line WHERE
              res-line.active-flag EQ 1 
...
PROCEDURE assign-it:
    ...
    /* t-vip-list.zipreis       = res-line.zipreis     Dzikri C24DB1 - Assign zero if show-rate false */
    t-vip-list.ankzeit       = res-line.ankzeit
    t-vip-list.abreisezeit   = res-line.abreisezeit
    t-vip-list.bezeich       = segment.bezeich.

    /* Dzikri C24DB1 - Assign zero if show-rate false */
    IF show-rate EQ YES THEN
    DO:
        ASSIGN
