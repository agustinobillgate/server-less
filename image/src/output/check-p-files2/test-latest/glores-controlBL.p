...
/* FOR EACH k-list,                                                             /* Rulita 221124 | Fixing issue git issues/122 */
    FIRST guest WHERE guest.gastnr = k-list.gastnr NO-LOCK 
    BY guest.name BY k-list.ankunft:  */

FOR EACH k-list no-lock BY k-list.ankunft:                                                       
    ...
    FOR EACH res-line WHERE res-line.gastnr =  k-list.gastnr 
        ...
        AND kontline.kontstatus = 1 NO-LOCK BY res-line.ankunft                          /* Rulita 121124 | fixing for serverless */
...
PROCEDURE create-alist: 
    ...
    FOR EACH kontline WHERE kontline.betriebsnr = 1
        ...
        AND kontline.kontstatus = 1 NO-LOCK,                                         /* Rulita 121124 | fixing for serverless */
