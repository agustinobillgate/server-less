...
DO:
    ...
    DO:
        ...
        AND ENTRY(2, dml-artdep.chginit, ";") NE ""
        AND dml-artdep.anzahl GT 0 NO-LOCK NO-ERROR. /* hide first DML if there is no artikel with qty greater than 0 by Oscar (11 November 2024) - C44256 */
        IF NOT AVAILABLE dml-artdep THEN
            FIND FIRST dml-artdep WHERE dml-artdep.datum EQ selected-date
                AND dml-artdep.departement EQ curr-dept AND dml-artdep.anzahl GT 0 NO-LOCK NO-ERROR. /* hide first DML if there is no artikel with qty greater than 0 by Oscar (11 November 2024) - C44256 */
