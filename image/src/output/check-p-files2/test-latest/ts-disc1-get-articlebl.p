...
DEF VAR zwkum AS INTEGER NO-UNDO.
  ...
  ASSIGN
      ...
      disc-list.mwst        = vhp.h-artikel.mwst-code                           /* Rulita 040225 | Fixing serverless issue git 518 */
      disc-list.service     = vhp.h-artikel.service-code                        /* Rulita 040225 | Fixing serverless issue git 518 */
