...
DEFINE TEMP-TABLE s-list 
 ...
 DEFINE TEMP-TABLE cl-list 
  ...
  FIELD phone-number   AS CHAR
  FIELD mobile-phone   AS CHAR
  FIELD changed-id     AS CHAR      FORMAT "X(5)" /*MG 7A7DC5*/
  .
...
DEFINE INPUT  PARAMETER ota-only        AS LOGICAL. /*FDL Dec 19, 2022 => Amaranta*/
    ...
    /* NEW: 01/12/2004 - aston bali : ignore the history validation */ 
        ...
        DO: 
            ...
            ASSIGN 
                ...
                cl-list.changed-id = res-line.changed-id  /*MG 7A7DC5*/
                .
            ...
            IF gmember.telefon NE "" THEN   /*FDL Dec 19, 2022 => Amaranta*/
              ASSIGN
              cl-list.company      = cl-list.company + ";" + gmember.telefon
              cl-list.phone-number = gmember.telefon.
            IF gmember.mobil-tel NE "" THEN /*FDL Dec 19, 2022 => Amaranta*/
                cl-list.mobile-phone = gmember.mobil-tel.
