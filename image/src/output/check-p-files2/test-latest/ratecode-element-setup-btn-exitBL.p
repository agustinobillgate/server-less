...
DEFINE BUFFER bqueasy FOR queasy. /*Alder - Ticket C0DB81*/
DEFINE BUFFER pqueasy FOR queasy. /*Alder - Ticket C0DB81*/
...
DO:
    ...
    DO:
        ...
        FOR EACH bqueasy WHERE bqueasy.KEY EQ 289 AND bqueasy.char2 EQ ratecode NO-LOCK:
            FIND FIRST pqueasy WHERE RECID(pqueasy) EQ RECID(bqueasy) EXCLUSIVE-LOCK.
            ASSIGN pqueasy.char2 = ratecode2.
