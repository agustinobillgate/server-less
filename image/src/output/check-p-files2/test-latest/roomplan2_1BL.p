...
DEFINE VARIABLE do-it1  AS LOGICAL.
  ...
  FOR EACH zimmer WHERE zimmer.zinr GE from-room NO-LOCK:
    ...
    DO:
      ...
      room-list.bezeich = zimmer.bezeich. /*Irfan 080118*//*zimkateg.bezeichnung->zimmer.bezeich*/
  ...
  FOR EACH res-line WHERE 
    ...
    AND  NOT res-line.ankunft GT to-date AND NOT res-line.abreise LE curr-date) /* Malik Serverless : AND  NOT to-date LT res-line.ankunft AND NOT curr-date GE res-line.abreise) ->  */
