...
DO:
    RUN po-list-btn-gocldbl.p(usrName, po-number, dml-only, OUTPUT param267, OUTPUT TABLE t-list).
END.
ELSE 
DO:
    RUN po-list-btn-go2cldbl.p(t-liefNo, last-doc-nr, sorttype, deptnr, all-supp, stattype, usrName,
                 from-date, to-date, billdate, dml-only, app-sort, OUTPUT first-docu-nr,
                 OUTPUT curr-docu-nr, OUTPUT param267, OUTPUT last-docu-nr,
                 OUTPUT TABLE t-list).
END.
p-267 = INT(param267).
