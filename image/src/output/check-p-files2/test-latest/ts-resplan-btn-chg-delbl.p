...
FIND FIRST queasy WHERE RECID(queasy) = s-recid NO-LOCK NO-ERROR. /* Malik Serverless 389 : NO-LOCK -> NO-LOCK NO-ERROR */
IF NOT AVAILABLE queasy THEN RETURN. /* Malik Serverless 389 */
CREATE t-queasy.
ASSIGN
