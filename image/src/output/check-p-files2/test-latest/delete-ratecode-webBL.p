DEFINE TEMP-TABLE recid-list 
  FIELD int1 AS INTEGER.

DEFINE INPUT PARAMETER case-type    AS INTEGER.
/* DEFINE INPUT PARAMETER int1         AS INTEGER. */
DEFINE INPUT PARAMETER TABLE FOR recid-list. 
...
CASE case-type :
    ...
    DO:
        FOR EACH recid-list:
            FIND FIRST ratecode WHERE RECID(ratecode) EQ recid-list.int1 NO-LOCK NO-ERROR.
            ...
            DO:
                ...
                DO:
                    ...
                    ASSIGN 
                        ...
                        res-history.aenderung   = "Delete Multiple RateCode, Code: " + prcode + " RmType : " + RmType + " Start:" + STRING(startperiode)
            ...
            FOR EACH queasy WHERE queasy.KEY = 2 AND NOT queasy.logi2
                ...
                DO:
                    ...
                    ASSIGN 
                        ...
                        res-history.datum       = TODAY
                        res-history.zeit        = TIME
                        res-history.aenderung   = "Auto Delete Child RateCode, Code: " + chcode + " RmType : " + RmType + " Parent : " + prcode
                        res-history.action      = "RateCode".
                    FIND CURRENT res-history NO-LOCK.
                    RELEASE res-history.
                END.
