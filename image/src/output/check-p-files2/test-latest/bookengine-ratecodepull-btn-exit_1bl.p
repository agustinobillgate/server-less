...
FIND FIRST queasy WHERE queasy.KEY = 163 AND queasy.number1 = bookengID NO-LOCK NO-ERROR.
DO WHILE AVAILABLE queasy :
	...
	DO:
		...
		RELEASE qsy.
	END.
	FIND NEXT queasy WHERE queasy.KEY = 163 AND queasy.number1 = bookengID NO-LOCK NO-ERROR.
END.
...
FOR EACH t-push-list NO-LOCK:
    ...
    FOR EACH outlist WHERE outlist.KEY EQ 163 AND outlist.number1 EQ bookengID:
        ...
        DO:
            ...
            DO:
                ...
                ASSIGN
                    ...
                    res-history.aenderung   = "Pull RateCode, Booking Engine ID: " + STRING(bookengID) + ", RateCode: " + str
