...
FIND FIRST bk-veran WHERE bk-veran.veran-nr = o-resnr USE-INDEX vernr-ix NO-LOCK NO-ERROR. 
IF NOT AVAILABLE bk-veran THEN RETURN.

FIND FIRST bk-reser WHERE RECID(bk-reser) = recid-bk-reser NO-LOCK NO-ERROR.
IF NOT AVAILABLE bk-reser THEN RETURN.
