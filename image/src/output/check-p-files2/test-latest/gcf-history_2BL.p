DEF TEMP-TABLE ghistory   LIKE history
  ...
  FIELD vcrnr   AS CHAR /*Add field vcrnr by damen 14/02/22 DF25EB*/
  .
  ...
  FOR EACH history WHERE history.gastnr = gastnr AND history.abreise GE fdate 
    ...
    */
    ...
    IF AVAILABLE hist1 THEN DO:
        ...
        ghistory.reslinnr = hist1.reslinnr. /* add by Michael 13/04/23 for VHP Cloud */
    END.

    /* add by damen 13/02/22 DF25EB request Sunardi */
