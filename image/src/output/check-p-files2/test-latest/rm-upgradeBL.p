DEFINE TEMP-TABLE str-list LIKE res-line
  ...
  FIELD rmtype   LIKE zimkateg.kurzbez COLUMN-LABEL "From" INITIAL "" /* Malik Serverless : rmType -> rmtype */
...
PROCEDURE upgrade1:
    FOR EACH genstat WHERE genstat.datum LT ci-date
        ...
        origZikatnr = 0.
        DO curr-i = 1 TO NUM-ENTRIES(genstat.res-char[2], ";") - 1:
           ct = ENTRY(curr-i, genstat.res-char[2], ";").
       ...
       FIND FIRST str-list WHERE str-list.resnr = genstat.resnr
            ...
            AND str-list.rmtype = origRmType NO-LOCK NO-ERROR. /* Malik Serverless : str-list.rmType -> str-list.rmtype */
        ...
        DO:
            ...
            DO:
                ...
                ASSIGN
                    ...
                    str-list.rmtype       = origRmType /* Malik Serverless : str-list.rmType -> str-list.rmtype */
                ...
                FIND FIRST waehrung WHERE waehrung.waehrungsnr = genstat.wahrungsnr NO-LOCK. /* Malik Serverless : genstat.wahrungsn -> genstat.wahrungsnr */
...
PROCEDURE upgrade2:
    FOR EACH res-line WHERE NOT res-line.ankunft GT to-date
        ...
        FIND FIRST str-list WHERE str-list.resnr = res-line.resnr
            ...
            AND str-list.rmtype = origRmType /* Malik Serverless : str-list.rmType -> str-list.rmtype */
