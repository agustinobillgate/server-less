...
PROCEDURE create-segm: 
  FOR EACH segment WHERE segment.betriebsnr LE 2 NO-LOCK 
    ...
    ASSIGN 
      ...
      segm1-list.bezeich = STRING(segment.segmentcode,">>9 ") + ENTRY(1, segment.bezeich, "$$0").     /* Rulita 140324| Fixing for Serverless */
...
PROCEDURE create-argt: 
  FOR EACH arrangement NO-LOCK BY arrangement.arrangement: 
    ...
    ASSIGN 
      ...
      argt-list.bezeich = STRING(arrangement.arrangement,"x(5)") + " " + arrangement.argt-bez.        /* Rulita 140324| Fixing for Serverless */
  END. 
END. 
...
PROCEDURE create-zikat: 
  FOR EACH zimkateg NO-LOCK BY zimkateg.kurzbez: 
    ...
    ASSIGN 
      ...
      zikat-list.bezeich = zimkateg.bezeichnung.    /* Rulita 140324| Fixing for Serverless */
  END. 
END. 
