...
/* Dzikri FA07D7 - repair tax serv calculation */
DEFINE VARIABLE vat2   AS DECIMAL FORMAT "->,>>>,>>>,>>9"   NO-UNDO.
DEFINE VARIABLE fact   AS DECIMAL FORMAT "->,>>>,>>>,>>9"   NO-UNDO.
/* Dzikri FA07D7 - END */
...
CASE case-type :
    ...
    DO:
        FOR EACH bill-line WHERE bill-line.rechnr = rechNo NO-LOCK :
            ...
            FIND FIRST artikel WHERE artikel.artnr = bill-line.artnr AND artikel.departement = bill-line.departement NO-LOCK NO-ERROR.
            IF AVAILABLE artikel THEN DO:
                ...
                */
                ...
                RUN calc-servtaxesbl.p (1, artikel.artnr, artikel.departement,
                       bill-line.bill-datum, OUTPUT serv, OUTPUT vat, OUTPUT vat2, OUTPUT fact).
            END.


            CREATE t-bill-line.
            BUFFER-COPY bill-line TO t-bill-line.
            ASSIGN t-bill-line.bl-recid = RECID(bill-line)
                   netto                = bill-line.betrag / fact
                   t-bill-line.serv     = netto * serv
                   t-bill-line.vat      = netto * vat
