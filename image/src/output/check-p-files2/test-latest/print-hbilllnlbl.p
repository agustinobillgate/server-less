...
DEFINE VARIABLE serv-perc       AS DECIMAL INITIAL 0.  
DEFINE VARIABLE mwst-perc       AS DECIMAL INITIAL 0.  
    ...
    DO:   
      ...
      DO:  
        ...
        RUN cal-servat (vhp.h-artikel.departement, vhp.h-artikel.artnr,  
          ...
          OUTPUT serv-perc, OUTPUT mwst-perc, OUTPUT fact).         
        ...
        DO:
            ...
            DO:
                ...
                ELSE
                    ASSIGN
                        h-service = vhp.h-bill-line.betrag / fact * serv-perc
                        h-service = ROUND(h-service,2).
                IF NOT vat-disc AND h-bill-line.artnr = f-discArt THEN.
                ELSE 
                    ASSIGN
                        h-mwst = vhp.h-bill-line.betrag / fact * mwst-perc
...
DEF OUTPUT PARAMETER serv-perc          AS DECIMAL INITIAL 0.  
DEF OUTPUT PARAMETER mwst-perc          AS DECIMAL INITIAL 0.  
...
/*        
      ...
      ASSIGN  
        serv-perc  = serv-htp  
        mwst-perc  = (1 + serv-htp) * vat-htp  
        servat = 1 + serv-perc + mwst-perc  
      .   
      ELSE  
*/        
      ASSIGN  
