...
PROCEDURE create-listhis:
  ...
  IF invType = 3 THEN 
    ...
    frNr = 3000000
    toNr = 9999999.
     FOR EACH l-artikel WHERE l-artikel.artnr GE frNr AND l-artikel.artnr LE toNr NO-LOCK,
         FIRST l-untergrup WHERE l-untergrup.zwkum = l-artikel.zwkum NO-LOCK,
         FIRST gl-acct WHERE gl-acct.fibukonto = l-untergrup.fibukonto NO-LOCK:
