...
DEFINE INPUT PARAMETER res-nr AS INTEGER.       /* Rulita 130324 | Fixing for serverless*/
...
/*   FIND FIRST reservation WHERE reservation.resnr = resnr NO-LOCK NO-ERROR. */
  FIND FIRST reservation WHERE reservation.resnr = res-nr NO-LOCK NO-ERROR.         /* Rulita 130324 | Fixing for serverless */
