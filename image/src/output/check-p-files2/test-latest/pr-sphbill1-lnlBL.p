/*This BL used in VHP Cloud Only (placed in folder compiled on GIT)*/
...
DO:  
  ...
  IF NOT AVAILABLE vhp.h-bill THEN RETURN. /* Malik Serverless 520 */
    ...
    DO:  
      ...
      output-list.str = output-list.str  
                + "     " + translateExtended ("Table",lvCAREA,"") + "|"   
                         ...
                         + "(" + STRING(billnr,">>>9") + ") " + "|"
                         + STRING(kname) + "|" /*"x(32)"*/  /* Modified by Gerald 260220 */
                         + order-id.
      CREATE output-list.
      output-list.sort-i = sort-i.
      sort-i = sort-i + 1.
      ...
      */  
      ...
      DO:     
          IF output-list.str NE "" THEN output-list.str = output-list.str + " | " + TRIM(queasy.char1).
      END.
