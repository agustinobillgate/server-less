...
FIND FIRST calls WHERE RECID(calls) = s-recid NO-LOCK NO-ERROR. /* Malik Serverless : NO-LOCK : NO-LOCK NO-ERROR */

IF NOT AVAILABLE calls THEN RETURN. /* Malik Serverless */
