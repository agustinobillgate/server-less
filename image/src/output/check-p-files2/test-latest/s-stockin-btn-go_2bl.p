...
DEF TEMP-TABLE op-list  LIKE l-op /*Agung Penambahan field mess-unit dan d-unit*/
    FIELD a-bezeich     LIKE l-artikel.bezeich
    FIELD mess-unit     LIKE l-op.anzahl 
    FIELD d-unit        LIKE l-op.anzahl
...
FOR EACH op-list:
    ...
    IF op-list.vat-value NE 0 THEN
        ASSIGN t-amount = t-amount + (op-list.warenwert + (op-list.warenwert * (op-list.vat-value / 100))).
    ELSE ASSIGN t-amount = t-amount + op-list.warenwert.
  ...
  DO TRANSACTION: 
    ...
    DO:
        ...
        ASSIGN
            ...
            queasy336.logi2     = NO               /*Not Direct Issue*/
