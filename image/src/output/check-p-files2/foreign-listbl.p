...
DO:
    ...
    DO: 
        ...
        DO:
            FOR EACH res-line WHERE resstatus = 8 AND active-flag = 2 
        ...
        DO:
            FOR EACH res-line WHERE (resstatus = 6 OR resstatus = 13) 
                AND active-flag = 1 AND res-line.ankunft = fdate NO-LOCK, 
                FIRST guest WHERE guest.gastnr = res-line.gastnrmember 
                AND guest.nation1 NE def-nat NO-LOCK 
                BY guest.nation1 BY res-line.name BY res-line.zinr :
                RUN create-foreign-list.
    ...
    DO: 
        ...
        DO:
            FOR EACH res-line WHERE (resstatus = 6 OR resstatus = 13 
                ...
                AND active-flag LE 2 AND res-line.ankunft LE fdate 
        ...
        DO:
            FOR EACH res-line WHERE (resstatus = 6 OR resstatus = 13 
                                     OR res-line.resstatus = 8) 
                AND active-flag LE 2 AND res-line.ankunft = fdate NO-LOCK, 
                FIRST guest WHERE guest.gastnr = res-line.gastnrmember 
                AND guest.nation1 NE def-nat NO-LOCK 
                BY guest.nation1 BY res-line.name BY res-line.zinr :
                RUN create-foreign-list.
