...
IF AVAIL queasy THEN RETURN.
DO:
    FIND FIRST queasy WHERE KEY = 142 AND number1 = price-list-artnr 
        AND number2 = price-list-deptnr
        AND queasy.date1 = price-list-date1 EXCLUSIVE-LOCK NO-ERROR.
