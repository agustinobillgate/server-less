...
PROCEDURE create-inhouse-v2:
    ...
    RUN pj-inhouse2-btn-go_4-cldbl.p 
    ...
    DO:
        FOR EACH cl-list BY cl-list.company:
            ...
            ASSIGN 
                ...
                argt-list.tot-pax       = argt-list.tot-pax + cl-list.a + cl-list.co
    ...
    DO:
        ...
        ASSIGN            
            summary-list1.summ       = ""
            summary-list1.room-type  = "TOTAL OCCUPIED"
    ...
    ASSIGN 
        ...
        summary-list1.qty       = STRING(tot-payrm).
