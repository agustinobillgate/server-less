...
FOR EACH print-list BY print-list.sort-i:
    ...
    DO:
        ...
        DO:
            outlet-print-list.table-desc = TRIM(ENTRY(6,print-list.str,"|")).
        END.
            
        /*outlet-print-list.table-usr-id   = translateExtended("Table",lvCAREA,"") + " " + table-no + " / " + CAPS(usr-id).*/  
        outlet-print-list.table-usr-id   = translateExtended(table-desc ,lvCAREA,"") + " / " + CAPS(usr-id).
    END.
    ...
    DO:
        ...
        CREATE outlet-print-list.
        outlet-print-list.sort-i = -1.
        outlet-print-list.descrip = FILL("-", 42).
        outlet-print-list.str-price = FILL("-", 19).
    END.
