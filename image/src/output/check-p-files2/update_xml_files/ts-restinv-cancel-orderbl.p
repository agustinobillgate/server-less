...
FIND FIRST h-bill-line WHERE RECID(h-bill-line) = h-bline-rec-id NO-LOCK NO-ERROR. /* Malik Serverless 394 : NO-LOCK NO-ERROR */
IF NOT AVAILABLE h-bill-line THEN RETURN. /* Malik Serverless 394 */
