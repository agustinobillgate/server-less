...
DO TRANSACTION: 
    ...
    /*MASDOD 141221 UPDATE ALL QUEASY RELATED ON SELF ORDER*/
    get-rechnr = vhp.h-bill.rechnr.
    FOR EACH h-bill-line WHERE h-bill-line.departemen EQ h-bill.departemen 
        AND h-bill-line.rechnr EQ h-bill.rechnr 
        AND h-bill-line.betrag LT 0 NO-LOCK:
        FIND FIRST h-artikel WHERE h-artikel.departemen EQ h-bill-line.departemen
    ...
    DO TRANSACTION:
        ...
        DO:            
            ...
            FIND FIRST orderbill WHERE orderbill.KEY EQ 225 AND orderbill.char1 EQ "orderbill" 
                AND orderbill.char3 EQ session-parameter EXCLUSIVE-LOCK NO-ERROR.
            ...
            DO:                
                ...
                FOR EACH orderbill-close WHERE orderbill-close.KEY EQ 225
                    ...
                    AND orderbill-close.logi1 EQ YES EXCLUSIVE-LOCK:
