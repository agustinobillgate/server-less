    ...
    DO:
        ...
        DO:
            ...
            DO:
                ...
                FIND FIRST queasy WHERE queasy.key = 348 AND queasy.date1 = gl-jouhdr.datum NO-LOCK NO-ERROR.
                IF AVAILABLE queasy THEN
                DO:
                    FOR EACH queasy-buff WHERE queasy-buff.key = 348 AND queasy-buff.date1 = gl-jouhdr.datum:
                        DELETE queasy-buff.
                    END.
                END.
                /* END Malik  */
