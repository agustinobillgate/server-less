...
DEFINE BUFFER accomp-r FOR res-line.
...
FOR EACH res-line WHERE res-line.active-flag = 1 
    ...
    /*start bernatd 40050B*/
    FOR EACH accomp-r WHERE accomp-r.resnr EQ q1-list.resnr AND accomp-r.resstatus = 13 AND accomp-r.l-zuordnung[3] = 1 NO-LOCK,
    FIRST guest2 WHERE guest2.gastnr = accomp-r.gastnrmember NO-LOCK:
          q1-list.accomp = q1-list.accomp + guest2.name + "  ".
    END.
    /*end bernatd*/
