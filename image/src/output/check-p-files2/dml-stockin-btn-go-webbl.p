...
/* UPDATE supplier turnover */ 
    ...
    MESSAGE "create l-op " billdate lief-nr s-artnr lscheinnr 
...
/* Create l-op record */ 
    ...
    DO: 
      FIND FIRST d-art WHERE d-art.artnr = s-artnr AND d-art.datum = billdate
          AND ENTRY(2, d-art.chginit, ";") = dml-code NO-LOCK NO-ERROR.
    ...
    DO: 
      FIND FIRST d-art1 WHERE d-art1.artnr = s-artnr AND d-art1.datum = billdate 
        ...
        AND ENTRY(2, d-art1.chginit, ";") = dml-code NO-LOCK NO-ERROR.
      ...
      ELSE DO:
          FIND FIRST reslin-queasy WHERE reslin-queasy.KEY EQ "DML"
            ...
            AND ENTRY(2, reslin-queasy.char3, ";") = dml-code NO-LOCK NO-ERROR.
...
DEFINE buffer l-op1 FOR l-op. 
  ...
  IF NOT do-it THEN RETURN. 
    ...
    MESSAGE "create AP " billdate lief-nr lscheinnr VIEW-AS ALERT-BOX INFO.
