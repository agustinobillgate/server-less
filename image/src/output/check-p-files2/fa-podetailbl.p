/*+++++++++++++++++++++++++++++++++++++++++++++++
BL for fa-podetail.w
29 Desember 2014
Eko Prasetio
++++++++++++++++++++++++++++++++++++++++++++++++*/
/*Define variable and parametre*/
...
FOR EACH fa-order WHERE fa-order.order-nr = docu-nr AND 
    fa-order.fa-pos GT 0 AND fa-order.activeflag = 0 NO-LOCK, 
    FIRST mathis WHERE mathis.nr = fa-order.fa-nr NO-LOCK BY fa-order.fa-pos: 
    ...
    create disclist. 
    ASSIGN 
      disclist.fa-recid = s-order.fa-pos /*RECID(s-order)*/ 
...
FOR EACH s-order WHERE s-order.order-nr = docu-nr NO-LOCK,
    FIRST disclist WHERE disclist.fa-recid = s-order.fa-pos /*integer(RECID(s-order))*/ NO-LOCK ,
    FIRST mathis WHERE mathis.nr = s-order.fa-nr NO-LOCK BY s-order.fa-pos:
    CREATE tmp-tbl-data.
    ASSIGN
