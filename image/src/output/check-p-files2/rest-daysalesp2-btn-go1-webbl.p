...
DO: 
    ...
    RUN rest-daysalesp2-btn-go_4-cldbl.p
        (INPUT TABLE bline-list, INPUT TABLE buf-art, disc-art1, 
         disc-art2, disc-art3, curr-dept, all-user, shift, 
         from-date, to-date, art-str, voucher-art, zero-vat-compli,
         show-fbodisc, curr-dept, incl-move-table,
