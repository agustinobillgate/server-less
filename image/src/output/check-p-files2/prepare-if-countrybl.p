...
FOR EACH parameters WHERE parameters.progname = "if-internal"
...
DEFINE VARIABLE n AS INTEGER INITIAL 0. 
  FOR EACH parameters WHERE progname = "Interface" 
    ...
    n = 0. 
    m = 1. 
    DO WHILE i LE 8 AND n LT length(parameters.vstring): 
      n = n + 1. 
...
DEFINE VARIABLE n AS INTEGER INITIAL 0. 
  FOR EACH parameters WHERE progname = "Interface" 
    ...
    n = 0. 
    m = 1. 
    DO WHILE i LE 3 AND n LT length(parameters.vstring): 
      n = n + 1. 
      IF SUBSTR(parameters.vstring, n, 1) = ";" THEN 
      DO: 
        IF i = 1 THEN 
