  ...
  FOR EACH hoteldpt WHERE hoteldpt.num GE from-dept 
    ...
    DO curr-date = from-date TO to-date: 
      FOR EACH h-journal WHERE h-journal.stornogrund NE "" 
        ...
        DO: 
            ASSIGN 
            cancel-journal.depart       = STRING(hoteldpt.depart, "x(30)")
            cancel-journal.tbno         = STRING(h-journal.tischnr, ">>>>>9")	/*gerald tambah digit B27E0F*/
            cancel-journal.artno        = STRING(h-journal.artnr, ">>>>>>>>>>>>9")  /*william tambah digit 302eb8*/      
            cancel-journal.bezeich      = STRING(h-journal.bezeich, "x(30)")      
            cancel-journal.cancel       = STRING(h-journal.stornogrund, "x(30)")  
