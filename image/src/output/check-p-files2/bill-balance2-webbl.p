...
DEFINE VARIABLE bill-saldo AS DECIMAL INITIAL 0.
                    ...
                    DO: 
                        ...
                        DO:                             
                            FOR EACH bill-line WHERE bill-line.rechnr = bill.rechnr 
                                ...
                                bill-saldo = bill-saldo + bill-line.betrag.
                            END.
                            tot-saldo = tot-saldo + bill-saldo.
                            ...
                            ASSIGN  
                                ...
                                billbalance-list.saldo   = /*bill.saldo*/ bill-saldo 
                            ...
                            ELSE
                            */
                            /*FDL May 16, 2024 => Ticket A10C18*/
                            DO:
                                billbalance-list.remarks = guest.bemerkung.                            
                            END.
                        END.              
                        tot-outstand = tot-outstand + /*bill.saldo*/ tot-saldo. 
                    END. 
                END. 
            END.
        END. 
...
tot-outstand = 0.
/*FDL June 24, 2024 => Ticket C316EE*/
FOR EACH billbalance-list:
    tot-outstand = tot-outstand + billbalance-list.saldo .
   
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,CHR(10),"").
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,CHR(13),"").
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,"~n","").
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,"\n","").
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,"~r","").
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,"~r~n","").
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,"&nbsp;"," ").
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,"</p>",CHR(13)).
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,"<BR>",CHR(13)).
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,CHR(10) + CHR(13),"").
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,CHR(2),"").
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,CHR(3),"").
    billbalance-list.remarks = REPLACE(billbalance-list.remarks,CHR(4),"").

    IF LENGTH(billbalance-list.remarks) LT 3 THEN billbalance-list.remarks = REPLACE(billbalance-list.remarks,CHR(32),"").
    IF LENGTH(billbalance-list.remarks) LT 3 THEN billbalance-list.remarks = "".
    IF LENGTH(billbalance-list.remarks) EQ ? THEN billbalance-list.remarks = "".

    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,CHR(10),"").
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,CHR(13),"").
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,"~n","").
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,"\n","").
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,"~r","").
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,"~r~n","").
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,"&nbsp;"," ").
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,"</p>",CHR(13)).
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,"<BR>",CHR(13)).
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,CHR(10) + CHR(13),"").
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,CHR(2),"").
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,CHR(3),"").
    billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,CHR(4),"").

    IF LENGTH(billbalance-list.bill-remark) LT 3 THEN billbalance-list.bill-remark = REPLACE(billbalance-list.bill-remark,CHR(32),"").
    IF LENGTH(billbalance-list.bill-remark) LT 3 THEN billbalance-list.bill-remark = "".
    IF LENGTH(billbalance-list.bill-remark) EQ ? THEN billbalance-list.bill-remark = "".
END.
CREATE billbalance-list. 
