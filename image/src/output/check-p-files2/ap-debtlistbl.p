...
/*      CREATE output-list. */ 
      ...
      output-list.str = STRING(l-kredit.rgdatum) 
        + STRING(receiver, "x(32)") 
        + STRING(l-kredit.name, "x(11)") 
        + STRING(l-kredit.lscheinnr, "x(24)") 
      ...
      IF AVAILABLE bediener THEN 
        output-list.str = output-list.str + STRING(bediener.userinit,"x(2)"). 
      ELSE output-list.str = output-list.str + "  ". 
      output-list.str = output-list.str + STRING(due-date). 
