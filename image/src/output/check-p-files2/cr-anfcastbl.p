...
/* IF roompaxselect = 0 THEN */ 
    ...
    DO:
        FOR EACH genstat WHERE genstat.datum GE curr-date AND genstat.datum LE datum2
            AND genstat.zinr NE "" AND genstat.res-logic[2] NO-LOCK:
            do-it = YES. 
    ...
    DO:
        FOR EACH res-line WHERE (res-line.resstatus NE 9 
                                 ...
                                 NO-LOCK USE-INDEX gnrank_ix BY res-line.resnr:
            ...
            IF do-it THEN 
            DO: 
                IF res-line.ankunft GE from-date THEN datum1 = res-line.ankunft.
