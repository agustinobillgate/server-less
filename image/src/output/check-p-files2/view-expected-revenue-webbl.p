...
FOR EACH res-line WHERE res-line.resnr EQ resno NO-LOCK BY res-line.reslinnr:
    ...
    DO curr-datum = res-line.ankunft TO abreise-date:
        ...
        FIND FIRST zimkateg WHERE zimkateg.zikatnr EQ res-line.zikatnr NO-LOCK.
        FIND FIRST arrangement WHERE arrangement.arrangement EQ res-line.arrangement NO-LOCK.  
        t-res-line.str-argt = arrangement.arrangement.  
...
FOR EACH output-list NO-LOCK BY output-list.datum BY output-list.rmtype-no BY output-list.flag:
    ...
    DO:
        FIND FIRST buf-list WHERE buf-list.flag EQ 3
...
FOR EACH output-list NO-LOCK BY output-list.datum BY output-list.rmtype-no BY output-list.flag:
    IF output-list.flag EQ 0 OR output-list.flag EQ 2 THEN
    DO:
    ...
    DO:                
        ...
        DO:
            ...
            FOR EACH fixleist WHERE fixleist.resnr = res-line.resnr 
                ...
                ELSE IF fixleist.sequenz = 5 AND day(datum + 1) = 1 THEN add-it = YES. 
