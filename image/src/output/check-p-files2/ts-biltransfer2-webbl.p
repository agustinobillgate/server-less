...
DO:
    ...
    DO:
        DO count-i = 1 TO NUM-ENTRIES(excl-str, ","):  
            ASSIGN  
                curr-dept = -1  
                curr-dept = INTEGER(ENTRY(count-i, excl-str, ",")) NO-ERROR  
            .  
            IF curr-dept GT 0 THEN  
            DO:  
                CREATE dept-list.  
                ASSIGN dept-list.deptNo = curr-dept.  
            END.  
        END.
        FIND FIRST dept-list WHERE dept-list.deptNo = dept NO-LOCK NO-ERROR.  
