...
DEFINE VARIABLE prev-date           AS DATE NO-UNDO. /*Alder - Serverless - Issue 719*/
...
DO:
    ASSIGN prev-date = ci-date - 1.                              /*Alder - Serverless - Issue 719*/
    FIND FIRST akt-line WHERE akt-line.userinit = user-init
        /*AND akt-line.datum GE (ci-date - 1)*/                 /*Alder - Serverless - Issue 719*/
        AND akt-line.datum GE prev-date                         /*Alder - Serverless - Issue 719*/
        AND akt-line.datum LE ci-date
        NO-LOCK NO-ERROR.
