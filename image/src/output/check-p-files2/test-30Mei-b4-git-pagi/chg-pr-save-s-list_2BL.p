...
FIND FIRST l-orderhdr WHERE RECID(l-orderhdr) = rec-id NO-LOCK NO-ERROR.
...
DO:
    ...
    /*ITA export to DP*/
    IF app-id[1] NE "" THEN DO:
        FIND FIRST queasy WHERE queasy.KEY = 278 AND queasy.char1 = l-orderhdr.docu-nr NO-LOCK NO-ERROR.
