...
FIND FIRST l-orderhdr WHERE RECID(l-orderhdr) EQ rec-id NO-LOCK NO-ERROR. /*Alder - Serverless - Issue 704*/ /*NO-LOCK NO-ERROR*/
IF AVAILABLE l-orderhdr THEN
DO:
    FIND CURRENT l-orderhdr EXCLUSIVE-LOCK. /*Alder - Serverless - Issue 704*/ /*EXCLUSIVE-LOCK*/
    ...
    FIND CURRENT l-orderhdr NO-LOCK. /*Alder - Serverless - Issue 704*/ /*FIND CURRENT*/
    RELEASE l-orderhdr. /*Alder - Serverless - Issue 704*/ /*RELEASE*/
END.
