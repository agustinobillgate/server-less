...
DEF TEMP-TABLE region-list LIKE orges-list.
...
PROCEDURE create-list:
   ...
   .
    ...
    FOR EACH queasy WHERE queasy.key = 6 NO-LOCK:
        CREATE region-list.
        ASSIGN region-list.nationality  = queasy.char1
               region-list.region-nr    = queasy.number1.
    END.
    ...
    FOR EACH genstat WHERE genstat.datum GE from-date
        ...
        FIRST nation WHERE nation.nationnr = genstat.nationnr,
        FIRST region-list WHERE region-list.region-nr = nation.untergruppe:
        
        FIND FIRST orges-list WHERE orges-list.nationnr = nation.nationnr NO-LOCK NO-ERROR.
        IF NOT AVAILABLE orges-list THEN
        DO:
            CREATE orges-list.
            ASSIGN orges-list.region-nr   = region-list.region-nr
                   orges-list.nationnr    = nation.nationnr
        ...
        DO:
            IF genstat.datum GE fdate AND genstat.datum LE to-date THEN DO:
                region-list.B-totRmNights = region-list.B-totRmNights + 1.
                ...
                DO:
                    region-list.B-groupRmNights = region-list.B-groupRmNights + 1.
                    orges-list.B-groupRmNights = orges-list.B-groupRmNights + 1.
                    tot-b-grup = tot-b-grup + 1.
                END.
                ELSE    /* individual */
                DO:
                    region-list.B-individualRmNights = region-list.B-individualRmNights + 1.
            ...
            IF MONTH(genstat.datum) = MONTH(to-date) THEN DO: /*MTD*/
                region-list.MTD-BtotRmNights = region-list.MTD-BtotRmNights + 1.
                ...
                IF AVAILABLE reservation 
                    AND (INTEGER(reservation.grpflag) + 1) = 2 THEN     /* grup rsv */
                DO:
                    region-list.MTD-BgroupRmNights = region-list.MTD-BgroupRmNights + 1.
                    orges-list.MTD-BgroupRmNights = orges-list.MTD-BgroupRmNights + 1.
                    MTDtot-b-grup = MTDtot-b-grup + 1.
                END.
                ELSE    /* individual */
                DO:
                    region-list.MTD-BindividualRmNights = region-list.MTD-BindividualRmNights + 1.
        ...
        DO:
            IF genstat.datum GE fdate AND genstat.datum LE to-date THEN DO:
                region-list.L-totRmNights = region-list.L-totRmNights + 1.
                ...
                IF AVAILABLE reservation 
                    AND (INTEGER(reservation.grpflag) + 1) = 2 THEN     /* grup rsv */
                DO:
                    region-list.L-groupRmNights = region-list.L-groupRmNights + 1.
                    orges-list.L-groupRmNights = orges-list.L-groupRmNights + 1.
                    tot-l-grup = tot-l-grup + 1.
                END.
                ELSE    /* individual */
                DO:
                    region-list.L-individualRmNights = region-list.L-individualRmNights + 1.
            ...
            IF MONTH(genstat.datum) = MONTH(to-date) THEN DO: /*MTD*/
                region-list.MTD-LtotRmNights = region-list.MTD-LtotRmNights + 1.
                ...
                IF AVAILABLE reservation 
                    AND (INTEGER(reservation.grpflag) + 1) = 2 THEN     /* grup rsv */
                DO:
                    region-list.MTD-LgroupRmNights = region-list.MTD-LgroupRmNights + 1.
                    orges-list.MTD-LgroupRmNights = orges-list.MTD-LgroupRmNights + 1.
                    MTDtot-l-grup = MTDtot-l-grup + 1.
                END.
                ELSE    /* individual */
                DO:
                    region-list.MTD-LindividualRmNights = region-list.MTD-LindividualRmNights + 1.
    ...
    FOR EACH orges-list NO-LOCK,
         FIRST region-list WHERE region-list.region-nr = orges-list.region-nr
         BY orges-list.region-nr:
     
        ASSIGN
            region-list.subtotal-date = region-list.B-totRmNights + region-list.L-totRmNights
            region-list.subtotal-MTD = region-list.MTD-BtotRmNights + region-list.MTD-LtotRmNights
            ...
            region-list.pMTD-BtotRmNights         = (region-list.MTD-BtotRmNights / MTDsubtot-b) * 100.00 
            region-list.pMTD-BgroupRmNights       = (region-list.MTD-BgroupRmNights / MTDtot-b-grup) * 100.00 
            region-list.pMTD-BindividualRmNights  = (region-list.MTD-BindividualRmNights / MTDtot-b-individual) * 100.00
            region-list.pMTD-LtotRmNights         = (region-list.MTD-LtotRmNights / MTDsubtot-l) * 100.00
            region-list.pMTD-LgroupRmNights       = (region-list.MTD-LgroupRmNights / MTDtot-l-grup) * 100.00
            region-list.pMTD-LindividualRmNights  = (region-list.MTD-LindividualRmNights / MTDtot-l-individual) * 100.00
            region-list.psubtotal-date            = (region-list.subtotal-date / subtot-date) * 100.00 
            region-list.psubtotal-MTD             = (region-list.subtotal-MTD / subtot-MTD) * 100.00
         ...
         IF region-list.pMTD-BtotRmNights           = ? THEN region-list.pMTD-BtotRmNights          = 0.00.
         IF region-list.pMTD-BgroupRmNights         = ? THEN region-list.pMTD-BgroupRmNights        = 0.00.
         IF region-list.pMTD-BindividualRmNights    = ? THEN region-list.pMTD-BindividualRmNights   = 0.00.
         IF region-list.pMTD-LtotRmNights           = ? THEN region-list.pMTD-LtotRmNights          = 0.00.
         IF region-list.pMTD-LgroupRmNights         = ? THEN region-list.pMTD-LgroupRmNights        = 0.00.
         IF region-list.pMTD-LindividualRmNights    = ? THEN region-list.pMTD-LindividualRmNights   = 0.00.
         IF region-list.psubtotal-date              = ? THEN region-list.psubtotal-date             = 0.00.
         IF region-list.psubtotal-MTD               = ? THEN region-list.psubtotal-MTD              = 0.00.
         ...
         FIND FIRST out-list WHERE out-list.num = 999
             AND out-list.region-nr = orges-list.region-nr NO-LOCK NO-ERROR.

         IF NOT AVAILABLE out-list THEN
         DO:
             CREATE out-list.
             ASSIGN out-list.num = 999
                    out-list.region-nr = region-list.region-nr.
             out-list.str = out-list.str + STRING("** " + region-list.nationality + " **", "x(30)")
                             + STRING(region-list.B-totRmNights,        "               >>>>9")
                             + STRING(region-list.B-groupRmNights,      "               >>>>9")
                             + STRING(region-list.B-individualRmNights, "               >>>>9")
                             + STRING(region-list.L-totRmNights,        "               >>>>9")
                             + STRING(region-list.L-groupRmNights,      "               >>>>9")
                             + STRING(region-list.L-individualRmNights, "               >>>>9")
                             + STRING(region-list.MTD-BtotRmNights,     "               >>>>9")
                             + STRING(region-list.MTD-BgroupRmNights,   "               >>>>9")
                             + STRING(region-list.MTD-BindividualRmNights, "               >>>>9")
                             + STRING(region-list.MTD-LtotRmNights,     "               >>>>9")
                             + STRING(region-list.MTD-LgroupRmNights,   "               >>>>9")
                             + STRING(region-list.MTD-LindividualRmNights, "               >>>>9")
                             + STRING(region-list.pMTD-BtotRmNights,     "              >>9.99")
                             + STRING(region-list.pMTD-BgroupRmNights,   "              >>9.99")
                             + STRING(region-list.pMTD-BindividualRmNights, "              >>9.99")
                             + STRING(region-list.pMTD-LtotRmNights,     "              >>9.99")
                             + STRING(region-list.pMTD-LgroupRmNights,   "              >>9.99")
                             + STRING(region-list.pMTD-LindividualRmNights, "              >>9.99")
                             + STRING(region-list.subtotal-date,         "               >>>>9")
                             + STRING(region-list.subtotal-MTD,          "               >>>>9")
                             + STRING(region-list.psubtotal-date,        "              >>9.99")
                             + STRING(region-list.psubtotal-MTD,         "              >>9.99")
             .
   ...
   .
    ...
    FOR EACH genstat WHERE genstat.datum GE from-date
        ...
        DO:
            ...
            IF genstat.datum GE jan1 AND genstat.datum LE to-date THEN DO:
                region-list.YTD-BtotRmNights = region-list.YTD-BtotRmNights + 1.
                ...
                IF AVAILABLE reservation 
                    AND (INTEGER(reservation.grpflag) + 1) = 2 THEN     /* grup rsv */
                DO:
                    region-list.YTD-BgroupRmNights = region-list.YTD-BgroupRmNights + 1.
                    orges-list.YTD-BgroupRmNights = orges-list.YTD-BgroupRmNights + 1.
                    YTDtot-b-grup = YTDtot-b-grup + 1.
                END.
                ELSE    /* individual */
                DO:
                    region-list.YTD-BindividualRmNights = region-list.YTD-BindividualRmNights + 1.
        ...
        DO:
           ...
           IF genstat.datum GE jan1 AND genstat.datum LE to-date THEN DO:
                region-list.YTD-LtotRmNights = region-list.YTD-LtotRmNights + 1.
                ...
                IF AVAILABLE reservation 
                    AND (INTEGER(reservation.grpflag) + 1) = 2 THEN     /* grup rsv */
                DO:
                    region-list.YTD-LgroupRmNights = region-list.YTD-LgroupRmNights + 1.
                    orges-list.YTD-LgroupRmNights = orges-list.YTD-LgroupRmNights + 1.
                    YTDtot-l-grup = YTDtot-l-grup + 1.
                END.
                ELSE    /* individual */
                DO:
                    region-list.YTD-LindividualRmNights = region-list.YTD-LindividualRmNights + 1.
    ...
    FOR EACH orges-list NO-LOCK,
         ...
         ASSIGN
             region-list.subtotal-date = region-list.B-totRmNights + region-list.L-totRmNights
             region-list.subtotal-MTD = region-list.MTD-BtotRmNights + region-list.MTD-LtotRmNights
             region-list.subtotal-YTD = region-list.YTD-BtotRmNights + region-list.YTD-LtotRmNights
             orges-list.subtotal-date = orges-list.B-totRmNights + orges-list.L-totRmNights
             orges-list.subtotal-MTD  = orges-list.MTD-BtotRmNights + orges-list.MTD-LtotRmNights
             ...
             region-list.pYTD-BtotRmNights         = (region-list.YTD-BtotRmNights / YTDsubtot-b) * 100.00 
             region-list.pYTD-BgroupRmNights       = (region-list.YTD-BgroupRmNights / YTDtot-b-grup) * 100.00 
             region-list.pYTD-BindividualRmNights  = (region-list.YTD-BindividualRmNights / YTDtot-b-individual) * 100.00
             region-list.pYTD-LtotRmNights         = (region-list.YTD-LtotRmNights / YTDsubtot-l) * 100.00
             region-list.pYTD-LgroupRmNights       = (region-list.YTD-LgroupRmNights / YTDtot-l-grup) * 100.00
             region-list.pYTD-LindividualRmNights  = (region-list.YTD-LindividualRmNights / YTDtot-l-individual) * 100.00
             region-list.psubtotal-YTD             = (region-list.subtotal-YTD / subtot-YTD) * 100.00
         ...
         IF region-list.pYTD-BtotRmNights           = ? THEN region-list.pYTD-BtotRmNights          = 0.00.
         IF region-list.pYTD-BgroupRmNights         = ? THEN region-list.pYTD-BgroupRmNights        = 0.00.
         IF region-list.pYTD-BindividualRmNights    = ? THEN region-list.pYTD-BindividualRmNights   = 0.00.
         IF region-list.pYTD-LtotRmNights           = ? THEN region-list.pYTD-LtotRmNights          = 0.00.
         IF region-list.pYTD-LgroupRmNights         = ? THEN region-list.pYTD-LgroupRmNights        = 0.00.
         IF region-list.pYTD-LindividualRmNights    = ? THEN region-list.pYTD-LindividualRmNights   = 0.00.
         IF region-list.psubtotal-YTD               = ? THEN region-list.psubtotal-YTD              = 0.00.
         ...
         FIND FIRST out-list1 WHERE out-list1.num = 999
             AND out-list1.region-nr = orges-list.region-nr NO-LOCK NO-ERROR.
         IF NOT AVAILABLE out-list1 THEN
         DO:
             CREATE out-list1.
             ASSIGN out-list1.num = 999
                    out-list1.region-nr = region-list.region-nr.
             out-list1.str = out-list1.str + STRING("** " + region-list.nationality + " **", "x(30)")
                             + STRING(region-list.B-totRmNights,        "               >>>>9")
                             + STRING(region-list.B-groupRmNights,      "               >>>>9")
                             + STRING(region-list.B-individualRmNights, "               >>>>9")
                             + STRING(region-list.L-totRmNights,        "               >>>>9")
                             ...
                             + STRING(region-list.subtotal-MTD,          "               >>>>9")
                             + STRING(region-list.psubtotal-date,        "              >>9.99")
                             + STRING(region-list.psubtotal-YTD,         "              >>9.99")
                             + STRING(region-list.YTD-BtotRmNights,     "               >>>>9")
                             + STRING(region-list.YTD-BgroupRmNights,   "               >>>>9")
                             + STRING(region-list.YTD-BindividualRmNights, "               >>>>9")
                             + STRING(region-list.YTD-LtotRmNights,     "               >>>>9")
                             + STRING(region-list.YTD-LgroupRmNights,   "               >>>>9")
                             + STRING(region-list.YTD-LindividualRmNights, "               >>>>9")
                             + STRING(region-list.pYTD-BtotRmNights,     "              >>9.99")
                             + STRING(region-list.pYTD-BgroupRmNights,   "              >>9.99")
                             + STRING(region-list.pYTD-BindividualRmNights, "              >>9.99")
                             + STRING(region-list.pYTD-LtotRmNights,     "              >>9.99")
                             + STRING(region-list.pYTD-LgroupRmNights,   "              >>9.99")
                             + STRING(region-list.pYTD-LindividualRmNights, "              >>9.99")
                             + STRING(region-list.subtotal-YTD,          "               >>>>9")
                             + STRING(region-list.psubtotal-YTD,         "              >>9.99")
                 .
