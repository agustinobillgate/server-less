...
async def handle_dynamic_data(request: Request, input_data: Dict[str, Any]):
    ...
    newlog.serverinfo = "Docker:" + docker_version
    ...
    hotel_code = input_data.get("hotelCode")
    if not hotel_code:
        hotel_code = input_data.get("hotelcode")
    ...
    try:
        ...
        output_data["path"] = path
        output_data["version"] = docker_version
        output_data["module/function"] = module_name
