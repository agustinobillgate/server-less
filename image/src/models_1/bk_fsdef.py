...
class Bk_fsdef(Base):
	...
	def __init__(self, *args, **kwargs):
		...
		kwargs.setdefault('fs_field_active', False)
		kwargs.setdefault('fs_field_length', 0)
		kwargs.setdefault('fs_field_name', "")
		kwargs.setdefault('fsname', "")
		kwargs.setdefault('segmentcode', 0)
		super(Bk_fsdef, self).__init__(*args, **kwargs)
