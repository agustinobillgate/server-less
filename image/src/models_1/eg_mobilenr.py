...
class Eg_mobilenr(Base):
	__tablename__ = 'eg_mobilenr'
	...
	mobilenr = sa.Column(sa.String, default="")
	...
	def __init__(self, *args, **kwargs):
		...
		super(Eg_mobilenr, self).__init__(*args, **kwargs)
