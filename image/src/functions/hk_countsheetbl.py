...
from models import Res_line, Zimmer, Reservation, Segmentstat, Outorder
...
def hk_countsheetbl(pvilanguage:int):
    ...
    res_line = zimmer = reservation = segmentstat = outorder = None
    ...
    def generate_output():
        nonlocal ci_date, out_list_list, netage, nseq, nsum, i, loop, nstat, nstr, stat, tot_stat, lvcarea, res_line, zimmer, reservation, segmentstat, outorder
    ...
    def create_list():
        ...
        for n in range(from_etage,anz_etage + 1) :
            ...
            if not zimmer or not(zimmer.etage == n):
            ...
            if zimmer:
                ...
                for zimmer in db_session.query(Zimmer).filter(
                    ...
                    if zimmer.zistatus >= 3 and zimmer.zistatus <= 5:
                        ...
                        if not res_line or not(res_line.active_flag == 1 and res_line.zinr == zimmer.zinr and res_line.zipreis == 0 and res_line.resstatus == 6):
                        ...
                        if res_line:
                            ...
                            if not segmentstat or not(segmentstat.segmentcode == reservation.segmentcode):
                                segmentstat = db_session.query(Segmentstat).filter(
                                    (Segmentstat.segmentcode == reservation.segmentcode)).first()

                            if segmentstat.betriebsnr != 2:

                                if not out_list or not(out_list.etage == zimmer.etage and out_list.stat == 8 and out_list.flag == 0):
                                ...
                                if not out_list or not(out_list.etage == zimmer.etage and out_list.stat == 9 and out_list.flag == 0):
                        ...
                        if not res_line or not(res_line.active_flag == 1 and res_line.zinr == zimmer.zinr):
                            res_line = db_session.query(Res_line).filter(
                        ...
                        if res_line:
                            ...
                            if not out_list or not(out_list.etage == zimmer.etage and out_list.stat == 12 and out_list.flag == 0):
                        ...
                        if not outorder or not(outorder.betriebsnr > 0 and outorder.gespstart <= ci_date and outorder.gespende >= ci_date and outorder.zinr == zimmer.zinr):
                        ...
                        if outorder:
                            ...
                            if not out_list or not(out_list.etage == zimmer.etage and out_list.stat == 7 and out_list.flag == 0):
                    ...
                    if not hu_flag and not om_flag:
                        ...
                        if not out_list or not(out_list.etage == zimmer.etage and out_list.stat == zimmer.zistatus and out_list.flag == 0):
                    ...
                    if not reslin1 or not(reslin1.active_flag == 0 and (reslin1.resstatus == 1 or reslin1.resstatus == 2 or reslin1.resstatus == 3 or reslin1.resstatus == 4) and reslin1.ankunft == ci_date and reslin1.zinr == zimmer.zinr):
                    ...
                    if reslin1:
                        ...
                        if not out_list or not(out_list.etage == zimmer.etage and out_list.flag == 0 and out_list.name.lower()  == ("EA").lower()):
