...
def ts_mkres_btn_exit_1bl(pvilanguage:int, moved_tisch:int, s_recid:int, curr_dept:int, curr_date:date, von_zeit:str, bis_zeit:str, pax:int, telefon:str, gname:str, user_init:str, comments:str, selected_gastnr:int, depo_amount:decimal, ns_billno:int):
    msg_str = ""
    done = False
    ...
    if s_recid == 0:
        ...
        queasy.deci1 = depo_amount
        queasy.deci2 = ns_billno
        queasy.logi3 = True
