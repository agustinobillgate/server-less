...
def outstand_polist_btn_gobl(from_date:date, to_date:date):
    ...
    exp_polist_list, Exp_polist = create_model("Exp_polist", {"bestelldatum":date, "firma":str, "docu_nr":str, "lieferdatum":date, "anzahl":decimal, "warenwert":decimal, "geliefert":decimal, "rechnungswert":decimal, "hlief_fax":[str], "bestellart":str, "gedruckt":date, "besteller":str, "lief_fax":[str], "lieferdatum1":date, "lieferdatum_eff":date})
