...
def gl_parser_fill_listbl(briefnr:int):
    ...
    t_gl_acct_list, T_gl_acct = create_model("T_gl_acct", {"fibukonto":str, "deptnr":int, "bezeich":str, "main_nr":int, "acc_type":int, "actual":[decimal], "budget":[decimal], "last_yr":[decimal], "ly_budget":[decimal]})
