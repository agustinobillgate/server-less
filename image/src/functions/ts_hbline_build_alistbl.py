    ...
    def build_alist():
        ...
        if not zero_flag:
            ...
            for h_artikel in db_session.query(H_artikel).filter(
                    (H_artikel.departement == dept) &  (H_artikel.artart == 0) &  (H_artikel.zwkum == curr_zwkum) &  (H_artikel.epreis1 != 0) &  (H_artikel.activeflag) &  ((H_artikel.s_gueltig == None) |  ((H_artikel.s_gueltig <= billdate) &  (H_artikel.e_gueltig >= billdate)))).all():
                i = i + 1
                art_list = Art_list()
            ...
            for h_artikel in db_session.query(H_artikel).filter(
                    (H_artikel.departement == dept) &  (H_artikel.artart == 0) &  (H_artikel.zwkum == curr_zwkum) &  (H_artikel.activeflag) &  ((H_artikel.s_gueltig == None) |  ((H_artikel.s_gueltig <= billdate) &  (H_artikel.e_gueltig >= billdate)))).all():
                i = i + 1
                art_list = Art_list()
                art_list_list.append(art_list)
