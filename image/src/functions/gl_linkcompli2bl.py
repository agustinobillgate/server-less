...
def gl_linkcompli2bl(pvilanguage:int, remains:decimal, credits:decimal, debits:decimal, to_date:date, refno:str, datum:date, bezeich:str, g_list:[G_list]):
    new_hdr:bool = True
    ...
    def create_journals():
        ...
        for g_list in query(g_list_list):
            ...
            gl_journal.debit = round(g_list.debit, 2)
            gl_journal.credit = round(g_list.credit, 2)
