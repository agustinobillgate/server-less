...
def prepare_roomplanbl(from_room:str):
    to_date = None
    curr_date = None
    ci_date = None
    do_it = False
    ...
    room_list_list, Room_list = create_model("Room_list", {"location":str, "zistatus":int, "ststr":str, "build":str, "build_flag":str, "etage":int, "zinr":str, "c_char":str, "i_char":str, "zikatnr":int, "rmcat":str, "connec":str, "avtoday":str, "recid1":[int, 28], "gstatus":[int, 28], "bcol":[int, 28], "fcol":[int, 28], "room":[str, 28], "off_mkt":[bool, 28]})
