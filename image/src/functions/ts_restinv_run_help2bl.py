...
def ts_restinv_run_help2bl(menu_list:[Menu_list], pvilanguage:int, session_parameter:str, do_it:bool, tischnr:int, curr_dept:int, curr_waiter:int, rechnr:int, departement:int, user_init:str):
    bill_date = None
    error_str = ""
    disc_art1:int = 0
    disc_art2:int = 0
    ...
    def generate_output():
        nonlocal bill_date, error_str, disc_art1, disc_art2, disc_art3, head_recid, i, htparam, queasy, h_bill_line, h_journal
