...
def cr_occfcast1_1lybl(curr_from_date:date, curr_to_date:date, all_segm:bool, all_argt:bool, all_zikat:bool, room_list:[Room_list], segm_list:[Segm_list], argt_list:[Argt_list], zikat_list:[Zikat_list]):
    date_1:date = None
    date_2:date = None
