...
def ap_list_1bl(from_date:date, to_date:date, lastname:str, sorttype:int, price_decimal:int, check_disp:int):
    output_list_list = []
    t_ap:decimal = 0
    t_pay:decimal = 0
    t_bal:decimal = 0
    ...
    output_list_list, Output_list = create_model("Output_list", {"betriebsnr":int, "ap_recid":int, "curr_pay":decimal, "lscheinnr":str, "str":str, "steuercode":int, "recv_date":date})
    ...
    def generate_output():
        nonlocal output_list_list, t_ap, t_pay, t_bal, tot_ap, tot_pay, tot_bal, i, l_kredit, l_lieferant, queasy
        nonlocal l_ap
        ...
        if lastname == "":
            ...
            if check_disp == 0:
                ...
                for l_kredit, l_lieferant in db_session.query(L_kredit, L_lieferant).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
                        (L_kredit.lief_nr > 0) &  (L_kredit.zahlkonto == 0) &  (L_kredit.opart == sorttype) &  (L_kredit.counter >= 0) &  (L_kredit.netto != 0)).all():
                    ...
                    if do_it:
                        ...
                        if l_kredit.counter > 0:
                            ...
                            for l_ap in db_session.query(L_ap).filter(
                                    (L_ap.counter == l_kredit.counter) &  (L_ap.zahlkonto > 0) &  (L_ap.opart > 0)).all():
                                curr_pay = curr_pay - l_ap.saldo
                        ...
                        t_ap = t_ap + l_kredit.netto
                        t_pay = t_pay + curr_pay
                        t_bal = t_bal + l_kredit.netto - curr_pay
                        tot_ap = tot_ap + l_kredit.netto
                        tot_pay = tot_pay + curr_pay
                        tot_bal = tot_bal + l_kredit.netto - curr_pay
                ...
                l_kredit_obj_list = []
                for l_kredit, l_lieferant in db_session.query(L_kredit, L_lieferant).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
                        (L_kredit.lief_nr > 0) &  (L_kredit.zahlkonto == 0) &  (L_kredit.opart == sorttype) &  (L_kredit.counter >= 0) &  (L_kredit.netto != 0) &  (L_kredit.rechnr != 0000000)).all():
                    if l_kredit._recid in l_kredit_obj_list:
                        continue
                    else:
                        l_kredit_obj_list.append(l_kredit._recid)
            ...
            if do_it:
                ...
                for l_kredit in db_session.query(L_kredit).filter(
                        (L_kredit.lief_nr == l_lieferant.lief_nr) &  (L_kredit.zahlkonto == 0) &  (L_kredit.opart == sorttype) &  (L_kredit.counter >= 0) &  (L_kredit.netto != 0)).all():
                    curr_pay = 0
    ...
    def disp_it0():
        ...
        if lastname == "":
            ...
            if check_disp == 0:
                ...
                l_kredit_obj_list = []
                for l_kredit, l_lieferant in db_session.query(L_kredit, L_lieferant).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
                        (L_kredit.lief_nr > 0) &  (L_kredit.zahlkonto == 0) &  (L_kredit.opart == sorttype) &  (L_kredit.rgdatum <= to_date) &  (L_kredit.counter >= 0) &  (L_kredit.netto != 0)).all():
                    if l_kredit._recid in l_kredit_obj_list:
                        continue
                    else:
                        l_kredit_obj_list.append(l_kredit._recid)
                ...
                l_kredit_obj_list = []
                for l_kredit, l_lieferant in db_session.query(L_kredit, L_lieferant).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
                        (L_kredit.lief_nr > 0) &  (L_kredit.zahlkonto == 0) &  (L_kredit.opart == sorttype) &  (L_kredit.rgdatum <= to_date) &  (L_kredit.counter >= 0) &  (L_kredit.netto != 0) &  (L_kredit.rechnr != 0000000)).all():
                    if l_kredit._recid in l_kredit_obj_list:
                        continue
                    else:
                        l_kredit_obj_list.append(l_kredit._recid)
            ...
            if do_it:
                ...
                for l_kredit in db_session.query(L_kredit).filter(
                        (L_kredit.lief_nr == l_lieferant.lief_nr) &  (L_kredit.zahlkonto == 0) &  (L_kredit.opart == sorttype) &  (L_kredit.counter >= 0) &  (L_kredit.netto != 0) &  (L_kredit.rgdatum <= to_date)).all():
                    curr_pay = 0
    ...
    def disp_it1():
        ...
        if lastname == "":
            ...
            if check_disp == 0:
                ...
                l_kredit_obj_list = []
                for l_kredit, l_lieferant in db_session.query(L_kredit, L_lieferant).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
                        (L_kredit.lief_nr > 0) &  (L_kredit.zahlkonto == 0) &  (L_kredit.opart == sorttype) &  (L_kredit.rgdatum >= from_date) &  (L_kredit.rgdatum <= to_date) &  (L_kredit.counter >= 0) &  (L_kredit.netto != 0)).all():
                    if l_kredit._recid in l_kredit_obj_list:
                        continue
                    else:
                        l_kredit_obj_list.append(l_kredit._recid)
                ...
                l_kredit_obj_list = []
                for l_kredit, l_lieferant in db_session.query(L_kredit, L_lieferant).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
                        (L_kredit.lief_nr > 0) &  (L_kredit.zahlkonto == 0) &  (L_kredit.opart == sorttype) &  (L_kredit.rgdatum >= from_date) &  (L_kredit.rgdatum <= to_date) &  (L_kredit.counter >= 0) &  (L_kredit.netto != 0) &  (L_kredit.rechnr != 0000000)).all():
                    if l_kredit._recid in l_kredit_obj_list:
                        continue
                    else:
                        l_kredit_obj_list.append(l_kredit._recid)
            ...
            if do_it:
                ...
                for l_kredit in db_session.query(L_kredit).filter(
                        (L_kredit.lief_nr == l_lieferant.lief_nr) &  (L_kredit.zahlkonto == 0) &  (L_kredit.opart == sorttype) &  (L_kredit.counter >= 0) &  (L_kredit.netto != 0) &  (L_kredit.rgdatum >= from_date) &  (L_kredit.rgdatum <= to_date)).all():
                    curr_pay = 0
