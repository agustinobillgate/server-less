...
def prepare_gl_jouhislistbl():
    ...
    def generate_output():
        nonlocal from_date, close_date, close_year, from_main, main_bez, chr977, gl_main_list_list, gl_depart_list_list, gl_main, htparam
        nonlocal gl_main1


        nonlocal gl_main_list, gl_depart_list, gl_main1
        nonlocal gl_main_list_list, gl_depart_list_list
    ...
    from_date = date_mdy(1, 1, get_year(htparam.fdate) - 3)
