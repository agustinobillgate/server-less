...
def hk_ooo_1_cldbl(om_list_list:[Om_list], fdate:date, tdate:date, disptype:int, sorttype:int, user_init:str):
    ci_date = None
    ooo_list_list = []
    ...
    def assign_it():
        ...
        local_storage.debugging = local_storage.debugging + "," + om_list.ind
