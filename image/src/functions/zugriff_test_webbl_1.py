...
def zugriff_test_webbl(user_init:str, array_nr:int, expected_nr:int):
    ...
    def generate_output():
        ...
        nonlocal value_list, signature_list, tp_bediener, t_messages, signature_list_list
        global value_list_list, tp_bediener_list, t_messages_list
    ...
    def create_signature(user_name:str, value_list_list:[Value_list]):
        ...
        def generate_inner_output():
            # return (epoch, "signature-list": signature_list_list)
            # return {"epoch" : epoch, "signature-list": signature_list_list}
        ...
        print("Value_list_list:", value_list_list)
        for value_list in query(value_list_list):
            value_str = value_list.value_str.lower()

            if value_str == ("YES").lower():
                value_str = "true"
            elif value_str == ("NO").lower():
                value_str = "false"
