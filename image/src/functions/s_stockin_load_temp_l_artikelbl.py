...
def s_stockin_load_temp_l_artikelbl(icase:int, a_artnr:int, a_bezeich:str):
    temp_l_artikel_list = []
    l_artikel = None

    temp_l_artikel = None

    temp_l_artikel_list, Temp_l_artikel = create_model("Temp_l_artikel", {"bezeich":str, "ek_aktuell":decimal, "artnr":int, "traubensort":str, "lief_einheit":decimal, "masseinheit":str, "betriebsnr":int, "alkoholgrad":decimal})
