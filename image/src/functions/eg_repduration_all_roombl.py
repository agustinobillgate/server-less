...
def eg_repduration_all_roombl(all_room:bool, tlocation:[Tlocation], tmaintask:[Tmaintask], troom:[Troom]):
    tproperty_list = []
    eg_property = queasy = eg_location = None

    tmaintask = troom = tproperty = tlocation = qbuff = comlocat = commain = comroom = ques = None
    ...
    def generate_output():
        ...
        nonlocal tmaintask, troom, tproperty, tlocation, qbuff, comlocat, commain, comroom, ques
        nonlocal tmaintask_list, troom_list, tproperty_list, tlocation_list
