...
def create_historybl(resnr:int, reslinnr:int, old_zinr:str, res_mode:str, user_init:str, ziwechsel_str:str):
    parent_nr:int = 0
    ...
    if res_mode.lower()  == "checkout":
        ...
        history.bemerk = to_string(htparam.fdate) + ": Moved to" + " " + res_line.zinr + chr(10) + ziwechsel_str
        history.bemerk = history.bemerk + chr(2) + user_init
