...
def check_gcfpaymentbl(pvilanguage:int, gastnr:int, payment:int):
    ...
    def generate_output():
        ...
        return {"msg_str": msg_str, "msg_str2": msg_str2, "htparam_fchar": htparam_fchar, "htparam_fchar1": htparam_fchar1, "guest_kreditlimit": guest_kreditlimit, "enter_passwd1": enter_passwd1, "enter_passwd2": enter_passwd2}
