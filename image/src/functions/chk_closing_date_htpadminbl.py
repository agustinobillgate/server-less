        ...
        if htparam.paramgruppe == 99 or htparam.paramgruppe == 100:
            ...
            if paramtext and paramtext.ptexte != "":
                ...
                if htparam.feldtyp == 3:
                    htpchar = to_string(lic_nr, "x(4)") + to_string(paramnr, "9999") + to_string(get_month(fdate) , "99") + to_string(get_day(fdate) , "99") + to_string(get_year(fdate) , "9999")

                elif htparam.feldtyp == 4:
                    htpchar = to_string(lic_nr, "x(4)") + to_string(paramnr, "9999") + to_string(flogical)
