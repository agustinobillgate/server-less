...
import decimal
from models import Queasy, Eg_property, Eg_location

def eg_repmaintain_all_categorybl(all_room:bool, tcategory:[Tcategory], tlocation:[Tlocation], troom:[Troom]):
    tmaintask_list = []
    tproperty_list = []
    queasy = eg_property = eg_location = None

    tproperty = troom = tlocation = tmaintask = tcategory = qbuff = comcategory = comlocat = commain = comroom = ques = None
    ...
    def generate_output():
        nonlocal tmaintask_list, tproperty_list, queasy, eg_property, eg_location
        nonlocal qbuff, comcategory, comlocat, commain, comroom, ques


        nonlocal tproperty, troom, tlocation, tmaintask, tcategory, qbuff, comcategory, comlocat, commain, comroom, ques
        nonlocal tproperty_list, troom_list, tlocation_list, tmaintask_list, tcategory_list
        return {"tMaintask": tmaintask_list, "tproperty": tproperty_list}
