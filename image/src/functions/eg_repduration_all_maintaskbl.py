...
import decimal
from models import Eg_property, Queasy, Eg_location, Eg_subtask

def eg_repduration_all_maintaskbl(all_room:bool, all_maintask:bool, tlocation:[Tlocation], tmaintask:[Tmaintask], troom:[Troom]):
    tproperty_list = []
    tsubtask_list = []
    eg_property = queasy = eg_location = eg_subtask = None

    tsubtask = tproperty = troom = tmaintask = tlocation = qbuff = comlocat = commain = comroom = ques = None
    ...
    def generate_output():
        nonlocal tproperty_list, tsubtask_list, eg_property, queasy, eg_location, eg_subtask
        nonlocal qbuff, comlocat, commain, comroom, ques


        nonlocal tsubtask, tproperty, troom, tmaintask, tlocation, qbuff, comlocat, commain, comroom, ques
        nonlocal tsubtask_list, tproperty_list, troom_list, tmaintask_list, tlocation_list
        return {"tproperty": tproperty_list, "tsubtask": tsubtask_list}
