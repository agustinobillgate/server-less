...
def prepare_eg_repdurationbl(all_maintask:bool, all_room:bool, user_init:str):
    engid = 0
    groupid = 0
    ci_date = None
    tlocation_list = []
    ...
    tsource = tsubtask = tpic = tproperty = tmaintask = troom = tlocation = tcategory = qbuff = qbuff1 = comlocat = commain = comroom = ques = comcategory = None
    ...
    def generate_output():
        nonlocal engid, groupid, ci_date, tlocation_list, tcategory_list, troom_list, tmaintask_list, tproperty_list, tpic_list, tsubtask_list, tsource_list, htparam, bediener, eg_location, zimmer, eg_property, queasy, eg_staff, eg_subtask
        nonlocal qbuff, qbuff1, comlocat, commain, comroom, ques, comcategory


        nonlocal tsource, tsubtask, tpic, tproperty, tmaintask, troom, tlocation, tcategory, qbuff, qbuff1, comlocat, commain, comroom, ques, comcategory
