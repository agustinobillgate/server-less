...
def eg_repmaintaincancel_all_locationbl(all_room:bool, tlocation:[Tlocation], tmaintask:[Tmaintask]):
    troom_list = []
    tproperty_list = []
    zimmer = eg_property = queasy = eg_location = None

    tproperty = tlocation = tmaintask = troom = qbuff = qbuff1 = comlocat = commain = comroom = ques = None
    ...
    def generate_output():
        ...
        nonlocal tproperty, tlocation, tmaintask, troom, qbuff, qbuff1, comlocat, commain, comroom, ques
        nonlocal tproperty_list, tlocation_list, tmaintask_list, troom_list
