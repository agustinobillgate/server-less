...
def res_log1bl(pvilanguage:int, from_date:date, mi_inhouse:bool):
    ...
    def create_list():
        ...
        for reslin_queasy in db_session.query(Reslin_queasy).filter(
                (Reslin_queasy.betriebsnr == 0) &  (func.lower(Reslin_queasy.key) == "ResChanges") &  (Reslin_queasy.number1 == 0) &  (Reslin_queasy.date1 == None) &  (Reslin_queasy.char3 > "") &  (Reslin_queasy.deci1 == 0) &  (Reslin_queasy.logi1 == False) &  (Reslin_queasy.date2 == from_date)).all():
            ...
            reservation = db_session.query(Reservation).filter(
                    (Reservation.resnr == reslin_queasy.resnr)).first()
            do_it = True
            ...
            if do_it:
                ...
                if re.match(".*;.*",reslin_queasy.char3):
                    ...
                    res_log1.rate1 = decimal.Decimal(entry(18, reslin_queasy.char3, ";"))
                    res_log1.rate2 = decimal.Decimal(entry(19, reslin_queasy.char3, ";"))
                    ...
                    res_log1.rate1 = decimal.Decimal(substring(reslin_queasy.char3, 74, 12))
                    res_log1.rate2 = decimal.Decimal(substring(reslin_queasy.char3, 86, 12))
