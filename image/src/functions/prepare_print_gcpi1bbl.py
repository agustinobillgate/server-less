...
def prepare_print_gcpi1bbl(docu_nr:str, user_init:str, printer_nr:int):
    output_list_list = []
    i:int = 0
    ...
    output_list_list, Output_list = create_model("Output_list", {"docu_nr":str, "chequeno":str, "pay_datum":date, "username":str, "duedate":date, "bemerk":str, "betrag":decimal, "path":str, "amount_array":[decimal], "bez_array":[str], "amtreturn":decimal, "grand_tot":decimal})
    ...
    output_list.amtReturn = gc_pi.returnAmt
    output_list.grand_tot = gc_pi.betrag - gc_pi.returnAmt
