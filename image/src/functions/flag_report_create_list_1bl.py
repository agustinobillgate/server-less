...
def flag_report_create_list_1bl(user_init:str, f_date:date, t_date:date, sorttype:int, alldept_flag:bool, curr_dept:int):
    s_list_list = []
        ...
        for reslin_queasy in db_session.query(Reslin_queasy).filter(
            ...
            if do_it:
                ...
                if res_line:
                    ...
                    if entry(1, reslin_queasy.char1, chr(2)) != "":
                        t_id = entry(1, reslin_queasy.char1, chr(2))

                        bediener = db_session.query(Bediener).filter(
                                (func.lower(Bediener.userinit) == (t_id).lower())).first()
