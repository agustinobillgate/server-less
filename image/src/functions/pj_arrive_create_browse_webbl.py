...
def pj_arrive_create_browse_webbl(tot_rm:int, tot_a:int, tot_c:int, tot_co:int, total_flag:bool, cl_list:[Cl_list], s_list:[S_list]):
    t_cl_list_list = []
    found:bool = False
    loopi:int = 0
    counter_str:str = ""
    ...
    def generate_output():
        ...
        nonlocal s_list_list, t_list_list, cl_list_list, t_cl_list_list
    ...
    for t_cl_list in query(t_cl_list_list):
