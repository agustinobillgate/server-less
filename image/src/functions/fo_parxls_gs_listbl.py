...
def fo_parxls_gs_listbl(pvilanguage:int, briefnr:int, from_date:date, to_date:date, link:str):
    msg_str = ""
    mess_result = ""
    success_flag = False
    lvcarea:str = "fo_parxls_gs"
    ch:str = ""
    xls_dir:str = ""
    ...
    def create_var1(texte:str, int_flag:bool):
        ...
        if subtext == "":
            ...
            if curr_cmd == 800 or curr_cmd == 180 or curr_cmd == 181 or curr_cmd == 9985 or curr_cmd == 9986 or curr_cmd == 1995 or curr_cmd == 1996 or curr_cmd == 1997 or curr_cmd == 1998 or curr_cmd == 1999:
                ...
                correct = check_to_int(check_to_int(subtext)
    ...
    def check_integer(texte:str):
        ...
        for i in range(1,len(texte)  + 1) :
            ...
            if ord(substring(texte, i - 1, 1)) > 57 or ord(substring(texte, i, 1)) < 48:
                correct = False
    ...
    if get_month(to_date) == 2 and get_day(to_date) == 29:
        lytoday = date_mdy(2, 28, get_year(to_date) - 1)


    else:
        lytoday = date_mdy(get_month(to_date) , get_day(to_date) , get_year(to_date) - 1)
    ...
    if prog_error:
        ...
        return generate_output()
    msg_str, error_nr = get_output(fo_parxls_gsbl(pvilanguage, ytd_flag, jan1, ljan1, lfrom_date, lto_date, pfrom_date, pto_date, from_date, to_date, start_date, lytd_flag, lmtd_flag, pmtd_flag, lytoday_flag, lytoday, foreign_flag, budget_flag, foreign_nr, price_decimal, briefnr, link, w1, w2))
