...
def prepare_po_stockin_webbl(lief_nr:int, docu_nr:str, user_init:str):
    enforce_rflag = False
    show_price = False
    qty_flag = False
    qty_tol = 0
    ...
    while None != l_order:
        ...
        if t_l_order.lief_einheit > 1 and t_l_order.geliefert > 0:
            ...
            t_l_order.geliefert = (t_l_order.geliefert - t_l_order.angebot_lief [0]) / t_l_order.lief_einheit
