...
def s_stockin_l_artikelbl(s_artnr:int):
    ...
    temp_l_artikel1_list, Temp_l_artikel1 = create_model("Temp_l_artikel1", {"bezeich":str, "ek_aktuell":decimal, "artnr":int, "traubensort":str, "lief_einheit":decimal, "masseinheit":str, "betriebsnr":int, "alkoholgrad":decimal})
