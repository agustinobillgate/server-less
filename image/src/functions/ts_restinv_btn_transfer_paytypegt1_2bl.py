...
def ts_restinv_btn_transfer_paytypegt1_2bl(rec_id:int, do_it:bool, transdate:date, curr_dept:int, disc_art1:int, disc_art2:int, disc_art3:int, kellner_kellner_nr:int):
    ...
    def generate_output():
        nonlocal bill_date, flag, t_h_bill_list, h_bill, h_artikel, tisch, htparam, h_umsatz, artikel, h_bill_line, queasy
        nonlocal h_art1, tbuff


        nonlocal t_h_bill, h_art1, tbuff
        nonlocal t_h_bill_list
        return {"bill_date": bill_date, "flag": flag, "t-h-bill": t_h_bill_list}
