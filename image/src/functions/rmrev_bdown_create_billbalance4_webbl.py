...
def rmrev_bdown_create_billbalance4_webbl(exc_taxserv:bool, pvilanguage:int, new_contrate:bool, foreign_rate:bool, price_decimal:int, fdate:date, tdate:date, srttype:int):
    ...
    def generate_output():
        nonlocal cl_list_list, currency_list_list, sum_list_list, s_list_list, argt_list_list, exchg_rate, frate, post_it, total_rev, lvcarea, curr_code, curr_rate, curr_local, curr_bfast, curr_lodge, curr_lunch, curr_dinner, curr_misc, curr_fcost, curr_trev, curr_pax, curr_com, curr_rm, curr_adult, curr_ch1, curr_ch2, curr_comch, argt_line, waehrung, guest, artikel, htparam, res_line, zimmer, genstat, arrangement, exrate, reservation, billjournal, bill, segment, zimkateg, reslin_queasy
