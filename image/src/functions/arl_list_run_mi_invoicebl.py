...
def arl_list_run_mi_invoicebl(resnr:int, curr_resnr:int, arl_list_reslinnr:int, t_active_flag:int, printtype:int):
    ...
    s_list = t_list = t_reservation = t_res_line = t_guest = rline = mbill = mainres = w1 = resline = None
    ...
    def generate_output():
        ...
        nonlocal rline, mbill, mainres, w1, resline


        nonlocal s_list, t_list, t_reservation, t_res_line, t_guest, rline, mbill, mainres, w1, resline
