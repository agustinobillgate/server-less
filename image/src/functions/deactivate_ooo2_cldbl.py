...
def deactivate_ooo2_cldbl(user_nr:int, oos_flag:bool, ci_date:date, ooo_list2:[Ooo_list2]):
    datum:date = None
    cat_flag:bool = False
    roomnr:int = 0
    ...
    def generate_output():
        ...
        global om_list_list, ooo_list2_list
        return {}
    ...
    outorder = db_session.query(Outorder).filter(
            ...
            (Outorder.gespende == ooo_list2.gespende)
            ).first()
