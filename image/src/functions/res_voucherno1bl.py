...
def res_voucherno1bl(voucher_no:str, fname:str):
    ...
    r_list_list, R_list = create_model("R_list", {"ta_name":str, "gname":str, "resnr":int, "voucher":str})
    ...
    for t_part_resline in query(t_part_resline_list):
        for i in range(1,num_entries(t_part_resline.zimmer_wunsch, ";") - 1 + 1) :
            ...
            if substring(str, 0, 7) == "voucher" and re.match(".*" + voucher_no + ".*",substring(str, 7)):
                i = 999
