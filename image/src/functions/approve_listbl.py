...
def approve_listbl():
    ...
    def create_list():
        ...
        for queasy in db_session.query(Queasy).filter(
                (Queasy.key == 36) &  (Queasy.logi1 == False) &  (Queasy.betriebsnr == 0)).all():
            ...
            if char1 == "RSV":
                keystr = "Reservation"
                pswd = entry(2, char3, ";")
                outstand = decimal.Decimal(entry(3, char3, ";"))
                crlimit = decimal.Decimal(entry(4, char3, ";"))
                ...
                pswd = entry(4, char3, ";")
                outstand = decimal.Decimal(entry(5, char3, ";"))
                crlimit = decimal.Decimal(entry(6, char3, ";"))
