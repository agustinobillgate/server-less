...
def pos_dashboard_initialize_postorder_webbl(order_item:[Order_item], post_table_no:int, post_order_no:int):
    do_it = False
    od_cancel_list_list = []
    post_order_list = []
    menu_list_list = []
    ...
    def generate_output():
        ...
        nonlocal order_item_list, post_order_list, od_cancel_list_list, menu_list_list
