...
def rest_daysalesp2_btn_gobl(bline_list:[Bline_list], disc_art1:int, disc_art2:int, disc_art3:int, curr_dept:int, all_user:bool, shift:int, from_date:date, to_date:date, art_str:str, voucher_art:int, zero_vat_compli:bool, show_fbodisc:bool):
    t_betrag = 0
    t_foreign = 0
    exchg_rate = 0
    tot_serv = None
    ...
    turnover_list, Turnover = create_model("Turnover", {"betrag":[decimal, 20], "other":decimal, "compli":bool, "flag":int, "gname":str, "int_rechnr":int, "st_comp":int, "p_curr":str, "t_vat":decimal})
