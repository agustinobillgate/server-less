...
def prepare_rwaiter_adminbl(dept:int):
    ...
    kellner_obj_list = []
    for kellner, kellne1 in db_session.query(Kellner, Kellne1).join(Kellne1,(Kellne1.departement == Kellner.departement) &  (Kellne1.kellner_nr == Kellner_nr)).filter(
        ...
        q1_list.kellner_nr = kellner_nr
        q1_list.kellnername = kellnername
