...
def gcf_list_del_gcfbl(i_case:int, pvilanguage:int, gastno:int, user_init:str):
    ...
    if error_code == 0:
        ...
        msg_str = translateExtended ("The file is currently used as Master_file of the guest file ", lvcarea, "") + guest1.name.upper() + ", " + guest1.vorname1.upper() + " " + guest1.anredefirma.upper() + guest1.anrede1.upper() + chr(10) + translateExtended ("Deletion not possible.", lvcarea, "")
