...
def ts_restinv_billartbl(billart:int, curr_dept:int):
    ...
    def generate_output():
        nonlocal price, t_h_artikel_list, h_artikel, paramtext


        nonlocal t_h_artikel
        nonlocal t_h_artikel_list
        return {"price": price, "t-h-artikel": t_h_artikel_list}
    ...
    def get_price():
        ...
        if paramtext:
            ...
            curr_min = to_int(substring(to_string(time, "HH:MM:SS") , 3, 2))
