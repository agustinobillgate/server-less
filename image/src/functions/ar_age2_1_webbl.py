...
def ar_age2_1_webbl(pvilanguage:int, curr_gastnr:int, from_art:int, disptype:int, to_date:date, show_inv:bool):
    ...
    output_list_list, Output_list = create_model("Output_list", {"inv_no":str, "fbetrag":str, "creditlimit":str, "curr":str, "str":str, "inv_soa":str, "bill_no":str, "g_name":str, "check_in":str, "check_out":str, "outstand":str, "age":str, "day1":str, "day2":str, "day3":str, "day4":str})
