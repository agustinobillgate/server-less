...
def bookengine_config_btn_exit_web_3bl(bookengid:int, autostart:bool, period:int, delay:int, hotelcode:str, username:str, password:str, liveflag:bool, defcurr:str, pushrateflag:bool, pullbookflag:bool, pushavailflag:bool, workpath:str, progavail:str, user_init:str, pushratebypax:bool, uppercasename:bool, delayrate:int, delaypull:int, delayavail:int, pushall:bool, re_calculate:bool, restriction:bool, allotment:bool, pax:int, bedsetup:bool, pushbookflag:bool, delaypushbook:int, vcwsagent:str, vcwsagent2:str, vcwsagent3:str, vcwsagent4:str, vcwsagent5:str, vcwebhost:str, vcwebport:str, email:str, dyna_code:str, incl_tentative:bool):
    i:int = 0
    str:str = ""
    oldstr:str = ""
    ct:str = ""
