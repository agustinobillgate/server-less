...
def prepare_gl_linkapbl():
    ...
    def generate_output():
        nonlocal f_int, last_acctdate, acct_date, close_year, gl_jouhdr_list_list, htparam, gl_jouhdr


        nonlocal gl_jouhdr_list
        nonlocal gl_jouhdr_list_list
        return {"f_int": f_int, "last_acctdate": last_acctdate, "acct_date": acct_date, "close_year": close_year, "gl-jouhdr-list": gl_jouhdr_list_list}
