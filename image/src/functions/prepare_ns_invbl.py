...
def prepare_ns_invbl(inp_rechnr:int, curr_department:int, combo_pf_file1:str, combo_pf_file2:str, combo_gastnr:int, combo_ledger:int):
    f_foinv_list = []
    t_bill_list = []
    t_guest_list = []
    golf_license:str = "NO"
    ...
    def generate_output():
        ...
        return {"f-foinv": f_foinv_list, "t-bill": t_bill_list, "t-guest": t_guest_list}
