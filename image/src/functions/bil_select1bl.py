    ...
    def disp_bill_list0():
        ...
        if sorttype == 1 and gastname == "":
            ...
            for bill, guest1 in db_session.query(Bill, Guest1).join(Guest1,(Guest1.gastnr == Bill.gastnr)).filter(
                    (Bill.flag == bil_flag) &  (Bill.resnr == 0) &  (Bill.reslinnr == 1) &  (Billtyp == dept)).all():
            ...
            bill_obj_list = []
            for bill, guest1 in db_session.query(Bill, Guest1).join(Guest1,(Guest1.gastnr == Bill.gastnr)).filter(
                    (Bill.flag == bil_flag) &  (func.lower(Bill.name) >= (fr_name).lower()) &  (func.lower(Bill.name) <= (to_name).lower()) &  (Bill.resnr == 0) &  (Bill.reslinnr == 1) &  (Billtyp == dept)).all():
                if bill._recid in bill_obj_list:
                    continue
                else:
                    bill_obj_list.append(bill._recid)
            ...
            bill_obj_list = []
            for bill, guest1 in db_session.query(Bill, Guest1).join(Guest1,(Guest1.gastnr == Bill.gastnr)).filter(
                    (Bill.flag == bil_flag) &  (Bill.rechnr >= rechnr) &  (Bill.resnr == 0) &  (Bill.reslinnr == 1) &  (Billtyp == dept)).all():
                if bill._recid in bill_obj_list:
                    continue
                else:
                    bill_obj_list.append(bill._recid)
            ...
            if not b1_list:
                ...
                bill_obj_list = []
                for bill, guest1 in db_session.query(Bill, Guest1).join(Guest1,(Guest1.gastnr == Bill.gastnr)).filter(
                        (Bill.flag == bil_flag) &  (Bill.rechnr >= rechnr) &  (Bill.rechnr <= (rechnr + 1000)) &  (Bill.resnr == 0) &  (Bill.reslinnr == 1) &  (Billtyp == dept)).all():
                    if bill._recid in bill_obj_list:
                        continue
                    else:
                        bill_obj_list.append(bill._recid)
    ...
    def disp_bill_list1():
        ...
        if sorttype == 1 and gastname != "":
            ...
            if not b1_list:
                ...
                bill_obj_list = []
                for bill, guest1 in db_session.query(Bill, Guest1).join(Guest1,(Guest1.gastnr == Bill.gastnr)).filter(
                        (Bill.flag == bil_flag) &  (Bill.rechnr >= rechnr) &  (Bill.rechnr <= (rechnr + 100)) &  (Bill.resnr == 0) &  (Bill.reslinnr == 1) &  (Billtyp == dept)).all():
                    if bill._recid in bill_obj_list:
                        continue
                    else:
                        bill_obj_list.append(bill._recid)
