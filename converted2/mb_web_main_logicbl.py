...
def mb_web_main_logicbl(bil_flag:int, curr_department:int):
    ...
    f_foinv_data, t_bill_data, t_guest_data, combo_pf_file1, combo_pf_file2, combo_gastnr, combo_ledger = get_output(prepare_ns_invbl(0, curr_department, combo_pf_file1, combo_pf_file2, combo_gastnr, combo_ledger))

    f_foinv = query(f_foinv_data, first=True)
    ...
    artlist_data = get_output(read_artikel1bl(25, None, curr_department, None, None, None, True))
