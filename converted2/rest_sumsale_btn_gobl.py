...
tt_artnr_data, Tt_artnr = create_model("Tt_artnr", {"curr_i":int, "artnr":int})

def rest_sumsale_btn_gobl(curr_dept:int, dept_name:string, exchg_rate:Decimal, tt_artnr_data:[Tt_artnr], ldry:int, dstore:int, clb:int, zeit2:int, zeit1:int, from_date:date):
    ...
    def generate_output():
        ...
        nonlocal outstand_list_data, pay_list_data, comp_list_data, turnover_data

        return {"curr_dept": curr_dept, "dept_name": dept_name, "exchg_rate": exchg_rate, "t_betrag": t_betrag, "t_foreign": t_foreign, "turnover": turnover_data, "outstand-list": outstand_list_data, "pay-list": pay_list_data}
    ...
    def daysale_list():
        ...
        for tt_artnr in query(tt_artnr_data):
        ...
        for turnover in query(turnover_data, filters=(lambda turnover: turnover.compli_amt != 0)):
            ...
            if h_artikel:
                ...
                if h_artikel.artart == 11 or h_artikel.artart == 12:
                    ...
                    if h_artikel.artart == 11:
                        ...
                        pay_list = query(pay_list_data, filters=(lambda pay_list: pay_list.flag == 6 and pay_list.bezeich == h_artikel.bezeich), first=True)
                    ...
                    if h_artikel.artart == 0:
                        ...
                        pay_list = query(pay_list_data, filters=(lambda pay_list: pay_list.flag == 1), first=True)
