...
def ratecode_adm_copy_rate_1bl(pvilanguage:int, argtnr1:int, zikatnr1:int, market_nr:int, prcode:string, market:string, user_init:string, adj_value:Decimal, adj_type:string, pr_list_data:[Pr_list]):
    ...
    def copy_rates():
        ...
        pr_list = query(pr_list_data, first=True)
        create_child_list()
