...
def ts_restinv_open_tablebl(balance:Decimal, curr_dept:int, tischnr:int, curedept_flag:bool, user_init:string, user_name:string, from_acct:bool, room:string, gname:string):
    ...
    def generate_output():
        nonlocal resrecid, kreditlimit, curr_room, rescomment, curr_gname, bcol, balance_foreign, printed, curr_user, order_taker, order_id, found, rechnr, avail_queasy, fl_code, t_h_bill_data, h_bill, guest, htparam, res_line, queasy, h_bill_line, h_artikel
