...
def fo_inv_openbill_list_webbll(bil_flag:int, bil_recid:int, room:str, vipflag:bool, fill_co:bool, double_currency:bool, foreign_rate:bool):
    abreise = None
    resname = ""
    ...
    t_res_line_list, T_res_line = create_model_like(Res_line, {"guest_name":str})
