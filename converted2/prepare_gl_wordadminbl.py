...
def prepare_gl_wordadminbl():
    ...
    def generate_output():
        nonlocal kateg, kategbezeich, glcoa_flag, briefnr, t_brief_data, brief, htparam, paramtext, guestbook


        nonlocal t_brief
        nonlocal t_brief_data

        return {"kateg": kateg, "kategbezeich": kategbezeich, "glcoa_flag": glcoa_flag, "briefnr": briefnr, "t-brief": t_brief_data}
