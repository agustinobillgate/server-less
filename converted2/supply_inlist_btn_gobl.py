...
def supply_inlist_btn_gobl(pvilanguage:int, last_artnr:int, lieferant_recid:int, l_kredit_recid:int, ap_recid:int, long_digit:bool, show_price:bool, store:int, all_supp:bool, sorttype:int, from_grp:int, to_grp:int, from_date:date, to_date:date, taxcode_list_data:[Taxcode_list]):
    ...
    def generate_output():
        nonlocal first_artnr, curr_artnr, last_artnr1, unit_price, str_list_data, lvcarea, tot_anz, tot_amount, tot_tax, tot_amt, i, counter, loopi, l_lieferant, l_kredit, l_artikel, l_op, l_ophdr, l_untergrup, htparam, l_ophis, l_ophhis, bediener, gl_acct
    ...
    def convert_fibu(konto:string):
        ...
        nonlocal first_artnr, curr_artnr, last_artnr1, unit_price, str_list_data, lvcarea, tot_anz, tot_amount, tot_tax, tot_amt, counter, loopi, l_lieferant, l_kredit, l_artikel, l_op, l_ophdr, l_untergrup, htparam, l_ophis, l_ophhis, bediener, gl_acct
        nonlocal pvilanguage, last_artnr, lieferant_recid, l_kredit_recid, ap_recid, long_digit, show_price, store, all_supp, sorttype, from_grp, to_grp, from_date, to_date
