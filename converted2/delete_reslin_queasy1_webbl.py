...
del_list_data, Del_list = create_model("Del_list", {"recid_reslin":int})

def delete_reslin_queasy1_webbl(case_type:int, int1:int, char1:string, date1:date, del_list_data:[Del_list]):
