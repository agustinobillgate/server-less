        ...
        for hoteldpt in db_session.query(Hoteldpt).filter(
            ...
            if h_journal:
                ...
                for h_journal in db_session.query(H_journal).filter(
                    ...
                    if not long_digit:
                        line = to_string(h_journal.zinr) + " " + to_string(h_journal.tischnr, ">>>9 ") + " " + to_string(rechnr, ">,>>>,>>9") + " " + to_string(h_journal.artnr, ">>>>9") + " " + to_string(h_journal.anzahl, "->>9") + " " + to_string(h_journal.bezeich, "x(23)") + " " + to_string(betrag, "->,>>>,>>>,>>9.99") + " " + to_string(zeit, "HH:MM") + " " + to_string(h_journal.kellner_nr, ">>>9")
                    else:
                        line = to_string(h_journal.zinr) + " " + to_string(h_journal.tischnr, ">>>9 ") + " " + to_string(rechnr, ">,>>>,>>9") + " " + to_string(h_journal.artnr, ">>>>9") + " " + to_string(h_journal.anzahl, "->>9") + " " + to_string(h_journal.bezeich, "x(23)") + " " + to_string(betrag, "->>,>>>,>>>,>>9") + " " + to_string(zeit, "HH:MM") + " " + to_string(h_journal.kellner_nr, ">>>9")
                    add_line(line)
