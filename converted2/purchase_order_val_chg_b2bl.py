...
def purchase_order_val_chg_b2bl(q2_list_docu_nr:string):
    ...
    q1_list_data, Q1_list = create_model("Q1_list", {"rec_id_l_order":int, "lief_nr":int, "docu_nr":string, "pos":int, "artnr":int, "bezeich":string, "anzahl":Decimal, "geliefert":Decimal, "angebot_lief_1":int, "rechnungswert":Decimal, "lief_fax_3":string, "txtnr":int, "lieferdatum_eff":date, "einzelpreis":Decimal, "lief_fax_2":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal q1_list_data, l_artikel, l_order
