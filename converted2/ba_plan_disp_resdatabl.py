...
def ba_plan_disp_resdatabl(rml_raum:string, t_resnr:int, t_reslinnr:int):
    ...
    def generate_output():
        nonlocal info1, info2, info3, rsl_data, stat, bk_veran, bk_reser, guest, bediener, bk_setup, bk_rset, bk_func
        ...
        return {"info1": info1, "info2": info2, "info3": info3, "rsl": rsl_data}
