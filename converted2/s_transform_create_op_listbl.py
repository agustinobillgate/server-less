...
def s_transform_create_op_listbl(op_list_data:[Op_list], qty:Decimal, price:Decimal, curr_lager:int, transdate:date, s_artnr:int, bediener_nr:int, lscheinnr:string, t_amount:Decimal):
