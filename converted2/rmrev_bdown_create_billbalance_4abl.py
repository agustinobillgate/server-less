...
def rmrev_bdown_create_billbalance_4abl(exc_taxserv:bool, pvilanguage:int, new_contrate:bool, foreign_rate:bool, price_decimal:int, curr_date:date, sorttype:int):
    ...
    def generate_output():
        nonlocal msg_str, msg_warning, cl_list_data, currency_list_data, sum_list_data, s_list_data, argt_list_data, exchg_rate, frate, post_it, total_rev, rm_rate, lvcarea, waehrung, guest, artikel, htparam, res_line, zimmer, arrangement, reservation, bill, zimkateg, reslin_queasy, guest_pr, pricecod, argt_line, fixleist
