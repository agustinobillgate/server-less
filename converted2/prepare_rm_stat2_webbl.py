...
def prepare_rm_stat2_webbl(gastno:int, segmcode:int, jan_date:date, to_date:date):
    ...
    t_list_data, T_list = create_model("T_list", {"gastnr":int, "mgastnr":int, "gname":string, "resnr":int, "reslinnr":int, "fdate":date, "tdate":date, "ankunft":date, "abreise":date, "zimmeranz":int, "dlodge":Decimal, "dnite":int, "drate":Decimal, "mlodge":Decimal, "mnite":int, "mrate":Decimal, "ylodge":Decimal, "ynite":int, "yrate":Decimal, "zinr":string}, {"fdate": get_current_date(), "tdate": date_mdy(1, 1, 1900), "ankunft": None, "abreise": None})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal avail_guest, f_tittle, t_list_data, guest, segment, genstat
