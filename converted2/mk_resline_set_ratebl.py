...
def mk_resline_set_ratebl(direct_change:bool, fixed_rate:bool, ebdisc_flag:bool, kbdisc_flag:bool, rate_readonly:bool, gastnr:int, res_mode:string, argt:string, contcode:string, bookdate:date, reslin_list_data:[Reslin_list]):
