...
from models import Paramtext, Queasy, Htparam, Akt_line

def prepare_main1bl(user_init:string):
    ...
    paramtext = queasy = htparam = akt_line = None

    db_session = local_storage.db_session

    def generate_output():
        nonlocal telop_sensitive, setting_sensitive, condotel_sensitive, club_sensitive, eng_sensitive, repgen_sensitive, wo_sensitive, new_contrate, ci_date, hpname_training, aktlist_flag, dynarate_flag, htl_city, curr_htl_city, p_1072, p_244, p_975, p_996, p_1002, p_997, p_988, p_992, p_1016, p_868, p_990, p_1015, p_169, p_991, p_2000, p_329, p_985, golf_license, paramtext, queasy, htparam, akt_line
        nonlocal user_init
