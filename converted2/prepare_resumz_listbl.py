...
def prepare_resumz_listbl():
    ...
    def generate_output():
        nonlocal long_digit, to_date, ldry, dstore, from_dept, to_dept, depname1, depname2, t_hoteldpt_data, min_dept, max_dept, hoteldpt, htparam


        nonlocal t_hoteldpt
        nonlocal t_hoteldpt_data

        return {"long_digit": long_digit, "to_date": to_date, "ldry": ldry, "dstore": dstore, "from_dept": from_dept, "to_dept": to_dept, "depname1": depname1, "depname2": depname2, "t-hoteldpt": t_hoteldpt_data}
