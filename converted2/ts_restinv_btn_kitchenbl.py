...
def ts_restinv_btn_kitchenbl(avail_t_h_bill:bool, from_acct:bool, prorder:int, prorder2:int):
    ...
    t_printer1_data, T_printer1 = create_model_like(Printer)
    t_printer2_data, T_printer2 = create_model_like(Printer)

    db_session = local_storage.db_session

    def generate_output():
        nonlocal close_it, err_code1, err_code2, t_printer1_data, t_printer2_data, printer
        nonlocal avail_t_h_bill, from_acct, prorder, prorder2


        nonlocal t_printer1, t_printer2
        nonlocal t_printer1_data, t_printer2_data

        return {"close_it": close_it, "err_code1": err_code1, "err_code2": err_code2, "t-printer1": t_printer1_data, "t-printer2": t_printer2_data}
    ...
    if avail_t_h_bill and not from_acct:
        ...
        t_printer1_data.append(t_printer1)
    ...
    if prorder2 != 0:
        ...
        t_printer2_data.append(t_printer2)
