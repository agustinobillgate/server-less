...
def prepare_sall_onhandhisbl():
    ...
    def generate_output():
        nonlocal show_price, avail_l_untergrup, t_l_lager_data, t_l_hauptgrp_data, l_lager, l_untergrup, l_hauptgrp


        nonlocal t_l_lager, t_l_hauptgrp
        nonlocal t_l_lager_data, t_l_hauptgrp_data

        return {"show_price": show_price, "avail_l_untergrup": avail_l_untergrup, "t-l-lager": t_l_lager_data, "t-l-hauptgrp": t_l_hauptgrp_data}
