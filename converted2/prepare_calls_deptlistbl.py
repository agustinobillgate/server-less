...
def prepare_calls_deptlistbl():
    ...
    def generate_output():
        nonlocal double_currency, price_decimal, cost1, cost2, cost_list_data, htparam, parameters


        nonlocal cost_list
        nonlocal cost_list_data

        return {"double_currency": double_currency, "price_decimal": price_decimal, "cost1": cost1, "cost2": cost2, "cost-list": cost_list_data}
