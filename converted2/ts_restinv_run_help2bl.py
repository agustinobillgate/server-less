...
def ts_restinv_run_help2bl(menu_list_data:[Menu_list], pvilanguage:int, session_parameter:string, do_it:bool, tischnr:int, curr_dept:int, curr_waiter:int, rechnr:int, departement:int, user_init:string):
