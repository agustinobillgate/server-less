...
def prepare_fb_statisticbl(fdept:int, tdept:int):
    ...
    def generate_output():
        nonlocal price_decimal, ci_date, fdpt_str, tdpt_str, t_hoteldpt_data, hoteldpt, htparam
        ...
        return {"price_decimal": price_decimal, "ci_date": ci_date, "fdpt_str": fdpt_str, "tdpt_str": tdpt_str, "t-hoteldpt": t_hoteldpt_data}
