...
def prepare_cr_occfcast1_1bl(pvilanguage:int, vhp_limited:bool):
    ...
    def generate_output():
        nonlocal curr_date, segm_list_data, argt_list_data, zikat_list_data, t_buff_queasy_data, outlook_list_data, lvcarea, queasy, htparam, paramtext, segment, arrangement, zimkateg
        ...
        return {"curr_date": curr_date, "segm-list": segm_list_data, "argt-list": argt_list_data, "zikat-list": zikat_list_data, "t-buff-queasy": t_buff_queasy_data, "outlook-list": outlook_list_data}
    ...
    def create_outlook():
        ...
        for paramtext in db_session.query(Paramtext).filter(
            ...
            outlook_list_data.append(outlook_list)
