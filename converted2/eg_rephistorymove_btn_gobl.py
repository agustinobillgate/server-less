...
def eg_rephistorymove_btn_gobl(pvilanguage:int, main_nr:int, fdate:date, tdate:date):
    ...
    smove_data, Smove = create_model("Smove", {"object_nr":int, "object_nm":string, "datum":date, "flocation_str":string, "froom":string, "tlocation_str":string, "troom":string})
    ...
    def generate_output():
        nonlocal smove_data, nr, nm, lvcarea, eg_moveproperty, queasy, eg_location, eg_property
