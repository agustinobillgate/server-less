...
def prepare_select_lartbl(lief_nr:int):
    ...
    def generate_output():
        nonlocal t_l_untergrup_data, t_l_artikel_data, l_untergrup, l_artikel
        nonlocal lief_nr


        nonlocal t_l_artikel, t_l_untergrup
        nonlocal t_l_artikel_data, t_l_untergrup_data

        return {"t-l-untergrup": t_l_untergrup_data, "t-l-artikel": t_l_artikel_data}
    ...
    if lief_nr > 0:
        ...
        t_l_untergrup = query(t_l_untergrup_data, first=True)
