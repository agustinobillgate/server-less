...
def prepare_ba_raum_1bl():
    ...
    t_bk_raum_data, T_bk_raum = create_model_like(Bk_raum, {"rec_id":int, "flag_desc":bool})
    ...
    for bk_raum in db_session.query(Bk_raum).order_by(Bk_raum.departement, Bk_raum.raum).all():
        t_bk_raum = T_bk_raum()
