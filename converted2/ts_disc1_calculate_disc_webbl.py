...
def ts_disc1_calculate_disc_webbl(pvilanguage:int, dept:int, procent:Decimal, disc_value:Decimal, menu_disc_data:[Menu_disc]):
    ...
    t_calc_disc_data, T_calc_disc = create_model("T_calc_disc", {"select_amt_taxserv":Decimal, "disc_taxserv":Decimal, "balance_taxserv":Decimal, "selected_amount":Decimal, "discount":Decimal, "balance":Decimal})
    ...
    def generate_output():
        ...
        return {"msg_str": msg_str, "t-calc-disc": t_calc_disc_data, "disc-list": disc_list_data}

    billart, description, b_artnrfront, o_artnrfront, disc_list_data = get_output(ts_disc1_get_articlebl(dept, disc_value, procent, b_billart, b2_billart))
    ...
    for menu_disc in query(menu_disc_data, filters=(lambda menu_disc: menu_disc.artnr != disc_art1 and menu_disc.artnr != disc_art2 and menu_disc.artnr != disc_art3)):
        ...
        t_h_artikel_data, t_artikel_data = get_output(ts_disc1_cal_amountbl(menu_disc.artnr, menu_disc.departement))
