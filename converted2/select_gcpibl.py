...
def select_gcpibl():
    ...
    b1_list_data, B1_list = create_model("B1_list", {"datum":date, "docu_nr":string, "betrag":Decimal, "bemerk":string, "username":string, "bezeich":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal b1_list_data, gc_pitype, bediener, gc_pi
