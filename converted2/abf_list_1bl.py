...
def abf_list_1bl(fdate:date, tdate:date, bfast_artnr:int, bfast_dept:int):
    ...
    def generate_output():
        nonlocal abf_list_data, datum, to_date, htparam, res_line, arrangement, artikel, argt_line, reslin_queasy, fixleist, guest, reservation, segment, ratecode, genstat, bill, master
