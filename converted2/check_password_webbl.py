...
payload_list_data, Payload_list = create_model("Payload_list", {"hashed_pass":string, "int_input":int, "vmode":string})

def check_password_webbl(user_name:string, payload_list_data:[Payload_list]):
    ...
    response_list_data, Response_list = create_model("Response_list", {"success_status":bool, "msg_str":string, "err_no":int})
    ...
    def generate_output():
        nonlocal response_list_data, epoch_signature, signature_list_data, hashed_pass, int_input, vmode, success_status, msg_str, err_no, hashed_from_be, licensenr, paramtext, htparam
        nonlocal user_name


        nonlocal payload_list, response_list, value_list, signature_list
        nonlocal response_list_data, value_list_data, signature_list_data

        return {"response-list": response_list_data, "epoch_signature": epoch_signature, "signature-list": signature_list_data}
    ...
    def gen_signature():
        ...
        epoch_signature, signature_list_data = create_signature(user_name, value_list_data)
    ...
    def create_signature(user_name:string, value_list_data:[Value_list]):
        ...
        nonlocal response_list_data, epoch_signature, signature_list_data, hashed_pass, int_input, vmode, success_status, msg_str, err_no, hashed_from_be, licensenr, paramtext, htparam
        nonlocal payload_list, response_list, value_list, signature_list
        nonlocal response_list_data, signature_list_data
