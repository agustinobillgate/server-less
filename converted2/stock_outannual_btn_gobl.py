...
def stock_outannual_btn_gobl(pvilanguage:int, sorttype:int, from_grp:int, mm:int, yy:int):
    ...
    def generate_output():
        nonlocal str_list_data, lvcarea, end_date, end_date1, to_date, from_date, datum, closed_date, date_mat, date_fb, num_date, htparam, l_artikel, l_ophis, l_op
    ...
    def create_list(mm:int, yy:int):
        ...
        i:int = 0
        tot_qty:List[Decimal] = create_empty_list(12,to_decimal("0"))
