...
def prepare_ins_rezeptbl(fr_artnr:int, to_artnr:int, h_artnr:int):
    ...
    def generate_output():
        nonlocal katnr, katbezeich, h_bezeich, portion, price_type, amount, t_l_artikel_data, t_h_rezept_data, s_rezlin_data, curr_pos, l_artikel, h_rezept, htparam, h_rezlin
        ...
        return {"katnr": katnr, "katbezeich": katbezeich, "h_bezeich": h_bezeich, "portion": portion, "price_type": price_type, "amount": amount, "t-l-artikel": t_l_artikel_data, "t-h-rezept": t_h_rezept_data, "s-rezlin": s_rezlin_data}
