...
def prepare_mk_aktlinebl(aktnr:int, inp_gastnr:int):
    ...
    def generate_output():
        nonlocal lname, guest_gastnr, p_400, p_405, p_406, p_407, t_akthdr_data, t_akt_code_data, akthdr, akt_code, akt_kont, guest, htparam
        nonlocal aktnr, inp_gastnr


        nonlocal t_akthdr, t_akt_code
        nonlocal t_akthdr_data, t_akt_code_data

        return {"lname": lname, "guest_gastnr": guest_gastnr, "p_400": p_400, "p_405": p_405, "p_406": p_406, "p_407": p_407, "t-akthdr": t_akthdr_data, "t-akt-code": t_akt_code_data}
