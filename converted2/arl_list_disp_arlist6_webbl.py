...
def arl_list_disp_arlist6_webbl(t_payload_list_data:[T_payload_list], show_rate:bool, last_sort:int, lresnr:int, long_stay:int, ci_date:date, grpflag:bool, room:string, lname:string, sorttype:int, fdate1:date, fdate2:date, fdate:date, excl_rmshare:bool, voucher_no:string, nation_str:string, disp_option:int):
