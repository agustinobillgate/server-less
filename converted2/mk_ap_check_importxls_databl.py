...
xls_list_data, Xls_list = create_model("Xls_list", {"fibukonto":string, "debit":Decimal, "credit":Decimal, "flag":bool, "bezeich":string, "remark":string}, {"fibukonto": "000000000000"})
...
def mk_ap_check_importxls_databl(xls_list_data:[Xls_list], s_list_data:[S_list]):
    ...
    def generate_output():
        ...
        return {"gl_notavail": gl_notavail, "gl_fibu": gl_fibu, "s-list": s_list_data}


    for xls_list in query(xls_list_data):
