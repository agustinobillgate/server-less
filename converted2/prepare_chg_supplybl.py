...
def prepare_chg_supplybl(supply_recid:int):
    ...
    t_l_lieferant_data, T_l_lieferant = create_model_like(L_lieferant, {"t_recid":int, "email":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal segm_bezeich, t_l_lieferant_data, l_lieferant, l_segment
        ...
        return {"segm_bezeich": segm_bezeich, "t-l-lieferant": t_l_lieferant_data}
