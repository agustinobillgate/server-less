...
from models import Artikel, Htparam, Waehrung, Reservation, Bediener, Debitor, Umsatz, Billjournal

def res_checkin_deposit_paybl(depoart:int, resnr:int, artnr:int, depositgef:decimal, payment:decimal, deposit_exrate:decimal, voucher_str:str, user_init:str):
    msg_str = ""
    error_flag = False
    deposit_pay = 0
    ...
    artikel = htparam = waehrung = reservation = bediener = debitor = umsatz = billjournal = None


    db_session = local_storage.db_session

    def generate_output():
        nonlocal msg_str, error_flag, deposit_pay, exchg_rate, foreign_payment, local_payment, price_decimal, pvilanguage, depo_bal, lvcarea, artikel, htparam, waehrung, reservation, bediener, debitor, umsatz, billjournal
    ...
    def deposit_payment1():
        ...
        reservation.depositgef = reservation.depositgef + depositgef
