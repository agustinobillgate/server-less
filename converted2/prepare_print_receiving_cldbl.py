...
def prepare_print_receiving_cldbl(pvilanguage:int, docu_nr:string, user_init:string, po_nr:string, lief_nr:int, store:int, to_date:date):
    ...
    str_list_data, Str_list = create_model("Str_list", {"artnr":int, "qty":Decimal, "warenwert":Decimal, "munit":string, "s":string, "fibu":string, "fibu_ze":string, "addvat_value":Decimal})
