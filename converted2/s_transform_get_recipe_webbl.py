...
def s_transform_get_recipe_webbl(pvilanguage:int, hrecipe_nr:int, qty:Decimal, curr_lager:int, transdate:date, bediener_nr:int, lscheinnr:string, t_op_list_data:[T_op_list]):
    ...
    def generate_output():
        nonlocal op_list_data, err_flag, msg_str, anzahl, stock_oh, t_logical, lvcarea, l_op, bediener, h_rezept, h_rezlin, htparam, l_artikel, l_bestand
        ...
        return {"t-op-list": t_op_list_data, "err_flag": err_flag, "msg_str": msg_str}
