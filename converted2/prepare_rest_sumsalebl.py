...
def prepare_rest_sumsalebl(curr_dept:int):
    ...
    tt_bezeich_data, Tt_bezeich = create_model("Tt_bezeich", {"curr_i":int, "bezeich":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal ldry, dstore, clb, price_decimal, exchg_rate, curr_local, curr_foreign, anzahl, sep_line, dept_name, from_date, tt_bezeich_data, tt_artnr_data, p_240, bezeich, artnr_list, i, paramnr_list, htparam, waehrung, artikel, hoteldpt
        nonlocal curr_dept


        nonlocal tt_artnr, tt_bezeich
        nonlocal tt_artnr_data, tt_bezeich_data

        return {"ldry": ldry, "dstore": dstore, "clb": clb, "price_decimal": price_decimal, "exchg_rate": exchg_rate, "curr_local": curr_local, "curr_foreign": curr_foreign, "anzahl": anzahl, "sep_line": sep_line, "dept_name": dept_name, "from_date": from_date, "tt-bezeich": tt_bezeich_data, "tt-artnr": tt_artnr_data, "p_240": p_240}
