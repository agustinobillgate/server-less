...
def nt_arrivalrm():
    ...
    cl_list_list, Cl_list = create_model("Cl_list", {"flag":int, "name":str, "depart":date, "rmcat":str, "rmno":str, "a":int, "c":int, "co":int, "argt":str, "company":str})
