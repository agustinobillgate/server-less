...
def eg_propertylist_btn_go_webbl(location:int, rmno:string, main_nr:int, sguestflag:bool):
    ...
    def generate_output():
        nonlocal q1_list_data, eg_location, queasy, eg_property
        nonlocal location, rmno, main_nr, sguestflag


        nonlocal q1_list
        nonlocal q1_list_data

        return {"location": location, "q1-list": q1_list_data}
    ...
    if sguestflag :
        ...
        if trim (rmno) != "" and main_nr == 0:
            ...
            for eg_property.nr, eg_property.bezeich, eg_property.zinr, eg_property.datum, eg_property.brand, eg_property.capacity, eg_property.dimension, eg_property.type, eg_property.price, eg_property.spec, eg_property.location, eg_property.activeflag, eg_property._recid, eg_location.bezeich, eg_location.nr, eg_location._recid, queasy.number1, queasy.char1, queasy._recid in db_session.query(Eg_property.nr, Eg_property.bezeich, Eg_property.zinr, Eg_property.datum, Eg_property.brand, Eg_property.capacity, Eg_property.dimension, Eg_property.type, Eg_property.price, Eg_property.spec, Eg_property.location, Eg_property.activeflag, Eg_property._recid, Eg_location.bezeich, Eg_location.nr, Eg_location._recid, Queasy.number1, Queasy.char1, Queasy._recid).join(Eg_location,(Eg_location.nr == Eg_property.location)).join(Queasy,(Queasy.key == 133) & (Queasy.number1 == Eg_property.maintask)).filter(
                     (Eg_property.zinr == rmno)).order_by(Eg_property._recid).all():
            ...
            queasy = Queasy()
            for eg_property.nr, eg_property.bezeich, eg_property.zinr, eg_property.datum, eg_property.brand, eg_property.capacity, eg_property.dimension, eg_property.type, eg_property.price, eg_property.spec, eg_property.location, eg_property.activeflag, eg_property._recid, eg_location.bezeich, eg_location.nr, eg_location._recid, queasy.number1, queasy.char1, queasy._recid in db_session.query(Eg_property.nr, Eg_property.bezeich, Eg_property.zinr, Eg_property.datum, Eg_property.brand, Eg_property.capacity, Eg_property.dimension, Eg_property.type, Eg_property.price, Eg_property.spec, Eg_property.location, Eg_property.activeflag, Eg_property._recid, Eg_location.bezeich, Eg_location.nr, Eg_location._recid, Queasy.number1, Queasy.char1, Queasy._recid).join(Eg_location,(Eg_location.nr == Eg_property.location)).join(Queasy,(Queasy.key == 133) & (Queasy.number1 == Eg_property.maintask)).filter(
                     (Eg_property.zinr == rmno) & (Eg_property.maintask == main_nr)).order_by(Eg_property._recid).all():
                if eg_property_obj_list.get(eg_property._recid):
                    continue
                else:
                    eg_property_obj_list[eg_property._recid] = True
            ...
            queasy = Queasy()
            for eg_property.nr, eg_property.bezeich, eg_property.zinr, eg_property.datum, eg_property.brand, eg_property.capacity, eg_property.dimension, eg_property.type, eg_property.price, eg_property.spec, eg_property.location, eg_property.activeflag, eg_property._recid, eg_location.bezeich, eg_location.nr, eg_location._recid, queasy.number1, queasy.char1, queasy._recid in db_session.query(Eg_property.nr, Eg_property.bezeich, Eg_property.zinr, Eg_property.datum, Eg_property.brand, Eg_property.capacity, Eg_property.dimension, Eg_property.type, Eg_property.price, Eg_property.spec, Eg_property.location, Eg_property.activeflag, Eg_property._recid, Eg_location.bezeich, Eg_location.nr, Eg_location._recid, Queasy.number1, Queasy.char1, Queasy._recid).join(Eg_location,(Eg_location.nr == Eg_property.location)).join(Queasy,(Queasy.key == 133) & (Queasy.number1 == Eg_property.maintask)).filter(
                     (Eg_property.location == location)).order_by(Eg_property._recid).all():
                if eg_property_obj_list.get(eg_property._recid):
                    continue
                else:
                    eg_property_obj_list[eg_property._recid] = True
            ...
            queasy = Queasy()
            for eg_property.nr, eg_property.bezeich, eg_property.zinr, eg_property.datum, eg_property.brand, eg_property.capacity, eg_property.dimension, eg_property.type, eg_property.price, eg_property.spec, eg_property.location, eg_property.activeflag, eg_property._recid, eg_location.bezeich, eg_location.nr, eg_location._recid, queasy.number1, queasy.char1, queasy._recid in db_session.query(Eg_property.nr, Eg_property.bezeich, Eg_property.zinr, Eg_property.datum, Eg_property.brand, Eg_property.capacity, Eg_property.dimension, Eg_property.type, Eg_property.price, Eg_property.spec, Eg_property.location, Eg_property.activeflag, Eg_property._recid, Eg_location.bezeich, Eg_location.nr, Eg_location._recid, Queasy.number1, Queasy.char1, Queasy._recid).join(Eg_location,(Eg_location.nr == Eg_property.location)).join(Queasy,(Queasy.key == 133) & (Queasy.number1 == Eg_property.maintask)).filter(
                     (Eg_property.location == location) & (Eg_property.maintask == main_nr)).order_by(Eg_property._recid).all():
                if eg_property_obj_list.get(eg_property._recid):
                    continue
                else:
                    eg_property_obj_list[eg_property._recid] = True
        ...
        if location == 0:
            ...
            if main_nr == 0:
                ...
                eg_location = Eg_location()
                queasy = Queasy()
                for eg_property.nr, eg_property.bezeich, eg_property.zinr, eg_property.datum, eg_property.brand, eg_property.capacity, eg_property.dimension, eg_property.type, eg_property.price, eg_property.spec, eg_property.location, eg_property.activeflag, eg_property._recid, eg_location.bezeich, eg_location.nr, eg_location._recid, queasy.number1, queasy.char1, queasy._recid in db_session.query(Eg_property.nr, Eg_property.bezeich, Eg_property.zinr, Eg_property.datum, Eg_property.brand, Eg_property.capacity, Eg_property.dimension, Eg_property.type, Eg_property.price, Eg_property.spec, Eg_property.location, Eg_property.activeflag, Eg_property._recid, Eg_location.bezeich, Eg_location.nr, Eg_location._recid, Queasy.number1, Queasy.char1, Queasy._recid).join(Eg_location,(Eg_location.nr == Eg_property.location)).join(Queasy,(Queasy.key == 133) & (Queasy.number1 == Eg_property.maintask)).order_by(Eg_property._recid).all():
                    if eg_property_obj_list.get(eg_property._recid):
                        continue
                    else:
                        eg_property_obj_list[eg_property._recid] = True
                ...
                queasy = Queasy()
                for eg_property.nr, eg_property.bezeich, eg_property.zinr, eg_property.datum, eg_property.brand, eg_property.capacity, eg_property.dimension, eg_property.type, eg_property.price, eg_property.spec, eg_property.location, eg_property.activeflag, eg_property._recid, eg_location.bezeich, eg_location.nr, eg_location._recid, queasy.number1, queasy.char1, queasy._recid in db_session.query(Eg_property.nr, Eg_property.bezeich, Eg_property.zinr, Eg_property.datum, Eg_property.brand, Eg_property.capacity, Eg_property.dimension, Eg_property.type, Eg_property.price, Eg_property.spec, Eg_property.location, Eg_property.activeflag, Eg_property._recid, Eg_location.bezeich, Eg_location.nr, Eg_location._recid, Queasy.number1, Queasy.char1, Queasy._recid).join(Eg_location,(Eg_location.nr == Eg_property.location)).join(Queasy,(Queasy.key == 133) & (Queasy.number1 == Eg_property.maintask)).filter(
                         (Eg_property.maintask == main_nr)).order_by(Eg_property._recid).all():
                    if eg_property_obj_list.get(eg_property._recid):
                        continue
                    else:
                        eg_property_obj_list[eg_property._recid] = True
