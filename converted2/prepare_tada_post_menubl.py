...
def prepare_tada_post_menubl(pvilanguage:int, curr_dept:int, curr_printer:int, user_init_str:string, transdate:date):
    ...
    def generate_output():
        nonlocal mealcoupon_cntrl, must_print, zero_flag, multi_cash, cancel_exist, msg_str, disc_art1, disc_art2, disc_art3, mi_ordertaker, price_decimal, curr_local, curr_foreign, double_currency, foreign_rate, exchg_rate, b_title, deptname, p_223, curr_waiter, fl_code, pos1, pos2, cashless_flag, hbill_data, t_kellner_data, lvcarea, user_init, from_acct, guest, printer, htparam, queasy, waehrung, hoteldpt, kellner, h_bill, bediener
