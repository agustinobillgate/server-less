...
def fo_inv_openbill_list_webbl(bil_flag:int, bil_recid:int, room:string, vipflag:bool, fill_co:bool, double_currency:bool, foreign_rate:bool):
    ...
    abreise, resname, res_exrate, zimmer_bezeich, kreditlimit, master_str, master_rechnr, bill_anzahl, queasy_char1, disp_warning, flag_report, guest_taxcode, t_res_line_data, t_bill_data = get_output(fo_invoice_open_bill_cld_1bl(bil_flag, bil_recid, room, vipflag))
