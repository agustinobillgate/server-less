...
def prepare_res_fixartbl(pvilanguage:int, resnr:int, reslinnr:int):
    ...
    t_fixleist_data, T_fixleist = create_model_like(Fixleist, {"depart":string, "rec_id":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal f_tittle, contcode, billdate, foreign_rate, double_currency, price_decimal, exchg_rate, curr_local, curr_foreign, flag, t_fixleist_data, lvcarea, ct, fixleist, res_line, guest_pr, htparam, hoteldpt, waehrung
        ...
        return {"f_tittle": f_tittle, "contcode": contcode, "billdate": billdate, "foreign_rate": foreign_rate, "double_currency": double_currency, "price_decimal": price_decimal, "exchg_rate": exchg_rate, "curr_local": curr_local, "curr_foreign": curr_foreign, "flag": flag, "t-fixleist": t_fixleist_data}
