...
def longshort_stay_btn_gobl(sorttype:int, to_date:date, from_date:date, long_stay:int):
    ...
    def generate_output():
        nonlocal tot_rm, tot_a, tot_c, tot_co, tot_avail, inactive, cl_list_data, s_list_data, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, htparam, zimmer, paramtext, guest, zimkateg, reservation, res_line, guestseg, nation
        ...
        return {"tot_rm": tot_rm, "tot_a": tot_a, "tot_c": tot_c, "tot_co": tot_co, "tot_avail": tot_avail, "inactive": inactive, "cl-list": cl_list_data, "s-list": s_list_data}
