...
def prepare_s_stockinsbl(l_recid:int, rcvdate:date):
    ...
    t_bediener_data, T_bediener = create_model("T_bediener", {"username":string, "nr":int})
    ...
    def generate_output():
        nonlocal rcv_type, f_endkum, b_endkum, m_endkum, lief_nr, curr_lager, billdate, fb_closedate, m_closedate, last_mdate, last_fbdate, lscheinnr, lief_bezeich, lager_bezeich, err_code, fl_code1, fl_code2, l_rcv_lscheinnr, l_out_stornogrund, avail_l_out, t_bediener_data, l_op, l_ophdr, htparam, l_lieferant, l_lager, bediener
