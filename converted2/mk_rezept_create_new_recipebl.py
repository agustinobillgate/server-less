...
def mk_rezept_create_new_recipebl(s_rezlin_data:[S_rezlin], h_artnr:int, h_bezeich:string, katbezeich:string, katnr:int, portion:int):
    ...
    def generate_output():
        ...
        nonlocal h_artnr, h_bezeich, katbezeich, katnr, portion
        nonlocal b_rezept
    ...
    def create_new_recipe():
        ...
        for s_rezlin in query(s_rezlin_data):
            h_rezlin = H_rezlin()
