...
def inv_adjustment_chk_fibubl(c_list_data:[C_list]):
    err_code = 0
    gl_acct = None
    ...
    for c_list1 in query(c_list1_data, filters=(lambda c_list1: c_list1.qty != c_list1.qty1 and c_list1.fibukonto.lower()  != ("0000000000").lower())):
