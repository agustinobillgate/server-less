...
def mapping_coa_2bl(coa_list_data:[Coa_list]):
    ...
    temp_gl_journal_data, Temp_gl_journal = create_model_like(Gl_journal)
    temp_gl_jourhis_data, Temp_gl_jourhis = create_model_like(Gl_jourhis)
    ...
    def generate_output():
        ...
        nonlocal temp_gl_journal_data, temp_gl_jourhis_data
