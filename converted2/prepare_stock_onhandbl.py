...
def prepare_stock_onhandbl(s_artnr:int):
    ...
    output_list_data, Output_list = create_model("Output_list", {"l_bezeich":string, "str":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal price_decimal, artnr, bezeich, output_list_data, long_digit, htparam, l_artikel, l_bestand, l_lager
        nonlocal s_artnr
        ...
        return {"price_decimal": price_decimal, "artnr": artnr, "bezeich": bezeich, "output-list": output_list_data}
