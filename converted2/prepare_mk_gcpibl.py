...
def prepare_mk_gcpibl(pvilanguage:int, pi_number:string, user_init:string):
    ...
    def generate_output():
        nonlocal pi_acctno, giro_tempacct, pi_mode, pi_status, pi_type1, fl_temp, fl_err, p_110, bemerk, rcvname, pay_acctno, department, pay_amount, pbuff_data, t_gc_pitype_data, t_gc_pibline_data, s_list_data, i, lvcarea, gc_pibline, gc_pi, gc_pitype, htparam, gl_acct, bediener, gc_piacct, queasy
