...
def ba_depopaybl(veran_nr:int):
    ...
    depobuff_data, Depobuff = create_model_like(Artikel)
    veran_list_data, Veran_list = create_model_like(Bk_veran)
    ...
    def generate_output():
        nonlocal currency, exchg_rate, bqt_dept, art_depo, err_msg, depoart, depobezeich, price_decimal, double_currency, depobuff_data, veran_list_data, artikel, bk_veran, htparam, waehrung
        nonlocal veran_nr
        nonlocal bartikel


        nonlocal depobuff, veran_list, bartikel
        nonlocal depobuff_data, veran_list_data

        return {"currency": currency, "exchg_rate": exchg_rate, "bqt_dept": bqt_dept, "art_depo": art_depo, "err_msg": err_msg, "depoart": depoart, "depobezeich": depobezeich, "price_decimal": price_decimal, "double_currency": double_currency, "depobuff": depobuff_data, "veran-list": veran_list_data}
