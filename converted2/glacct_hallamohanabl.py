...
def glacct_hallamohanabl(months:int, years:int):
    ...
    def generate_output():
        nonlocal fromdate, todate, mm, loc_curr, t_gl_jouhdr_data, g_list_data, gl_journal, gl_jouhdr, htparam, gl_acct
        ...
        for t_gl_jouhdr in query(t_gl_jouhdr_data):
            ...
            for gl_journal in db_session.query(Gl_journal).filter(
                ...
                if gl_acct:
                    ...
                    note_list = query(note_list_data, filters=(lambda note_list: note_list.s_recid == to_int(gl_journal._recid)), first=True)
