...
def ts_restinv_print_orderticket_webbl(submenu_list_data:[Submenu_list], pvilanguage:int, close_it:bool, reprint_it:bool, h_bill_rechnr:int, curr_dept:int, disc_art1:int, disc_art2:int, disc_art3:int, prorder:int, desclength:int):
    ...
    output_list_data, Output_list = create_model("Output_list", {"bill_no":int, "bezeich":string, "pos":int, "subgrp":string, "submenu_request":string, "printcod_concod":string, "aendertext":string, "pax":string, "stornogrund":string, "submenu_bezeich":string, "bezeich2":string})
    ...
    def generate_output():
        nonlocal k, header_list_data, output_list_data, prev_zknr, do_it, recid_h_bill_line, lvcarea, h_artikel, h_bill_line, queasy, h_bill, wgrpdep, hoteldpt, kellner, printcod, h_journal, h_mjourn
        ...
        nonlocal header_list_data, output_list_data
    ...
    def write_article(s_recid:int, prev_zknr:int):
        ...
        nonlocal k, header_list_data, output_list_data, do_it, recid_h_bill_line, lvcarea, h_artikel, h_bill_line, queasy, h_bill, wgrpdep, hoteldpt, kellner, printcod, h_journal, h_mjourn
        nonlocal pvilanguage, close_it, reprint_it, h_bill_rechnr, curr_dept, disc_art1, disc_art2, disc_art3, prorder, desclength
        nonlocal abuff, hbuff, hbline, qsy
