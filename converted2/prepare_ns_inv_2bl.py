...
def prepare_ns_inv_2bl(inp_rechnr:int, curr_department:int, combo_pf_file1:string, combo_pf_file2:string, combo_gastnr:int, combo_ledger:int):
    ...
    def generate_output():
        nonlocal cashless_license, cashless_minsaldo, ns_useraccess, f_foinv_data, t_bill_data, t_guest_data, golf_license, bill, guest, htparam, artikel, waehrung, brief, hoteldpt
        ...
        nonlocal t_bill_data, t_guest_data, f_foinv_data

        return {"cashless_license": cashless_license, "cashless_minsaldo": cashless_minsaldo, "ns_useraccess": ns_useraccess, "f-foinv": f_foinv_data, "t-bill": t_bill_data, "t-guest": t_guest_data, "combo_pf_file1": combo_pf_file1, "combo_pf_file2": combo_pf_file2, "combo_gastnr": combo_gastnr, "combo_ledger": combo_ledger}
