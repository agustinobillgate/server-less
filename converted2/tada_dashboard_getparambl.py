...
def tada_dashboard_getparambl(dept:int):
    ...
    def generate_output():
        nonlocal t_dept_data, t_queasy270_data, licensenr, interval_time, cancel_exist, t_status_data, pax, orderdatetime, gname, room, gastnr, resnr, reslinnr, mess_str, i_str, mess_token, mess_keyword, mess_value, table_no, dtime, queasy, hoteldpt, paramtext
        nonlocal dept
        nonlocal qsy230, session_table, posted_item


        nonlocal t_dept, t_status, t_queasy270, qsy230, session_table, posted_item
        nonlocal t_dept_data, t_status_data, t_queasy270_data

        return {"t-dept": t_dept_data, "t-queasy270": t_queasy270_data, "licensenr": licensenr, "interval_time": interval_time, "cancel_exist": cancel_exist, "t-status": t_status_data}
