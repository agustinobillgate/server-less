...
def prepare_hmcoup_listbl():
    ...
    def generate_output():
        nonlocal billdate, from_date, to_date, from_art, to_art, from_dept, to_dept, depname1, depname2, double_currency, foreign_nr, exchg_rate, t_hoteldpt_data, min_dept, max_dept, min_art, max_art, htparam, hoteldpt, waehrung


        nonlocal t_hoteldpt
        nonlocal t_hoteldpt_data

        return {"billdate": billdate, "from_date": from_date, "to_date": to_date, "from_art": from_art, "to_art": to_art, "from_dept": from_dept, "to_dept": to_dept, "depname1": depname1, "depname2": depname2, "double_currency": double_currency, "foreign_nr": foreign_nr, "exchg_rate": exchg_rate, "t-hoteldpt": t_hoteldpt_data}
