...
def prepare_over_crlimit_listbl():
    ...
    def generate_output():
        nonlocal from_dept, to_dept, depname1, depname2, billdate, t_hoteldpt_data, min_dept, max_dept, hoteldpt, htparam


        nonlocal t_hoteldpt
        nonlocal t_hoteldpt_data

        return {"from_dept": from_dept, "to_dept": to_dept, "depname1": depname1, "depname2": depname2, "billdate": billdate, "t-hoteldpt": t_hoteldpt_data}
