...
from functions.trialbalance_btn_go_1_cldbl import trialbalance_btn_go_1_cldbl

def trialbaiance_btn_execute_webbl(acct_type:int, from_fibu:str, to_fibu:str, sorttype:int, from_dept:int, from_date:date, to_date:date, close_month:int, close_date:date, pnl_acct:str, close_year:date, prev_month:int, show_longbal:bool, pbal_flag:bool, asremoteflag:bool):
    msg_str = ""
    tb_list_detail_list = []
    ...
    output_list_list = get_output(trialbalance_btn_go_1_cldbl(acct_type, from_fibu, to_fibu, sorttype, from_dept, from_date, to_date, close_month, close_date, pnl_acct, close_year, prev_month, show_longbal, pbal_flag, asremoteflag))
