...
def prepare_config_setup_save_horekabl():
    ...
    tlist_data, Tlist = create_model("Tlist", {"datum":date, "depart":int, "approved":bool, "send_horeka":bool, "user_name":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal custid, username, password, url_push, url_notif, storage, push_dml, art_deposit, api_key, supplier, coa_apdeposit, coa_apclearence, artikel_apclearence, usr_id, tlist_data, loopi, str, queasy
