...
def prepare_split_bill_webbl(pvilanguage:int, bil_recid:int):
    ...
    t_bline1_data, T_bline1 = create_model_like(Bill_line, {"bl_recid":int, "artart":int, "tool_tip":string})
    ...
    def create_browse():
        ...
        if t_bill.rechnr != 0:
            t_bline1_data = get_output(read_bill_line1bl(3, pvilanguage, t_bill.rechnr, None, None, None, None, None))
        ...
        while i <= bill_anzahl:
            ...
            if i != billnr1:
                bill1_data = get_output(read_bill1bl(12, i, t_bill.resnr, t_bill.parent_nr, 0, t_bill.zinr, None, None, None, None))
    ...
    if t_bill:
        ...
        bill_anzahl = 0
        bill1_data = get_output(read_bill1bl(2, None, t_bill.resnr, t_bill.parent_nr, 0, t_bill.zinr, None, None, None, None))
