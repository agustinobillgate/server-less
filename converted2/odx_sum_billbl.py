...
def odx_sum_billbl(rechnr:int, dept:int):
    ...
    summary_bill_data, Summary_bill = create_model("Summary_bill", {"department":int, "tableno":int, "rechnr":int, "pax":int, "total_food":Decimal, "total_bev":Decimal, "total_other":Decimal, "total_service":Decimal, "total_tax":Decimal, "total_disc":Decimal, "total_tips":Decimal, "total_amount":Decimal})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal summary_bill_data, vat, vat2, service, fact, netto, t_service, discfood_artnr, discoth_artnr, discbev_artnr, htparam, h_bill, h_bill_line, h_artikel, artikel
        nonlocal rechnr, dept


        nonlocal summary_bill
        nonlocal summary_bill_data
    ...
    for summary_bill in query(summary_bill_data):
