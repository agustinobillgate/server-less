...
def sarticle_list_bulk_delete_article_webbl(pvilanguage:int, t_l_artikel_data:[T_l_artikel]):
    ...
    t_l_artikel = query(t_l_artikel_data, filters=(lambda t_l_artikel: t_l_artikel.is_select  and t_l_artikel.is_delete), first=True)
    ...
    for t_l_artikel in query(t_l_artikel_data, filters=(lambda t_l_artikel: t_l_artikel.is_select  and t_l_artikel.is_delete)):
