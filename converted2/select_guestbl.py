...
def select_guestbl(sorttype:int, curr_name:string):
    ...
    t_guest_data, T_guest = create_model("T_guest", {"gastnr":int, "name":string, "anredefirma":string, "wohnort":string, "adresse1":string, "vorname1":string, "anrede1":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal t_guest_data, to_name, guest
