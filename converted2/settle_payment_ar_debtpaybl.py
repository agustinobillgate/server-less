...
pay_list_data, Pay_list = create_model("Pay_list", {"artnr":int, "bezeich":string, "proz":Decimal, "betrag":Decimal, "f_amt":Decimal, "currency":int, "curr_str":string, "bemerk":string, "remain_amt":Decimal, "fremain_amt":Decimal})

def settle_payment_ar_debtpaybl(age_list_data:[Age_list], pay_list_data:[Pay_list], pvilanguage:int, outstand1:Decimal, foutstand1:Decimal, outstand:Decimal, curr_art:int, rundung:int, foutstand:Decimal, pay_date:date, balance:Decimal, fbalance:Decimal, user_init:string):
