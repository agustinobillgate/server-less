...
def sall_onhand_btn_go_1bl(all_flag:bool, show_price:bool, zero_flag:bool, from_grp:int, sub_grp:int, from_lager:int, to_lager:int, sorttype:int, mattype:int, minoh_flag:bool):
    ...
    def generate_output():
        nonlocal str_list_data, curr_best, long_digit, i, j, tot_anz, tot_val, t_anz, t_val, t_value, tt_value, avrg_price, zwkum, bezeich, grp1, grp2, must_order, tt_val, qty, wert, tot_bezeich, l_bestand, htparam, l_lager, l_artikel, l_untergrup
    ...
    def create_lines():
        ...
        if tot_anz != 0 or (tot_anz == 0 and zero_flag):
            ...
            if show_price:
                ...
                if not long_digit:
                    str_list.s = to_string(l_artikel.artnr, "9999999") + substring(to_string(tmp_str) , 0, 50) + to_string(l_artikel.masseinheit, "x(3)") + to_string(l_artikel.inhalt, ">>,>>9.99") + to_string(l_artikel.traubensorte, "x(8)") + to_string(l_artikel.lief_einheit, ">>,>>9.99") + to_string(l_artikel.ek_letzter, ">>>,>>>,>>9.99") + to_string(l_artikel.ek_aktuell, ">>>,>>>,>>9.99") + to_string(l_artikel.vk_preis, "->>,>>>,>>9.99") + to_string(tot_anz, "->,>>>,>>9.99") + to_string(tot_val, "->>,>>>,>>>,>>9.99") + to_string(l_artikel.min_bestand, "->,>>>,>>9.99") + to_string(must_order, "->,>>>,>>9.99")
                else:
                    str_list.s = to_string(l_artikel.artnr, "9999999") + substring(to_string(tmp_str) , 0, 50) + to_string(l_artikel.masseinheit, "x(3)") + to_string(l_artikel.inhalt, ">>,>>9.99") + to_string(l_artikel.traubensorte, "x(8)") + to_string(l_artikel.lief_einheit, ">>,>>9.99") + to_string(l_artikel.ek_letzter, ">,>>>,>>>,>>9") + to_string(l_artikel.ek_aktuell, ">,>>>,>>>,>>9") + to_string(l_artikel.vk_preis, "->,>>>,>>>,>>9") + to_string(tot_anz, "->,>>>,>>9.99") + to_string(tot_val, "->,>>>,>>>,>>>,>>9") + to_string(l_artikel.min_bestand, "->,>>>,>>9.99") + to_string(must_order, "->,>>>,>>9.99")
            else:

                if not long_digit:
                    str_list.s = to_string(l_artikel.artnr, "9999999") + substring(to_string(tmp_str) , 0, 50) + to_string(l_artikel.masseinheit, "x(3)") + to_string(l_artikel.inhalt, ">>,>>9.99") + to_string(l_artikel.traubensorte, "x(8)") + to_string(l_artikel.lief_einheit, ">>,>>9.99") + to_string(0, ">>,>>>,>>9.99") + to_string(0, ">>,>>>,>>9.99") + to_string(0, ">>,>>>,>>9.99") + to_string(tot_anz, "->,>>>,>>9.99") + to_string(0, "->>,>>>,>>>,>>9.99") + to_string(l_artikel.min_bestand, "->,>>>,>>9.99") + to_string(must_order, "->,>>>,>>9.99")
                else:
                    str_list.s = to_string(l_artikel.artnr, "9999999") + substring(to_string(tmp_str) , 0, 50) + to_string(l_artikel.masseinheit, "x(3)") + to_string(l_artikel.inhalt, ">>,>>9.99") + to_string(l_artikel.traubensorte, "x(8)") + to_string(l_artikel.lief_einheit, ">>,>>9.99") + to_string(0, ">,>>>,>>>,>>9") + to_string(0, ">,>>>,>>>,>>9") + to_string(0, ">,>>>,>>>,>>9") + to_string(tot_anz, "->,>>>,>>9.99") + to_string(0, "->,>>>,>>>,>>>,>>9") + to_string(l_artikel.min_bestand, "->,>>>,>>9.99") + to_string(must_order, "->,>>>,>>9.99")
