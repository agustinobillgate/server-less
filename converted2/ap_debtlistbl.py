...
def ap_debtlistbl(duedate_flag:bool, from_lief:int, to_lief:int, paid_flag:bool, excl_apmanual:bool, from_date:date, to_date:date, from_supp:string, to_supp:string, only_apmanual:bool, taxcode_list_data:[Taxcode_list]):
    ...
    output_list_data, Output_list = create_model("Output_list", {"paid":string, "ap_recid":int, "str":string, "lscheinnr":string, "gstid":string, "tax_code":string, "tax_amount":string, "tot_amt":string})
