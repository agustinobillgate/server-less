...
def prepare_inv_adjustmentbl():
    ...
    def generate_output():
        nonlocal billdate, mat_grp, early_adjust, inv_postdate, transdate, t_l_hauptgrp_data, t_l_lager_data, htparam, l_hauptgrp, l_lager


        nonlocal t_l_lager, t_l_hauptgrp
        nonlocal t_l_lager_data, t_l_hauptgrp_data

        return {"billdate": billdate, "mat_grp": mat_grp, "early_adjust": early_adjust, "inv_postdate": inv_postdate, "transdate": transdate, "t-l-hauptgrp": t_l_hauptgrp_data, "t-l-lager": t_l_lager_data}
