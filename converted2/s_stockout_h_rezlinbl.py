...
def s_stockout_h_rezlinbl(p_artnr:int, curr_lager:int):
    ...
    def generate_output():
        nonlocal t_l_bestand_data, t_h_rezlin_data, l_bestand, h_rezlin
        nonlocal p_artnr, curr_lager


        nonlocal t_l_bestand, t_h_rezlin
        nonlocal t_l_bestand_data, t_h_rezlin_data

        return {"t-l-bestand": t_l_bestand_data, "t-h-rezlin": t_h_rezlin_data}
