...
def prtable_adminbl(t_prtable_data:[T_prtable], t_prmarket_data:[T_prmarket], t_queasy_data:[T_queasy]):
    ...
    def generate_output():
        nonlocal b1_list_data, prtable, prmarket, queasy
    ...
    t_prtable = query(t_prtable_data, first=True)
    ...
    t_prmarket = query(t_prmarket_data, first=True)
