...
def ba_npartikelbl(veran_nr:int, bill_date:date):
    ...
    bk_list_data, Bk_list = create_model("Bk_list", {"datum":date, "raum":string, "veran_artnr":int, "bezeich":string, "anzahl":int, "preis":Decimal, "amount":Decimal, "von_zeit":string, "bis_zeit":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal bk_list_data, bk_reser, bk_rart
