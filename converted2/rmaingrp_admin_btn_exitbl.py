...
wgrpgen_list_data, Wgrpgen_list = create_model_like(Wgrpgen)

def rmaingrp_admin_btn_exitbl(wgrpgen_list_data:[Wgrpgen_list], case_type:int):
    ...
    wgrpgen_list = query(wgrpgen_list_data, first=True)
