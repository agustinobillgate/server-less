...
def prepare_print_letterbl(last_sort:int, fdate:date, lname:string):
    ...
    def generate_output():
        nonlocal ci_date, briefnr, q1_list_data, htparam
        ...
        return {"ci_date": ci_date, "briefnr": briefnr, "q1-list": q1_list_data}
    ...
    q1_list_data = get_output(print_letter_disp_arlistbl(last_sort, fdate, lname))
