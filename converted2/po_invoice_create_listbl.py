...
def po_invoice_create_listbl(lscheinnr:string):
    ...
    def generate_output():
        nonlocal tot_amt, tot_disc, tot_disc2, tot_vat, tot_val, confirm_flag, s_list_data, l_artikel, l_op
        nonlocal lscheinnr
        ...
        return {"tot_amt": tot_amt, "tot_disc": tot_disc, "tot_disc2": tot_disc2, "tot_vat": tot_vat, "tot_val": tot_val, "confirm_flag": confirm_flag, "s-list": s_list_data}
