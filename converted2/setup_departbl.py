...
depart_list_data, Depart_list = create_model_like(Dept_list)

def setup_departbl(icase:int, depart_list_data:[Depart_list]):
    ...
    def generate_output():
        nonlocal dept_list_data, dept_list_data, success_flag, counter, del_flag, curr_num, hoteldpt, htparam, umsatz
        nonlocal icase
        nonlocal bdept
        ...
        return {"dept-list": dept_list_data, "success_flag": success_flag}
    ...
    if icase == 1:
        ...
        depart_list = query(depart_list_data, first=True)
