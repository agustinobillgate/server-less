...
def prepare_reservationbl(gastno:int):
    ...
    def generate_output():
        nonlocal i_param297, i_cardtype, ext_char, ci_date, t_guest_data, guest
        nonlocal gastno
        ...
        return {"i_param297": i_param297, "i_cardtype": i_cardtype, "ext_char": ext_char, "ci_date": ci_date, "t-guest": t_guest_data}
