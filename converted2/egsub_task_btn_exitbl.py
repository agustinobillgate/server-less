...
subtask_data, Subtask = create_model_like(Eg_subtask)

def egsub_task_btn_exitbl(subtask_data:[Subtask], case_type:int, user_init:string, rec_id:int):
    ...
    subtask = query(subtask_data, first=True)
