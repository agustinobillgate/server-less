...
def eg_rephistoryroom_detail_webbl(case_type:int, reqno:int):
    ...
    t_hisroom_line_cost_data, T_hisroom_line_cost = create_model("T_hisroom_line_cost", {"reqno":string, "flag":string, "artno":string, "bezeich":string, "qty":string, "price":string, "tot_price":string})
    t_hisroom_line_vendor_data, T_hisroom_line_vendor = create_model("T_hisroom_line_vendor", {"reqno":string, "flag":string, "outsource":string, "vendor_nm":string, "startdate":string, "finishdate":string, "price":string})
    ...
    def generate_output():
        nonlocal tot_cost, tot_vend, t_hisroom_line_cost_data, t_hisroom_line_vendor_data, tot, curr_tot, l_artikel, eg_queasy, eg_vperform, eg_vendor
        nonlocal case_type, reqno
        nonlocal tbuff


        nonlocal t_hisroom_line_cost, t_hisroom_line_vendor, tbuff
        nonlocal t_hisroom_line_cost_data, t_hisroom_line_vendor_data

        return {"tot_cost": tot_cost, "tot_vend": tot_vend, "t-hisroom-line-cost": t_hisroom_line_cost_data, "t-hisroom-line-vendor": t_hisroom_line_vendor_data}
