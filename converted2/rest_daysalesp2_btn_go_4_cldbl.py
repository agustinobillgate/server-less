...
def rest_daysalesp2_btn_go_4_cldbl(bline_list_list:[Bline_list], buf_art_list:[Buf_art], disc_art1:int, disc_art2:int, disc_art3:int, curr_dept:int, all_user:bool, shift:int, from_date:date, to_date:date, art_str:str, voucher_art:int, zero_vat_compli:bool, show_fbodisc:bool, htl_dept_dptnr:int, incl_move_table:bool):
    ...
    def generate_output():
        ...
        nonlocal disc_art1, disc_art2, disc_art3, curr_dept, all_user, shift, from_date, to_date, art_str, voucher_art, zero_vat_compli, show_fbodisc, htl_dept_dptnr, incl_move_table
