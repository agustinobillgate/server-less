...
def telext_adminbl(sorttype:int):
    ...
    def generate_output():
        nonlocal t_nebenst_data, cost_list_data, nebenst, parameters
        nonlocal sorttype


        nonlocal cost_list, t_nebenst
        nonlocal cost_list_data, t_nebenst_data

        return {"t-nebenst": t_nebenst_data, "cost-list": cost_list_data}
