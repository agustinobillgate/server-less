...
def hk_ooo_1_cldbl(om_list_data:[Om_list], fdate:date, tdate:date, disptype:int, sorttype:int, user_init:string):
    ...
    def generate_output():
        nonlocal ci_date, ooo_list_data, zimmer, outorder
