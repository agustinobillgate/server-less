...
def search_cost_center_webbl(account_no:string):
    ...
    out_list_data, Out_list = create_model("Out_list", {"fibu":string, "fibu_desc":string, "costcenter_no":int, "costcenter_name":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal vsuccess, result_msg, out_list_data, varcode, parameters, gl_acct
        nonlocal account_no
        ...
        return {"vsuccess": vsuccess, "result_msg": result_msg, "out-list": out_list_data}
