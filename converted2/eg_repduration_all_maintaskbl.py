...
def eg_repduration_all_maintaskbl(all_room:bool, all_maintask:bool, tlocation_data:[Tlocation], tmaintask_data:[Tmaintask], troom_data:[Troom]):
    ...
    def generate_output():
        nonlocal tproperty_data, tsubtask_data, eg_property, queasy, eg_location, eg_subtask
        nonlocal all_room, all_maintask


        nonlocal tsubtask, tproperty, troom, tmaintask, tlocation, comlocat, commain, comroom
        nonlocal tsubtask_data, tproperty_data

        return {"tproperty": tproperty_data, "tsubtask": tsubtask_data}
