...
def res_changesbl(pvilanguage:int, res_mode:string, guestname:string, mr_comment:string, rl_comment:string, user_init:string, earlyci:bool, fixed_rate:bool, reslin_list_data:[Reslin_list]):
