...
def prepare_ts_splititembl(h_recid:int):
    ...
    def generate_output():
        nonlocal price_decimal, double_currency, curr_qty, t_h_bill_line_data, h_bill_line, htparam
        nonlocal h_recid
        ...
        return {"price_decimal": price_decimal, "double_currency": double_currency, "curr_qty": curr_qty, "t-h-bill-line": t_h_bill_line_data}
