...
pci_setup_data, Pci_setup = create_model("Pci_setup", {"number1":int, "number2":int, "number3":int, "descr":string, "setupflag":bool, "price":Decimal})

def common_precheckin_savesetupbl(input_username:string, input_userkey:string, pci_setup_data:[Pci_setup]):
