...
def prepare_drstore_reportbl():
    ...
    user_list_data, User_list = create_model("User_list", {"rec_id":int, "dept":int, "depart":string, "usrnr":int, "usrname":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal p_110, dstore_dept, ekumnr, zknr1, zknr2, zknr3, zknr4, zknr5, zknr6, bezeich1, bezeich2, bezeich3, bezeich4, bezeich5, bezeich6, user_list_data, htparam, hoteldpt, kellner, h_artikel, wgrpdep


        nonlocal user_list
        nonlocal user_list_data

        return {"p_110": p_110, "dstore_dept": dstore_dept, "ekumnr": ekumnr, "zknr1": zknr1, "zknr2": zknr2, "zknr3": zknr3, "zknr4": zknr4, "zknr5": zknr5, "zknr6": zknr6, "bezeich1": bezeich1, "bezeich2": bezeich2, "bezeich3": bezeich3, "bezeich4": bezeich4, "bezeich5": bezeich5, "bezeich6": bezeich6, "user-list": user_list_data}
