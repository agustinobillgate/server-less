...
def prepare_dml_stockinbl(curr_dept:int):
    ...
    def generate_output():
        nonlocal price_decimal, f_endkum, b_endkum, m_endkum, billdate, fb_closedate, m_closedate, over_proz, flag_error, p_232, dml_list_data, t_hoteldpt_data, t_l_lager_data, t_bediener_data, hoteldpt, l_lager, bediener, htparam
        nonlocal curr_dept


        nonlocal dml_list, t_hoteldpt, t_l_lager, t_bediener
        nonlocal dml_list_data, t_hoteldpt_data, t_l_lager_data, t_bediener_data

        return {"price_decimal": price_decimal, "f_endkum": f_endkum, "b_endkum": b_endkum, "m_endkum": m_endkum, "billdate": billdate, "fb_closedate": fb_closedate, "m_closedate": m_closedate, "over_proz": over_proz, "flag_error": flag_error, "p_232": p_232, "dml-list": dml_list_data, "t-hoteldpt": t_hoteldpt_data, "t-l-lager": t_l_lager_data, "t-bediener": t_bediener_data}
    ...
    dml_list_data = get_output(dml_stockin_create_dml_listbl(curr_dept, billdate))
