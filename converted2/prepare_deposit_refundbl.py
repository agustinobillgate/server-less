...
def prepare_deposit_refundbl(resnr:int):
    ...
    t_artikel_data, T_artikel = create_model_like(Artikel, {"pay_exrate":Decimal, "w_wabkurz":string}, {"pay_exrate": 1})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal deposit_exrate, depobezeich, depoart, flag_err, p_60, p_152, t_reservation_data, t_artikel_data, reservation, artikel, htparam, waehrung
        nonlocal resnr


        nonlocal t_reservation, t_artikel
        nonlocal t_reservation_data, t_artikel_data

        return {"deposit_exrate": deposit_exrate, "depobezeich": depobezeich, "depoart": depoart, "flag_err": flag_err, "p_60": p_60, "p_152": p_152, "t-reservation": t_reservation_data, "t-artikel": t_artikel_data}
