...
def mb_web_open_billbl(bil_recid:int, foreign_rate:bool, double_currency:bool, ba_dept:int):
    ...
    def generate_output():
        nonlocal invno, gname, resname, rescomment, printed, rechnr, balance, balance_foreign, kreditlimit, enbtn_bareserve, t_bill_line_data, t_bill_data, curr_select, telbill_flag, babill_flag, curr_gname, curr_invno, curr_b_recid, art_no, res_no, tot_adult, tot_room, room_no, bk_reser, guest, htparam, bk_veran, bill, bill_line
        ...
        nonlocal t_bk_reser_data, t_guest_data, t_htparam_data, t_bk_veran_data, t_bill_data, t_bill_line_data, spbill_list_data, b_list_data, b1_list_data

        return {"invno": invno, "gname": gname, "resname": resname, "rescomment": rescomment, "printed": printed, "rechnr": rechnr, "balance": balance, "balance_foreign": balance_foreign, "kreditlimit": kreditlimit, "enbtn_bareserve": enbtn_bareserve, "t-bill-line": t_bill_line_data, "t-bill": t_bill_data}
    ...
    def disp_bill_line(read_flag:bool):
        ...
        if read_flag:
            t_bill_line_data = get_output(read_bill_line1bl(3, 1, t_bill.rechnr, None, None, None, None, None))
