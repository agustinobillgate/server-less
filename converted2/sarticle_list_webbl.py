...
def sarticle_list_webbl(sorttype:int, last_art:string, last_art1:int, idflag:string):
    ...
    t_l_artikel_data, T_l_artikel = create_model("T_l_artikel", {"artnr":int, "bezeich":string, "masseinheit":string, "inhalt":Decimal, "traubensorte":string, "unit_price":Decimal, "lief_einheit":Decimal, "soh":Decimal})
    ...
    def generate_output():
        nonlocal t_l_artikel_data, counter, queasy, l_artikel, l_bestand
