...
def select_pguestbl(roomno:string, sorttype:int, gname:string):
    ...
    b1_list_data, B1_list = create_model("B1_list", {"resnr":int, "reslinnr":int, "zinr":string, "name":string, "arrangement":string, "ankunft":date, "abreise":date})
    ...
    def generate_output():
        nonlocal b1_list_data, bill, res_line
