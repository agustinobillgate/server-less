...
def chg_rcommentbl(icase:int, resno:int, reslinno:int, user_init:string, res_com:string, resl_com:string, g_com:string, web_com:string):

    prepare_cache ([Res_line, Reservation, Guest, Queasy, Reslin_queasy, Bediener, Res_history])
