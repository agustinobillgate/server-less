...
from functions.fo_invoice_open_bill_cldbl import fo_invoice_open_bill_cldbl
...
def fo_inv_openbill_listbl(bil_flag:int, bil_recid:int, room:string, vipflag:bool, fill_co:bool, double_currency:bool, foreign_rate:bool):
    abreise = None
    resname = ""
    ...
    def generate_output():
        nonlocal abreise, resname, res_exrate, zimmer_bezeich, kreditlimit, master_str, master_rechnr, bill_anzahl, queasy_char1, disp_warning, flag_report, rescomment, printed, rechnr, rmrate, balance, balance_foreign, tot_balance, t_res_line_data, t_bill_data, spbill_list_data, t_bill_line_data, bill, res_line, bill_line
    ...
    abreise, resname, res_exrate, zimmer_bezeich, kreditlimit, master_str, master_rechnr, bill_anzahl, queasy_char1, disp_warning, flag_report, t_res_line_data, t_bill_data = get_output(fo_invoice_open_bill_cldbl(bil_flag, bil_recid, room, vipflag))
