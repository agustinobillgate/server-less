...
def res_rmrate_view_repeat_chargebl(pvilanguage:int, user_init:string, reslin_list_data:[Reslin_list]):
    ...
    def disp_query():
        ...
        for reslin_queasy in db_session.query(Reslin_queasy).filter(
            ...
            if periode_list:
                ...
                q2_reslin_queasy = query(q2_reslin_queasy_data, filters=(lambda q2_reslin_queasy: q2_reslin_queasy.date1 == periode_list.periode1 and q2_reslin_queasy.date2 == periode_list.periode2), first=True)
