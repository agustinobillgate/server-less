...
def rm_drecap2bl(pvilanguage:int, opening_date:date, from_date:date, to_date:date, fdate:date, tdate:date, segmtype_exist:bool, mi_mtd_chk:bool, mi_ftd_chk:bool, mi_exchu_chk:bool, mi_exccomp_chk:bool, long_digit:bool):
    ...
    cl_list_data, Cl_list = create_model("Cl_list", {"flag":string, "segm":int, "betriebsnr":int, "compli":bool, "bezeich":string, "droom":int, "proz1":Decimal, "mroom":int, "proz2":Decimal, "dpax":int, "mpax":int, "drate":Decimal, "mrate":Decimal, "drev":Decimal, "mrev":Decimal, "yroom":int, "proz3":Decimal, "ypax":int, "yrate":Decimal, "yrev":Decimal})
