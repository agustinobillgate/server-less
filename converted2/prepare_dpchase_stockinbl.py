...
def prepare_dpchase_stockinbl():
    ...
    q2_list_data, Q2_list = create_model("Q2_list", {"docu_nr":string, "lief_nr":int, "loeschflag":int, "lscheinnr":string, "lager_nr":int, "artnr":int, "bezeich":string, "einzelpreis":Decimal, "anzahl":Decimal, "warenwert":Decimal, "firma":string, "datum":date})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal billdate, heute, beg_date, q2_list_data, htparam, l_lieferant, l_artikel, l_op, queasy


        nonlocal q2_list
        nonlocal q2_list_data

        return {"billdate": billdate, "heute": heute, "beg_date": beg_date, "q2-list": q2_list_data}
