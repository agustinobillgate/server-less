...
def pj_depart_4bl(pvilanguage:int, case_type:int, disptype:int, curr_date:date, froom:string, troom:string, disp_accompany:bool, setup_list_data:[Setup_list], zikat_list_data:[Zikat_list]):
