...
def gcf_history_1bl(gastnr:int, fdate:date, tdate:date):
    ...
    ghistory_data, Ghistory = create_model_like(History, {"hname":string, "gname":string, "address":string, "s_recid":int})
    ...
    def generate_output():
        nonlocal ghistory_data, summ_list_data, htl_name, history, paramtext
