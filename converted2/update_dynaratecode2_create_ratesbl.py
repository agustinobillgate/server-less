...
def update_dynaratecode2_create_ratesbl(dynarate_list_data:[Dynarate_list], rmtype:string, currcode:string, from_date:date, to_date:date, market_number:int):
    ...
    def generate_output():
        nonlocal rate_list1_data, curr_date, i, curr_i, w_day, inp_zikatnr, wd_array, zimkateg, ratecode, queasy
