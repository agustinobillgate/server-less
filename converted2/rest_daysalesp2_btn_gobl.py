...
def rest_daysalesp2_btn_gobl(bline_list_data:[Bline_list], disc_art1:int, disc_art2:int, disc_art3:int, curr_dept:int, all_user:bool, shift:int, from_date:date, to_date:date, art_str:string, voucher_art:int, zero_vat_compli:bool, show_fbodisc:bool):
    ...
    def generate_output():
        ...
        nonlocal other_art_data, temp_data, t_tot_betrag_data, t_nt_betrag_data, outstand_list_data, pay_list_data, turnover_data
    ...
    def daysale_list1():
        ...
        if zero_vat_compli:
            ...
            for tlist in query(tlist_data, filters=(lambda tlist: tlist.comp)):
    ...
    if turnover:
        ...
        turnover = query(turnover_data, filters=(lambda turnover: turnover.rechnr.lower()  == ("G-Total").lower()), first=True)
