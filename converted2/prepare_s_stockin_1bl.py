...
def prepare_s_stockin_1bl():
    ...
    def generate_output():
        nonlocal f_endkum, b_endkum, m_endkum, billdate, fb_closedate, m_closedate, last_mdate, last_fbdate, fl_code1, fl_code2, ci_date, t_l_lager_data, temp_bediener_data, l_lager, bediener, htparam


        nonlocal t_l_lager, temp_bediener
        nonlocal t_l_lager_data, temp_bediener_data

        return {"f_endkum": f_endkum, "b_endkum": b_endkum, "m_endkum": m_endkum, "billdate": billdate, "fb_closedate": fb_closedate, "m_closedate": m_closedate, "last_mdate": last_mdate, "last_fbdate": last_fbdate, "fl_code1": fl_code1, "fl_code2": fl_code2, "ci_date": ci_date, "t-l-lager": t_l_lager_data, "temp-bediener": temp_bediener_data}
