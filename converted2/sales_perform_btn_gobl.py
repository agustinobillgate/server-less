...
def sales_perform_btn_gobl(from_date:string, to_date:string, usr_init:string):
    ...
    def check_budget():
        ...
        nonlocal its_ok, slist_data, usr_grp, slist_generated, htparam, bediener, salesbud, salestat, genstat, guest, h_bill, h_artikel, artikel, h_bill_line
        nonlocal from_date, to_date, usr_init
