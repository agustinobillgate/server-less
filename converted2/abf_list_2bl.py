...
def abf_list_2bl(fdate:date, bfast_artnr:int, bfast_dept:int, zikat_list_data:[Zikat_list]):
    ...
    def generate_output():
        nonlocal abf_list_data, mxtime_dayuse, param_561, htparam, res_line, arrangement, artikel, argt_line, reslin_queasy, fixleist, guest, reservation, segment, ratecode, bill, master
