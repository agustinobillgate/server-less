...
def prepare_cancel_stockinbl():
    ...
    def generate_output():
        nonlocal show_price, t_l_lager_data, t_l_hauptgrp_data, l_lager, l_hauptgrp


        nonlocal t_l_lager, t_l_hauptgrp
        nonlocal t_l_lager_data, t_l_hauptgrp_data

        return {"show_price": show_price, "t-l-lager": t_l_lager_data, "t-l-hauptgrp": t_l_hauptgrp_data}
