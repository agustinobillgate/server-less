...
def sls_bystatus_btn_go_listbl(pvilanguage:int, next_date:date, to_date:date, all_flag:bool, usr_init:string):
    ...
    def fill_status():
        ...
        for p_list in query(p_list_data):
            ...
            slstatus_list_data.append(slstatus_list)
