...
def prepare_hk_statadminbl(zinr:string, floor:int, dispsort:int, statsort:int):
    ...
    def generate_output():
        nonlocal ci_date, z_list_data, om_list_data, bline_list_data, setup_list_data, t_zimkateg_data, zimkateg, htparam, zimmer, res_line, outorder, paramtext
        nonlocal zinr, floor, dispsort, statsort


        nonlocal t_zimkateg, z_list, om_list, bline_list, setup_list
        nonlocal t_zimkateg_data, z_list_data, om_list_data, bline_list_data, setup_list_data
