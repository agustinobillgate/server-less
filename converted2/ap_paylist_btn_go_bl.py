...
def ap_paylist_btn_go_bl(all_supp:bool, remark_flag:bool, from_supp:string, from_date:date, to_date:date, from_remark:string, price_decimal:int):
    ...
    def create_list1():
        ...
        for l_kredit.bemerk, l_kredit.zahlkonto, l_kredit.saldo, l_kredit._recid, l_kredit.bediener_nr, l_kredit.rgdatum, debt.bemerk, debt.zahlkonto, debt.saldo, debt._recid, debt.bediener_nr, debt.rgdatum, art.artnr, art.bezeich, art._recid, l_lieferant.firma, l_lieferant.anredefirma, l_lieferant.lief_nr, l_lieferant._recid in db_session.query(L_kredit.bemerk, L_kredit.zahlkonto, L_kredit.saldo, L_kredit._recid, L_kredit.bediener_nr, L_kredit.rgdatum, Debt.bemerk, Debt.zahlkonto, Debt.saldo, Debt._recid, Debt.bediener_nr, Debt.rgdatum, Art.artnr, Art.bezeich, Art._recid, L_lieferant.firma, L_lieferant.anredefirma, L_lieferant.lief_nr, L_lieferant._recid).join(Debt,(Debt.counter == L_kredit.counter) & (Debt.zahlkonto == 0)).join(Art,(Art.artnr == L_kredit.zahlkonto) & (Art.departement == 0)).join(L_lieferant,(L_lieferant.lief_nr == L_kredit.lief_nr)).filter(
    ...
    def create_list2():
        ...
        debt = L_kredit()
        art = Artikel()
        for l_kredit.bemerk, l_kredit.zahlkonto, l_kredit.saldo, l_kredit._recid, l_kredit.bediener_nr, l_kredit.rgdatum, debt.bemerk, debt.zahlkonto, debt.saldo, debt._recid, debt.bediener_nr, debt.rgdatum, art.artnr, art.bezeich, art._recid in db_session.query(L_kredit.bemerk, L_kredit.zahlkonto, L_kredit.saldo, L_kredit._recid, L_kredit.bediener_nr, L_kredit.rgdatum, Debt.bemerk, Debt.zahlkonto, Debt.saldo, Debt._recid, Debt.bediener_nr, Debt.rgdatum, Art.artnr, Art.bezeich, Art._recid).join(Debt,(Debt.counter == L_kredit.counter) & (Debt.zahlkonto == 0)).join(Art,(Art.artnr == L_kredit.zahlkonto) & (Art.departement == 0)).filter(
