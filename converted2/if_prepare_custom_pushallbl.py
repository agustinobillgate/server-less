...
def if_prepare_custom_pushallbl(becode:int):
    ...
    def generate_output():
        nonlocal t_list_data, t_push_list_data, date_110, i, str, queasy, htparam
        nonlocal becode


        nonlocal t_list, t_push_list
        nonlocal t_list_data, t_push_list_data

        return {"t-list": t_list_data, "t-push-list": t_push_list_data, "date_110": date_110}
