...
def mk_resline_leave_zipreisbl(from_date:date, to_date:date, r_arrangement:string, r_betriebsnr:int, local_nr:int, price_decimal:int, rmcat:int):
    ...
    t_list_data, T_list = create_model("T_list", {"datum":date, "avail_katpreis":bool})
    ...
    def generate_output():
        nonlocal wrong_price, exrate1, exrate2, t_list_data, datum, tol_value, wd_array, htparam, arrangement, waehrung, katpreis
        ...
        return {"wrong_price": wrong_price, "exrate1": exrate1, "exrate2": exrate2, "t-list": t_list_data}
