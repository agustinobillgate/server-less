...
def s_stockiss_load_l_artikelbl(icase:int, a_artnr:int, a_bezeich:string):
    ...
    temp_l_artikel_data, Temp_l_artikel = create_model("Temp_l_artikel", {"fibukonto":string, "bezeich":string, "ek_aktuell":Decimal, "artnr":int, "traubensort":string, "lief_einheit":Decimal, "masseinheit":string, "betriebsnr":int, "alkoholgrad":Decimal})
