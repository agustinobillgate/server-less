...
def gl_linkar_load_databl(pvilanguage:int, merge_flag:bool, from_date:date, to_date:date, user_init:string, refno:string):
    ...
    def generate_output():
        nonlocal curr_anz, msg_str, g_list_data, s_list_data, acct_error, debit1, credit1, remain1, art_artnr, art_bezeich, lvcarea
        ...
        return {"curr_anz": curr_anz, "msg_str": msg_str, "g-list": g_list_data, "s-list": s_list_data}

    curr_anz, acct_error, debit1, credit1, remain1, g_list_data, s_list_data, art_artnr, art_bezeich = get_output(gl_linkarbl(merge_flag, from_date, to_date, user_init, refno, curr_anz))
