...
def prepare_rest_daysalesp1bl():
    ...
    def generate_output():
        nonlocal disc_art1, disc_art2, disc_art3, exchg_rate, curr_local, curr_foreign, serv_taxable, dpt_str, art_str, oth_str, anzahl, curr_dept, dept_name, voucher_art, use_voucher, from_date, to_date, htl_dept_dptnr, err_flag, p_110, p_240, buf_art_data, htl_dept_data, usr1_data, f_cash, i, str_tmp, artnr_list, show_option, hoteldpt, kellner, htparam, waehrung, artikel, h_artikel


        nonlocal htl_dept, t_hoteldpt, buf_art, usr1
        nonlocal htl_dept_data, t_hoteldpt_data, buf_art_data, usr1_data

        return {"disc_art1": disc_art1, "disc_art2": disc_art2, "disc_art3": disc_art3, "exchg_rate": exchg_rate, "curr_local": curr_local, "curr_foreign": curr_foreign, "serv_taxable": serv_taxable, "dpt_str": dpt_str, "art_str": art_str, "oth_str": oth_str, "anzahl": anzahl, "curr_dept": curr_dept, "dept_name": dept_name, "voucher_art": voucher_art, "use_voucher": use_voucher, "from_date": from_date, "to_date": to_date, "htl_dept_dptnr": htl_dept_dptnr, "err_flag": err_flag, "p_110": p_110, "p_240": p_240, "buf-art": buf_art_data, "htl-dept": htl_dept_data, "usr1": usr1_data}
