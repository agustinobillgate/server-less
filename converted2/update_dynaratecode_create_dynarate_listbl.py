...
def update_dynaratecode_create_dynarate_listbl(prcode:string):
    ...
    def generate_output():
        nonlocal currency, market, market_number, avail_queasy, avail_prmarket, dynarate_list_data, iftask, mestoken, mesvalue, tokcounter, ratecode, queasy, prmarket
        nonlocal prcode
