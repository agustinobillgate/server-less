...
def fb_cost_enable_uibl(sorttype:int, dept:int, price_type:int):
    ...
    def generate_output():
        nonlocal d_bezeich, double_currency, exchg_rate, amount, grid_list_data, hoteldpt, htparam, waehrung
        ...
        return {"d_bezeich": d_bezeich, "double_currency": double_currency, "exchg_rate": exchg_rate, "amount": amount, "grid-list": grid_list_data}
    ...
    amount, grid_list_data = get_output(fb_cost_fill_grid_listbl(double_currency, sorttype, dept, exchg_rate, price_type))
