...
def if_custom_pushall_ratebl(currcode:string, start_counter:int, inp_str:string, fdate:date, tdate:date, adult:int, child:int, becode:int, temp_list_data:[Temp_list]):
    ...
    def generate_output():
        ...
        nonlocal dynarate_list_data, r_list_data, s_list_data, rate_list_data, push_rate_list_data, change_room_data, bratecode_data, t_zimkateg_data, t_waehrung_data, t_arrangement_data, t_queasy_data, bqueasy_data, t_qsy18_data, t_qsy145_data, t_qsy152_data, q_curr_data, t_qsy171_data
    ...
    for t_qsy171 in query(t_qsy171_data, filters=(lambda t_qsy171: t_qsy171.char1 == "")):
    ...
    for rate_list in query(rate_list_data, filters=(lambda rate_list: rate_list.startperiode >= fdate and rate_list.endperiode <= tdate)):
