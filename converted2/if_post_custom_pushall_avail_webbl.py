...
def if_post_custom_pushall_avail_webbl(t_list_data:[T_list], t_push_list_data:[T_push_list], user_init:string, cur_type:string, from_date:date, to_date:date, bookengid:int):
    v_success = False
    error_msg = ""
    do_it:bool = False
    ...
    def read_param(t_list_data:[T_list]):
