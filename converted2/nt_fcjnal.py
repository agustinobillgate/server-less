        ...
        for hoteldpt in db_session.query(Hoteldpt).filter(
            ...
            if billjournal:
                ...
                for billjournal in db_session.query(Billjournal).filter(
                    ...
                    if not long_digit:
                        line = to_string(billjournal.zinr) + " " + to_string(billjournal.rechnr, ">,>>>,>>9") + " " + to_string(billjournal.artnr, ">>>>9") + " " + to_string(billjournal.anzahl, "->>9") + " " + to_string(billjournal.bezeich, "x(23)") + " " + to_string(billjournal.betrag, "->>,>>>,>>9.99") + " " + to_string(billjournal.stornogrund, "x(24)") + " " + to_string(zeit, "HH:MM") + " " + to_string(billjournal.userinit, "x(2)")
                    else:
                        line = to_string(billjournal.zinr) + " " + to_string(billjournal.rechnr, ">,>>>,>>9") + " " + to_string(billjournal.artnr, ">>>>9") + " " + to_string(billjournal.anzahl, "->>9") + " " + to_string(billjournal.bezeich, "x(23)") + " " + to_string(billjournal.betrag, "->,>>>,>>>,>>9") + " " + to_string(billjournal.stornogrund, "x(24)") + " " + to_string(zeit, "HH:MM") + " " + to_string(billjournal.userinit, "x(2)")
                    add_line(line)
