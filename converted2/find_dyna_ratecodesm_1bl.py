...
def find_dyna_ratecodesm_1bl(gastno:int, datum:date, rmtype:str, adult:int, child:int, rmrate:decimal, dynacode:str, argtno:int):
    statcode = ""
    markno = 0
    wahrno = 0
    room_occ = 0
    ...
    def generate_output():
        ...
        return {"statcode": statcode, "argtno": argtno, "markno": markno, "wahrno": wahrno, "room_occ": room_occ}
