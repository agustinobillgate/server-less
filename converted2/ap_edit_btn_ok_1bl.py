...
def ap_edit_btn_ok_1bl(t_l_kredit_data:[T_l_kredit], recid_ap:int, orig_liefnr:int, lief_nr:int, firma:string, user_init:string):
    ...
    if l_kredit:
        ...
        if subuff:
            ...
            if supplier:
                ...
                t_l_kredit = query(t_l_kredit_data, first=True)
