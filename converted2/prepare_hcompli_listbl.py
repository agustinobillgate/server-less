...
def prepare_hcompli_listbl():
    ...
    def generate_output():
        nonlocal from_dept, to_dept, billdate, avail_queasy, min_dept, max_dept, depname1, depname2, double_currency, exchg_rate, foreign_nr, min_art, max_art, from_art, to_art, t_hoteldpt_data, ldry, dstore, hoteldpt, htparam, queasy, waehrung


        nonlocal t_hoteldpt
        nonlocal t_hoteldpt_data

        return {"from_dept": from_dept, "to_dept": to_dept, "billdate": billdate, "avail_queasy": avail_queasy, "min_dept": min_dept, "max_dept": max_dept, "depname1": depname1, "depname2": depname2, "double_currency": double_currency, "exchg_rate": exchg_rate, "foreign_nr": foreign_nr, "min_art": min_art, "max_art": max_art, "from_art": from_art, "to_art": to_art, "t-hoteldpt": t_hoteldpt_data}
