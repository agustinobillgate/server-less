...
def prepare_print_gcpi1abl(docu_nr:string, user_init:string, printer_nr:int):
    ...
    output_list_data, Output_list = create_model("Output_list", {"docu_nr":string, "chequeno":string, "pay_datum":date, "username":string, "duedate":date, "bemerk":string, "betrag":Decimal, "path":string})
    ...
    def generate_output():
        nonlocal output_list_data, bediener, gc_pi, gc_pitype, printer
