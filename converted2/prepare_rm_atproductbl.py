...
def prepare_rm_atproductbl():
    ...
    def generate_output():
        nonlocal ci_date, to_date, fdate, tdate, p_143, t_bediener_data, bediener, htparam


        nonlocal t_bediener
        nonlocal t_bediener_data

        return {"ci_date": ci_date, "to_date": to_date, "fdate": fdate, "tdate": tdate, "p_143": p_143, "t-bediener": t_bediener_data}
