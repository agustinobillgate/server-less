...
def hk_roomplan_disp_resdatabl(i:int, curr_date:date, zinr:string, gstatus:int, recid1:int):
    ...
    def generate_output():
        nonlocal n_edit, c_edit, fgcol_n, fgcol_c, t_res_line_data, res_line, reservation, outorder
        ...
        return {"n_edit": n_edit, "c_edit": c_edit, "fgcol_n": fgcol_n, "fgcol_c": fgcol_c, "t-res-line": t_res_line_data}
