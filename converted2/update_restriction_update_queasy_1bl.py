...
from models import Queasy, Htparam, Zimkateg, Guest_pr, Bediener, Res_history
...
def update_restriction_update_queasy_1bl(from_date:date, to_date:date, inp_str:string, rmtype:string, ota:string, restriction:int, flag:int):
    ...
    prepare_cache ([Queasy, Htparam, Zimkateg, Guest_pr, Bediener, Res_history])
    ...
    str:string = ""
    progavail:string = ""
    queasy = htparam = zimkateg = guest_pr = bediener = res_history = None
    ...
    def generate_output():
        ...
        nonlocal room_list_data, rcode_list_data
    ...
    def create_new_queasy(rate_code:string, roomno:int):
        ...
        nonlocal i, cat_flag, datum, ci_date, otanr, rcode, user_init, stat, str, progavail, queasy, htparam, zimkateg, guest_pr, bediener, res_history
        nonlocal from_date, to_date, inp_str, rmtype, ota, restriction, flag
        nonlocal qsy, buffqsy, qsy160, checkqsy
