...
def check_htl_name_adminbl():
    ...
    t_list_data, T_list = create_model("T_list", {"htl_name":string, "htl_adr1":string, "htl_adr2":string, "htl_adr3":string, "htl_tel":string, "htl_fax":string, "htl_email":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal flag, t_list_data, htparam, paramtext


        nonlocal t_list
        nonlocal t_list_data

        return {"flag": flag, "t-list": t_list_data}
