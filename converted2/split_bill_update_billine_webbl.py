...
def split_bill_update_billine_webbl(pvilanguage:int, j:int, recid_array:[int]):
    ...
    t_bline3_data = []
    t_bline4_data = []
    lvcarea:string = "split-bill-update-billine-webbl"
    ...
    def generate_output():
        nonlocal balance1, balance2, balance3, balance4, bcol1, bcol2, bcol3, bcol4, t_bline1_data, t_bline2_data, t_bline3_data, t_bline4_data, lvcarea, bill, guest, htparam, bill_line
        nonlocal pvilanguage, j, recid_array


        nonlocal spbill_list, bill1, t_guest, t_htparam, t_bline1, t_bline2, t_bline3, t_bline4
        nonlocal spbill_list_data, bill1_data, t_guest_data, t_htparam_data, t_bline1_data, t_bline2_data, t_bline3_data, t_bline4_data

        return {"balance1": balance1, "balance2": balance2, "balance3": balance3, "balance4": balance4, "bcol1": bcol1, "bcol2": bcol2, "bcol3": bcol3, "bcol4": bcol4, "t-bline1": t_bline1_data, "t-bline2": t_bline2_data, "t-bline3": t_bline3_data, "t-bline4": t_bline4_data}

    def update_browse(j:int):

        nonlocal balance1, balance2, balance3, balance4, bcol1, bcol2, bcol3, bcol4, t_bline1_data, t_bline2_data, t_bline3_data, t_bline4_data, lvcarea, bill, guest, htparam, bill_line
        nonlocal pvilanguage, recid_array
        ...
        if (recid_array[j - 1] != 0):
            bill1_data = get_output(read_bill1bl(5, recid_array[j - 1], None, None, None, None, None, None, None, None))
            ...
            if j == 1 and bill1.rechnr != 0:
                t_bline1_data = get_output(read_bill_line1bl(3, pvilanguage, bill1.rechnr, None, None, None, None, None))
                balance1 =  to_decimal(bill1.saldo)
