...
def rmrev_bdown_create_billbalance_2bl(exc_taxserv:bool, pvilanguage:int, new_contrate:bool, foreign_rate:bool, price_decimal:int, curr_date:date):
    ...
    def generate_output():
        nonlocal msg_str, msg_warning, cl_list_data, currency_list_data, sum_list_data, s_list_data, exchg_rate, frate, post_it, total_rev, rm_rate, lvcarea, waehrung, guest, artikel, htparam, zimmer, res_line, arrangement, reservation, bill, reslin_queasy, guest_pr, pricecod, argt_line, fixleist
        ...
        nonlocal sum_list_data, currency_list_data, cl_list_data, s_list_data

        return {"msg_str": msg_str, "msg_warning": msg_warning, "cl-list": cl_list_data, "currency-list": currency_list_data, "sum-list": sum_list_data, "s-list": s_list_data}
