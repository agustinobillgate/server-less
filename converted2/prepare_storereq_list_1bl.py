...
def prepare_storereq_list_1bl():
    ...
    t_l_untergrup_data, T_l_untergrup = create_model("T_l_untergrup", {"zwkum":int, "bezeich":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal billdate, from_date, to_date, show_price, p_224, p_221, t_l_lager_data, t_l_hauptgrp_data, t_l_untergrup_data, htparam, l_lager, l_hauptgrp, l_untergrup


        nonlocal t_l_lager, t_l_hauptgrp, t_l_untergrup
        nonlocal t_l_lager_data, t_l_hauptgrp_data, t_l_untergrup_data

        return {"billdate": billdate, "from_date": from_date, "to_date": to_date, "show_price": show_price, "p_224": p_224, "p_221": p_221, "t-l-lager": t_l_lager_data, "t-l-hauptgrp": t_l_hauptgrp_data, "t-l-untergrup": t_l_untergrup_data}
