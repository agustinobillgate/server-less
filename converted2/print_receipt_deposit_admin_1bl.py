...
def print_receipt_deposit_admin_1bl(resnr:int, printer_nr:int):
    ...
    def generate_output():
        nonlocal curr_local, ch, ch1, secondpay, string_guest, string_reslinename, string_deposit, balance, voucher_no, ci_date, co_date, rmno, t_printer_data, printer, waehrung, htparam, reservation, artikel, guest, res_line, debitor
        ...
        return {"curr_local": curr_local, "ch": ch, "ch1": ch1, "secondpay": secondpay, "string_guest": string_guest, "string_reslinename": string_reslinename, "string_deposit": string_deposit, "balance": balance, "voucher_no": voucher_no, "ci_date": ci_date, "co_date": co_date, "rmno": rmno, "t-printer": t_printer_data}
