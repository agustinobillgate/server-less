...
def prepare_mk_pobl(docu_nr:string, pvilanguage:int, lief_nr:int, pr_deptnr:int, po_type:int, potype:int, bediener_username:string, ordername_screen_value:string, crterm:int):
    ...
    def generate_output():
        nonlocal local_nr, billdate, zeroprice_flag, deptname, supplier, curr_liefnr, p_222, p_234, p_266, pos, t_amount, currency_add_first, currency_screen_value, msg_str, p_1093, p_464, p_220, disc_list_data, t_waehrung_data, t_l_order_data, t_l_orderhdr_data, t_parameters_data, lvcarea, l_order, l_orderhdr, htparam, waehrung, l_lieferant, parameters, l_artikel
