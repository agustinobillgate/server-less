...
def prepare_print_gcpi1bbl(docu_nr:string, user_init:string, printer_nr:int):
    ...
    output_list_data, Output_list = create_model("Output_list", {"docu_nr":string, "chequeno":string, "pay_datum":date, "username":string, "duedate":date, "bemerk":string, "betrag":Decimal, "path":string, "amount_array":[Decimal,10], "bez_array":[string,10], "amtreturn":Decimal, "grand_tot":Decimal})
    ...
    def generate_output():
        nonlocal output_list_data, i, bediener, gc_pi, gc_pitype, printer
