...
def fo_wordadminbl():
    ...
    def generate_output():
        nonlocal kateg, kategbezeich, briefnr, t_brief_data, brief, htparam, paramtext, guestbook


        nonlocal t_brief
        nonlocal t_brief_data

        return {"kateg": kateg, "kategbezeich": kategbezeich, "briefnr": briefnr, "t-brief": t_brief_data}
