...
def prepare_ts_biltransferbl(h_recid:int):
    ...
    def generate_output():
        nonlocal multi_vat, dept, splitted, t_h_bill_data, h_bill, htparam, h_bill_line
        nonlocal h_recid
        ...
        return {"multi_vat": multi_vat, "dept": dept, "splitted": splitted, "t-h-bill": t_h_bill_data}
