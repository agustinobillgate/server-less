...
def mk_resline_contcodebl(contcode:string):
    ...
    def generate_output():
        nonlocal currency, currency_nr, t_queasy_data, t_ratecode_data, t_prmarket_data, iftask, statcode, mestoken, mesvalue, tokcounter, dyna_flag, queasy, ratecode, prmarket, waehrung
        nonlocal contcode


        nonlocal t_queasy, t_ratecode, t_prmarket
        nonlocal t_queasy_data, t_ratecode_data, t_prmarket_data

        return {"currency": currency, "currency_nr": currency_nr, "t-queasy": t_queasy_data, "t-ratecode": t_ratecode_data, "t-prmarket": t_prmarket_data}
