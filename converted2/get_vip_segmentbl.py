...
def get_vip_segmentbl(inp_gastnr:int):
    ...
    def generate_output():
        nonlocal t_segment_data, segm_code, segm_bez, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, segment, guestseg
        nonlocal inp_gastnr
        ...
        return {"t-segment": t_segment_data, "segm_code": segm_code, "segm_bez": segm_bez}
