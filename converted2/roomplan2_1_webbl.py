...
def roomplan2_1_webbl(from_room:string, curr_date:date, ci_date:date):
    ...
    def generate_output():
        nonlocal do_it, to_date, t_res_line_data, t_res_line2_data, t_outorder_data, t_outorder1_data, room_list_data, t_res_line3_data, stat_list, a, item_fgcol, res_line, outorder, zimmer, zimkateg, history
        ...
        return {"do_it": do_it, "to_date": to_date, "t-res-line": t_res_line_data, "t-res-line2": t_res_line2_data, "t-outorder": t_outorder_data, "t-outorder1": t_outorder1_data, "room-list": room_list_data, "t-res-line3": t_res_line3_data}
