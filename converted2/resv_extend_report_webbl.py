...
def resv_extend_report_webbl(from_date:date, to_date:date):
    ...
    output_list_data, Output_list = create_model("Output_list", {"resdate":date, "zinr":string, "resnr":int, "guestname":string, "pax":int, "arrival":date, "olddepart":date, "newdepart":date, "customer":string, "ratecode":string})
    ...
    def generate_output():
        nonlocal output_list_data, oldetd, newetd, i, str, guest, res_line, reslin_queasy
