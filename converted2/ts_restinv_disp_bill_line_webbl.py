...
def ts_restinv_disp_bill_line_webbl(double_currency:bool, rechnr:int, curr_dept:int, avail_t_h_bill:bool):
    ...
    def generate_output():
        ...
        return {"t-h-bill-line": t_h_bill_line_data, "summary-bill": summary_bill_data, "t-h-artikel": t_h_artikel_data, "amount_bill": amount_bill}
