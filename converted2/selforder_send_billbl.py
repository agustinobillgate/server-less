...
def selforder_send_billbl(dept:int, session_parameter:string, guest_email:string, tableno:int):
    ...
    mess_result, user_name, dept_name, guest_name, pax, room, total_tax, total_service, total_price, total_payment, grandtotamount, sessionexpired, hold_payment, bill_number, payment_method, ordered_item_data = get_output(selforder_prepare_sendbillbl("01", dept, tableno, session_parameter))
    mess_result = ""
    ...
    while True:
        ...
        if matches(textbody,r"*$bgColor*"):
            ...
            for ordered_item in query(ordered_item_data, filters=(lambda ordered_item: ordered_item.article_type.lower()  == ("SALES").lower()  and ordered_item.subtotal != 0)):
            ...
            for ordered_item in query(ordered_item_data, filters=(lambda ordered_item: matches(ordered_item.article_type,r"*discount*"))):
            ...
            for ordered_item in query(ordered_item_data, filters=(lambda ordered_item: matches(ordered_item.article_type,r"*PAYMENT*"))):
            ...
            for ordered_item in query(ordered_item_data, filters=(lambda ordered_item: matches(ordered_item.article_type,r"*VOUCHER*"))):
