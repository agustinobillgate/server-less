...
def prepare_eg_propertybl(user_init:string):
    ...
    location_data, Location = create_model("Location", {"loc_nr":int, "loc_nm":string})
    ...
    def generate_output():
        nonlocal engid, groupid, maintask_data, location_data, t_eg_property_data, t_eg_location_data, queasy_133_data, t_zimmer_data, queasy, eg_property, eg_location, zimmer, htparam, bediener
        nonlocal user_init


        nonlocal queasy_133, maintask, location, t_eg_property, t_eg_location, t_zimmer
        nonlocal queasy_133_data, maintask_data, location_data, t_eg_property_data, t_eg_location_data, t_zimmer_data

        return {"engid": engid, "groupid": groupid, "Maintask": maintask_data, "Location": location_data, "t-eg-property": t_eg_property_data, "t-eg-location": t_eg_location_data, "queasy-133": queasy_133_data, "t-zimmer": t_zimmer_data}
