...
def na_start_get_info_webbl():
    ...
    plist_data, Plist = create_model("Plist", {"bezeich":string, "progres":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal na_done, plist_data, inpfile, lic_nr, search_txt, temp_char, queasy


        nonlocal plist
        nonlocal plist_data

        return {"na_done": na_done, "plist": plist_data}
