...
def prepare_ns_invbl(inp_rechnr:int, curr_department:int, combo_pf_file1:string, combo_pf_file2:string, combo_gastnr:int, combo_ledger:int):
    ...
    def generate_output():
        nonlocal f_foinv_data, t_bill_data, t_guest_data, golf_license, bill, guest, htparam, artikel, waehrung, brief, hoteldpt
        ...
        return {"f-foinv": f_foinv_data, "t-bill": t_bill_data, "t-guest": t_guest_data, "combo_pf_file1": combo_pf_file1, "combo_pf_file2": combo_pf_file2, "combo_gastnr": combo_gastnr, "combo_ledger": combo_ledger}
