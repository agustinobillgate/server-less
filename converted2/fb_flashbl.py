...
def fb_flashbl(pvilanguage:int, from_grp:int, food:int, bev:int, date1:date, date2:date, incl_initoh:bool):
    ...
    def generate_output():
        ...
        nonlocal pvilanguage, from_grp, food, bev, date1, date2, incl_initoh
