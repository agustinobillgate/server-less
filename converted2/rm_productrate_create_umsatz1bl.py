...
def rm_productrate_create_umsatz1bl(disptype:int, mi_ftd:bool, mi_cust:bool, f_date:date, t_date:date, to_date:date, cardtype:int, incl_comp:bool, sales_id:string):
    ...
    def generate_output():
        ...
        nonlocal to_list_data, output_list2_data

        return {"output-list2": output_list2_data, "to-list": to_list_data}
    ...
    def create_output():
        ...
        output_buff_data = output_list2_data
        ...
        for to_list in query(to_list_data, sort_by=[("ratecode",False),("name",False)]):
            ...
            output_buff = query(output_buff_data, filters=(lambda output_buff: output_buff.rate == to_list.ratecode), first=True)
