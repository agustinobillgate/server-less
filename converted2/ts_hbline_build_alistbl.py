...
def ts_hbline_build_alistbl(zero_flag:bool, dept:int, curr_zwkum:int, billdate:date):
    ...
    art_list_data, Art_list = create_model("Art_list", {"pos":int, "artnr":int, "bezeich":string, "epreis":Decimal, "item_bgcol":int, "item_fgcol":int}, {"item_bgcol": 2, "item_fgcol": 15})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal curr_apos, max_apos, art_list_data, fgcol_array, h_artikel
        ...
        return {"curr_apos": curr_apos, "max_apos": max_apos, "art-list": art_list_data}
