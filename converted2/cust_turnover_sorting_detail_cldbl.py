                        ...
                        if excl_other == False:
                            ...
                            for bill in db_session.query(Bill).filter(
                                ...
                                for bill_line, artikel in db_session.query(Bill_line, Artikel).join(Artikel,(Artikel.artnr == Bill_line.artnr) & (Artikel.departement == Bill_line.departement) & (Artikel.artart == 0)).filter(
                                    ...
                                    if currency != " ":
                                        cust_list_detail.sonst_umsatz = to_string(to_decimal(cust_list_detail.sonst_umsatz) + ((bill_line.betrag / (1 + service2 + vat2)) / exrate) , "->>>,>>>,>>>,>>9.99")
                                        cust_list_detail.gesamtumsatz = to_string(to_decimal(cust_list_detail.gesamtumsatz) + ((bill_line.betrag / (1 + service2 + vat2)) / exrate) , "->>>,>>>,>>>,>>9.99")
                ...
                if res_line:
                    ...
                    if cust_list_detail:
                        ...
                        for h_bill_line, h_artikel, artikel in db_session.query(H_bill_line, H_artikel, Artikel).join(H_artikel,(H_artikel.artnr == H_bill_line.artnr) & (H_artikel.departement == H_bill_line.departement)).join(Artikel,(Artikel.artnr == H_artikel.artnrfront) & (Artikel.departement == H_artikel.departement)).filter(
                            ...
                            if currency != " ":
                                cust_list_detail.f_b_umsatz = to_string(to_decimal(cust_list_detail.f_b_umsatz) + (((guest_queasy.deci1 + guest_queasy.deci2) / (1 + service2 + vat2)) / exrate) , "->>>,>>>,>>>,>>9.99")
                                cust_list_detail.sonst_umsatz = to_string(to_decimal(cust_list_detail.sonst_umsatz) + ((guest_queasy.deci3 / (1 + service2 + vat2)) / exrate) , "->>>,>>>,>>>,>>9.99")
                                cust_list_detail.gesamtumsatz = to_string(to_decimal(cust_list_detail.gesamtumsatz) + (((guest_queasy.deci1 + guest_queasy.deci2 +\
                                    guest_queasy.deci3) / (1 + service2 + vat2)) / exrate) , "->>>,>>>,>>>,>>9.99")
