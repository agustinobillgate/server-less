...
def prepare_selforder_articleadminbl(dept:string, case_type:int):
    ...
    def generate_output():
        nonlocal licensenr, t_article_data, t_dept_data, nr, paramtext, hoteldpt, h_artikel, queasy
        nonlocal dept, case_type


        nonlocal t_article, t_dept
        nonlocal t_article_data, t_dept_data

        return {"licensenr": licensenr, "t-article": t_article_data, "t-dept": t_dept_data}
