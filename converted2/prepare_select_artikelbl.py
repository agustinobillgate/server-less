...
def prepare_select_artikelbl(veran_nr:int, veran_seite:int, sub_group:int):
    ...
    def generate_output():
        nonlocal curr_date, bill_date, ba_dept, double_currency, foreign_rate, exchg_rate, art_list_data, bk_reser, htparam, waehrung, artikel, bk_rart
        nonlocal veran_nr, veran_seite, sub_group


        nonlocal art_list
        nonlocal art_list_data

        return {"curr_date": curr_date, "bill_date": bill_date, "ba_dept": ba_dept, "double_currency": double_currency, "foreign_rate": foreign_rate, "exchg_rate": exchg_rate, "art-list": art_list_data}
