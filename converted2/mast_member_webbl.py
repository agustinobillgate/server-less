...
def mast_member_webbl(resno:int, billno:int):
    ...
    b1_list_data, B1_list = create_model("B1_list", {"resnr":int, "reslinnr":int, "zinr":string, "name":string, "erwachs":int, "rechnr":int, "saldo":Decimal, "resstatus":int, "ankunft":date, "abreise":date, "gname":string, "gratis":int, "kind1":int, "kind2":int, "arrangement":string, "zipreis":Decimal, "wabkurz":string, "bill_name":string})
    ...
    def generate_output():
        nonlocal tot_adult, tot_room, b1_list_data, bill, res_line, waehrung, guest
