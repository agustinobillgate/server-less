...
def hk_change_room_status_webbl(pvilanguage:int, chgsort:int, user_init:string, room_list_data:[Room_list], remark:string):
    ...
    if chgsort != 4 and chgsort != 5:
        ...
        if flag == 6:
            ...
            if t_zistatus == 6:
                ...
                bline_list_data, om_list_data, curr_zinr, curr_stat, z_list_data = get_output(hk_statadmin_chg_zistatus_cldbl(bline_list_data, om_list_data, 0, ci_date, chgsort, "", user_init, bediener.nr, remark))
