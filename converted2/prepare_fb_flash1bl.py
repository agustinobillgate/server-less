...
def prepare_fb_flash1bl():
    ...
    def generate_output():
        nonlocal food, bev, date2, date1, bill_date, double_currency, foreign_nr, exchg_rate, t_l_lager_data, t_l_hauptgrp_data, l_lager, htparam, waehrung, l_hauptgrp


        nonlocal t_l_hauptgrp, t_l_lager
        nonlocal t_l_hauptgrp_data, t_l_lager_data

        return {"food": food, "bev": bev, "date2": date2, "date1": date1, "bill_date": bill_date, "double_currency": double_currency, "foreign_nr": foreign_nr, "exchg_rate": exchg_rate, "t-l-lager": t_l_lager_data, "t-l-hauptgrp": t_l_hauptgrp_data}
