...
def rmrev_bdown_create_billbalance1_1bl(exc_taxserv:bool, pvilanguage:int, new_contrate:bool, foreign_rate:bool, price_decimal:int, curr_date:date):
    ...
    def generate_output():
        nonlocal cl_list_data, currency_list_data, sum_list_data, s_list_data, exchg_rate, frate, post_it, total_rev, lvcarea, waehrung, guest, artikel, htparam, res_line, zimmer, genstat, arrangement, exrate, reservation, bill, argt_line, reslin_queasy, fixleist
        ...
        return {"cl-list": cl_list_data, "currency-list": currency_list_data, "sum-list": sum_list_data, "s-list": s_list_data}
    ...
    def get_genstat_argt_betrag(frate:Decimal, argt_betrag:Decimal):
        ...
        nonlocal cl_list_data, currency_list_data, sum_list_data, s_list_data, exchg_rate, post_it, total_rev, lvcarea, waehrung, guest, artikel, htparam, res_line, zimmer, genstat, arrangement, exrate, reservation, bill, argt_line, reslin_queasy, fixleist
        nonlocal exc_taxserv, pvilanguage, new_contrate, foreign_rate, price_decimal, curr_date
        nonlocal waehrung1, cc_list
