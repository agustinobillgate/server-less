...
def prepare_eg_propertymeterbl(user_init:string):
    ...
    def generate_output():
        nonlocal groupid, engid, msg, rec_meter_data, t_eg_property_data, eg_property, bediener, htparam, eg_propmeter
        nonlocal user_init


        nonlocal t_eg_property, rec_meter
        nonlocal t_eg_property_data, rec_meter_data

        return {"groupid": groupid, "engid": engid, "msg": msg, "rec-meter": rec_meter_data, "t-eg-property": t_eg_property_data}
