...
def prepare_eg_chgreq_webbl(pvilanguage:int, reqno:int, view_first:bool, user_init:string):
    ...
    def generate_output():
        nonlocal groupid, engid, source_str, dept_str, strproperty, main_str, categ_str, sub_str, usr_str, guestname, sguestflag, flag1, flag2, flag3, s_othersflag, subtask_bez, avail_eg_request, avail_eg_subtask, avail_subtask, t_fstat, svendor_data, request1_data, send_alert_data, tvendor_data, t_eg_location_data, treqdetail_data, t_eg_request_data, t_eg_property_data, t_queasy130_data, t_queasy_data, t_zimmer_data, lvcarea, alert_str, zimmer, queasy, eg_property, eg_request, eg_location, eg_subtask, res_line, guest, htparam, bediener, eg_vendor, eg_alert, eg_staff, eg_vperform, eg_action, eg_reqdetail
