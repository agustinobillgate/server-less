...
def s_stockin_l_artikelbl(s_artnr:int):
    ...
    temp_l_artikel1_data, Temp_l_artikel1 = create_model("Temp_l_artikel1", {"bezeich":string, "ek_aktuell":Decimal, "artnr":int, "traubensort":string, "lief_einheit":Decimal, "masseinheit":string, "betriebsnr":int, "alkoholgrad":Decimal})
