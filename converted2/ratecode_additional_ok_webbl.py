...
g_list_data, G_list = create_model("G_list", {"rcode":string})
t_queasy_data, T_queasy = create_model_like(Queasy)

def ratecode_additional_ok_webbl(g_list_data:[G_list], t_queasy_data:[T_queasy]):
    ...
    success_flag = get_output(write_queasybl(6, t_queasy_data, t_queasy_data))
