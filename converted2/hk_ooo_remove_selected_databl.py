    ...
    if case_type == 1:
        ...
        for ooo_list2 in query(ooo_list2_list, filters=(lambda ooo_list2: ooo_list2.selected_om)):
            ...
            outorder = db_session.query(Outorder).filter(
                     (Outorder.zinr == ooo_list2.zinr) & (Outorder.gespstart == ooo_list2.gespstart) & (Outorder.gespende == ooo_list2.gespende) & (Outorder.betriebsnr == ooo_list2.betriebsnr)).first()
