...
def nt_dashboard_dailybl(pick_date:date, exclude_article:str):
    his_res_list = []
    his_inv_list = []
    future_res_list = []
    future_inv_list = []
