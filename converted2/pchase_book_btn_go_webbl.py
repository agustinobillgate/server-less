...
def pchase_book_btn_go_webbl(sorttype:int, from_date:date, to_date:date, mtd_date:date, mi_ch:string, mi_all:bool, s_artnr:int):
    ...
    if not mi_all:
        ...
        if sorttype == 1:
            ...
            l_lieferant = L_lieferant()
            for l_pprice.bestelldatum, l_pprice.docu_nr, l_pprice.betriebsnr, l_pprice.anzahl, l_pprice.einzelpreis, l_pprice.warenwert, l_pprice.lief_nr, l_pprice.artnr, l_pprice._recid, l_art.traubensorte, l_art.lief_einheit, l_art.artnr, l_art.bezeich, l_art._recid, l_lieferant.firma, l_lieferant._recid in db_session.query(L_pprice.bestelldatum, L_pprice.docu_nr, L_pprice.betriebsnr, L_pprice.anzahl, L_pprice.einzelpreis, L_pprice.warenwert, L_pprice.lief_nr, L_pprice.artnr, L_pprice._recid, L_art.traubensorte, L_art.lief_einheit, L_art.artnr, L_art.bezeich, L_art._recid, L_lieferant.firma, L_lieferant._recid).join(L_art,(L_art.artnr == L_pprice.artnr)).join(L_lieferant,(L_lieferant.lief_nr == L_pprice.lief_nr)).filter(
                     (L_pprice.bestelldatum >= f_date) & (L_pprice.bestelldatum <= t_date)).order_by(L_pprice.bestelldatum.desc(), L_lieferant.firma, L_art.bezeich, L_pprice.einzelpreis).all():
                if l_pprice_obj_list.get(l_pprice._recid):
                    continue
                else:
                    l_pprice_obj_list[l_pprice._recid] = True
            ...
            l_lieferant = L_lieferant()
            for l_pprice.bestelldatum, l_pprice.docu_nr, l_pprice.betriebsnr, l_pprice.anzahl, l_pprice.einzelpreis, l_pprice.warenwert, l_pprice.lief_nr, l_pprice.artnr, l_pprice._recid, l_art.traubensorte, l_art.lief_einheit, l_art.artnr, l_art.bezeich, l_art._recid, l_lieferant.firma, l_lieferant._recid in db_session.query(L_pprice.bestelldatum, L_pprice.docu_nr, L_pprice.betriebsnr, L_pprice.anzahl, L_pprice.einzelpreis, L_pprice.warenwert, L_pprice.lief_nr, L_pprice.artnr, L_pprice._recid, L_art.traubensorte, L_art.lief_einheit, L_art.artnr, L_art.bezeich, L_art._recid, L_lieferant.firma, L_lieferant._recid).join(L_art,(L_art.artnr == L_pprice.artnr)).join(L_lieferant,(L_lieferant.lief_nr == L_pprice.lief_nr)).filter(
                     (L_pprice.bestelldatum >= f_date) & (L_pprice.bestelldatum <= t_date)).order_by(L_lieferant.firma, L_pprice.bestelldatum.desc(), L_art.bezeich, L_pprice.einzelpreis).all():
                if l_pprice_obj_list.get(l_pprice._recid):
                    continue
                else:
                    l_pprice_obj_list[l_pprice._recid] = True
            ...
            l_lieferant = L_lieferant()
            for l_pprice.bestelldatum, l_pprice.docu_nr, l_pprice.betriebsnr, l_pprice.anzahl, l_pprice.einzelpreis, l_pprice.warenwert, l_pprice.lief_nr, l_pprice.artnr, l_pprice._recid, l_art.traubensorte, l_art.lief_einheit, l_art.artnr, l_art.bezeich, l_art._recid, l_lieferant.firma, l_lieferant._recid in db_session.query(L_pprice.bestelldatum, L_pprice.docu_nr, L_pprice.betriebsnr, L_pprice.anzahl, L_pprice.einzelpreis, L_pprice.warenwert, L_pprice.lief_nr, L_pprice.artnr, L_pprice._recid, L_art.traubensorte, L_art.lief_einheit, L_art.artnr, L_art.bezeich, L_art._recid, L_lieferant.firma, L_lieferant._recid).join(L_art,(L_art.artnr == L_pprice.artnr)).join(L_lieferant,(L_lieferant.lief_nr == L_pprice.lief_nr)).filter(
                     (L_pprice.bestelldatum >= f_date) & (L_pprice.bestelldatum <= t_date)).order_by(L_pprice.einzelpreis, L_lieferant.firma, L_pprice.bestelldatum.desc(), L_art.bezeich).all():
                if l_pprice_obj_list.get(l_pprice._recid):
                    continue
                else:
                    l_pprice_obj_list[l_pprice._recid] = True
            ...
            l_lieferant = L_lieferant()
            for l_pprice.bestelldatum, l_pprice.docu_nr, l_pprice.betriebsnr, l_pprice.anzahl, l_pprice.einzelpreis, l_pprice.warenwert, l_pprice.lief_nr, l_pprice.artnr, l_pprice._recid, l_art.traubensorte, l_art.lief_einheit, l_art.artnr, l_art.bezeich, l_art._recid, l_lieferant.firma, l_lieferant._recid in db_session.query(L_pprice.bestelldatum, L_pprice.docu_nr, L_pprice.betriebsnr, L_pprice.anzahl, L_pprice.einzelpreis, L_pprice.warenwert, L_pprice.lief_nr, L_pprice.artnr, L_pprice._recid, L_art.traubensorte, L_art.lief_einheit, L_art.artnr, L_art.bezeich, L_art._recid, L_lieferant.firma, L_lieferant._recid).join(L_art,(L_art.artnr == L_pprice.artnr)).join(L_lieferant,(L_lieferant.lief_nr == L_pprice.lief_nr)).filter(
                     (L_pprice.bestelldatum >= f_date) & (L_pprice.bestelldatum <= t_date)).order_by(L_art.bezeich, L_lieferant.firma, L_pprice.bestelldatum.desc(), L_pprice.einzelpreis).all():
                if l_pprice_obj_list.get(l_pprice._recid):
                    continue
                else:
                    l_pprice_obj_list[l_pprice._recid] = True
