...
def hk_availextra(fdate:date, tdate:date, artnr:int, sorttype:int, language_code:int):
    ...
    tmp_extra_list, Tmp_extra = create_model("Tmp_extra", {"reihe":int, "typ_pos":str, "pos_from":str, "cdate":date, "room":str, "qty":int, "resnr":int})
    disp_table_list, Disp_table = create_model("Disp_table", {"reihe":int, "str_typ":str, "str1":str, "str2":str, "str3":str, "str5":str, "str6":str})
    ...
    def disp_detail():
        ...
        while ndate <= tdate :
            ...
            if not tmp_extra or not(tmp_extra.cdate == ndate):
            ...
            if tmp_extra:
                ...
                for tmp_extra in query(tmp_extra_list, filters=(lambda tmp_extra: tmp_extra.cdate == ndate), sort_by=[("reihe",False),("room",False)]):
                    ...
                    if not disp_table or not(disp_table.str1 == to_string(ndate , "99/99/9999") and disp_table.str2 == tmp_extra.room):
                    ...
                    if disp_table:
                        ...
                        disp_table.str6 = to_string(tmp_extra.resnr)
