...
def htp_admin_check_passwd_web_1bl(user_name:string, id_str:string, grp_no:int):
    ...
    def generate_output():
        nonlocal passwd_ok, epoch_signature, signature_list_data, fchar, pswd_str, nanci, s, i, licensenr, paramtext
        ...
        return {"passwd_ok": passwd_ok, "epoch_signature": epoch_signature, "signature-list": signature_list_data}

    def aufbau(i:int, ch:string):

        nonlocal passwd_ok, epoch_signature, signature_list_data, fchar, pswd_str, nanci, s, licensenr, paramtext
        nonlocal user_name, id_str, grp_no
    ...
    def decode_string(in_str:string):
        ...
        nonlocal passwd_ok, epoch_signature, signature_list_data, fchar, pswd_str, nanci, i, licensenr, paramtext
        nonlocal user_name, id_str, grp_no
