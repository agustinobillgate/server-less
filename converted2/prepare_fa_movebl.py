...
def prepare_fa_movebl(artnr:int):
    ...
    def generate_output():
        nonlocal mathis_name, fa_artikel_anzahl, mathis_location, t_fa_lager_data, fa_lager, mathis, fa_artikel
        nonlocal artnr
        ...
        return {"mathis_name": mathis_name, "fa_artikel_anzahl": fa_artikel_anzahl, "mathis_location": mathis_location, "t-fa-lager": t_fa_lager_data}
