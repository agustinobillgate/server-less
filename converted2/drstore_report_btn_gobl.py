...
def drstore_report_btn_gobl(usr_created:bool, dstore_dept:int, all_flag:bool, ekumnr:int, zknr1:int, zknr2:int, zknr3:int, zknr4:int, zknr5:int, zknr6:int, from_date:date, to_date:date, usr_init:string):
    ...
    s_list_data, S_list = create_model("S_list", {"zinr":string, "gname":string, "rechnr":int, "zknr":[int,6], "anzahl":[int,6], "amount":[Decimal,6], "tamount":Decimal, "tanz":int, "userinit":string})
    ...
    def generate_output():
        nonlocal exchg_rate, t_betrag, t_foreign, s_list_data, pay_list_data, h_journal, kellner, h_bill, bill, res_line, h_artikel, artikel, wgrpdep
        ...
        nonlocal s_list_data, pay_list_data, usr_list_data

        return {"exchg_rate": exchg_rate, "t_betrag": t_betrag, "t_foreign": t_foreign, "s-list": s_list_data, "pay-list": pay_list_data}
