...
def rm_productbyratebl(to_date:date):
    ...
    def generate_output():
        nonlocal tlist_data, s, curr_code, do_it, counter, tot_rmrev, tot_arr, tot_rmsold, tot_fbrev, tot_proz, tot_mrmrev, tot_marr, tot_mrmsold, tot_mfbrev, tot_mproz, tot_yrmrev, tot_yarr, tot_yrmsold, tot_yfbrev, tot_yproz, fdate, queasy, guest, genstat
        nonlocal to_date
        nonlocal bqueasy
