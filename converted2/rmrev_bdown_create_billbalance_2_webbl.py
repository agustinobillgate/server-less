...
def rmrev_bdown_create_billbalance_2_webbl(exc_taxserv:bool, pvilanguage:int, new_contrate:bool, foreign_rate:bool, price_decimal:int, curr_date:date):
    ...
    prepare_cache ([Waehrung, Guest, Artikel, Htparam, Zimmer, Res_line, Arrangement, Reservation, Bill, Segment, Reslin_queasy, Guest_pr, Pricecod, Argt_line, Fixleist])
    ...
    def generate_output():
        nonlocal msg_str, msg_warning, cl_list_data, currency_list_data, sum_list_data, s_list_data, exchg_rate, frate, post_it, total_rev, rm_rate, lvcarea, waehrung, guest, artikel, htparam, zimmer, res_line, arrangement, reservation, bill, segment, reslin_queasy, guest_pr, pricecod, argt_line, fixleist
