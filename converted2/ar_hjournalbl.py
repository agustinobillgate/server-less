...
def ar_hjournalbl(from_art:int, to_art:int, from_dept:int, to_dept:int, from_date:date, to_date:date):
        ...
        for hoteldpt in db_session.query(Hoteldpt).filter(
            ...
            for curr_date in date_range(from_date,to_date) :
                ...
                for h_journal in db_session.query(H_journal).filter(
                    ...
                    if not long_digit:
                        output_list.str = to_string(h_journal.bill_datum) + to_string(h_journal.tischnr, "9999") + to_string(h_journal.rechnr, "9,999,999") + to_string(h_journal.artnr, "99999") + to_string(h_journal.bezeich, "x(28)") + to_string(hoteldpt.depart, "x(12)") + to_string(h_journal.anzahl, "-9999") + to_string(h_journal.betrag, "->,>>>,>>>,>>9.99") + to_string(h_journal.zeit, "HH:MM:SS") + to_string(h_journal.kellner_nr, "999")
                    else:
                        output_list.str = to_string(h_journal.bill_datum) + to_string(h_journal.tischnr, "9999") + to_string(h_journal.rechnr, "9,999,999") + to_string(h_journal.artnr, "99999") + to_string(h_journal.bezeich, "x(28)") + to_string(hoteldpt.depart, "x(12)") + to_string(h_journal.anzahl, "-9999") + to_string(h_journal.betrag, " ->>>,>>>,>>>,>>9") + to_string(h_journal.zeit, "HH:MM:SS") + to_string(h_journal.kellner_nr, "999")
            ...
            if it_exist:
                ...
                if not long_digit:
                    output_list.str = to_string("", "x(54)") + to_string("T O T A L ", "x(12)") + to_string(qty, "-9999") + to_string(sub_tot, "->,>>>,>>>,>>9.99")
                else:
                    output_list.str = to_string("", "x(54)") + to_string("T O T A L ", "x(12)") + to_string(qty, "-9999") + to_string(sub_tot, " ->>>,>>>,>>>,>>9")
    ...
    if not long_digit:
        output_list.str = to_string("", "x(54)") + to_string("Grand TOTAL ", "x(12)") + to_string(0, "-9999") + to_string(tot, "->,>>>,>>>,>>9.99")
    else:
        output_list.str = to_string("", "x(54)") + to_string("Grand TOTAL ", "x(12)") + to_string(0, "-9999") + to_string(tot, " ->>>,>>>,>>>,>>9")
