...
def prepare_eg_vendorbl(user_init:string):
    ...
    t_eg_vendor_data, T_eg_vendor = create_model_like(Eg_vendor, {"rec_id":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal engid, groupid, t_eg_vendor_data, eg_vendor, htparam, bediener
        nonlocal user_init
        ...
        return {"engid": engid, "groupid": groupid, "t-eg-vendor": t_eg_vendor_data}
