...
def update_global_allotment_browsebl(pvilanguage:int, input_date:date, currcode:string, rmtype:string):
    ...
    def generate_output():
        nonlocal allot_list_data, lvcarea, curr_date, from_date, to_date, ci_date, kontline, zimkateg, zimmer, outorder, res_line
    ...
    def create_allot_list():
        ...
        nonlocal allot_list_data, lvcarea, curr_date, from_date, to_date, kontline, zimkateg, zimmer, outorder, res_line
        nonlocal pvilanguage, input_date, currcode, rmtype
    ...
    def create_browse():
        ...
        kline = None
        Abuff1 = Allot_list
        abuff1_data = allot_list_data
        Abuff2 = Allot_list
        abuff2_data = allot_list_data
        ...
        for allot_list in query(allot_list_data):
