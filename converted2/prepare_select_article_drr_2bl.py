...
def prepare_select_article_drr_2bl(case_type:int, nr:int):
    ...
    str_list_data, Str_list = create_model("Str_list", {"nr":int, "bezeich":string, "used":bool, "descr":string})
    stat_list_data, Stat_list = create_model("Stat_list", {"artnr":int, "used":bool, "descr":string, "zwkum":int, "flag":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal str2, str3, st1, st2, st3, st4, n, n1, n2, n3, n4, str_list_data, zwkum, queasy, artikel
        nonlocal case_type, nr


        nonlocal str_list, stat_list
        nonlocal str_list_data, stat_list_data
