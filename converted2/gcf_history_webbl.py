...
def gcf_history_webbl(gastnr:int, fdate:date, tdate:date, vkey:int, gastnr:int, fdate:date, tdate:date, vkey:int):
    ...
    def generate_output():
        nonlocal ghistory_data, summ_list_data, htl_name, str, i, ghistory_data, summ_list_data, htl_name, str, i, history, paramtext, res_line, guest
        ...
        return {"ghistory": ghistory_data, "summ-list": summ_list_data, "ghistory": ghistory_data, "summ-list": summ_list_data}
