...
def eg_mainscheduleed_propertynrbl(case_type:int, m_propertynr:int, h_location:int, h_zinr:string):
    ...
    def generate_output():
        nonlocal avail_eg_property, t_maintask, t_bezeich, t_queasy_data, queasy, eg_property
        ...
        return {"avail_eg_property": avail_eg_property, "t_maintask": t_maintask, "t_bezeich": t_bezeich, "t-queasy": t_queasy_data}
