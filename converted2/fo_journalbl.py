...
def fo_journalbl(from_art:int, to_art:int, from_dept:int, to_dept:int, from_date:date, to_date:date, sorttype:int, exclude_artrans:bool, long_digit:bool, foreign_flag:bool, mi_onlyjournal:bool, mi_excljournal:bool, mi_post:bool):
    ...
    def generate_output():
        nonlocal gtot, output_list_data, curr_date, descr1, voucher_no, ind, gdelimiter, roomnumber, zinrdate, billnumber, guest, artikel, hoteldpt, billjournal, bill, h_bill, bk_veran, reservation, res_line
    ...
    def journal_list():
        ...
        nonlocal gtot, output_list_data, descr1, voucher_no, ind, gdelimiter, roomnumber, zinrdate, billnumber, guest, artikel, hoteldpt, billjournal, bill, h_bill, bk_veran, reservation, res_line
        nonlocal from_art, to_art, from_dept, to_dept, from_date, to_date, sorttype, exclude_artrans, long_digit, foreign_flag, mi_onlyjournal, mi_excljournal, mi_post
