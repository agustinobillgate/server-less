...
def pr_list_disp_list_11bl(char1:string, billdate:date, from_date:date, to_date:date, outstand_flag:bool, expired_flag:bool, approve_flag:bool, reject_flag:bool, artnumber:int):
    ...
    def generate_output():
        ...
        nonlocal char1, billdate, from_date, to_date, outstand_flag, expired_flag, approve_flag, reject_flag, artnumber
