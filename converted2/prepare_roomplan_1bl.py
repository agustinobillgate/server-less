...
def prepare_roomplan_1bl(from_room:string):
    ...
    def generate_output():
        nonlocal to_date, curr_date, ci_date, do_it, t_res_line_data, t_res_line2_data, t_outorder_data, t_outorder1_data, room_list_data, t_res_line3_data, stat_list, a, res_line, outorder, htparam, zimmer, zimkateg, history
        nonlocal from_room
        ...
        return {"to_date": to_date, "curr_date": curr_date, "ci_date": ci_date, "do_it": do_it, "t-res-line": t_res_line_data, "t-res-line2": t_res_line2_data, "t-outorder": t_outorder_data, "t-outorder1": t_outorder1_data, "room-list": room_list_data, "t-res-line3": t_res_line3_data}
