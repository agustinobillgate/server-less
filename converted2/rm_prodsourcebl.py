...
def rm_prodsourcebl(source_name:string, ytd_flag:bool, incl_comp:bool, fr_date:date, to_date:date):
    ...
    output_list_data, Output_list = create_model("Output_list", {"gname":string, "flag":bool, "name":string, "dlodge":Decimal, "mlodge":Decimal, "ylodge":Decimal, "dnite":int, "mnite":int, "ynite":int, "drate":Decimal, "mrate":Decimal, "yrate":Decimal})
    ...
    def generate_output():
        nonlocal flag, output_list_data, tot_dlodge, tot_mlodge, tot_ylodge, tot_dnite, tot_mnite, tot_ynite, tot_drate, tot_mrate, tot_yrate, tot1_dlodge, tot1_mlodge, tot1_ylodge, tot1_dnite, tot1_mnite, tot1_ynite, tot1_drate, tot1_mrate, tot1_yrate, sourccod, guest, genstat
