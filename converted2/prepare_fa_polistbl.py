...
def prepare_fa_polistbl():
    ...
    def generate_output():
        ...
        return {"long_digit": long_digit, "billdate": billdate, "briefnr": briefnr, "p_464": p_464, "htl_name": htl_name, "htl_adr": htl_adr, "htl_tel": htl_tel, "cost-list": cost_list_data, "w-list": w_list_data, "username": username_data, "l-supp": l_supp_data}
