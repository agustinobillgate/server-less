...
def mk_sarticle_btn_gobl(pvilanguage:int, tt_artnr_data:[Tt_artnr], tt_content_data:[Tt_content], artnr:int, dml_art:bool, fibukonto:string, bez_aend:bool, s_unit:string, l_art_data:[L_art]):
