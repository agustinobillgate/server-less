...
sortir_list_data, Sortir_list = create_model("Sortir_list", {"from_date":date, "to_date":date, "location":int, "show_all":bool})

def prepare_fa_artlist_webbl(sortir_list_data:[Sortir_list]):
    ...
    def generate_output():
        nonlocal p_881, q1_list_data, fibu_list_data, sort_loc, fa_grup, fa_artikel, mathis, fa_lager, fa_kateg, gl_acct
        nonlocal bfa_grup
    ...
    sortir_list = query(sortir_list_data, first=True)
