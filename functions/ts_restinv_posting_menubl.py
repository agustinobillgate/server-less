...
def ts_restinv_posting_menubl(case_type:int, pvilanguage:int, tischnr:int, curr_dept:int, cancel_reason:string, double_currency:bool, exchg_rate:Decimal, price_decimal:int, transdate:date, foreign_rate:bool, deptname:string, cancel_order:bool, order_taker:int, curr_waiter:int, gname:string, pax:int, kreditlimit:Decimal, change_str:string, cc_comment:string, hoga_card:string, print_to_kitchen:bool, from_acct:bool, pay_type:int, guestnr:int, transfer_zinr:string, curedept_flag:bool, curr_room:string, user_init:string, hoga_resnr:int, hoga_reslinnr:int, incl_vat:bool, get_price:int, mc_str:string, tp_bediener_data:[Tp_bediener], submenu_list_data:[Submenu_list], cancel_flag:bool, menu_list_data:[Menu_list], t_h_bill_data:[T_h_bill]):
    ...
    def generate_output():
        ...
        nonlocal t_menu_list_data, bmenu_data, t_h_artikel_data, kellner1_data, t_submenu_list_data, tp_bediener1_data
