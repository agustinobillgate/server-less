...
def availability1bl(pvilanguage:int, printer_nr:int, call_from:int, txt_file:string, curr_date:date, incl_tentative:bool):
    ...
    def generate_output():
        nonlocal msg_str, room_list_data, sum_list_data, lnldelimeter, ttl_room, occ_room, ooo_room, anz_setup, tot_room, isetup_array, csetup_array, ci_date, datum, week_list, i, j, curr_day, lvcarea, res_line, zimkateg, htparam, artikel, fixleist, arrangement, reslin_queasy, paramtext, zimmer, kontline, outorder, guest
    ...
    def create_browse():
        ...
        nonlocal msg_str, room_list_data, sum_list_data, lnldelimeter, ttl_room, occ_room, ooo_room, anz_setup, tot_room, isetup_array, csetup_array, ci_date, week_list, j, curr_day, lvcarea, res_line, zimkateg, htparam, artikel, fixleist, arrangement, reslin_queasy, paramtext, zimmer, kontline, outorder, guest
        nonlocal pvilanguage, printer_nr, call_from, txt_file, curr_date, incl_tentative
        nonlocal zkbuff
