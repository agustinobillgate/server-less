...
def prepare_gl_linkcomplibl():
    ...
    def generate_output():
        nonlocal f_int, double_currency, foreign_nr, exchg_rate, last_acctdate, acct_date, close_year, gl_jouhdr_list_data, htparam, waehrung, gl_jouhdr


        nonlocal gl_jouhdr_list
        nonlocal gl_jouhdr_list_data

        return {"f_int": f_int, "double_currency": double_currency, "foreign_nr": foreign_nr, "exchg_rate": exchg_rate, "last_acctdate": last_acctdate, "acct_date": acct_date, "close_year": close_year, "gl-jouhdr-list": gl_jouhdr_list_data}
