...
def pj_arrive_create_browse1_webbl(tot_rm:int, tot_a:int, tot_c:int, tot_co:int, total_flag:bool, cl_list_data:[Cl_list], s_list_data:[S_list]):
    t_cl_list_data = []
    found:bool = False
    loopi:int = 0
    counter_str:string = ""
    ...
    def generate_output():
        nonlocal t_cl_list_data, found, loopi, counter_str, tot_troom, tot_trsv, tot_tadult, tot_tkind
        nonlocal tot_rm, tot_a, tot_c, tot_co, total_flag


        nonlocal s_list, t_list, cl_list, t_cl_list
        nonlocal t_list_data, t_cl_list_data
