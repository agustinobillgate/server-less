...
def prepare_slow_moving_1bl(lnl_prog:string):
    ...
    def generate_output():
        nonlocal lnl_filepath, show_price, t_l_lager_data, t_l_hauptgrp_data, t_l_untergrup_data, htparam, l_lager, l_hauptgrp, l_untergrup
        nonlocal lnl_prog
        ...
        return {"lnl_filepath": lnl_filepath, "show_price": show_price, "t-l-lager": t_l_lager_data, "t-l-hauptgrp": t_l_hauptgrp_data, "t-l-untergrup": t_l_untergrup_data}
