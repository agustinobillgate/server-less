...
def prepare_fa_stockinbl(ponum:string):
    ...
    def generate_output():
        nonlocal price_decimal, billdate, heute, todate, beg_date, q2_list_data, htparam, l_lieferant, mathis, fa_op
        nonlocal ponum
        ...
        return {"price_decimal": price_decimal, "billdate": billdate, "heute": heute, "todate": todate, "beg_date": beg_date, "q2-list": q2_list_data}
