...
def po_list_btn_print_web_1bl(case_type:int, all_supp:bool, stattype:int, deptno:int, from_date:date, to_date:date, billdate:date, disp_comm:bool, l_orderhdr_docu_nr:string, str4:string, l_supp_lief_nr:int, dml_only:bool, pr_only:bool, excl_dml_pr:bool):
    ...
    po_list_data, Po_list = create_model("Po_list", {"bestelldatum":date, "bezeich":string, "firma":string, "docu_nr":string, "odrhdr_lieferdatum":date, "bestellart":string, "besteller":string, "lief_fax2":string, "order1_lieferdatum":date, "lief_fax3":string, "lieferdatum_eff":date, "rechnungswert":Decimal, "pr_number":string})
    detail_po_list_data, Detail_po_list = create_model("Detail_po_list", {"bestelldatum":date, "artnr":string, "bezeich":string, "lief_fax3":string, "txtnr":int, "anzahl":Decimal, "einzelpreis":Decimal, "warenwert":Decimal, "geliefert":Decimal, "angebot_lief1":int})
    ...
    def generate_output():
        nonlocal output_list_data, po_list_data, detail_po_list_data, ind, l_order1_lieferdatum, l_order1_lieferdatum_eff, l_odrhdr_lieferdatum, l_order1_rechnungswert, l_orderhdr, l_order, l_lieferant, l_artikel, parameters
        nonlocal case_type, all_supp, stattype, deptno, from_date, to_date, billdate, disp_comm, l_orderhdr_docu_nr, str4, l_supp_lief_nr, dml_only, pr_only, excl_dml_pr
        ...
        nonlocal cost_list_data, output_list_data, po_list_data, detail_po_list_data

        return {"output-list": output_list_data, "po-list": po_list_data, "detail-po-list": detail_po_list_data}
    ...
    def print_polist1():
        ...
        detail_po_list_data.append(detail_po_list)
        ...
        if stattype == 0:
            ...
            if deptno <= 0:
                ...
                l_order1 = L_order()
                for l_odrhdr.bestelldatum, l_odrhdr.angebot_lief, l_odrhdr.docu_nr, l_odrhdr.lief_fax, l_odrhdr.lieferdatum, l_odrhdr.bestellart, l_odrhdr.besteller, l_odrhdr._recid, l_supplier.firma, l_supplier._recid, l_order1.lief_fax, l_order1.lieferdatum, l_order1.lieferdatum_eff, l_order1.rechnungswert, l_order1._recid, l_order1.artnr, l_order1.txtnr, l_order1.anzahl, l_order1.einzelpreis, l_order1.warenwert, l_order1.geliefert, l_order1.angebot_lief in db_session.query(L_odrhdr.bestelldatum, L_odrhdr.angebot_lief, L_odrhdr.docu_nr, L_odrhdr.lief_fax, L_odrhdr.lieferdatum, L_odrhdr.bestellart, L_odrhdr.besteller, L_odrhdr._recid, L_supplier.firma, L_supplier._recid, L_order1.lief_fax, L_order1.lieferdatum, L_order1.lieferdatum_eff, L_order1.rechnungswert, L_order1._recid, L_order1.artnr, L_order1.txtnr, L_order1.anzahl, L_order1.einzelpreis, L_order1.warenwert, L_order1.geliefert, L_order1.angebot_lief).join(L_supplier,(L_supplier.lief_nr == L_odrhdr.lief_nr)).join(L_order1,(L_order1.docu_nr == L_odrhdr.docu_nr) & (L_order1.loeschflag == 0) & (L_order1.pos == 0)).filter(
                    ...
                    cost_list = query(cost_list_data, filters=(lambda cost_list: cost_list.nr == l_odrhdr.angebot_lief[0]), first=True)
                    ...
                    l_order2 = L_order()
                    l_art2 = L_artikel()
                    for l_order2.lief_fax, l_order2.lieferdatum, l_order2.lieferdatum_eff, l_order2.rechnungswert, l_order2._recid, l_order2.artnr, l_order2.txtnr, l_order2.anzahl, l_order2.einzelpreis, l_order2.warenwert, l_order2.geliefert, l_order2.angebot_lief, l_art2.bezeich, l_art2._recid in db_session.query(L_order2.lief_fax, L_order2.lieferdatum, L_order2.lieferdatum_eff, L_order2.rechnungswert, L_order2._recid, L_order2.artnr, L_order2.txtnr, L_order2.anzahl, L_order2.einzelpreis, L_order2.warenwert, L_order2.geliefert, L_order2.angebot_lief, L_art2.bezeich, L_art2._recid).join(L_art2,(L_art2.artnr == L_order2.artnr)).filter(
            ...
            if deptno <= 0:
                ...
                l_supplier = L_lieferant()
                l_order1 = L_order()
                for l_odrhdr.bestelldatum, l_odrhdr.angebot_lief, l_odrhdr.docu_nr, l_odrhdr.lief_fax, l_odrhdr.lieferdatum, l_odrhdr.bestellart, l_odrhdr.besteller, l_odrhdr._recid, l_supplier.firma, l_supplier._recid, l_order1.lief_fax, l_order1.lieferdatum, l_order1.lieferdatum_eff, l_order1.rechnungswert, l_order1._recid, l_order1.artnr, l_order1.txtnr, l_order1.anzahl, l_order1.einzelpreis, l_order1.warenwert, l_order1.geliefert, l_order1.angebot_lief in db_session.query(L_odrhdr.bestelldatum, L_odrhdr.angebot_lief, L_odrhdr.docu_nr, L_odrhdr.lief_fax, L_odrhdr.lieferdatum, L_odrhdr.bestellart, L_odrhdr.besteller, L_odrhdr._recid, L_supplier.firma, L_supplier._recid, L_order1.lief_fax, L_order1.lieferdatum, L_order1.lieferdatum_eff, L_order1.rechnungswert, L_order1._recid, L_order1.artnr, L_order1.txtnr, L_order1.anzahl, L_order1.einzelpreis, L_order1.warenwert, L_order1.geliefert, L_order1.angebot_lief).join(L_supplier,(L_supplier.lief_nr == L_odrhdr.lief_nr)).join(L_order1,(L_order1.docu_nr == L_odrhdr.docu_nr) & (L_order1.loeschflag == 1) & (L_order1.pos == 0)).filter(
            ...
            if deptno <= 0:
                ...
                l_supplier = L_lieferant()
                l_order1 = L_order()
                for l_odrhdr.bestelldatum, l_odrhdr.angebot_lief, l_odrhdr.docu_nr, l_odrhdr.lief_fax, l_odrhdr.lieferdatum, l_odrhdr.bestellart, l_odrhdr.besteller, l_odrhdr._recid, l_supplier.firma, l_supplier._recid, l_order1.lief_fax, l_order1.lieferdatum, l_order1.lieferdatum_eff, l_order1.rechnungswert, l_order1._recid, l_order1.artnr, l_order1.txtnr, l_order1.anzahl, l_order1.einzelpreis, l_order1.warenwert, l_order1.geliefert, l_order1.angebot_lief in db_session.query(L_odrhdr.bestelldatum, L_odrhdr.angebot_lief, L_odrhdr.docu_nr, L_odrhdr.lief_fax, L_odrhdr.lieferdatum, L_odrhdr.bestellart, L_odrhdr.besteller, L_odrhdr._recid, L_supplier.firma, L_supplier._recid, L_order1.lief_fax, L_order1.lieferdatum, L_order1.lieferdatum_eff, L_order1.rechnungswert, L_order1._recid, L_order1.artnr, L_order1.txtnr, L_order1.anzahl, L_order1.einzelpreis, L_order1.warenwert, L_order1.geliefert, L_order1.angebot_lief).join(L_supplier,(L_supplier.lief_nr == L_odrhdr.lief_nr)).join(L_order1,(L_order1.docu_nr == L_odrhdr.docu_nr) & (L_order1.loeschflag == 2) & (L_order1.pos == 0)).filter(
                         (L_odrhdr.bestelldatum >= from_date) & (L_odrhdr.bestelldatum <= to_date) & (L_odrhdr.betriebsnr <= 1)).order_by(L_odrhdr.bestelldatum, l_orderhdr_docu_nr, L_supplier.firma).all():
                    if l_odrhdr_obj_list.get(l_odrhdr._recid):
                        continue
                    else:
