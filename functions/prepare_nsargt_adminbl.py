...
def prepare_nsargt_adminbl():
    ...
    q1_list_data, Q1_list = create_model("Q1_list", {"rec_id":int, "argtnr":int, "arrangement":string, "argt_bez":string, "artnr_logis":int, "intervall":int, "argt_artikelnr":int, "zuordnung":string})
    q2_list_data, Q2_list = create_model("Q2_list", {"rec_id":int, "argtnr":int, "departement":int, "argt_artnr":int, "bezeich":string, "artnr":int, "betrag":Decimal, "vt_percnt":Decimal})
    t_hoteldpt_data, T_hoteldpt = create_model("T_hoteldpt", {"num":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal q1_list_data, q2_list_data, t_hoteldpt_data, arrangement, artikel, argt_line, hoteldpt


        nonlocal q1_list, q2_list, t_hoteldpt
        nonlocal q1_list_data, q2_list_data, t_hoteldpt_data

        return {"q1-list": q1_list_data, "q2-list": q2_list_data, "t-hoteldpt": t_hoteldpt_data}
    ...
    for q1_list in query(q1_list_data):
