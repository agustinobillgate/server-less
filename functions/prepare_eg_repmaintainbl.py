...
def prepare_eg_repmaintainbl(user_init:string, all_room:bool):
    ...
    def generate_output():
        nonlocal ci_date, engid, groupid, tproperty_data, troom_data, tmaintask_data, tpic_data, tstatus_data, tfrequency_data, tlocation_data, tcategory_data, t_zimmer_data, zimmer, htparam, bediener, eg_staff, queasy, eg_location, eg_property
