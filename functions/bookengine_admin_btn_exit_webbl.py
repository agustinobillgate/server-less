...
book_engine_list_data, Book_engine_list = create_model_like(Queasy)

def bookengine_admin_btn_exit_webbl(book_engine_list_data:[Book_engine_list], icase:int, user_init:string):
    ...
    book_engine_list = query(book_engine_list_data, first=True)
