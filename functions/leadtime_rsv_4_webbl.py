...
def leadtime_rsv_4_webbl(fromdate:date, todate:date, from_rsv:string, to_rsv:string, exclude:bool, rm_sharer:bool, check_cdate:bool):
    ...
    def create_browse():
        ...
        if check_cdate:
            ...
            for output_list in query(output_list_data, sort_by=[("rsvname",False),("create_date",False)]):
                ...
                if output_list.tot_avg_rate == None:
                    output_list.tot_avg_rate = output_list.tot_rate
            ...
            res_line = Res_line()
            reservation = Reservation()
            for res_line.betriebsnr, res_line.gastnrmember, res_line.gastnr, res_line.resnr, res_line.reslinnr, res_line.ankunft, res_line.abreise, res_line.arrangement, res_line.zipreis, res_line.erwachs, res_line.kind1, res_line.kind2, res_line.gratis, res_line.l_zuordnung, res_line.zikatnr, res_line._recid, res_line.zimmer_wunsch, res_line.reserve_int, res_line.reserve_dec, reservation.name, reservation.resart, reservation.resdat, reservation.segmentcode, reservation._recid in db_session.query(Res_line.betriebsnr, Res_line.gastnrmember, Res_line.gastnr, Res_line.resnr, Res_line.reslinnr, Res_line.ankunft, Res_line.abreise, Res_line.arrangement, Res_line.zipreis, Res_line.erwachs, Res_line.kind1, Res_line.kind2, Res_line.gratis, Res_line.l_zuordnung, Res_line.zikatnr, Res_line._recid, Res_line.zimmer_wunsch, Res_line.reserve_int, Res_line.reserve_dec, Reservation.name, Reservation.resart, Reservation.resdat, Reservation.segmentcode, Reservation._recid).join(Reservation,(Reservation.resnr == Res_line.resnr) & (Reservation.resdat >= fromdate) & (Reservation.resdat <= todate)).filter(
                ...
                guest = get_cache (Guest, {"gastnr": [(eq, res_line.gastnrmember)],"name": [(ge, from_rsv),(le, to_rsv)]})
                ...
                if guest:
                    ...
                    if not output_list:
                        ...
                        output_list.create_date = reservation.resdat
                        output_list.lead =  to_decimal(res_line.ankunft) - to_decimal(reservation.resdat)
                        ...
                        for ldatum in date_range(res_line.ankunft,res_line.abreise - 1) :
                            ...
                            if reslin_queasy:
                                output_list.tot_rate = to_string(to_decimal(output_list.tot_rate) + reslin_queasy.deci1, "->>>,>>>,>>>,>>9.99")
                            ...
                            output_list.tot_lodging = to_string(to_decimal(output_list.tot_lodging) + net_lodg, "->>>,>>>,>>>,>>9.99")
                        ...
                        output_list.lodging1 =  to_decimal(output_list.lodging) / to_decimal(foreign_curr)
                        output_list.avg_rmrate =  to_decimal(to_decimal(output_list.tot_rate)) / to_decimal(output_list.room_night)
                        output_list.avg_lodging =  to_decimal(output_list.lodging) / to_decimal(output_list.room_night)
                        output_list.tot_avg_rate = to_string(to_decimal(output_list.tot_rate) / output_list.room_night, "->>>,>>>,>>>,>>9.99")
                        output_list.tot_rate1 = to_string(to_decimal(output_list.tot_rate) / foreign_curr, "->>>,>>>,>>>,>>9.99")
                        ...
                        if output_list.avg_rmrate == None:
                            output_list.avg_rmrate =  to_decimal(to_decimal(output_list.tot_rate) )
                        ...
                        if output_list.tot_avg_lodging == None:
                            output_list.tot_avg_lodging = output_list.tot_lodging
            ...
            for output_list in query(output_list_data, sort_by=[("rsvname",False),("create_date",False)]):
                ...
                if t_gastnr != 0 and t_gastnr != output_list.gastnr:
                    ...
                    t_roomrate =  to_decimal("0")
                    t_roomrate1 =  to_decimal("0")
                    t_avg_rmrate =  to_decimal("0")
                    t_lodg =  to_decimal("0")
                    t_avg_lodg =  to_decimal("0")
                    t_lodg1 =  to_decimal("0")
                    counter = counter + 1
                ...
                t_roomrate =  to_decimal(t_roomrate) + to_decimal(to_decimal(output_list.tot_rate) )
                t_roomrate1 =  to_decimal(t_roomrate1) + to_decimal(to_decimal(output_list.tot_rate1) )
                t_avg_rmrate =  to_decimal(t_avg_rmrate) + to_decimal(to_decimal(output_list.avg_rmrate) )
            ...
            for output_list in query(output_list_data, sort_by=[("gastnr",False)]):
                counter = counter + 1
    ...
    def create_browse_exclude():
        ...
        if check_cdate:
            ...
            for output_list in query(output_list_data, sort_by=[("create_date",False)]):
                output_list.rmrate1 =  to_decimal(output_list.rmrate) / to_decimal(foreign_curr)
                output_list.lodging1 =  to_decimal(output_list.lodging) / to_decimal(foreign_curr)
                output_list.avg_rmrate =  to_decimal(output_list.rmrate) / to_decimal(output_list.room_night)
                output_list.avg_lodging =  to_decimal(output_list.lodging) / to_decimal(output_list.room_night)
            ...
            for res_line in db_session.query(Res_line).filter(
                     (((Res_line.resstatus <= 13) & (Res_line.resstatus != 4) & (Res_line.resstatus != 8) & (Res_line.resstatus != 9) & (Res_line.resstatus != 10) & (Res_line.resstatus != 12) & (Res_line.active_flag <= 1)) | ((Res_line.resstatus == 8) & (Res_line.active_flag == 2) & (Res_line.ankunft == ci_date) & (Res_line.abreise == ci_date))) & (Res_line.gastnr != 1) & (Res_line.l_zuordnung[inc_value(2)] != 1)).order_by(Res_line.resnr, Res_line.reslinnr.desc()).all():
            ...
            for output_list in query(output_list_data, sort_by=[("rsvname",False),("create_date",False),("gastnr",False)]):
                counter = counter + 1
            ...
            if todate >= ci_date:
                ...
                for res_line in db_session.query(Res_line).filter(
                         (((Res_line.resstatus <= 13) & (Res_line.resstatus != 4) & (Res_line.resstatus != 8) & (Res_line.resstatus != 9) & (Res_line.resstatus != 10) & (Res_line.resstatus != 12) & (Res_line.active_flag <= 1) & (Res_line.ankunft >= fromdate) & (Res_line.ankunft <= todate)) | ((Res_line.resstatus == 8) & (Res_line.active_flag == 2) & (Res_line.ankunft == ci_date) & (Res_line.abreise == ci_date))) & (Res_line.gastnr != 1) & (Res_line.l_zuordnung[inc_value(2)] != 1)).order_by(Res_line.resnr, Res_line.reslinnr.desc()).all():
    ...
    def create_browse_exclude1():
        ...
        if check_cdate:
            ...
            res_line = Res_line()
            reservation = Reservation()
            for res_line.betriebsnr, res_line.gastnrmember, res_line.gastnr, res_line.resnr, res_line.reslinnr, res_line.ankunft, res_line.abreise, res_line.arrangement, res_line.zipreis, res_line.erwachs, res_line.kind1, res_line.kind2, res_line.gratis, res_line.l_zuordnung, res_line.zikatnr, res_line._recid, res_line.zimmer_wunsch, res_line.reserve_int, res_line.reserve_dec, reservation.name, reservation.resart, reservation.resdat, reservation.segmentcode, reservation._recid in db_session.query(Res_line.betriebsnr, Res_line.gastnrmember, Res_line.gastnr, Res_line.resnr, Res_line.reslinnr, Res_line.ankunft, Res_line.abreise, Res_line.arrangement, Res_line.zipreis, Res_line.erwachs, Res_line.kind1, Res_line.kind2, Res_line.gratis, Res_line.l_zuordnung, Res_line.zikatnr, Res_line._recid, Res_line.zimmer_wunsch, Res_line.reserve_int, Res_line.reserve_dec, Reservation.name, Reservation.resart, Reservation.resdat, Reservation.segmentcode, Reservation._recid).join(Reservation,(Reservation.resdat >= fromdate) & (Reservation.resdat <= todate) & (Reservation.resnr == Res_line.resnr)).filter(
                     (((Res_line.active_flag <= 1) & (Res_line.resstatus != 4) & (Res_line.resstatus != 12)) | ((Res_line.active_flag == 2) & (Res_line.resstatus == 8) & (Res_line.ankunft == ci_date) & (Res_line.abreise == ci_date))) & (Res_line.gastnr > 0) & (Res_line.l_zuordnung[inc_value(2)] != 1)).order_by(Res_line.resnr).all():
                if res_line_obj_list.get(res_line._recid):
                    continue
                else:
                    res_line_obj_list[res_line._recid] = True
            ...
            for output_list in query(output_list_data, sort_by=[("create_date",False),("gastnr",False)]):
                counter = counter + 1
            ...
            for res_line in db_session.query(Res_line).filter(
                     (((Res_line.active_flag <= 1) & (Res_line.resstatus != 4) & (Res_line.resstatus != 12) & (Res_line.ankunft >= fromdate) & (Res_line.ankunft <= todate)) | ((Res_line.active_flag == 2) & (Res_line.resstatus == 8) & (Res_line.ankunft == ci_date) & (Res_line.abreise == ci_date))) & (Res_line.gastnr > 0) & (Res_line.l_zuordnung[inc_value(2)] != 1)).order_by(Res_line.resnr).all():
                curr_i = 0
                tot_breakfast =  to_decimal("0")
                tot_lunch =  to_decimal("0")
                tot_dinner =  to_decimal("0")
    ...
    def create_browse_rm_sharer():
        ...
        if check_cdate:
            ...
            reservation = Reservation()
            guest = Guest()
            for genstat.gastnr, genstat.resnr, genstat.res_int, genstat.res_date, genstat.argt, genstat.zipreis, genstat.logis, genstat.erwachs, genstat.kind1, genstat.kind2, genstat.gratis, genstat.kind3, genstat.gastnrmember, genstat.segmentcode, genstat.zikatnr, genstat._recid, reservation.name, reservation.resart, reservation.resdat, reservation.segmentcode, reservation._recid, guest.name, guest._recid, guest.nation1 in db_session.query(Genstat.gastnr, Genstat.resnr, Genstat.res_int, Genstat.res_date, Genstat.argt, Genstat.zipreis, Genstat.logis, Genstat.erwachs, Genstat.kind1, Genstat.kind2, Genstat.gratis, Genstat.kind3, Genstat.gastnrmember, Genstat.segmentcode, Genstat.zikatnr, Genstat._recid, Reservation.name, Reservation.resart, Reservation.resdat, Reservation.segmentcode, Reservation._recid, Guest.name, Guest._recid, Guest.nation1).join(Reservation,(Reservation.resdat >= fromdate) & (Reservation.resdat <= todate) & (Reservation.gastnr == Genstat.gastnr)).join(Guest,(Guest.gastnr == Genstat.gastnrmember) & (Guest.name >= (from_rsv).lower()) & (Guest.name <= (to_rsv).lower())).filter(
            ...
            reservation = Reservation()
            for res_line.betriebsnr, res_line.gastnrmember, res_line.gastnr, res_line.resnr, res_line.reslinnr, res_line.ankunft, res_line.abreise, res_line.arrangement, res_line.zipreis, res_line.erwachs, res_line.kind1, res_line.kind2, res_line.gratis, res_line.l_zuordnung, res_line.zikatnr, res_line._recid, res_line.zimmer_wunsch, res_line.reserve_int, res_line.reserve_dec, reservation.name, reservation.resart, reservation.resdat, reservation.segmentcode, reservation._recid in db_session.query(Res_line.betriebsnr, Res_line.gastnrmember, Res_line.gastnr, Res_line.resnr, Res_line.reslinnr, Res_line.ankunft, Res_line.abreise, Res_line.arrangement, Res_line.zipreis, Res_line.erwachs, Res_line.kind1, Res_line.kind2, Res_line.gratis, Res_line.l_zuordnung, Res_line.zikatnr, Res_line._recid, Res_line.zimmer_wunsch, Res_line.reserve_int, Res_line.reserve_dec, Reservation.name, Reservation.resart, Reservation.resdat, Reservation.segmentcode, Reservation._recid).join(Reservation,(Reservation.resdat >= fromdate) & (Reservation.resdat <= todate) & (Reservation.resnr == Res_line.resnr)).filter(
                     (((Res_line.active_flag <= 1)) | ((Res_line.resstatus != 11) & (Res_line.active_flag == 2) & (Res_line.ankunft == ci_date) & (Res_line.abreise == ci_date))) & (Res_line.gastnr > 0) & (Res_line.l_zuordnung[inc_value(2)] != 0)).order_by(Res_line.resnr, Res_line.reslinnr.desc()).all():
                if res_line_obj_list.get(res_line._recid):
                    continue
                else:
                    res_line_obj_list[res_line._recid] = True
            ...
            if todate >= ci_date:
                ...
                for res_line in db_session.query(Res_line).filter(
                         (((Res_line.active_flag <= 1) & (Res_line.ankunft >= fromdate) & (Res_line.ankunft <= todate)) | ((Res_line.resstatus == 11) & (Res_line.active_flag == 2) & (Res_line.ankunft == ci_date) & (Res_line.abreise == ci_date))) & (Res_line.gastnr > 0) & (Res_line.l_zuordnung[inc_value(2)] != 0)).order_by(Res_line.resnr, Res_line.reslinnr.desc()).all():
    ...
    def create_browse_rm_sharer1():
        ...
        if check_cdate:
            ...
            reservation = Reservation()
            for res_line.betriebsnr, res_line.gastnrmember, res_line.gastnr, res_line.resnr, res_line.reslinnr, res_line.ankunft, res_line.abreise, res_line.arrangement, res_line.zipreis, res_line.erwachs, res_line.kind1, res_line.kind2, res_line.gratis, res_line.l_zuordnung, res_line.zikatnr, res_line._recid, res_line.zimmer_wunsch, res_line.reserve_int, res_line.reserve_dec, reservation.name, reservation.resart, reservation.resdat, reservation.segmentcode, reservation._recid in db_session.query(Res_line.betriebsnr, Res_line.gastnrmember, Res_line.gastnr, Res_line.resnr, Res_line.reslinnr, Res_line.ankunft, Res_line.abreise, Res_line.arrangement, Res_line.zipreis, Res_line.erwachs, Res_line.kind1, Res_line.kind2, Res_line.gratis, Res_line.l_zuordnung, Res_line.zikatnr, Res_line._recid, Res_line.zimmer_wunsch, Res_line.reserve_int, Res_line.reserve_dec, Reservation.name, Reservation.resart, Reservation.resdat, Reservation.segmentcode, Reservation._recid).join(Reservation,(Reservation.resdat >= fromdate) & (Reservation.resdat <= todate) & (Reservation.resnr == Res_line.resnr)).filter(
                     (((Res_line.active_flag <= 1)) | ((Res_line.active_flag == 2) & (Res_line.resstatus != 11) & (Res_line.ankunft == ci_date) & (Res_line.abreise == ci_date))) & (Res_line.gastnr > 0) & (Res_line.l_zuordnung[inc_value(2)] != 0)).order_by(Res_line.resnr).all():
                if res_line_obj_list.get(res_line._recid):
                    continue
                else:
                    res_line_obj_list[res_line._recid] = True
            ...
            for res_line in db_session.query(Res_line).filter(
                     (((Res_line.active_flag <= 1) & (Res_line.resstatus <= 13) & (Res_line.resstatus != 4) & (Res_line.resstatus != 12) & (Res_line.ankunft >= fromdate) & (Res_line.ankunft <= todate) & (Res_line.l_zuordnung[inc_value(2)] == 0)) | ((Res_line.active_flag == 2) & (Res_line.resstatus == 8) & (Res_line.ankunft == ci_date) & (Res_line.abreise == ci_date)) | ((Res_line.resstatus == 11) & (Res_line.ankunft >= fromdate) & (Res_line.ankunft <= todate) & (Res_line.l_zuordnung[inc_value(2)] == 1))) & (Res_line.gastnr > 0)).order_by(Res_line.resnr).all():
                curr_i = 0
                tot_breakfast =  to_decimal("0")
                tot_lunch =  to_decimal("0")
                tot_dinner =  to_decimal("0")
