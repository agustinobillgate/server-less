...
def fa_depreciation_report_webbl(payload_list_data:[Payload_list]):
    ...
    def generate_output():
        nonlocal depreciation_asset_data, tot_amount, tot_depn_value, tot_book_value, tot_acc_depn, fa_ordheader, mathis, fa_artikel, fa_order


        nonlocal depreciation_asset, payload_list
        nonlocal depreciation_asset_data
