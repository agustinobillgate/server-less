...
def prepare_quote_list_webbl(artno:int, supno:int, docuno:string):
    ...
    quote_list_data, Quote_list = create_model("Quote_list", {"artnr":int, "lief_nr":int, "supname":string, "artname":string, "devunit":string, "content":Decimal, "unitprice":Decimal, "curr":string, "from_date":date, "to_date":date, "remark":string, "filname":string, "activeflag":bool, "docu_nr":string, "minqty":Decimal, "delivday":int, "disc":Decimal, "avl":bool, "quote_recid":int}, {"avl": True})
    ...
    def cr_lquote():
        ...
        quote_list.quote_recid = l_quote._recid
