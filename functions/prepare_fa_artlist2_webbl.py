...
payload_list_data, Payload_list = create_model("Payload_list", {"from_date":date, "to_date":date, "location":int, "show_all":bool, "asset_name":string, "remark":string, "asset_number":string, "sorttype":int, "last_nr":int, "last_artname":string, "last_remark":string, "last_asset_number":string, "mode":int, "num_data":int})
