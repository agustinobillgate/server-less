...
def stock_ohlist1_1bl(from_lager:int, to_lager:int, from_art:int, to_art:int, from_date:date, to_date:date, move_art:bool):
    ...
    def generate_output():
        nonlocal stockoh_list_data, do_it, curr_art, curr_lager, out_bestand, zwkum, t_val, bezeich, j, tot_prev, tot_value, tot_in, tot_out, total_in, total_out, total_prev, total_value, tdate, qty, wert, long_digit, l_bestand, l_besthis, htparam, l_lager, l_artikel, l_op, l_ophis, l_untergrup, printcod
