...
def prepare_supply_hinlist_1bl():
    ...
    def generate_output():
        nonlocal t_l_lager_data, t_l_hauptgrp_data, gst_flag, l_lager, l_hauptgrp, l_lieferant


        nonlocal t_l_lager, t_l_hauptgrp
        nonlocal t_l_lager_data, t_l_hauptgrp_data

        return {"t-l-lager": t_l_lager_data, "t-l-hauptgrp": t_l_hauptgrp_data, "gst_flag": gst_flag}
