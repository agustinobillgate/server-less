...
def roomplan2_1bl(from_room:string, curr_date:date, ci_date:date):
    ...
    def generate_output():
        nonlocal do_it, to_date, t_res_line_data, t_res_line2_data, t_outorder_data, t_outorder1_data, room_list_data, t_res_line3_data, stat_list, a, res_line, outorder, zimmer, zimkateg, history
