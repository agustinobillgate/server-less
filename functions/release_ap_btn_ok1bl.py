...
def release_ap_btn_ok1bl(pvilanguage:int, bill_no:string, datum:date, saldo:Decimal):
    ...
    pay_list_data, Pay_list = create_model("Pay_list", {"datum":date, "saldo":Decimal, "bezeich":string, "s_recid":int})
    ...
    def generate_output():
        nonlocal msg_str, msg_str2, rec_id, pay_list_data, lvcarea, tot_anz, l_kredit, artikel, l_lieferant, htparam
        ...
        return {"msg_str": msg_str, "msg_str2": msg_str2, "rec_id": rec_id, "pay-list": pay_list_data}
