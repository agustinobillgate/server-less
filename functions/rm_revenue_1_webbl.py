...
def rm_revenue_1_webbl(m_ftd:bool, m_ytd:bool, f_date:date, t_date:date, to_date:date, rm_no:string, sorttype:int, lod__rev:bool):
    ...
    def generate_output():
        nonlocal output_list_data, i, anz, manz, yanz, pax, mpax, ypax, mnet, ynet, net, t_anz, t_manz, t_yanz, t_pax, t_mpax, t_ypax, t_net, t_mnet, t_ynet, from_bez, to_bez, price_decimal, from_date, curr_zeit, ci_date, htparam, zimmer, arrangement, res_line, waehrung, argt_line, artikel, zinrstat, zimkateg, genstat
    ...
    def create_resline():
        ...
        nonlocal output_list_data, i, anz, manz, yanz, pax, mpax, ypax, mnet, ynet, net, t_anz, t_manz, t_yanz, t_pax, t_mpax, t_ypax, t_net, t_mnet, t_ynet, from_bez, to_bez, from_date, curr_zeit, ci_date, htparam, zimmer, arrangement, res_line, waehrung, argt_line, artikel, zinrstat, zimkateg, genstat
        nonlocal m_ftd, m_ytd, f_date, t_date, to_date, rm_no, sorttype, lod__rev
