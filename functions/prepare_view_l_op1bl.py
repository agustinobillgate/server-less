...
def prepare_view_l_op1bl(user_init:string):
    ...
    q1_list_data, Q1_list = create_model("Q1_list", {"datum":date, "lager_nr":int, "artnr":int, "bezeich":string, "anzahl":Decimal, "einzelpreis":Decimal, "warenwert":Decimal, "lscheinnr":string, "username":string, "zeit":int, "stornogrund":string, "pos":int})
    q11_list_data, Q11_list = create_model("Q11_list", {"datum":date, "lager_nr":int, "artnr":int, "bezeich":string, "anzahl":Decimal, "lscheinnr":string, "username":string, "zeit":int, "stornogrund":string, "pos":int})
    ...
    def generate_output():
        nonlocal show_price, q1_list_data, q11_list_data, bediener, htparam, l_artikel, l_op
        nonlocal user_init
        nonlocal sys_user


        nonlocal sys_user, q1_list, q11_list
        nonlocal q1_list_data, q11_list_data

        return {"show_price": show_price, "q1-list": q1_list_data, "q11-list": q11_list_data}
