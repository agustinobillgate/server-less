...
def gl_linkcompli1bl(pvilanguage:int, from_date:date, to_date:date, double_currency:bool, foreign_nr:int, exchg_rate:Decimal, user_init:string):
    ...
    def generate_output():
        nonlocal curr_anz, debits, credits, remains, msg_str, t_g_list_data, s_list_data, curr_i, lvcarea, h_artikel, gl_acct, htparam, hoteldpt, h_compli, exrate, artikel, h_cost, h_bill_line
