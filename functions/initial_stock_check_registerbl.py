...
def initial_stock_check_registerbl(s_artnr:int, curr_lager:int):
    ...
    def generate_output():
        nonlocal error_code, fl_code, best_list_data, l_bestand, l_op, l_ophis
        nonlocal s_artnr, curr_lager


        nonlocal best_list
        nonlocal best_list_data

        return {"error_code": error_code, "fl_code": fl_code, "best-list": best_list_data}
