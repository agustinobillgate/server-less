...
def hk_zimaidbl(pvilanguage:int):
    ...
    output_list_data, Output_list = create_model("Output_list", {"personal":bool, "reihenfolge":int, "selected":bool, "cleanflag":bool, "odd_even":int, "flag":int, "zinr":string, "rstat":string, "rstat1":string, "departed":string, "gstat":string, "floor":int, "code":string, "inactive":string, "ldry":string, "towel":string, "kbezeich":string, "arrival":bool, "ankunft":date, "abreise":date, "nation":string, "zistatus":int, "gname":string, "resname":string, "bemerk":string, "rsv_flag":bool, "co_time":string, "vip":string}, {"flag": 1})
