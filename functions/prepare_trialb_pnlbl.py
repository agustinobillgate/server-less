...
def prepare_trialb_pnlbl():
    ...
    def generate_output():
        nonlocal pbal_flag, to_date, close_date, pnl_acct, gl_depart_list_data, beg_month, end_month, htparam, gl_acct


        nonlocal gl_depart_list
        nonlocal gl_depart_list_data

        return {"pbal_flag": pbal_flag, "to_date": to_date, "close_date": close_date, "pnl_acct": pnl_acct, "gl-depart-list": gl_depart_list_data}
