...
def prepare_gl_linkstockbl(link_in:bool):
    ...
    def generate_output():
        nonlocal f_int, jtype, last_acctdate, acct_date, close_year, l_hauptgrp_list_data, htparam, l_hauptgrp
        nonlocal link_in
        ...
        return {"f_int": f_int, "jtype": jtype, "last_acctdate": last_acctdate, "acct_date": acct_date, "close_year": close_year, "l-hauptgrp-list": l_hauptgrp_list_data}
