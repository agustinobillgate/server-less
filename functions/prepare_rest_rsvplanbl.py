...
def prepare_rest_rsvplanbl():
    ...
    def generate_output():
        nonlocal from_date, to_date, min_dept, max_dept, from_dept, to_dept, curr_dept, depname1, depname2, depname3, t_hoteldpt_data, hoteldpt, htparam


        nonlocal t_hoteldpt
        nonlocal t_hoteldpt_data

        return {"from_date": from_date, "to_date": to_date, "min_dept": min_dept, "max_dept": max_dept, "from_dept": from_dept, "to_dept": to_dept, "curr_dept": curr_dept, "depname1": depname1, "depname2": depname2, "depname3": depname3, "t-hoteldpt": t_hoteldpt_data}
