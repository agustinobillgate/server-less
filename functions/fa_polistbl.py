...
def fa_polistbl(t_table:string, supplier_nr:int, order_nr:string):
    ...
    t_order_data, T_order = create_model("T_order", {"fa_nr":int, "name":string, "asset":string, "order_qty":int, "order_price":Decimal, "order_amount":Decimal, "order_nr":string, "model":string})
    ...
    def generate_output():
        ...
        return {"flag_avail": flag_avail, "t-order": t_order_data}
