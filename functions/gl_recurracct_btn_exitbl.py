...
def gl_recurracct_btn_exitbl(pvilanguage:int, case_type:int, titel:string, remark:string, fibu:string, rec_id:int):
    ...
    b1_list_data, B1_list = create_model_like(Queasy, {"fibukonto":string, "bezeich":string, "rec_id":int})
    ...
    def generate_output():
        nonlocal msg_str, b1_list_data, lvcarea, queasy, gl_acct
        ...
        return {"msg_str": msg_str, "b1-list": b1_list_data}
