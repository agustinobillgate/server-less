        ...
        if paramqsy:
            ...
            if dynamic_qr:
                ...
                pickup_table = db_session.query(Pickup_table).filter(
                             (Pickup_table.key == 225) & (func.lower(Pickup_table.char1) == ("taken-table").lower()) & (Pickup_table.number1 == curr_dept) & (Pickup_table.logi1) & (Pickup_table.logi2) & (Pickup_table.number2 == paramqsy.number2) & (entry(0, Pickup_table.char3, "|Pickup_table.") == (session_parameter).lower())).first()
            ...
            orderbill = db_session.query(Orderbill).filter(
                         (Orderbill.key == 225) & (func.lower(Orderbill.char1) == ("orderbill").lower()) & (func.lower(Orderbill.char3) == (session_parameter).lower()) & (Orderbill.logi1) & (Orderbill.logi3)).first()
            ...
            if orderbill:
                ...
                for orderbill_close in db_session.query(Orderbill_close).filter(
                             (Orderbill_close.key == 225) & (func.lower(Orderbill_close.char1) == ("orderbill").lower()) & (func.lower(Orderbill_close.char3) == (session_parameter).lower()) & (Orderbill_close.logi1) & (Orderbill_close.logi3)).order_by(Orderbill_close._recid).all():
            ...
            if dynamic_qr:
                ...
                for orderbilline in db_session.query(Orderbilline).filter(
                             (Orderbilline.key == 225) & (func.lower(Orderbilline.char1) == ("orderbill-line").lower()) & (entry(3, Orderbilline.char2, "|Orderbilline.") == (session_parameter).lower())).order_by(Orderbilline._recid).all():
