...
def s_stockin_btn_go_2bl(s_artnr:int, qty:Decimal, op_list_data:[Op_list], f_endkum:int, b_endkum:int, m_endkum:int, lief_nr:int, lscheinnr:string, billdate:date, curr_lager:int, fb_closedate:date, m_closedate:date, bediener_nr:int, bediener_userinit:string):
