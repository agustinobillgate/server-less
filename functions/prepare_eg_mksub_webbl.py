...
def prepare_eg_mksub_webbl(deptnr:int, mainnr:int):
    ...
    t_queasy_data, T_queasy = create_model("T_queasy", {"number1":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal fl_code, subtask, t_queasy_data, queasy, eg_subtask
        ...
        return {"fl_code": fl_code, "subtask": subtask, "t-queasy": t_queasy_data}
