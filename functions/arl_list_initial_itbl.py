...
def arl_list_initial_itbl(inp_resname:string, user_init:string):
    ...
    t_guest_data, T_guest = create_model("T_guest", {"firmen_nr":int, "steuernr":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal ext_char, long_stay, ci_date, fdate1, fdate2, lname, show_rate, bediener_permissions, feldtype_336, flogical_336, finteger_337, finteger_338, flogical_1111, p_297, p_437, l_param472, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, t_guest_data, setup_list_data, htparam, bediener, guest, paramtext
        nonlocal inp_resname, user_init


        nonlocal setup_list, t_guest
        nonlocal setup_list_data, t_guest_data

        return {"ext_char": ext_char, "long_stay": long_stay, "ci_date": ci_date, "fdate1": fdate1, "fdate2": fdate2, "lname": lname, "show_rate": show_rate, "bediener_permissions": bediener_permissions, "feldtype_336": feldtype_336, "flogical_336": flogical_336, "finteger_337": finteger_337, "finteger_338": finteger_338, "flogical_1111": flogical_1111, "p_297": p_297, "p_437": p_437, "l_param472": l_param472, "vipnr1": vipnr1, "vipnr2": vipnr2, "vipnr3": vipnr3, "vipnr4": vipnr4, "vipnr5": vipnr5, "vipnr6": vipnr6, "vipnr7": vipnr7, "vipnr8": vipnr8, "vipnr9": vipnr9, "t-guest": t_guest_data, "setup-list": setup_list_data}
