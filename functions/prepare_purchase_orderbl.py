...
def prepare_purchase_orderbl(lief_nr:int):
    ...
    prepare_cache ([L_order, Htparam, Waehrung, L_orderhdr])
    ...
    q2_list_data, Q2_list = create_model("Q2_list", {"lief_nr":int, "docu_nr":string, "bestelldatum":date, "lieferdatum":date, "wabkurz":string, "bestellart":string, "gedruckt":date, "besteller":string, "lief_fax_3":string, "lief_fax_2":string, "rechnungswert":Decimal, "rec_id":int})
    ...
    def generate_output():
        nonlocal billdate, enforce_rflag, p_1093, p_464, p_220, q2_list_data, l_order, htparam, waehrung, l_orderhdr
        nonlocal lief_nr
        nonlocal l_order1
        ...
        return {"billdate": billdate, "enforce_rflag": enforce_rflag, "p_1093": p_1093, "p_464": p_464, "p_220": p_220, "q2-list": q2_list_data}
    ...
    def disp_it():
        ...
        q2_list = query(q2_list_data, first=True)
