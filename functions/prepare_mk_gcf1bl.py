...
def prepare_mk_gcf1bl(lastname:string, firstname:string):
    ...
    t_sourccod1_data, T_sourccod1 = create_model("T_sourccod1", {"source_code":int, "bezeich":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal err_nr, curr_gastnr, lname, f_logical, avail_genlayout, t_nation1_data, t_sourccod1_data, t_guest_data, guest, htparam, sourccod, genlayout, nation
        nonlocal lastname, firstname


        nonlocal t_nation1, t_guest, t_sourccod1
        nonlocal t_nation1_data, t_guest_data, t_sourccod1_data

        return {"err_nr": err_nr, "curr_gastnr": curr_gastnr, "lname": lname, "f_logical": f_logical, "avail_genlayout": avail_genlayout, "t-nation1": t_nation1_data, "t-sourccod1": t_sourccod1_data, "t-guest": t_guest_data}
    ...
    for sourccod in db_session.query(Sourccod).filter(
        ...
        t_sourccod1_data.append(t_sourccod1)
