...
def select_artikel_unit_pricebl(veran_nr:int, veran_seite:int, departement:int, q2_artnr:int, qty:int, bediener_nr:int, unit_price:Decimal):
    ...
    def generate_output():
        nonlocal bkrart_data, bk_rart, artikel, bk_reser, bk_func
        nonlocal veran_nr, veran_seite, departement, q2_artnr, qty, bediener_nr, unit_price


        nonlocal bkrart
        nonlocal bkrart_data

        return {"bkrart": bkrart_data}
    ...
    bk_rart.preis =  to_decimal(unit_price)
