...
def new_drr_gsbl(from_date:date, to_date:date, gsheet_link:string, rev_seg_list_data:[Rev_seg_list], rev_list_data:[Rev_list], payable_list_data:[Payable_list], stat_list_data:[Stat_list], payment_list_data:[Payment_list], gl_list_data:[Gl_list], fb_sales_food_data:[Fb_sales_food], fb_sales_beverage_data:[Fb_sales_beverage], fb_sales_other_data:[Fb_sales_other], fb_sales_tot_data:[Fb_sales_tot], rev_seg_list1_data:[Rev_seg_list1], fb_sales_material_data:[Fb_sales_material]):
    ...
    rev_seg_list = rev_seg_list1 = rev_list = payable_list = tot_list = stat_list = payment_list = gl_list = fb_sales_food = fb_sales_beverage = fb_sales_other = fb_sales_tot = fb_sales_material = menu_drr = stream_list = None
    ...
    def generate_output():
        ...
        nonlocal rev_seg_list, rev_seg_list1, rev_list, payable_list, tot_list, stat_list, payment_list, gl_list, fb_sales_food, fb_sales_beverage, fb_sales_other, fb_sales_tot, fb_sales_material, menu_drr, stream_list
    ...
    stream_list.crow = 7
    stream_list.ccol = 6
    stream_list.cval = "O C C U P A N C Y B Y s E G M E N T"
    ...
    stream_list.crow = ct_row
    stream_list.ccol = 6
    stream_list.cval = "L O A D G I N G B Y s E G M E N T"
    ...
    for rev_seg_list1 in query(rev_seg_list1_data, sort_by=[("flag",False)]):
        ct_row = ct_row + 1
        stream_list = Stream_list()
        stream_list_data.append(stream_list)
        ...
        stream_list.crow = ct_row
        stream_list.ccol = 2
        stream_list.cval = rev_seg_list1.descr
        ...
        stream_list.crow = ct_row
        stream_list.ccol = 3
        stream_list.cval = to_string(rev_seg_list1.t_day, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row
        stream_list.ccol = 4
        stream_list.cval = to_string(rev_seg_list1.dper, "->>9.99")
        ...
        stream_list.crow = ct_row
        stream_list.ccol = 5
        stream_list.cval = to_string(rev_seg_list1.mtd, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row
        stream_list.ccol = 6
        stream_list.cval = to_string(rev_seg_list1.mtd_per, "->>9.99")
        ...
        stream_list.crow = ct_row
        stream_list.ccol = 7
        stream_list.cval = to_string(rev_seg_list1.mtd_budget, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row
        stream_list.ccol = 8
        stream_list.cval = to_string(rev_seg_list1.variance, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row
        stream_list.ccol = 9
        stream_list.cval = to_string(rev_seg_list1.ytd, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row
        stream_list.ccol = 10
        stream_list.cval = to_string(rev_seg_list1.ytd_per, "->>9.99")
    ...
    for fb_sales_material in query(fb_sales_material_data):
        ct_row2 = ct_row2 + 1
        stream_list = Stream_list()
        stream_list_data.append(stream_list)
        ...
        stream_list.crow = ct_row2
        stream_list.ccol = 12
        stream_list.cval = to_string(fb_sales_material.descr)
        ...
        stream_list.crow = ct_row2
        stream_list.ccol = 13
        stream_list.cval = to_string(fb_sales_material.tday_cov, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row2
        stream_list.ccol = 14
        stream_list.cval = to_string(fb_sales_material.tday_avg, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row2
        stream_list.ccol = 15
        stream_list.cval = to_string(fb_sales_material.tday_rev, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row2
        stream_list.ccol = 16
        stream_list.cval = to_string(fb_sales_material.mtd_cov, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row2
        stream_list.ccol = 17
        stream_list.cval = to_string(fb_sales_material.mtd_avg, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row2
        stream_list.ccol = 18
        stream_list.cval = to_string(fb_sales_material.mtd_rev, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row2
        stream_list.ccol = 19
        stream_list.cval = to_string(fb_sales_material.ytd_cov, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row2
        stream_list.ccol = 20
        stream_list.cval = to_string(fb_sales_material.ytd_avg, "->>,>>>,>>>,>>9.99")
        ...
        stream_list.crow = ct_row2
        stream_list.ccol = 21
        stream_list.cval = to_string(fb_sales_material.ytd_rev, "->>,>>>,>>>,>>9.99")
    ...
    stream_list.crow = ct_row2
    stream_list.ccol = 12
    stream_list.cval = "BANQUET REVENUE"
