...
def prepare_flag_reportbl(resnr:int, reslinnr:int, user_init:string):
    ...
    def generate_output():
        nonlocal perm_bediener, s_list_data, t_res_line_data, n, res_line, reslin_queasy, bediener
        ...
        return {"perm_bediener": perm_bediener, "s-list": s_list_data, "t-res-line": t_res_line_data}
