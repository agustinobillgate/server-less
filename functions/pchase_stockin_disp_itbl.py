...
def pchase_stockin_disp_itbl(sorttype:int, ponum:string, supplier:string, to_supp:string, order_date:date):
    ...
    def generate_output():
        nonlocal q2_list_data, l_order, l_lieferant, l_orderhdr, htparam, waehrung
        nonlocal sorttype, ponum, supplier, to_supp, order_date
        nonlocal l_order1
