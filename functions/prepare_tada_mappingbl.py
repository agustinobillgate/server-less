...
def prepare_tada_mappingbl(dept:int):
    ...
    def generate_output():
        nonlocal t_dept_data, t_queasy270_data, vhp_art_data, t_article_data, queasy, hoteldpt, h_artikel
        nonlocal dept


        nonlocal t_dept, t_queasy270, vhp_art, t_article
        nonlocal t_dept_data, t_queasy270_data, vhp_art_data, t_article_data

        return {"t-dept": t_dept_data, "t-queasy270": t_queasy270_data, "vhp-art": vhp_art_data, "t-article": t_article_data}
