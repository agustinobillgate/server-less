...
def pj_depart1_2bl(pvilanguage:int, case_type:int, disptype:int, fdate:date, tdate:date, froom:string, troom:string, setup_list_data:[Setup_list]):
    ...
    def generate_output():
        nonlocal tot_rm, tot_a, tot_c, tot_co, str_list_data, s_list_data, cl_list_data, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, all_remark, lvcarea, guest, zimkateg, reservation, res_line, history, guestseg, nation, bill, mc_guest, mc_types
