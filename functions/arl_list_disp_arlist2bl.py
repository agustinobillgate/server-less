...
def arl_list_disp_arlist2bl(inp_gastnr:int, inp_grpname:string, ci_date:date, show_rate:bool, long_stay:int):
    ...
    def generate_output():
        nonlocal arl_list_data, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, done_flag, curr_resnr, curr_resline, today_str, reserve_str, created_time, do_it, all_inclusive, res_mode, checkin_flag, guest, paramtext, waehrung, reservation, zimkateg, res_line, master, messages, kontline, gentable, mc_guest, htparam, reslin_queasy, zimmer, queasy
