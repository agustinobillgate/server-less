...
def prepare_rarticle_adminbl(dept:int):
    ...
    q1_list_data, Q1_list = create_model_like(H_artikel, {"bez":string, "zknr":int, "bezeich2":string, "zk_bezeich":string, "ek_bezeich":string, "fart_bezeich":string, "fo_dept":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal long_digit, d_bezeich, q1_list_data, h_artikel, htparam, wgrpdep, hoteldpt, queasy, wgrpgen, artikel
        nonlocal dept
        ...
        return {"long_digit": long_digit, "d_bezeich": d_bezeich, "q1-list": q1_list_data}
