...
def res_list_1_webbl(case_type:int, from_date:date, to_date:date, resnr:int, gastnr:int, search_resno:int, search_voucher:string):
    ...
    def generate_output():
        nonlocal curr_select, res_listmain_data, res_listmember_data, vip_nr, res_bemerk, loopk, htparam, zimkateg, res_line, guest, reservation, segment, sourccod, reslin_queasy, guestseg
