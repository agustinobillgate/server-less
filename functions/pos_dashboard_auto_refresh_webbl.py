...
def pos_dashboard_auto_refresh_webbl(user_init:string, dept_no:int):
    urlws = ""
    licensenr = 0
    dynamic_qr = False
    interval_time = 0
    ...
    def generate_output():
        nonlocal urlws, licensenr, dynamic_qr, interval_time, asroom_service, cancel_exist, found_new_order, ask_bill_flag, t_dept_data, t_queasy222_data, t_list_data, pick_table_data, order_list_data, order_item_data, check_new_ordered, queasy
        ...
        return {"urlws": urlws, "licensenr": licensenr, "dynamic_qr": dynamic_qr, "interval_time": interval_time, "asroom_service": asroom_service, "cancel_exist": cancel_exist, "found_new_order": found_new_order, "ask_bill_flag": ask_bill_flag, "t-dept": t_dept_data, "t-queasy222": t_queasy222_data, "t-list": t_list_data, "pick-table": pick_table_data, "order-list": order_list_data, "order-item": order_item_data}
