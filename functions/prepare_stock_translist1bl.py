...
def prepare_stock_translist1bl():
    ...
    def generate_output():
        nonlocal show_price, avail_queasy, t_l_lager_data, t_l_hauptgrp_data, l_lager, htparam, queasy, l_hauptgrp


        nonlocal t_l_lager, t_l_hauptgrp
        nonlocal t_l_lager_data, t_l_hauptgrp_data

        return {"show_price": show_price, "avail_queasy": avail_queasy, "t-l-lager": t_l_lager_data, "t-l-hauptgrp": t_l_hauptgrp_data}
