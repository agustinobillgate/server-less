...
def main_fs_display_browser2bl(b1_resnr:int, glist_gastnr:int, rsvsort:int, guestsort:int, to_date:date):
    ...
    q2_list_data, Q2_list = create_model("Q2_list", {"rechnr":int, "bk_veran_recid":int, "resstatus":int, "veran_nr":int, "anlass":string})
    ...
    def generate_output():
        nonlocal bq_rechnr, q2_list_data, bk_reser, guest, bk_veran
        ...
        return {"bq_rechnr": bq_rechnr, "q2-list": q2_list_data}
