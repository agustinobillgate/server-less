...
def rest_statsegment_go_webbl(pvilanguage:int, from_date:date, to_date:date, sorttype:int):
    ...
    def generate_output():
        nonlocal output_list_data, price_decimal, black_list, start_month, start_year, long_digit, f_endkum, m_endkum, b_endkum, lvcarea, htparam, h_bill, h_artikel, h_journal, artikel, res_line, guest, segment
            ...
            if artikel:
                ...
                if guest_no != 0 and h_bill.segmentcode != 0:
                    ...
                    if guest:
                        ...
                        t_list = query(t_list_data, filters=(lambda t_list: t_list.segm_no == h_bill.segmentcode), first=True)
