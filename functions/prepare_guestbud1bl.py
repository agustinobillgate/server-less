...
def prepare_guestbud1bl(gastnr:int, user_init:string):
    ...
    def generate_output():
        nonlocal price_decimal, bill_date, from_date, q1_list_data, bediener, guest, htparam, guestbud
        ...
        return {"price_decimal": price_decimal, "bill_date": bill_date, "from_date": from_date, "q1-list": q1_list_data}
