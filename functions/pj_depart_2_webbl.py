...
def pj_depart_2_webbl(pvilanguage:int, case_type:int, disptype:int, curr_date:date, froom:string, troom:string, ota_only:bool, setup_list_data:[Setup_list]):
    ...
    def generate_output():
        nonlocal tot_rm, tot_a, tot_c, tot_co, str_list_data, s_list_data, cl_list_data, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, lvcarea, all_remark, htparam, guest, zimkateg, reservation, res_line, history, guestseg, nation, bill, mc_guest, mc_types, segment
