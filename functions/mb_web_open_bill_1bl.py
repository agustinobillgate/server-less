...
def mb_web_open_bill_1bl(bil_recid:int, foreign_rate:bool, double_currency:bool, ba_dept:int):
    ...
    def generate_output():
        ...
        return {"invno": invno, "gname": gname, "resname": resname, "rescomment": rescomment, "printed": printed, "rechnr": rechnr, "balance": balance, "balance_foreign": balance_foreign, "kreditlimit": kreditlimit, "enbtn_bareserve": enbtn_bareserve, "t-bill-line": t_bill_line_data, "t-bill": t_bill_data, "t-data": t_data_data}
