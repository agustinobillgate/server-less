...
def prepare_config_setup_save_horeka1bl():
    ...
    def generate_output():
        nonlocal custid, username, password, url_push, url_notif, storage, push_dml, art_deposit, api_key, supplier, coa_apdeposit, coa_apclearence, artikel_apclearence, usr_id, url_pr, tlist_data, loopi, str, queasy
