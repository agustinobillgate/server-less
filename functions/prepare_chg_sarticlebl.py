...
def prepare_chg_sarticlebl(artnr:int, changed:bool):
    ...
    def generate_output():
        nonlocal fibukonto, dml_art, bez_aend, s_unit, tt_artnr_data, tt_content_data, tt_bezeich_data, pict_file, recipe_bez, firma1, firma2, firma3, zw_bezeich, end_bezeich, set_disp1, set_disp2, set_disp3, set_disp4, artnr_ok, l_art_data, t_l_art_data, ttguestbook_data, ss_artnr, ss_content, ss_bezeich, i_counter, strartnr, lp_price, l_artikel, guestbook, l_bestand, l_ophis, htparam, h_rezept, l_lieferant, l_untergrup, l_hauptgrp, queasy
        nonlocal artnr, changed
        nonlocal lbuff


        nonlocal l_art, t_l_art, tt_artnr, tt_content, tt_bezeich, ttguestbook, lbuff
        nonlocal l_art_data, t_l_art_data, tt_artnr_data, tt_content_data, tt_bezeich_data, ttguestbook_data

        return {"fibukonto": fibukonto, "dml_art": dml_art, "bez_aend": bez_aend, "s_unit": s_unit, "tt-artnr": tt_artnr_data, "tt-content": tt_content_data, "tt-bezeich": tt_bezeich_data, "pict_file": pict_file, "recipe_bez": recipe_bez, "firma1": firma1, "firma2": firma2, "firma3": firma3, "zw_bezeich": zw_bezeich, "end_bezeich": end_bezeich, "set_disp1": set_disp1, "set_disp2": set_disp2, "set_disp3": set_disp3, "set_disp4": set_disp4, "artnr_ok": artnr_ok, "l-art": l_art_data, "t-l-art": t_l_art_data, "ttGuestBook": ttguestbook_data}
