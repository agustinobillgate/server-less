...
from models import Res_line, Htparam, Waehrung, Kontline, Zimmer, Guest, Zimkateg, Segment, Genstat, Exrate, Arrangement, Artikel, Fixleist, Reservation, Bill_line, Queasy, Reslin_queasy, Guestseg, Zinrstat, Outorder, Zkstat, Umsatz
...
def cr_occfcast1_2bl(segm_list_data:[Segm_list], argt_list_data:[Argt_list], zikat_list_data:[Zikat_list], outlook_list_data:[Outlook_list], pvilanguage:int, op_type:int, flag_i:int, curr_date:date, to_date:date, all_segm:bool, all_argt:bool, all_zikat:bool, exclooo:bool, incl_tent:bool, show_rev:int, vhp_limited:bool, excl_compl:bool, all_outlook:bool, incl_oth:bool):
    ...
    curr_time:int = 0
    res_line = htparam = waehrung = kontline = zimmer = guest = zimkateg = segment = genstat = exrate = arrangement = artikel = fixleist = reservation = bill_line = queasy = reslin_queasy = guestseg = zinrstat = outorder = zkstat = umsatz = None
