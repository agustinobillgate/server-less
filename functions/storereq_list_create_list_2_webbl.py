...
def storereq_list_create_list_2_webbl(from_date:date, to_date:date, from_dept:int, to_dept:int, curr_lschein:string, show_price:bool):
    ...
    def generate_output():
        nonlocal it_exist, t_list_data, sr_remark_list_data, appflag, long_digit, htparam, l_lager, l_op, l_artikel, l_ophdr, parameters, l_bestand, bediener, gl_acct, queasy
    ...
    def create_list():
        ...
        nonlocal it_exist, t_list_data, sr_remark_list_data, long_digit, htparam, l_lager, l_op, l_artikel, l_ophdr, parameters, l_bestand, bediener, gl_acct, queasy
        nonlocal from_date, to_date, from_dept, to_dept, curr_lschein, show_price
