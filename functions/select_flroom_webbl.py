...
def select_flroom_webbl(sel_type:int, etage:int, location:int):
    ...
    r_list_data, R_list = create_model("R_list", {"zinr":string, "bezeich":string, "location":int, "floor":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal r_list_data, zimmer, queasy
