...
def prepare_officer_admin_webbl():
    ...
    t_queasy_data, T_queasy = create_model_like(Queasy, {"rec_id":int, "char4":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal compli_dept, t_queasy_data, str, queasy, h_artikel


        nonlocal t_queasy
        nonlocal t_queasy_data

        return {"compli_dept": compli_dept, "t-queasy": t_queasy_data}
