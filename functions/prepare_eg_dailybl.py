...
def prepare_eg_dailybl(user_init:string):
    ...
    def generate_output():
        nonlocal engid, groupid, t_eg_resources_data, t_eg_cost_data, t_eg_budget_data, eg_cost, eg_resources, eg_budget, htparam, bediener
        nonlocal user_init


        nonlocal t_eg_cost, t_eg_resources, t_eg_budget
        nonlocal t_eg_cost_data, t_eg_resources_data, t_eg_budget_data

        return {"engid": engid, "groupid": groupid, "t-eg-resources": t_eg_resources_data, "t-eg-cost": t_eg_cost_data, "t-eg-budget": t_eg_budget_data}
