...
def dml_issue_create_dml_list_webbl(curr_dept:int, billdate:date):
    ...
    def generate_output():
        nonlocal dml_list_data, t_l_artikel_data, l_artikel, dml_art, l_lieferant, dml_artdep, reslin_queasy
    ...
    for dml_list in query(dml_list_data):
        ...
        if l_artikel:
            ...
            t_l_artikel = query(t_l_artikel_data, filters=(lambda t_l_artikel: t_l_artikel.artnr == l_artikel.artnr), first=True)
