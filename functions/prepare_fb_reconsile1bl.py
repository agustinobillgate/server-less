...
def prepare_fb_reconsile1bl():
    ...
    def generate_output():
        nonlocal food, bev, ldry, dstore, to_date, from_date, bill_date, foreign_nr, double_currency, exchg_rate, t_l_hauptgrp_data, htparam, waehrung, l_hauptgrp


        nonlocal t_l_hauptgrp
        nonlocal t_l_hauptgrp_data

        return {"food": food, "bev": bev, "ldry": ldry, "dstore": dstore, "to_date": to_date, "from_date": from_date, "bill_date": bill_date, "foreign_nr": foreign_nr, "double_currency": double_currency, "exchg_rate": exchg_rate, "t-l-hauptgrp": t_l_hauptgrp_data}
