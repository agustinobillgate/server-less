...
def fa_polist_btn_gobl(from_date:date, to_date:date, billdate:date, stat_order:int, lnumber:int, all_supp:bool, po_number:string, cost_list_data:[Cost_list], w_list_data:[W_list], username_data:[Username]):

    prepare_cache ([L_lieferant, Fa_ordheader])
    ...
    def generate_output():
        nonlocal temp_data, min_statorder, l_lieferant, fa_ordheader
