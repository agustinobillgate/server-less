...
def prepare_ts_rnonstaybl(dept:int):
    ...
    q1_list_data, Q1_list = create_model("Q1_list", {"rechnr":int, "resnr":int, "bill_name":string, "name":string, "gastnr":int, "anredefirma":string, "vorname1":string, "saldo":Decimal, "rec_id":int, "guest_rec_id":int})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal overcl_flag, mc_flag, q1_list_data, htparam, guest, bill
        nonlocal dept
        ...
        return {"overcl_flag": overcl_flag, "mc_flag": mc_flag, "q1-list": q1_list_data}
