...
def delete_manual_arbl(pvilanguage:int, rechnr:int, ar_recid:int):
    ...
    t_gl_journal_data, T_gl_journal = create_model_like(Gl_journal, {"b_recid":int})
    ...
    t_gl_journal_data = get_output(read_gl_journalbl(3, None, None, None, None, None, char1, "", "", None, None))

    t_gl_journal = query(t_gl_journal_data, first=True)
