...
def prepare_master_invbl(inp_rechnr:int, dept:int):
    ...
    def generate_output():
        nonlocal f_foinv_data, t_bill_data, t_guest_data, t_artikel_data, artikel, bill, guest, htparam, waehrung, brief, hoteldpt
        nonlocal inp_rechnr, dept


        nonlocal t_artikel, t_bill, t_guest, f_foinv
        nonlocal t_artikel_data, t_bill_data, t_guest_data, f_foinv_data

        return {"f-foinv": f_foinv_data, "t-bill": t_bill_data, "t-guest": t_guest_data, "t-artikel": t_artikel_data}
