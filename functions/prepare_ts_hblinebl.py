...
def prepare_ts_hblinebl(user_init:string, dept:int, curr_rechnr:int):
    ...
    def generate_output():
        nonlocal zero_flag, billdate, balance, max_gpos, menu_list_data, grp_list_data, curr_zwkum, fgcol_array, kellner, htparam, bediener, h_artikel, h_bill_line, wgrpdep
        ...
        return {"zero_flag": zero_flag, "billdate": billdate, "balance": balance, "max_gpos": max_gpos, "menu-list": menu_list_data, "grp-list": grp_list_data}
