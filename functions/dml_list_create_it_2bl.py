...
def dml_list_create_it_2bl(curr_dept:int, selected_date:date, dml_no:string):
    ...
    def generate_output():
        nonlocal supply_list_data, c_list_data, dml_counter, fill_dml_nr, dml_artdep, reslin_queasy, dml_art, l_artikel, l_untergrup, l_bestand, queasy, l_lieferant
        ...
        return {"supply-list": supply_list_data, "c-list": c_list_data}
