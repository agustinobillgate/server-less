...
def prepare_quick_postbl():
    ...
    def generate_output():
        nonlocal foreign_rate, double_currency, price_decimal, exchg_rate, curr_local, curr_foreign, t_hoteldpt_data, htparam, waehrung, hoteldpt


        nonlocal t_hoteldpt
        nonlocal t_hoteldpt_data

        return {"foreign_rate": foreign_rate, "double_currency": double_currency, "price_decimal": price_decimal, "exchg_rate": exchg_rate, "curr_local": curr_local, "curr_foreign": curr_foreign, "t-hoteldpt": t_hoteldpt_data}
