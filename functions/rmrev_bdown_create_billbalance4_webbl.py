...
def rmrev_bdown_create_billbalance4_webbl(exc_taxserv:bool, pvilanguage:int, new_contrate:bool, foreign_rate:bool, price_decimal:int, fdate:date, tdate:date, srttype:int):
    ...
    def generate_output():
        nonlocal cl_list_data, currency_list_data, sum_list_data, s_list_data, argt_list_data, exchg_rate, frate, post_it, total_rev, lvcarea, argt_line, waehrung, guest, artikel, htparam, res_line, zimmer, genstat, arrangement, exrate, reservation, billjournal, bill, segment, zimkateg, reslin_queasy
    ...
    def get_genstat_argt_betrag(frate:Decimal, argt_betrag:Decimal):
        ...
        nonlocal cl_list_data, currency_list_data, sum_list_data, s_list_data, argt_list_data, exchg_rate, post_it, total_rev, lvcarea, argt_line, waehrung, guest, artikel, htparam, res_line, zimmer, genstat, arrangement, exrate, reservation, billjournal, bill, segment, zimkateg, reslin_queasy
        nonlocal exc_taxserv, pvilanguage, new_contrate, foreign_rate, price_decimal, fdate, tdate, srttype
        nonlocal waehrung1, cc_list
