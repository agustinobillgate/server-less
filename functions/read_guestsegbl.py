...
def read_guestsegbl(case_type:int, gastno:int, segmcode:int):
    ...
    t_guestseg_data, T_guestseg = create_model_like(Guestseg)

    db_session = local_storage.db_session

    def generate_output():
        nonlocal t_guestseg_data, vipnr1, vipnr2, vipnr3, vipnr4, vipnr5, vipnr6, vipnr7, vipnr8, vipnr9, guestseg, segment
        nonlocal case_type, gastno, segmcode


        nonlocal t_guestseg
        nonlocal t_guestseg_data

        return {"t-guestseg": t_guestseg_data}
    ...
    if case_type == 1:
        ...
        if guestseg:
            ...
            t_guestseg_data.append(t_guestseg)
