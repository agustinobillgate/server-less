...
def eg_maincalendar_all_categorybl(all_room:bool, tcategory_data:[Tcategory], tlocation_data:[Tlocation], troom_data:[Troom]):
    ...
    def generate_output():
        nonlocal tmaintask_data, queasy, eg_property, eg_location
        nonlocal all_room
        ...
        return {"tmaintask": tmaintask_data}
