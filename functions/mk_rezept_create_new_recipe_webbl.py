...
def mk_rezept_create_new_recipe_webbl(s_rezlin_data:[S_rezlin], h_artnr:int, h_bezeich:string, katbezeich:string, katnr:int, portion:int, cost_percent:Decimal, poten_sell_price:Decimal):
