...
def prepare_ts_rnonstay_1bl(dept:int):
    ...
    q1_list_data, Q1_list = create_model("Q1_list", {"rechnr":int, "resnr":int, "bill_name":string, "name":string, "gastnr":int, "anredefirma":string, "vorname1":string, "saldo":Decimal, "rec_id":int, "guest_rec_id":int, "barcode":string})

    db_session = local_storage.db_session

    def generate_output():
        nonlocal overcl_flag, mc_flag, cashless_lic, min_saldo, q1_list_data, htparam, guest, bill
        nonlocal dept
        ...
        return {"overcl_flag": overcl_flag, "mc_flag": mc_flag, "cashless_lic": cashless_lic, "min_saldo": min_saldo, "q1-list": q1_list_data}
