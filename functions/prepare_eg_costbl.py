...
def prepare_eg_costbl(user_init:string):
    ...
    t_eg_cost_data, T_eg_cost = create_model_like(Eg_cost)

    db_session = local_storage.db_session

    def generate_output():
        nonlocal engid, groupid, ci_date, t_eg_resources_data, t_eg_budget_data, t_eg_cost_data, eg_resources, eg_budget, eg_cost, htparam, bediener
        nonlocal user_init


        nonlocal t_eg_resources, t_eg_budget, t_eg_cost
        nonlocal t_eg_resources_data, t_eg_budget_data, t_eg_cost_data

        return {"engid": engid, "groupid": groupid, "ci_date": ci_date, "t-eg-resources": t_eg_resources_data, "t-eg-budget": t_eg_budget_data, "t-eg-cost": t_eg_cost_data}
