...
class Htparam(Base):
	...
	def __init__(self, *args, **kwargs):
		...
		kwargs.setdefault('fchar', "")
		kwargs.setdefault('fdate', None)
		kwargs.setdefault('fdecimal', 0)
		kwargs.setdefault('fdefault', "")
		kwargs.setdefault('feldtyp', 0)
		kwargs.setdefault('finteger', 0)
		kwargs.setdefault('flogical', False)
		kwargs.setdefault('htp_help', "")
		kwargs.setdefault('lupdate', get_current_date())
		kwargs.setdefault('paramgruppe', 0)
		kwargs.setdefault('paramnr', 0)
		kwargs.setdefault('reihenfolge', 0)
		super(Htparam, self).__init__(*args, **kwargs)
